...
export const metadata: Metadata = {
  title: 'Full Jaw Atrophy | Surgical Procedures in Vellore | Indira Dental Clinic',
  description: 'Expert full jaw atrophy services in surgical procedures at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'full jaw atrophy, surgical procedures, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Full Jaw Atrophy | Surgical Procedures in Vellore',
    description: 'Expert full jaw atrophy in surgical procedures',
...
const schemaMarkup = {
  ...
  "name": "Full Jaw Atrophy",
  "description": "Professional full jaw atrophy at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is full jaw atrophy?",
    answer: "Full Jaw Atrophy is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is full jaw atrophy treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern surgical procedures techniques to address full jaw atrophy. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of full jaw atrophy treatment?",
  ...
  {
    question: "Is full jaw atrophy treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for full jaw atrophy?",
...
export default function FullJawAtrophyPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Full Jaw Atrophy" serviceSlug="full-jaw-atrophy" />
		</SectionContainer>
		...
		<PageHeader title="Full Jaw Atrophy" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Full Jaw Atrophy Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert full jaw atrophy care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Full Jaw Atrophy</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in surgical procedures 
                    including comprehensive full jaw atrophy care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert full jaw atrophy care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Full Jaw Atrophy?"
		...
		<StandardServiceLayout serviceName="Full Jaw Atrophy" serviceSlug="full-jaw-atrophy" showPriceComparison={false} />
)
}
