...
export const metadata: Metadata = {
  title: 'Jaw Atrophy | Surgical Procedures in Vellore | Indira Dental Clinic',
  description: 'Expert jaw atrophy services in surgical procedures at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'jaw atrophy, surgical procedures, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Jaw Atrophy | Surgical Procedures in Vellore',
    description: 'Expert jaw atrophy in surgical procedures',
...
const schemaMarkup = {
  ...
  "name": "Jaw Atrophy",
  "description": "Professional jaw atrophy at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is jaw atrophy?",
    answer: "Jaw Atrophy is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is jaw atrophy treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern surgical procedures techniques to address jaw atrophy. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of jaw atrophy treatment?",
  ...
  {
    question: "Is jaw atrophy treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for jaw atrophy?",
...
export default function JawAtrophyPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Jaw Atrophy" serviceSlug="jaw-atrophy" />
		</SectionContainer>
		...
		<PageHeader title="Jaw Atrophy" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Jaw Atrophy Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert jaw atrophy care at Indira Dental Clinic, Vellore. 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert jaw atrophy care in Vellore</p>
		...
		<StandardServiceLayout serviceName="Jaw Atrophy" serviceSlug="jaw-atrophy" showPriceComparison={false} />
)
}
