...
export const metadata: Metadata = {
  title: 'Chin Implant | Surgical Procedures in Vellore | Indira Dental Clinic',
  description: 'Expert chin implant services in surgical procedures at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'chin implant, surgical procedures, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Chin Implant | Surgical Procedures in Vellore',
    description: 'Expert chin implant in surgical procedures',
...
const schemaMarkup = {
  ...
  "name": "Chin Implant",
  "description": "Professional chin implant at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is chin implant?",
    answer: "Chin Implant is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is chin implant treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern surgical procedures techniques to address chin implant. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of chin implant treatment?",
  ...
  {
    question: "Is chin implant treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for chin implant?",
...
export default function ChinImplantPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Chin Implant" serviceSlug="chin-implant" />
		</SectionContainer>
		...
		<PageHeader title="Chin Implant" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Chin Implant Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert chin implant care at Indira Dental Clinic, Vellore. 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert chin implant care in Vellore</p>
		...
		<StandardServiceLayout serviceName="Chin Implant" serviceSlug="chin-implant" showPriceComparison={false} />
)
}
