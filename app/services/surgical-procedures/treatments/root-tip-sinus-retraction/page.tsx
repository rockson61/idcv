...
export const metadata: Metadata = {
  title: 'Root Tip Sinus Retraction | Surgical Procedures in Vellore | Indira Dental Clinic',
  description: 'Expert root tip sinus retraction services in surgical procedures at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'root tip sinus retraction, surgical procedures, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Root Tip Sinus Retraction | Surgical Procedures in Vellore',
    description: 'Expert root tip sinus retraction in surgical procedures',
...
const schemaMarkup = {
  ...
  "name": "Root Tip Sinus Retraction",
  "description": "Professional root tip sinus retraction at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is root tip sinus retraction?",
    answer: "Root Tip Sinus Retraction is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is root tip sinus retraction treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern surgical procedures techniques to address root tip sinus retraction. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of root tip sinus retraction treatment?",
  ...
  {
    question: "Is root tip sinus retraction treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for root tip sinus retraction?",
...
export default function RootTipSinusRetractionPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Root Tip Sinus Retraction" serviceSlug="root-tip-sinus-retraction" />
		</SectionContainer>
		...
		<PageHeader title="Root Tip Sinus Retraction" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Root Tip Sinus Retraction Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert root tip sinus retraction care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Root Tip Sinus Retraction</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in surgical procedures 
                    including comprehensive root tip sinus retraction care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert root tip sinus retraction care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Root Tip Sinus Retraction?"
		...
		<StandardServiceLayout serviceName="Root Tip Sinus Retraction" serviceSlug="root-tip-sinus-retraction" showPriceComparison={false} />
)
}
