...
export const metadata: Metadata = {
  title: 'Chin Autograft Mandibular | Surgical Procedures in Vellore | Indira Dental Clinic',
  description: 'Expert chin autograft mandibular services in surgical procedures at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'chin autograft mandibular, surgical procedures, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Chin Autograft Mandibular | Surgical Procedures in Vellore',
    description: 'Expert chin autograft mandibular in surgical procedures',
...
const schemaMarkup = {
  ...
  "name": "Chin Autograft Mandibular",
  "description": "Professional chin autograft mandibular at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is chin autograft mandibular?",
    answer: "Chin Autograft Mandibular is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is chin autograft mandibular treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern surgical procedures techniques to address chin autograft mandibular. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of chin autograft mandibular treatment?",
  ...
  {
    question: "Is chin autograft mandibular treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for chin autograft mandibular?",
...
export default function ChinAutograftMandibularPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Chin Autograft Mandibular" serviceSlug="chin-autograft-mandibular" />
		</SectionContainer>
		...
		<PageHeader title="Chin Autograft Mandibular" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Chin Autograft Mandibular Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert chin autograft mandibular care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Chin Autograft Mandibular</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in surgical procedures 
                    including comprehensive chin autograft mandibular care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert chin autograft mandibular care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Chin Autograft Mandibular?"
		...
		<StandardServiceLayout serviceName="Chin Autograft Mandibular" serviceSlug="chin-autograft-mandibular" showPriceComparison={false} />
)
}
