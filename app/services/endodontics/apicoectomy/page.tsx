  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Apicoectomy" serviceSlug="apicoectomy" />
		</SectionContainer>

      <SectionContainer className="py-8">
        <Breadcrumb 
		<PageHeader title="Apicoectomy" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Endodontics', href: '/services/endodontics' }, { title: 'Apicoectomy', href: '/services/endodontics/apicoectomy' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Apicoectomy Doctors in India - Dental Specialist Near Me</h1>
		...
		<CTAWidget title={`Book Apicoectomy`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />

		<StandardServiceLayout serviceName="Apicoectomy" serviceSlug="apicoectomy" showPriceComparison={false} />
)
}
