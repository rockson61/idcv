...
export const metadata: Metadata = {
  title: 'Mechanical Rct | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert mechanical rct services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'mechanical rct, endodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Mechanical Rct | Endodontics in Vellore',
    description: 'Expert mechanical rct in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Mechanical Rct",
  "description": "Professional mechanical rct at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is mechanical rct?",
    answer: "Mechanical Rct is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is mechanical rct treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address mechanical rct. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of mechanical rct treatment?",
  ...
  {
    question: "Is mechanical rct treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for mechanical rct?",
...
export default function MechanicalRctPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Mechanical Rct" serviceSlug="mechanical-rct" />
		</SectionContainer>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Mechanical Rct Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert mechanical rct care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Mechanical Rct</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in endodontics 
                    including comprehensive mechanical rct care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert mechanical rct care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Mechanical Rct?"
		...
		<StandardServiceLayout serviceName="Mechanical Rct" serviceSlug="mechanical-rct" showPriceComparison={false} />
)
}
