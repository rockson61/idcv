...
export const metadata: Metadata = {
  title: 'Manual Rct | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert manual rct services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'manual rct, endodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Manual Rct | Endodontics in Vellore',
    description: 'Expert manual rct in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Manual Rct",
  "description": "Professional manual rct at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is manual rct?",
    answer: "Manual Rct is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is manual rct treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address manual rct. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of manual rct treatment?",
  ...
  {
    question: "Is manual rct treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for manual rct?",
...
export default function ManualRctPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Manual Rct" serviceSlug="manual-rct" />
		</SectionContainer>
		...
		<PageHeader title="Manual Rct" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Manual Rct Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert manual rct care at Indira Dental Clinic, Vellore. 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert manual rct care in Vellore</p>
		...
		<StandardServiceLayout serviceName="Manual Rct" serviceSlug="manual-rct" showPriceComparison={false} />
)
}
