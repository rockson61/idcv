...
export const metadata: Metadata = {
  title: 'Antibiotics Root Canal | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert antibiotics root canal services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'antibiotics root canal, endodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Antibiotics Root Canal | Endodontics in Vellore',
    description: 'Expert antibiotics root canal in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Antibiotics Root Canal",
  "description": "Professional antibiotics root canal at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is antibiotics root canal?",
    answer: "Antibiotics Root Canal is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is antibiotics root canal treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address antibiotics root canal. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of antibiotics root canal treatment?",
  ...
  {
    question: "Is antibiotics root canal treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for antibiotics root canal?",
...
export default function AntibioticsRootCanalPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Antibiotics Root Canal" serviceSlug="antibiotics-root-canal" />
		</SectionContainer>
		...
		<PageHeader title="Antibiotics Root Canal" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Antibiotics Root Canal Doctors in India - Endodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert antibiotics root canal care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Antibiotics Root Canal</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in endodontics 
                    including comprehensive antibiotics root canal care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert antibiotics root canal care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Antibiotics Root Canal?"
		...
		<StandardServiceLayout serviceName="Antibiotics Root Canal" serviceSlug="antibiotics-root-canal" showPriceComparison={false} />
)
}
