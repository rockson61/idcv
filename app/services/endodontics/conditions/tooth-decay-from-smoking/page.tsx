...
export const metadata: Metadata = {
  title: 'Tooth Decay From Smoking | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert tooth decay from smoking services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'tooth decay from smoking, endodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Tooth Decay From Smoking | Endodontics in Vellore',
    description: 'Expert tooth decay from smoking in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Tooth Decay From Smoking",
  "description": "Professional tooth decay from smoking at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is tooth decay from smoking?",
    answer: "Tooth Decay From Smoking is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is tooth decay from smoking treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address tooth decay from smoking. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of tooth decay from smoking treatment?",
  ...
  {
    question: "Is tooth decay from smoking treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for tooth decay from smoking?",
...
export default function ToothDecayFromSmokingPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Tooth Decay From Smoking" serviceSlug="tooth-decay-from-smoking" />
		</SectionContainer>
		...
		<PageHeader title="Tooth Decay From Smoking" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Tooth Decay From Smoking Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert tooth decay from smoking care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Tooth Decay From Smoking</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in endodontics 
                    including comprehensive tooth decay from smoking care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert tooth decay from smoking care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Tooth Decay From Smoking?"
		...
		<StandardServiceLayout serviceName="Tooth Decay From Smoking" serviceSlug="tooth-decay-from-smoking" showPriceComparison={false} />
)
}
