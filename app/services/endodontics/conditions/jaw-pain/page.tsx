...
export const metadata: Metadata = {
  title: 'Jaw Pain | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert jaw pain services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'jaw pain, endodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Jaw Pain | Endodontics in Vellore',
    description: 'Expert jaw pain in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Jaw Pain",
  "description": "Professional jaw pain at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is jaw pain?",
    answer: "Jaw Pain is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is jaw pain treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address jaw pain. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of jaw pain treatment?",
  ...
  {
    question: "Is jaw pain treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for jaw pain?",
...
export default function JawPainPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Jaw Pain" serviceSlug="jaw-pain" />
		</SectionContainer>
		...
		<PageHeader title="Jaw Pain" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Jaw Pain Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert jaw pain care at Indira Dental Clinic, Vellore. 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert jaw pain care in Vellore</p>
		...
		<StandardServiceLayout serviceName="Jaw Pain" serviceSlug="jaw-pain" showPriceComparison={false} />
)
}
