...
export const metadata: Metadata = {
  title: 'Toothache Only At Night | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert toothache only at night services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'toothache only at night, endodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Toothache Only At Night | Endodontics in Vellore',
    description: 'Expert toothache only at night in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Toothache Only At Night",
  "description": "Professional toothache only at night at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is toothache only at night?",
    answer: "Toothache Only At Night is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is toothache only at night treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address toothache only at night. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of toothache only at night treatment?",
  ...
  {
    question: "Is toothache only at night treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for toothache only at night?",
...
export default function ToothacheOnlyAtNightPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Toothache Only At Night" serviceSlug="toothache-only-at-night" />
		</SectionContainer>
		...
		<PageHeader title="Toothache Only At Night" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Toothache Only At Night Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert toothache only at night care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Toothache Only At Night</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in endodontics 
                    including comprehensive toothache only at night care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert toothache only at night care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Toothache Only At Night?"
		...
		<StandardServiceLayout serviceName="Toothache Only At Night" serviceSlug="toothache-only-at-night" showPriceComparison={false} />
)
}
