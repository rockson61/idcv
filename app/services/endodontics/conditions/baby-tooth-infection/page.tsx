...
export const metadata: Metadata = {
  title: 'Baby Tooth Infection | Endodontics in Vellore | Indira Dental Clinic',
  description: 'Expert baby tooth infection services in endodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'baby tooth infection, endodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Baby Tooth Infection | Endodontics in Vellore',
    description: 'Expert baby tooth infection in endodontics',
...
const schemaMarkup = {
  ...
  "name": "Baby Tooth Infection",
  "description": "Professional baby tooth infection at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is baby tooth infection?",
    answer: "Baby Tooth Infection is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is baby tooth infection treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern endodontics techniques to address baby tooth infection. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of baby tooth infection treatment?",
  ...
  {
    question: "Is baby tooth infection treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for baby tooth infection?",
...
export default function BabyToothInfectionPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Baby Tooth Infection" serviceSlug="baby-tooth-infection" />
		</SectionContainer>
		...
		<PageHeader title="Baby Tooth Infection" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Baby Tooth Infection Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert baby tooth infection care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Baby Tooth Infection</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in endodontics 
                    including comprehensive baby tooth infection care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert baby tooth infection care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Baby Tooth Infection?"
		...
		<StandardServiceLayout serviceName="Baby Tooth Infection" serviceSlug="baby-tooth-infection" showPriceComparison={false} />
)
}
