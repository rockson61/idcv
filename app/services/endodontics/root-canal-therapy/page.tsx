...
export const metadata: Metadata = {
  title: 'Root Canal Therapy in Vellore | Indira Dental Clinic',
  description: 'Expert root canal therapy services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced root canal therapy with modern technology and affordable pricing.',
  keywords: 'root canal therapy, root canal therapy vellore, endodontics, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Root Canal Therapy in Vellore | Indira Dental Clinic',
    description: 'Expert root canal therapy services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional root canal therapy treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    ...
    answer: "Root Canal Therapy is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does root canal therapy cost in Vellore?",
    answer: "The cost of root canal therapy varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is root canal therapy painful?",
    answer: "Modern root canal therapy procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does root canal therapy take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for root canal therapy?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Root Canal Therapy" serviceSlug="root-canal-therapy" />
		</SectionContainer>
		...
		<PageHeader title="Root Canal Therapy" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Root Canal Therapy</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive root canal therapy services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Root Canal Therapy?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert root canal therapy treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Root Canal Therapy?"
		...
		<StandardServiceLayout serviceName="Root Canal Therapy" serviceSlug="root-canal-therapy" showPriceComparison={false} />
)
}
