...
export const metadata: Metadata = {
  title: "Teeth Whitening Cost in Delhi vs Vellore - Save 60% | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    "q": "How much does teeth whitening cost in Delhi?",
    "a": "Delhi: ₹8,000-25,000. Vellore (our clinic): ₹3,000-10,000 depending on method."
  },
  {
    "q": "Which teeth whitening is best?",
    "a": "Professional Zoom whitening provides fastest results (1-2 hours), home kits are gradual but effective."
  },
  {
    "q": "How long does teeth whitening last?",
    "a": "Results last 1-3 years with proper care and avoiding staining foods/drinks."
  }
]
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Teeth Whitening Cost in Delhi vs Vellore",
            "description": "Compare teeth whitening costs. Professional treatment at 60% less in Vellore.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
        <Breadcrumb items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Teeth Whitening Cost', href: '#' }]} />
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">Teeth Whitening Cost in Delhi vs Vellore</ModernCardTitle>
