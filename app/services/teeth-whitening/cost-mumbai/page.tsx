...
export const metadata: Metadata = {
  title: "Teeth Whitening Cost in Mumbai vs Vellore | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    "q": "Teeth whitening cost in Mumbai?",
    "a": "Mumbai: ₹10,000-30,000. Vellore (our clinic): ₹3,000-10,000 - Save ₹7,000-20,000!"
  },
  {
    "q": "Is teeth whitening safe?",
    "a": "Yes, professional whitening is completely safe when done by qualified dentist like Dr. Rockson Samuel."
  },
  {
    "q": "Can I get same results in Vellore as Mumbai?",
    "a": "Absolutely! We use same international products and advanced technology."
  }
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Teeth Whitening Cost in Mumbai vs Vellore",
            "description": "Save on teeth whitening - Mumbai prices vs Vellore. Same quality, 50% less cost.",
            "provider": {
              "@type": "Dentist",
...
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Teeth Whitening Cost', href: '#' }]} />
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">Teeth Whitening Cost in Mumbai vs Vellore</ModernCardTitle>
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Cost Mumbai" serviceSlug="cost-mumbai" showPriceComparison={false} />
)
}
