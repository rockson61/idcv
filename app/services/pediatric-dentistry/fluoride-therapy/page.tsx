...
export const metadata: Metadata = {
  title: 'Fluoride Therapy in Vellore | Indira Dental Clinic',
  description: 'Expert fluoride therapy services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced fluoride therapy with modern technology and affordable pricing.',
  keywords: 'fluoride therapy, fluoride therapy vellore, pediatric dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Fluoride Therapy in Vellore | Indira Dental Clinic',
    description: 'Expert fluoride therapy services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional fluoride therapy treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is fluoride therapy?",
    answer: "Fluoride Therapy is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does fluoride therapy cost in Vellore?",
    answer: "The cost of fluoride therapy varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is fluoride therapy painful?",
    answer: "Modern fluoride therapy procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does fluoride therapy take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for fluoride therapy?",
...
export default function FluorideTherapyPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Fluoride Therapy" serviceSlug="fluoride-therapy" />
		</SectionContainer>
		...
		<PageHeader title="Fluoride Therapy" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Pediatric Dentistry', href: '/services/pediatric-dentistry' },
                { title: 'Fluoride Therapy', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Fluoride Therapy Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert fluoride therapy services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Fluoride Therapy</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive fluoride therapy services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Fluoride Therapy?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert fluoride therapy treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Fluoride Therapy?"
		...
		<StandardServiceLayout serviceName="Fluoride Therapy" serviceSlug="fluoride-therapy" showPriceComparison={false} />
)
}
