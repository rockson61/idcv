...
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Pediatric Dentistry', href: '/services/pediatric-dentistry' }, { title: 'Dental Sealants', href: '/services/pediatric-dentistry/dental-sealants' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
		...
		<CTAWidget title={`Book Dental Sealants`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />
