...
export const metadata: Metadata = {
  title: "Bad Breath Home Remedies | Natural Halitosis Cure | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    "q": "How to get rid of bad breath permanently?",
    "a": "Proper oral hygiene, professional cleaning, treat gum disease, stay hydrated, and avoid smoking."
  },
  {
    "q": "What home remedy kills bad breath?",
    "a": "Rinse with salt water, chew fennel seeds, use baking soda paste, drink green tea, and eat apples/carrots."
  },
  {
    "q": "Can lemon cure bad breath?",
    "a": "Yes, lemon water helps temporarily by stimulating saliva production and killing bacteria."
  }
]
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Bad Breath Home Remedies That Actually Work",
            "description": "Effective home remedies for bad breath. Expert tips from Dr. Rockson Samuel.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
        <Breadcrumb items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Bad Breath Home Remedies That Actually Work', href: '#' }]} />
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">Bad Breath Home Remedies That Actually Work</ModernCardTitle>
