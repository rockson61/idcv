...
export const metadata: Metadata = {
  title: "Tooth Pain at Night | Why & How to Stop It | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    ...
    "a": "Lying down increases blood flow to the head, causing more pressure on the painful tooth."
  },
  {
    "q": "How to sleep with tooth pain?",
    "a": "Elevate your head, use cold compress, take pain medication, and avoid lying on the affected side."
  },
  {
    "q": "What can I do for tooth pain at night?",
    "a": "Rinse with salt water, apply clove oil, take pain medication, and book an emergency dental appointment."
  }
]
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Why Tooth Pain is Worse at Night & How to Stop It",
            "description": "Why tooth pain worsens at night and how to get relief. Expert guidance from Dr. Rockson Samuel.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Tooth Pain At Night" serviceSlug="tooth-pain-at-night" />
		</SectionContainer>

        <Breadcrumb

		<PageHeader title="Tooth Pain At Night" subtitle="Expert care with modern technology" />
          items={[
            { title: 'Home', href: '/' },
        ...
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">
              Why Tooth Pain is Worse at Night & How to Stop It
            </ModernCardTitle>
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Tooth Pain At Night" serviceSlug="tooth-pain-at-night" showPriceComparison={false} />
)
}
