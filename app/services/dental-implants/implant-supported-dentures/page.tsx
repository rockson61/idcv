...
export const metadata: Metadata = {
  title: 'Implant Supported Dentures in Vellore | Indira Dental Clinic',
  description: 'Expert implant supported dentures services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced implant supported dentures with modern technology and affordable pricing.',
  keywords: 'implant supported dentures, implant supported dentures vellore, dental implants, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Implant Supported Dentures in Vellore | Indira Dental Clinic',
    description: 'Expert implant supported dentures services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional implant supported dentures treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is implant supported dentures?",
    answer: "Implant Supported Dentures is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does implant supported dentures cost in Vellore?",
    answer: "The cost of implant supported dentures varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is implant supported dentures painful?",
    answer: "Modern implant supported dentures procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does implant supported dentures take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for implant supported dentures?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Implant Supported Dentures" serviceSlug="implant-supported-dentures" />
		</SectionContainer>
		...
		<PageHeader title="Implant Supported Dentures" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Implant Supported Dentures Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert implant supported dentures services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Implant Supported Dentures</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive implant supported dentures services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Implant Supported Dentures?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert implant supported dentures treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Implant Supported Dentures?"
		...
		<StandardServiceLayout serviceName="Implant Supported Dentures" serviceSlug="implant-supported-dentures" showPriceComparison={false} />
)
}
