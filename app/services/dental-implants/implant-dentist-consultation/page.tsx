...
export const metadata: Metadata = {
  title: 'Implant Dentist Consultation in Vellore | Indira Dental Clinic',
  description: 'Expert implant dentist consultation services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced implant dentist consultation with modern technology and affordable pricing.',
  keywords: 'implant dentist consultation, implant dentist consultation vellore, dental implants, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Implant Dentist Consultation in Vellore | Indira Dental Clinic',
    description: 'Expert implant dentist consultation services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Implant Dentist Consultation",
  "description": "Professional implant dentist consultation treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is implant dentist consultation?",
    answer: "Implant Dentist Consultation is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does implant dentist consultation cost in Vellore?",
    answer: "The cost of implant dentist consultation varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is implant dentist consultation painful?",
    answer: "Modern implant dentist consultation procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does implant dentist consultation take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for implant dentist consultation?",
    answer: "Dr. Rockson Samuel (BDS, PgDM, BDM) brings expertise in dental implants with 15+ years of experience, modern equipment, and affordable pricing in Vellore."
  }
];

export default function ImplantDentistConsultationPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Implant Dentist Consultation" serviceSlug="implant-dentist-consultation" />
		</SectionContainer>
		...
		<PageHeader title="Implant Dentist Consultation" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Implant Dentist Consultation Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert implant dentist consultation services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Implant Dentist Consultation</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive implant dentist consultation services 
                    using the latest technology and techniques. Dr. Rockson Samuel (BDS, PgDM, BDM | General Dentist & Community Leader - DentalReach) 
                    has over 15 years of experience in dental implants.
                  </p>
                  
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Implant Dentist Consultation?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert implant dentist consultation treatment in Vellore
                  </p>
              ...
              <ModernCard>
                ...
                <ModernCardContent>
                  <div className="space-y-2">
                    ...
                    >
                      <span className="text-gray-900 group-hover:text-teal-600">All Dental Implants Services</span>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Implant Dentist Consultation?"
		...
		<StandardServiceLayout serviceName="Implant Dentist Consultation" serviceSlug="implant-dentist-consultation" showPriceComparison={false} />
)
}
