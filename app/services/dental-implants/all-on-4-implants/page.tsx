...
export const metadata: Metadata = {
  title: 'All On 4 Implants in Vellore | Indira Dental Clinic',
  description: 'Expert all on 4 implants services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced all on 4 implants with modern technology and affordable pricing.',
  keywords: 'all on 4 implants, all on 4 implants vellore, dental implants, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'All On 4 Implants in Vellore | Indira Dental Clinic',
    description: 'Expert all on 4 implants services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional all on 4 implants treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    ...
    answer: "All On 4 Implants is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does all on 4 implants cost in Vellore?",
    answer: "The cost of all on 4 implants varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is all on 4 implants painful?",
    answer: "Modern all on 4 implants procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does all on 4 implants take?",
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert all on 4 implants services by Dr. Rockson Samuel at Indira Dental Clinic. 
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                ...
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive all on 4 implants services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for All On 4 Implants?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert all on 4 implants treatment in Vellore
                  </p>
