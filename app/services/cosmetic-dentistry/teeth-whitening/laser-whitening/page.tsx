...
export const metadata: Metadata = {
  title: 'Laser Whitening in Vellore | Indira Dental Clinic',
  description: 'Expert laser whitening services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced laser whitening with modern technology and affordable pricing.',
  keywords: 'laser whitening, laser whitening vellore, cosmetic dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Laser Whitening in Vellore | Indira Dental Clinic',
    description: 'Expert laser whitening services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional laser whitening treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is laser whitening?",
    answer: "Laser Whitening is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does laser whitening cost in Vellore?",
    answer: "The cost of laser whitening varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is laser whitening painful?",
    answer: "Modern laser whitening procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does laser whitening take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for laser whitening?",
...
export default function LaserWhiteningPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Laser Whitening" serviceSlug="laser-whitening" />
		</SectionContainer>
		...
		<PageHeader title="Laser Whitening" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Laser Whitening</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive laser whitening services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Laser Whitening?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert laser whitening treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Laser Whitening?"
		...
		<StandardServiceLayout serviceName="Laser Whitening" serviceSlug="laser-whitening" showPriceComparison={false} />
)
}
