  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-blue-50 to-purple-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Veneers" serviceSlug="veneers" />
		</SectionContainer>

      <SectionContainer className="py-8">
        <Breadcrumb 
		<PageHeader title="Veneers" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Cosmetic Dentistry', href: '/services/cosmetic-dentistry' }, { title: 'Veneers', href: '/services/cosmetic-dentistry/veneers' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
		...
		<CTAWidget title={`Book Veneers`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />

		<StandardServiceLayout serviceName="Veneers" serviceSlug="veneers" showPriceComparison={false} />
)
}
