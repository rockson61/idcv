...
export const metadata: Metadata = {
  title: 'Sinus Lift With Implant | Implantology in Vellore | Indira Dental Clinic',
  description: 'Expert sinus lift with implant services in implantology at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'sinus lift with implant, implantology, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Sinus Lift With Implant | Implantology in Vellore',
    description: 'Expert sinus lift with implant in implantology',
...
const schemaMarkup = {
  ...
  "name": "Sinus Lift With Implant",
  "description": "Professional sinus lift with implant at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is sinus lift with implant?",
    answer: "Sinus Lift With Implant is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is sinus lift with implant treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern implantology techniques to address sinus lift with implant. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of sinus lift with implant treatment?",
  ...
  {
    question: "Is sinus lift with implant treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for sinus lift with implant?",
...
export default function SinusLiftWithImplantPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Sinus Lift With Implant" serviceSlug="sinus-lift-with-implant" />
		</SectionContainer>
		...
		<PageHeader title="Sinus Lift With Implant" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Sinus Lift With Implant Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert sinus lift with implant care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Sinus Lift With Implant</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in implantology 
                    including comprehensive sinus lift with implant care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert sinus lift with implant care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Sinus Lift With Implant?"
		...
		<StandardServiceLayout serviceName="Sinus Lift With Implant" serviceSlug="sinus-lift-with-implant" showPriceComparison={false} />
)
}
