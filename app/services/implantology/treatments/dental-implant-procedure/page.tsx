...
export const metadata: Metadata = {
  title: 'Dental Implant Procedure | Implantology in Vellore | Indira Dental Clinic',
  description: 'Expert dental implant procedure services in implantology at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'dental implant procedure, implantology, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Dental Implant Procedure | Implantology in Vellore',
    description: 'Expert dental implant procedure in implantology',
...
const schemaMarkup = {
  ...
  "description": "Professional dental implant procedure at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is dental implant procedure?",
    answer: "Dental Implant Procedure is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is dental implant procedure treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern implantology techniques to address dental implant procedure. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of dental implant procedure treatment?",
  ...
  {
    question: "Is dental implant procedure treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for dental implant procedure?",
...
export default function DentalImplantProcedurePage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Dental Implant Procedure" serviceSlug="dental-implant-procedure" />
		</SectionContainer>
		...
		<PageHeader title="Dental Implant Procedure" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dental Implant Procedure Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert dental implant procedure care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Dental Implant Procedure</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in implantology 
                    including comprehensive dental implant procedure care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert dental implant procedure care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Dental Implant Procedure?"
		...
		<StandardServiceLayout serviceName="Dental Implant Procedure" serviceSlug="dental-implant-procedure" showPriceComparison={false} />
)
}
