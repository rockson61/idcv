...
export const metadata: Metadata = {
  title: 'All On 4 Implants | Implantology in Vellore | Indira Dental Clinic',
  description: 'Expert all on 4 implants services in implantology at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'all on 4 implants, implantology, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'All On 4 Implants | Implantology in Vellore',
    description: 'Expert all on 4 implants in implantology',
...
const schemaMarkup = {
  ...
  "description": "Professional all on 4 implants at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is all on 4 implants?",
    answer: "All On 4 Implants is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is all on 4 implants treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern implantology techniques to address all on 4 implants. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of all on 4 implants treatment?",
  ...
  {
    question: "Is all on 4 implants treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for all on 4 implants?",
...
export default function AllOn4ImplantsPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="All On 4 Implants" serviceSlug="all-on-4-implants" />
		</SectionContainer>
		...
		<PageHeader title="All On 4 Implants" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best All On 4 Implants Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert all on 4 implants care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About All On 4 Implants</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in implantology 
                    including comprehensive all on 4 implants care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert all on 4 implants care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for All On 4 Implants?"
		...
		<StandardServiceLayout serviceName="All On 4 Implants" serviceSlug="all-on-4-implants" showPriceComparison={false} />
)
}
