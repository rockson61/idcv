...
export const metadata: Metadata = {
  title: "Bleeding Gums Treatment | Stop Gum Bleeding | Indira Dental Clinic",
...
export default function ServicePage() {
  ...
  {
    "q": "Why do gums bleed?",
    "a": "Common causes include gingivitis, vitamin deficiency, aggressive brushing, and certain medications."
  },
  {
    "q": "How to stop gum bleeding immediately?",
    "a": "Apply pressure with gauze, rinse with salt water, use ice pack, and avoid hot foods."
  },
  {
    "q": "Can bleeding gums be cured?",
    "a": "Yes, with professional cleaning, proper oral hygiene, and addressing underlying causes."
  }
]
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Bleeding Gums Treatment in Vellore",
            "description": "Stop bleeding gums permanently. Expert treatment by Dr. Rockson Samuel, Vellore.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Bleeding Gums Treatment" serviceSlug="bleeding-gums-treatment" />
		</SectionContainer>

        <Breadcrumb

		<PageHeader title="Bleeding Gums Treatment" subtitle="Expert care with modern technology" />
          items={[
            { title: 'Home', href: '/' },
            { title: 'Services', href: '/services' },
            { title: 'Bleeding Gums Treatment', href: '#' }
          ]}
        />
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Bleeding Gums Treatment" serviceSlug="bleeding-gums-treatment" showPriceComparison={false} />
)
}
