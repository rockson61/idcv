...
export const metadata: Metadata = {
  title: "Laser Gum Treatment in Vellore | Modern Therapy | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    ...
    "a": "No, laser treatment is virtually painless and requires minimal anesthesia."
  },
  {
    "q": "How long does laser gum treatment take?",
    "a": "Treatment time varies but typically takes 1-2 hours depending on severity."
  },
  {
    "q": "What are benefits of laser gum treatment?",
    "a": "Less pain, faster healing, reduced bleeding, lower infection risk, and more precise treatment."
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Laser Gum Treatment in Vellore",
            "description": "Advanced laser gum treatment for gum disease. Painless and effective therapy by Dr. Rockson Samuel.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Laser Gum Treatment" serviceSlug="laser-gum-treatment" />
		</SectionContainer>

        <Breadcrumb 
		<PageHeader title="Laser Gum Treatment" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Laser Gum Treatment', href: '#' }]} />
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">Laser Gum Treatment in Vellore</ModernCardTitle>
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Laser Gum Treatment" serviceSlug="laser-gum-treatment" showPriceComparison={false} />
)
}
