  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-orange-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Periodontics Doctors in India - Dental Specialist Near Me</h1>
      ...
      <SectionContainer className="py-16 bg-gradient-to-r from-red-50/50 to-pink-50/50">
		...
		<StandardServiceLayout serviceName="Periodontics" serviceSlug="periodontics" showPriceComparison={false} />
)
}
