    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Gum Recession Treatment" serviceSlug="gum-recession-treatment" />
		</SectionContainer>
		...
		<PageHeader title="Gum Recession Treatment" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
		...
		<StandardServiceLayout serviceName="Gum Recession Treatment" serviceSlug="gum-recession-treatment" showPriceComparison={false} />
)
}
