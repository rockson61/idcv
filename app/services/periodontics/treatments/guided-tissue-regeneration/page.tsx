...
export const metadata: Metadata = {
  title: 'Guided Tissue Regeneration | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert guided tissue regeneration services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'guided tissue regeneration, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Guided Tissue Regeneration | Periodontics in Vellore',
    description: 'Expert guided tissue regeneration in periodontics',
...
const schemaMarkup = {
  ...
  "description": "Professional guided tissue regeneration at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is guided tissue regeneration?",
    answer: "Guided Tissue Regeneration is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is guided tissue regeneration treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address guided tissue regeneration. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of guided tissue regeneration treatment?",
  ...
  {
    question: "Is guided tissue regeneration treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for guided tissue regeneration?",
...
export default function GuidedTissueRegenerationPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Guided Tissue Regeneration" serviceSlug="guided-tissue-regeneration" />
		</SectionContainer>
		...
		<PageHeader title="Guided Tissue Regeneration" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Periodontics', href: '/services/periodontics' },
                { title: 'Treatments', href: '/services/periodontics/treatments' },
                { title: 'Guided Tissue Regeneration', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Guided Tissue Regeneration Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert guided tissue regeneration care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Guided Tissue Regeneration</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive guided tissue regeneration care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert guided tissue regeneration care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Guided Tissue Regeneration?"
		...
		<StandardServiceLayout serviceName="Guided Tissue Regeneration" serviceSlug="guided-tissue-regeneration" showPriceComparison={false} />
)
}
