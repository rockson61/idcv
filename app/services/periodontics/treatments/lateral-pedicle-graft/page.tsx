...
export const metadata: Metadata = {
  title: 'Lateral Pedicle Graft | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert lateral pedicle graft services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'lateral pedicle graft, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Lateral Pedicle Graft | Periodontics in Vellore',
    description: 'Expert lateral pedicle graft in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Lateral Pedicle Graft",
  "description": "Professional lateral pedicle graft at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is lateral pedicle graft?",
    answer: "Lateral Pedicle Graft is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is lateral pedicle graft treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address lateral pedicle graft. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of lateral pedicle graft treatment?",
  ...
  {
    question: "Is lateral pedicle graft treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for lateral pedicle graft?",
...
export default function LateralPedicleGraftPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Lateral Pedicle Graft" serviceSlug="lateral-pedicle-graft" />
		</SectionContainer>
		...
		<PageHeader title="Lateral Pedicle Graft" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Lateral Pedicle Graft Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert lateral pedicle graft care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Lateral Pedicle Graft</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive lateral pedicle graft care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert lateral pedicle graft care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Lateral Pedicle Graft?"
		...
		<StandardServiceLayout serviceName="Lateral Pedicle Graft" serviceSlug="lateral-pedicle-graft" showPriceComparison={false} />
)
}
