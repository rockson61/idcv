...
export const metadata: Metadata = {
  title: 'Periodontal Cleaning | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert periodontal cleaning services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'periodontal cleaning, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Periodontal Cleaning | Periodontics in Vellore',
    description: 'Expert periodontal cleaning in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Periodontal Cleaning",
  "description": "Professional periodontal cleaning at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is periodontal cleaning?",
    answer: "Periodontal Cleaning is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is periodontal cleaning treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address periodontal cleaning. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of periodontal cleaning treatment?",
  ...
  {
    question: "Is periodontal cleaning treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for periodontal cleaning?",
...
export default function PeriodontalCleaningPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Periodontal Cleaning" serviceSlug="periodontal-cleaning" />
		</SectionContainer>
		...
		<PageHeader title="Periodontal Cleaning" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Periodontal Cleaning Doctors in India - Periodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert periodontal cleaning care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Periodontal Cleaning</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive periodontal cleaning care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert periodontal cleaning care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Periodontal Cleaning?"
		...
		<StandardServiceLayout serviceName="Periodontal Cleaning" serviceSlug="periodontal-cleaning" showPriceComparison={false} />
)
}
