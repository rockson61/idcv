...
export const metadata: Metadata = {
  title: 'Scaling And Root Planing | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert scaling and root planing services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'scaling and root planing, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Scaling And Root Planing | Periodontics in Vellore',
    description: 'Expert scaling and root planing in periodontics',
...
const schemaMarkup = {
  ...
  "description": "Professional scaling and root planing at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    ...
    answer: "Scaling And Root Planing is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is scaling and root planing treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address scaling and root planing. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of scaling and root planing treatment?",
  ...
  {
    question: "Is scaling and root planing treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for scaling and root planing?",
...
export default function ScalingAndRootPlaningPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Scaling And Root Planing" serviceSlug="scaling-and-root-planing" />
		</SectionContainer>
		...
		<PageHeader title="Scaling And Root Planing" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Scaling And Root Planing Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert scaling and root planing care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Scaling And Root Planing</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive scaling and root planing care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert scaling and root planing care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Scaling And Root Planing?"
		...
		<StandardServiceLayout serviceName="Scaling And Root Planing" serviceSlug="scaling-and-root-planing" showPriceComparison={false} />
)
}
