...
export const metadata: Metadata = {
  title: 'Prophylaxis With Recession | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert prophylaxis with recession services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'prophylaxis with recession, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Prophylaxis With Recession | Periodontics in Vellore',
    description: 'Expert prophylaxis with recession in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Prophylaxis With Recession",
  "description": "Professional prophylaxis with recession at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is prophylaxis with recession?",
    answer: "Prophylaxis With Recession is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is prophylaxis with recession treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address prophylaxis with recession. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of prophylaxis with recession treatment?",
  ...
  {
    question: "Is prophylaxis with recession treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for prophylaxis with recession?",
...
export default function ProphylaxisWithRecessionPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Prophylaxis With Recession" serviceSlug="prophylaxis-with-recession" />
		</SectionContainer>
		...
		<PageHeader title="Prophylaxis With Recession" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Periodontics', href: '/services/periodontics' },
                { title: 'Treatments', href: '/services/periodontics/treatments' },
                { title: 'Prophylaxis With Recession', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Prophylaxis With Recession Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert prophylaxis with recession care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Prophylaxis With Recession</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive prophylaxis with recession care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert prophylaxis with recession care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Prophylaxis With Recession?"
		...
		<StandardServiceLayout serviceName="Prophylaxis With Recession" serviceSlug="prophylaxis-with-recession" showPriceComparison={false} />
)
}
