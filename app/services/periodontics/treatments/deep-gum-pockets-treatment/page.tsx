...
export const metadata: Metadata = {
  title: 'Deep Gum Pockets Treatment | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert deep gum pockets treatment services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'deep gum pockets treatment, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Deep Gum Pockets Treatment | Periodontics in Vellore',
    description: 'Expert deep gum pockets treatment in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Deep Gum Pockets Treatment",
  "description": "Professional deep gum pockets treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is deep gum pockets treatment?",
    answer: "Deep Gum Pockets Treatment is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is deep gum pockets treatment treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address deep gum pockets treatment. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of deep gum pockets treatment treatment?",
  ...
  {
    question: "Is deep gum pockets treatment treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for deep gum pockets treatment?",
...
export default function DeepGumPocketsTreatmentPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Deep Gum Pockets Treatment" serviceSlug="deep-gum-pockets-treatment" />
		</SectionContainer>
		...
		<PageHeader title="Deep Gum Pockets Treatment" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Deep Gum Pockets Treatment Doctors in India - Periodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert deep gum pockets treatment care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Deep Gum Pockets Treatment</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive deep gum pockets treatment care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert deep gum pockets treatment care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Deep Gum Pockets Treatment?"
		...
		<StandardServiceLayout serviceName="Deep Gum Pockets Treatment" serviceSlug="deep-gum-pockets-treatment" showPriceComparison={false} />
)
}
