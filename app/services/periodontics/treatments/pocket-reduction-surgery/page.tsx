...
export const metadata: Metadata = {
  title: 'Pocket Reduction Surgery | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert pocket reduction surgery services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'pocket reduction surgery, periodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Pocket Reduction Surgery | Periodontics in Vellore',
    description: 'Expert pocket reduction surgery in periodontics',
...
const schemaMarkup = {
  ...
  "description": "Professional pocket reduction surgery at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is pocket reduction surgery?",
    answer: "Pocket Reduction Surgery is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is pocket reduction surgery treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address pocket reduction surgery. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of pocket reduction surgery treatment?",
  ...
  {
    question: "Is pocket reduction surgery treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for pocket reduction surgery?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Pocket Reduction Surgery" serviceSlug="pocket-reduction-surgery" />
		</SectionContainer>
		...
		<PageHeader title="Pocket Reduction Surgery" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Pocket Reduction Surgery Doctors in India - Oral Surgeon Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert pocket reduction surgery care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Pocket Reduction Surgery</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive pocket reduction surgery care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert pocket reduction surgery care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Pocket Reduction Surgery?"
