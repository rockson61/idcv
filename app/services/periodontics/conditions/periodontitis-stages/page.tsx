...
export const metadata: Metadata = {
  title: 'Periodontitis Stages | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert periodontitis stages services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'periodontitis stages, periodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Periodontitis Stages | Periodontics in Vellore',
    description: 'Expert periodontitis stages in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Periodontitis Stages",
  "description": "Professional periodontitis stages at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is periodontitis stages?",
    answer: "Periodontitis Stages is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is periodontitis stages treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address periodontitis stages. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of periodontitis stages treatment?",
  ...
  {
    question: "Is periodontitis stages treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for periodontitis stages?",
...
export default function PeriodontitisStagesPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Periodontitis Stages" serviceSlug="periodontitis-stages" />
		</SectionContainer>
		...
		<PageHeader title="Periodontitis Stages" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Periodontitis Stages Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert periodontitis stages care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Periodontitis Stages</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive periodontitis stages care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert periodontitis stages care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Periodontitis Stages?"
		...
		<StandardServiceLayout serviceName="Periodontitis Stages" serviceSlug="periodontitis-stages" showPriceComparison={false} />
)
}
