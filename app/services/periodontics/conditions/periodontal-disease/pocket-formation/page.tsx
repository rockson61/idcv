...
export const metadata: Metadata = {
  title: 'Periodontal Disease   pocket Formation | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert periodontal disease   pocket formation services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'periodontal disease   pocket formation, periodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Periodontal Disease   pocket Formation | Periodontics in Vellore',
    description: 'Expert periodontal disease   pocket formation in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Periodontal Disease   pocket Formation",
  "description": "Professional periodontal disease   pocket formation at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is periodontal disease   pocket formation?",
    answer: "Periodontal Disease   pocket Formation is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is periodontal disease   pocket formation treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address periodontal disease   pocket formation. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of periodontal disease   pocket formation treatment?",
  ...
  {
    question: "Is periodontal disease   pocket formation treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for periodontal disease   pocket formation?",
...
export default function PeriodontalDiseasepocketFormationPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Pocket Formation" serviceSlug="pocket-formation" />
		</SectionContainer>
		...
		<PageHeader title="Pocket Formation" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Pocket Formation Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert periodontal disease   pocket formation care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Periodontal Disease   pocket Formation</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive periodontal disease   pocket formation care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert periodontal disease   pocket formation care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Periodontal Disease   pocket Formation?"
		...
		<StandardServiceLayout serviceName="Pocket Formation" serviceSlug="pocket-formation" showPriceComparison={false} />
)
}
