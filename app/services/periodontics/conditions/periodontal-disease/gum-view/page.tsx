...
export const metadata: Metadata = {
  title: 'Periodontal Disease   gum View | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert periodontal disease   gum view services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'periodontal disease   gum view, periodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Periodontal Disease   gum View | Periodontics in Vellore',
    description: 'Expert periodontal disease   gum view in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Periodontal Disease   gum View",
  "description": "Professional periodontal disease   gum view at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is periodontal disease   gum view?",
    answer: "Periodontal Disease   gum View is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is periodontal disease   gum view treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address periodontal disease   gum view. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of periodontal disease   gum view treatment?",
  ...
  {
    question: "Is periodontal disease   gum view treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for periodontal disease   gum view?",
...
export default function PeriodontalDiseasegumViewPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Gum View" serviceSlug="gum-view" />
		</SectionContainer>
		...
		<PageHeader title="Gum View" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Gum View Doctors in India - Periodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert periodontal disease   gum view care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Periodontal Disease   gum View</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive periodontal disease   gum view care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert periodontal disease   gum view care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Periodontal Disease   gum View?"
		...
		<StandardServiceLayout serviceName="Gum View" serviceSlug="gum-view" showPriceComparison={false} />
)
}
