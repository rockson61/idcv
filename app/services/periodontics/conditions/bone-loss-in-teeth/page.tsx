...
export const metadata: Metadata = {
  title: 'Bone Loss In Teeth | Periodontics in Vellore | Indira Dental Clinic',
  description: 'Expert bone loss in teeth services in periodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'bone loss in teeth, periodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Bone Loss In Teeth | Periodontics in Vellore',
    description: 'Expert bone loss in teeth in periodontics',
...
const schemaMarkup = {
  ...
  "name": "Bone Loss In Teeth",
  "description": "Professional bone loss in teeth at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is bone loss in teeth?",
    answer: "Bone Loss In Teeth is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is bone loss in teeth treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern periodontics techniques to address bone loss in teeth. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of bone loss in teeth treatment?",
  ...
  {
    question: "Is bone loss in teeth treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for bone loss in teeth?",
...
export default function BoneLossInTeethPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Bone Loss In Teeth" serviceSlug="bone-loss-in-teeth" />
		</SectionContainer>
		...
		<PageHeader title="Bone Loss In Teeth" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Bone Loss In Teeth Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert bone loss in teeth care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Bone Loss In Teeth</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in periodontics 
                    including comprehensive bone loss in teeth care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert bone loss in teeth care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Bone Loss In Teeth?"
		...
		<StandardServiceLayout serviceName="Bone Loss In Teeth" serviceSlug="bone-loss-in-teeth" showPriceComparison={false} />
)
}
