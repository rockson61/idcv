    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Gum Infection Treatment" serviceSlug="gum-infection-treatment" />
		</SectionContainer>

        <Breadcrumb

		<PageHeader title="Gum Infection Treatment" subtitle="Expert care with modern technology" />
          items={[
            { title: 'Home', href: '/' },
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Gum Infection Treatment" serviceSlug="gum-infection-treatment" showPriceComparison={false} />
)
}
