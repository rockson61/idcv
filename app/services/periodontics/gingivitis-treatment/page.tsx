...
export const metadata: Metadata = {
  title: 'Gingivitis Treatment in Vellore | Indira Dental Clinic',
  description: 'Expert gingivitis treatment services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced gingivitis treatment with modern technology and affordable pricing.',
  keywords: 'gingivitis treatment, gingivitis treatment vellore, periodontics, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Gingivitis Treatment in Vellore | Indira Dental Clinic',
    description: 'Expert gingivitis treatment services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional gingivitis treatment treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is gingivitis treatment?",
    answer: "Gingivitis Treatment is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does gingivitis treatment cost in Vellore?",
    answer: "The cost of gingivitis treatment varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is gingivitis treatment painful?",
    answer: "Modern gingivitis treatment procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does gingivitis treatment take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for gingivitis treatment?",
...
export default function GingivitisTreatmentPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Gingivitis Treatment" serviceSlug="gingivitis-treatment" />
		</SectionContainer>
		...
		<PageHeader title="Gingivitis Treatment" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Gingivitis Treatment Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert gingivitis treatment services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Gingivitis Treatment</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive gingivitis treatment services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Gingivitis Treatment?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert gingivitis treatment treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Gingivitis Treatment?"
		...
		<StandardServiceLayout serviceName="Gingivitis Treatment" serviceSlug="gingivitis-treatment" showPriceComparison={false} />
)
}
