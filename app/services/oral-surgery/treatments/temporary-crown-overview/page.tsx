...
export const metadata: Metadata = {
  title: 'Temporary Crown Overview | Oral Surgery in Vellore | Indira Dental Clinic',
  description: 'Expert temporary crown overview services in oral surgery at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'temporary crown overview, oral surgery, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Temporary Crown Overview | Oral Surgery in Vellore',
    description: 'Expert temporary crown overview in oral surgery',
...
const schemaMarkup = {
  ...
  "name": "Temporary Crown Overview",
  "description": "Professional temporary crown overview at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is temporary crown overview?",
    answer: "Temporary Crown Overview is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is temporary crown overview treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern oral surgery techniques to address temporary crown overview. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of temporary crown overview treatment?",
  ...
  {
    question: "Is temporary crown overview treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for temporary crown overview?",
...
export default function TemporaryCrownOverviewPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Temporary Crown Overview" serviceSlug="temporary-crown-overview" />
		</SectionContainer>
		...
		<PageHeader title="Temporary Crown Overview" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Temporary Crown Overview Doctors in India - Prosthodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert temporary crown overview care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Temporary Crown Overview</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in oral surgery 
                    including comprehensive temporary crown overview care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert temporary crown overview care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Temporary Crown Overview?"
		...
		<StandardServiceLayout serviceName="Temporary Crown Overview" serviceSlug="temporary-crown-overview" showPriceComparison={false} />
)
}
