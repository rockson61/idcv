...
export const metadata: Metadata = {
  title: 'Gum Flap Surgery | Oral Surgery in Vellore | Indira Dental Clinic',
  description: 'Expert gum flap surgery services in oral surgery at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'gum flap surgery, oral surgery, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Gum Flap Surgery | Oral Surgery in Vellore',
    description: 'Expert gum flap surgery in oral surgery',
...
const faqs = [
  ...
  },
  {
    ...
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern oral surgery techniques to address gum flap surgery. The treatment is customized based on your specific needs and condition."
  },
  {
