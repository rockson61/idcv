...
export const metadata: Metadata = {
  title: 'Tooth Extraction Complications | Oral Surgery in Vellore | Indira Dental Clinic',
  description: 'Expert tooth extraction complications services in oral surgery at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'tooth extraction complications, oral surgery, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Tooth Extraction Complications | Oral Surgery in Vellore',
    description: 'Expert tooth extraction complications in oral surgery',
...
const schemaMarkup = {
  ...
  "name": "Tooth Extraction Complications",
  "description": "Professional tooth extraction complications at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is tooth extraction complications?",
    answer: "Tooth Extraction Complications is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is tooth extraction complications treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern oral surgery techniques to address tooth extraction complications. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of tooth extraction complications treatment?",
  ...
  {
    question: "Is tooth extraction complications treatment painful?",
    answer: "Modern oral surgery procedures are designed for patient comfort. We use advanced anesthesia and pain management techniques to ensure a comfortable experience."
  },
  {
    question: "Why choose Indira Dental Clinic for tooth extraction complications?",
    answer: "Dr. Rockson Samuel brings 15+ years of expertise in oral surgery, using state-of-the-art equipment and proven techniques. We offer affordable pricing, personalized care, and excellent results."
  }
];

export default function ToothExtractionComplicationsPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Tooth Extraction Complications" serviceSlug="tooth-extraction-complications" />
		</SectionContainer>
		...
		<PageHeader title="Tooth Extraction Complications" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Tooth Extraction Complications Doctors in India - Oral Surgeon Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert tooth extraction complications care at Indira Dental Clinic, Vellore. 
              Dr. Rockson Samuel provides advanced oral surgery with modern technology and personalized treatment plans.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Tooth Extraction Complications</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in oral surgery 
                    including comprehensive tooth extraction complications care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert tooth extraction complications care in Vellore</p>
              ...
              <ModernCard>
                ...
                <ModernCardContent>
                  <div className="space-y-2">
                    ...
                    >
                      <span className="text-gray-900 group-hover:text-teal-600">All Oral Surgery</span>
          ...
          <CTAWidget 
            title="Ready for Tooth Extraction Complications?"
            description="Book your consultation with Dr. Rockson Samuel. Expert oral surgery, modern technology, affordable prices."
            primaryAction={{
		...
		<StandardServiceLayout serviceName="Tooth Extraction Complications" serviceSlug="tooth-extraction-complications" showPriceComparison={false} />
)
}
