...
export const metadata: Metadata = {
  title: 'Dental Abscess | Oral Surgery in Vellore | Indira Dental Clinic',
  description: 'Expert dental abscess services in oral surgery at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'dental abscess, oral surgery, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Dental Abscess | Oral Surgery in Vellore',
    description: 'Expert dental abscess in oral surgery',
...
const schemaMarkup = {
  ...
  "name": "Dental Abscess",
  "description": "Professional dental abscess at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    ...
    answer: "Dental Abscess is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is dental abscess treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern oral surgery techniques to address dental abscess. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of dental abscess treatment?",
  ...
  {
    question: "Is dental abscess treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for dental abscess?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Dental Abscess" serviceSlug="dental-abscess" />
		</SectionContainer>
		...
		<PageHeader title="Dental Abscess" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dental Abscess Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert dental abscess care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Dental Abscess</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in oral surgery 
                    including comprehensive dental abscess care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert dental abscess care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Dental Abscess?"
		...
		<StandardServiceLayout serviceName="Dental Abscess" serviceSlug="dental-abscess" showPriceComparison={false} />
)
}
