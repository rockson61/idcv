...
export const metadata: Metadata = {
  title: 'Gum Abscess | Oral Surgery in Vellore | Indira Dental Clinic',
  description: 'Expert gum abscess services in oral surgery at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'gum abscess, oral surgery, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Gum Abscess | Oral Surgery in Vellore',
    description: 'Expert gum abscess in oral surgery',
...
const schemaMarkup = {
  ...
  "name": "Gum Abscess",
  "description": "Professional gum abscess at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is gum abscess?",
    answer: "Gum Abscess is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is gum abscess treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern oral surgery techniques to address gum abscess. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of gum abscess treatment?",
  ...
  {
    question: "Is gum abscess treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for gum abscess?",
...
export default function GumAbscessPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Gum Abscess" serviceSlug="gum-abscess" />
		</SectionContainer>
		...
		<PageHeader title="Gum Abscess" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Gum Abscess Doctors in India - Periodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert gum abscess care at Indira Dental Clinic, Vellore. 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert gum abscess care in Vellore</p>
		...
		<StandardServiceLayout serviceName="Gum Abscess" serviceSlug="gum-abscess" showPriceComparison={false} />
)
}
