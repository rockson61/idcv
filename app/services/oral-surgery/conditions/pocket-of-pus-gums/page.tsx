...
export const metadata: Metadata = {
  title: 'Pocket Of Pus Gums | Oral Surgery in Vellore | Indira Dental Clinic',
  description: 'Expert pocket of pus gums services in oral surgery at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'pocket of pus gums, oral surgery, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Pocket Of Pus Gums | Oral Surgery in Vellore',
    description: 'Expert pocket of pus gums in oral surgery',
...
const schemaMarkup = {
  ...
  "name": "Pocket Of Pus Gums",
  "description": "Professional pocket of pus gums at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is pocket of pus gums?",
    answer: "Pocket Of Pus Gums is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is pocket of pus gums treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern oral surgery techniques to address pocket of pus gums. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of pocket of pus gums treatment?",
  ...
  {
    question: "Is pocket of pus gums treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for pocket of pus gums?",
...
export default function PocketOfPusGumsPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Pocket Of Pus Gums" serviceSlug="pocket-of-pus-gums" />
		</SectionContainer>
		...
		<PageHeader title="Pocket Of Pus Gums" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Pocket Of Pus Gums Doctors in India - Periodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert pocket of pus gums care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Pocket Of Pus Gums</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in oral surgery 
                    including comprehensive pocket of pus gums care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert pocket of pus gums care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Pocket Of Pus Gums?"
		...
		<StandardServiceLayout serviceName="Pocket Of Pus Gums" serviceSlug="pocket-of-pus-gums" showPriceComparison={false} />
)
}
