...
export const metadata: Metadata = {
  title: 'Oral Pathology in Vellore | Indira Dental Clinic',
  description: 'Expert oral pathology services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced oral pathology with modern technology and affordable pricing.',
  keywords: 'oral pathology, oral pathology vellore, oral surgery, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Oral Pathology in Vellore | Indira Dental Clinic',
    description: 'Expert oral pathology services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Oral Pathology",
  "description": "Professional oral pathology treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    ...
    answer: "Oral Pathology is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does oral pathology cost in Vellore?",
    answer: "The cost of oral pathology varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is oral pathology painful?",
    answer: "Modern oral pathology procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does oral pathology take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for oral pathology?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Oral Pathology" serviceSlug="oral-pathology" />
		</SectionContainer>
		...
		<PageHeader title="Oral Pathology" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert oral pathology services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Oral Pathology</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive oral pathology services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Oral Pathology?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert oral pathology treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Oral Pathology?"
		...
		<StandardServiceLayout serviceName="Oral Pathology" serviceSlug="oral-pathology" showPriceComparison={false} />
)
}
