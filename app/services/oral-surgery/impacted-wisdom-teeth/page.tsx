      ...
      <SectionContainer className="py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Impacted Wisdom Teeth Doctors in India - Oral Surgeon Near Me</h1>
		...
		<StandardServiceLayout serviceName="Impacted Wisdom Teeth" serviceSlug="impacted-wisdom-teeth" showPriceComparison={false} />
)
}
