...
export const metadata: Metadata = {
  title: 'Extractions in Vellore | Indira Dental Clinic',
  description: 'Expert extractions services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced extractions with modern technology and affordable pricing.',
  keywords: 'extractions, extractions vellore, oral surgery, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Extractions in Vellore | Indira Dental Clinic',
    description: 'Expert extractions services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Extractions",
  "description": "Professional extractions treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is extractions?",
    answer: "Extractions is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does extractions cost in Vellore?",
    answer: "The cost of extractions varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is extractions painful?",
    answer: "Modern extractions procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does extractions take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for extractions?",
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Extractions Doctors in India - Oral Surgeon Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert extractions services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Extractions</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive extractions services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Extractions?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert extractions treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="Extractions" serviceSlug="extractions" showPriceComparison={false} />
)
}
