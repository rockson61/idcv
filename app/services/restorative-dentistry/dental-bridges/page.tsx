...
export const metadata: Metadata = {
  title: 'Dental Bridges in Vellore | Indira Dental Clinic',
  description: 'Expert dental bridges services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced dental bridges with modern technology and affordable pricing.',
  keywords: 'dental bridges, dental bridges vellore, restorative dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Dental Bridges in Vellore | Indira Dental Clinic',
    description: 'Expert dental bridges services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Dental Bridges",
  "description": "Professional dental bridges treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is dental bridges?",
    answer: "Dental Bridges is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does dental bridges cost in Vellore?",
    answer: "The cost of dental bridges varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is dental bridges painful?",
    answer: "Modern dental bridges procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does dental bridges take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for dental bridges?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Dental Bridges" serviceSlug="dental-bridges" />
		</SectionContainer>
		...
		<PageHeader title="Dental Bridges" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Restorative Dentistry', href: '/services/restorative-dentistry' },
                { title: 'Dental Bridges', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert dental bridges services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Dental Bridges</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive dental bridges services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Dental Bridges?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert dental bridges treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Dental Bridges?"
		...
		<StandardServiceLayout serviceName="Dental Bridges" serviceSlug="dental-bridges" showPriceComparison={false} />
)
}
