...
export const metadata: Metadata = {
  title: 'Inlays Onlays in Vellore | Indira Dental Clinic',
  description: 'Expert inlays onlays services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced inlays onlays with modern technology and affordable pricing.',
  keywords: 'inlays onlays, inlays onlays vellore, restorative dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Inlays Onlays in Vellore | Indira Dental Clinic',
    description: 'Expert inlays onlays services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Inlays Onlays",
  "description": "Professional inlays onlays treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is inlays onlays?",
    answer: "Inlays Onlays is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does inlays onlays cost in Vellore?",
    answer: "The cost of inlays onlays varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is inlays onlays painful?",
    answer: "Modern inlays onlays procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does inlays onlays take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for inlays onlays?",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert inlays onlays services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Inlays Onlays</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive inlays onlays services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Inlays Onlays?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert inlays onlays treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="Inlays Onlays" serviceSlug="inlays-onlays" showPriceComparison={false} />
)
}
