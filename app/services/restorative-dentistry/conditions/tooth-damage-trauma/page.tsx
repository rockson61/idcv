...
export const metadata: Metadata = {
  title: 'Tooth Damage Trauma | Restorative Dentistry in Vellore | Indira Dental Clinic',
  description: 'Expert tooth damage trauma services in restorative dentistry at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'tooth damage trauma, restorative dentistry, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Tooth Damage Trauma | Restorative Dentistry in Vellore',
    description: 'Expert tooth damage trauma in restorative dentistry',
...
const schemaMarkup = {
  ...
  "name": "Tooth Damage Trauma",
  "description": "Professional tooth damage trauma at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is tooth damage trauma?",
    answer: "Tooth Damage Trauma is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is tooth damage trauma treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern restorative dentistry techniques to address tooth damage trauma. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of tooth damage trauma treatment?",
  ...
  {
    question: "Is tooth damage trauma treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for tooth damage trauma?",
...
export default function ToothDamageTraumaPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Tooth Damage Trauma" serviceSlug="tooth-damage-trauma" />
		</SectionContainer>
		...
		<PageHeader title="Tooth Damage Trauma" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Tooth Damage Trauma Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert tooth damage trauma care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Tooth Damage Trauma</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in restorative dentistry 
                    including comprehensive tooth damage trauma care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert tooth damage trauma care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Tooth Damage Trauma?"
		...
		<StandardServiceLayout serviceName="Tooth Damage Trauma" serviceSlug="tooth-damage-trauma" showPriceComparison={false} />
)
}
