...
export const metadata: Metadata = {
  title: 'Chipped Crown Exposed Metal | Restorative Dentistry in Vellore | Indira Dental Clinic',
  description: 'Expert chipped crown exposed metal services in restorative dentistry at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'chipped crown exposed metal, restorative dentistry, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Chipped Crown Exposed Metal | Restorative Dentistry in Vellore',
    description: 'Expert chipped crown exposed metal in restorative dentistry',
...
const schemaMarkup = {
  ...
  "name": "Chipped Crown Exposed Metal",
  "description": "Professional chipped crown exposed metal at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is chipped crown exposed metal?",
    answer: "Chipped Crown Exposed Metal is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is chipped crown exposed metal treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern restorative dentistry techniques to address chipped crown exposed metal. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of chipped crown exposed metal treatment?",
  ...
  {
    question: "Is chipped crown exposed metal treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for chipped crown exposed metal?",
...
export default function ChippedCrownExposedMetalPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Chipped Crown Exposed Metal" serviceSlug="chipped-crown-exposed-metal" />
		</SectionContainer>
		...
		<PageHeader title="Chipped Crown Exposed Metal" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Chipped Crown Exposed Metal</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in restorative dentistry 
                    including comprehensive chipped crown exposed metal care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert chipped crown exposed metal care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Chipped Crown Exposed Metal?"
		...
		<StandardServiceLayout serviceName="Chipped Crown Exposed Metal" serviceSlug="chipped-crown-exposed-metal" showPriceComparison={false} />
)
}
