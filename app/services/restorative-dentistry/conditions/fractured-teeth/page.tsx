...
export const metadata: Metadata = {
  title: 'Fractured Teeth | Restorative Dentistry in Vellore | Indira Dental Clinic',
  description: 'Expert fractured teeth services in restorative dentistry at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'fractured teeth, restorative dentistry, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Fractured Teeth | Restorative Dentistry in Vellore',
    description: 'Expert fractured teeth in restorative dentistry',
...
const schemaMarkup = {
  ...
  "name": "Fractured Teeth",
  "description": "Professional fractured teeth at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is fractured teeth?",
    answer: "Fractured Teeth is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is fractured teeth treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern restorative dentistry techniques to address fractured teeth. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of fractured teeth treatment?",
  ...
  {
    question: "Is fractured teeth treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for fractured teeth?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Fractured Teeth" serviceSlug="fractured-teeth" />
		</SectionContainer>
		...
		<PageHeader title="Fractured Teeth" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Fractured Teeth Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert fractured teeth care at Indira Dental Clinic, Vellore. 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert fractured teeth care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Fractured Teeth?"
		...
		<StandardServiceLayout serviceName="Fractured Teeth" serviceSlug="fractured-teeth" showPriceComparison={false} />
)
}
