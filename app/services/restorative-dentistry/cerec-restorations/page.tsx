...
export const metadata: Metadata = {
  title: 'Cerec Restorations in Vellore | Indira Dental Clinic',
  description: 'Expert cerec restorations services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced cerec restorations with modern technology and affordable pricing.',
  keywords: 'cerec restorations, cerec restorations vellore, restorative dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Cerec Restorations in Vellore | Indira Dental Clinic',
    description: 'Expert cerec restorations services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Cerec Restorations",
  "description": "Professional cerec restorations treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is cerec restorations?",
    answer: "Cerec Restorations is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does cerec restorations cost in Vellore?",
    answer: "The cost of cerec restorations varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is cerec restorations painful?",
    answer: "Modern cerec restorations procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does cerec restorations take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for cerec restorations?",
...
export default function CerecRestorationsPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Cerec Restorations" serviceSlug="cerec-restorations" />
		</SectionContainer>
		...
		<PageHeader title="Cerec Restorations" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Cerec Restorations</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive cerec restorations services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Cerec Restorations?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert cerec restorations treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Cerec Restorations?"
		...
		<StandardServiceLayout serviceName="Cerec Restorations" serviceSlug="cerec-restorations" showPriceComparison={false} />
)
}
