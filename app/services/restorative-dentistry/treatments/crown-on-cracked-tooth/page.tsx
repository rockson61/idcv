...
export const metadata: Metadata = {
  title: 'Crown On Cracked Tooth | Restorative Dentistry in Vellore | Indira Dental Clinic',
  description: 'Expert crown on cracked tooth services in restorative dentistry at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'crown on cracked tooth, restorative dentistry, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Crown On Cracked Tooth | Restorative Dentistry in Vellore',
    description: 'Expert crown on cracked tooth in restorative dentistry',
...
const schemaMarkup = {
  ...
  "name": "Crown On Cracked Tooth",
  "description": "Professional crown on cracked tooth at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is crown on cracked tooth?",
    answer: "Crown On Cracked Tooth is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is crown on cracked tooth treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern restorative dentistry techniques to address crown on cracked tooth. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of crown on cracked tooth treatment?",
  ...
  {
    question: "Is crown on cracked tooth treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for crown on cracked tooth?",
...
export default function CrownOnCrackedToothPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Crown On Cracked Tooth" serviceSlug="crown-on-cracked-tooth" />
		</SectionContainer>
		...
		<PageHeader title="Crown On Cracked Tooth" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Crown On Cracked Tooth Doctors in India - Prosthodontist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert crown on cracked tooth care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Crown On Cracked Tooth</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in restorative dentistry 
                    including comprehensive crown on cracked tooth care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert crown on cracked tooth care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Crown On Cracked Tooth?"
