...
export const metadata: Metadata = {
  title: 'Porcelain Fillings | Restorative Dentistry in Vellore | Indira Dental Clinic',
  description: 'Expert porcelain fillings services in restorative dentistry at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'porcelain fillings, restorative dentistry, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Porcelain Fillings | Restorative Dentistry in Vellore',
    description: 'Expert porcelain fillings in restorative dentistry',
...
const schemaMarkup = {
  ...
  "name": "Porcelain Fillings",
  "description": "Professional porcelain fillings at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is porcelain fillings?",
    answer: "Porcelain Fillings is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is porcelain fillings treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern restorative dentistry techniques to address porcelain fillings. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of porcelain fillings treatment?",
  ...
  {
    question: "Is porcelain fillings treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for porcelain fillings?",
...
export default function PorcelainFillingsPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Porcelain Fillings" serviceSlug="porcelain-fillings" />
		</SectionContainer>
		...
		<PageHeader title="Porcelain Fillings" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Porcelain Fillings Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert porcelain fillings care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Porcelain Fillings</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in restorative dentistry 
                    including comprehensive porcelain fillings care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert porcelain fillings care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Porcelain Fillings?"
		...
		<StandardServiceLayout serviceName="Porcelain Fillings" serviceSlug="porcelain-fillings" showPriceComparison={false} />
)
}
