...
export const metadata: Metadata = {
  title: 'Pfm Crown in Vellore | Indira Dental Clinic',
  description: 'Expert pfm crown services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced pfm crown with modern technology and affordable pricing.',
  keywords: 'pfm crown, pfm crown vellore, restorative dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Pfm Crown in Vellore | Indira Dental Clinic',
    description: 'Expert pfm crown services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Pfm Crown",
  "description": "Professional pfm crown treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is pfm crown?",
    answer: "Pfm Crown is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does pfm crown cost in Vellore?",
    answer: "The cost of pfm crown varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is pfm crown painful?",
    answer: "Modern pfm crown procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does pfm crown take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for pfm crown?",
...
export default function PfmCrownPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Pfm Crown" serviceSlug="pfm-crown" />
		</SectionContainer>
		...
		<PageHeader title="Pfm Crown" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Pfm Crown</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive pfm crown services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Pfm Crown?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert pfm crown treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="Pfm Crown" serviceSlug="pfm-crown" showPriceComparison={false} />
)
}
