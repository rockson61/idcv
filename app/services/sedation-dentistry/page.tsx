  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Sedation Dentistry" serviceSlug="sedation-dentistry" />
		</SectionContainer>

      <SectionContainer className="py-8">
        <Breadcrumb 
		<PageHeader title="Sedation Dentistry" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Sedation Dentistry', href: '/services/sedation-dentistry' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
		...
		<CTAWidget title={`Book Sedation Dentistry`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />

		<StandardServiceLayout serviceName="Sedation Dentistry" serviceSlug="sedation-dentistry" showPriceComparison={false} />
)
}
