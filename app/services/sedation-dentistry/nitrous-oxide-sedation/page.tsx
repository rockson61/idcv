...
export const metadata: Metadata = {
  title: 'Nitrous Oxide Sedation in Vellore | Indira Dental Clinic',
  description: 'Expert nitrous oxide sedation services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced nitrous oxide sedation with modern technology and affordable pricing.',
  keywords: 'nitrous oxide sedation, nitrous oxide sedation vellore, sedation dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Nitrous Oxide Sedation in Vellore | Indira Dental Clinic',
    description: 'Expert nitrous oxide sedation services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional nitrous oxide sedation treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is nitrous oxide sedation?",
    answer: "Nitrous Oxide Sedation is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does nitrous oxide sedation cost in Vellore?",
    answer: "The cost of nitrous oxide sedation varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is nitrous oxide sedation painful?",
    answer: "Modern nitrous oxide sedation procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does nitrous oxide sedation take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for nitrous oxide sedation?",
    answer: "Dr. Rockson Samuel (BDS, PgDM, BDM) brings expertise in sedation dentistry with 15+ years of experience, modern equipment, and affordable pricing in Vellore."
  }
];

export default function NitrousOxideSedationPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Nitrous Oxide Sedation" serviceSlug="nitrous-oxide-sedation" />
		</SectionContainer>
		...
		<PageHeader title="Nitrous Oxide Sedation" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Nitrous Oxide Sedation Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert nitrous oxide sedation services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Nitrous Oxide Sedation</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive nitrous oxide sedation services 
                    using the latest technology and techniques. Dr. Rockson Samuel (BDS, PgDM, BDM | General Dentist & Community Leader - DentalReach) 
                    has over 15 years of experience in sedation dentistry.
                  </p>
                  
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Nitrous Oxide Sedation?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert nitrous oxide sedation treatment in Vellore
                  </p>
              ...
              <ModernCard>
                ...
                <ModernCardContent>
                  <div className="space-y-2">
                    ...
                    >
                      <span className="text-gray-900 group-hover:text-teal-600">All Sedation Dentistry Services</span>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Nitrous Oxide Sedation?"
		...
		<StandardServiceLayout serviceName="Nitrous Oxide Sedation" serviceSlug="nitrous-oxide-sedation" showPriceComparison={false} />
)
}
