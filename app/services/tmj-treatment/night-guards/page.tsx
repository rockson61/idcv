...
export const metadata: Metadata = {
  title: 'Night Guards in Vellore | Indira Dental Clinic',
  description: 'Expert night guards services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced night guards with modern technology and affordable pricing.',
  keywords: 'night guards, night guards vellore, tmj treatment, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Night Guards in Vellore | Indira Dental Clinic',
    description: 'Expert night guards services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Night Guards",
  "description": "Professional night guards treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is night guards?",
    answer: "Night Guards is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does night guards cost in Vellore?",
    answer: "The cost of night guards varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is night guards painful?",
    answer: "Modern night guards procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does night guards take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for night guards?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Night Guards" serviceSlug="night-guards" />
		</SectionContainer>
		...
		<PageHeader title="Night Guards" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Night Guards Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert night guards services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Night Guards</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive night guards services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Night Guards?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert night guards treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="Night Guards" serviceSlug="night-guards" showPriceComparison={false} />
)
}
