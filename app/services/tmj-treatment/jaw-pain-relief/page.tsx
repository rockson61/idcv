...
export const metadata: Metadata = {
  title: "Jaw Pain Relief Treatment in Vellore | TMJ Cure | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    "q": "What helps jaw pain fast?",
    "a": "Apply ice/heat, take pain medication, do jaw exercises, avoid hard foods, and consult a dentist."
  },
  {
    "q": "How to relieve TMJ pain?",
    "a": "Gentle jaw exercises, stress reduction, proper bite alignment, and professional treatment can relieve TMJ pain."
  },
  {
    "q": "Is TMJ treatment expensive?",
    "a": "Cost varies by treatment. At Indira Dental Clinic, we offer affordable solutions with flexible payment plans."
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Jaw Pain Relief & TMJ Treatment in Vellore",
            "description": "Effective jaw pain relief and TMJ treatment by Dr. Rockson Samuel at Indira Dental Clinic.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Jaw Pain Relief" serviceSlug="jaw-pain-relief" />
		</SectionContainer>

        <Breadcrumb 
		<PageHeader title="Jaw Pain Relief" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Jaw Pain Relief & TMJ Treatment', href: '#' }]} />
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">Jaw Pain Relief & TMJ Treatment in Vellore</ModernCardTitle>
