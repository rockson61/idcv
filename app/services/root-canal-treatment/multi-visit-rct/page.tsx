...
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Multi Visit Rct' }]} />
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Multi Visit Rct Doctors in India - Dental Specialist Near Me</h1>
		...
		<StandardServiceLayout serviceName="Multi Visit Rct" serviceSlug="multi-visit-rct" showPriceComparison={false} />
)
}