...
export const metadata: Metadata = {
  title: "Root Canal Pain Management | Painless RCT Vellore | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    ...
    "a": "No, modern RCT is painless with proper anesthesia. You'll only feel pressure, no pain during procedure."
  },
  {
    "q": "What pain relief is used for RCT?",
    "a": "Local anesthesia, sedation dentistry, and post-treatment pain medication ensure complete comfort."
  },
  {
    "q": "How long does RCT pain last?",
    "a": "Mild discomfort for 2-3 days after treatment is normal. Pain medication helps manage it easily."
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Painless Root Canal Treatment in Vellore",
            "description": "Completely painless root canal treatment. Advanced pain management by Dr. Rockson Samuel.",
            "provider": {
              "@type": "Dentist",
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Pain Management" serviceSlug="pain-management" />
		</SectionContainer>

        <Breadcrumb 
		<PageHeader title="Pain Management" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Painless Root Canal Treatment', href: '#' }]} />
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Pain Management" serviceSlug="pain-management" showPriceComparison={false} />
)
}
