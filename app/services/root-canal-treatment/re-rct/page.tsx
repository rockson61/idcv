  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Re Rct" serviceSlug="re-rct" />
		</SectionContainer>

      <SectionContainer className="py-8">
        <Breadcrumb 
		<PageHeader title="Re Rct" subtitle="Expert care with modern technology" />
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Root Canal Treatment', href: '/services/root-canal-treatment' }, { title: 'Re-RCT', href: '/services/root-canal-treatment/re-rct' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Re Rct Doctors in India - Dental Specialist Near Me</h1>
		...
		<CTAWidget title={`Book Re Rct`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />

		<StandardServiceLayout serviceName="Re Rct" serviceSlug="re-rct" showPriceComparison={false} />
)
}
