...
export const metadata: Metadata = {
  title: 'Maxillary Excess Reduction | Orthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert maxillary excess reduction services in orthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'maxillary excess reduction, orthodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Maxillary Excess Reduction | Orthodontics in Vellore',
    description: 'Expert maxillary excess reduction in orthodontics',
...
const schemaMarkup = {
  ...
  "name": "Maxillary Excess Reduction",
  "description": "Professional maxillary excess reduction at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is maxillary excess reduction?",
    answer: "Maxillary Excess Reduction is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is maxillary excess reduction treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern orthodontics techniques to address maxillary excess reduction. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of maxillary excess reduction treatment?",
  ...
  {
    question: "Is maxillary excess reduction treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for maxillary excess reduction?",
...
export default function MaxillaryExcessReductionPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Maxillary Excess Reduction" serviceSlug="maxillary-excess-reduction" />
		</SectionContainer>
		...
		<PageHeader title="Maxillary Excess Reduction" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Maxillary Excess Reduction Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert maxillary excess reduction care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Maxillary Excess Reduction</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in orthodontics 
                    including comprehensive maxillary excess reduction care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert maxillary excess reduction care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Maxillary Excess Reduction?"
		...
		<StandardServiceLayout serviceName="Maxillary Excess Reduction" serviceSlug="maxillary-excess-reduction" showPriceComparison={false} />
)
}
