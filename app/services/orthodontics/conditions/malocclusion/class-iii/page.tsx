...
export const metadata: Metadata = {
  title: 'Malocclusion   class Iii | Orthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert malocclusion   class iii services in orthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'malocclusion   class iii, orthodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Malocclusion   class Iii | Orthodontics in Vellore',
    description: 'Expert malocclusion   class iii in orthodontics',
...
const schemaMarkup = {
  ...
  "name": "Malocclusion   class Iii",
  "description": "Professional malocclusion   class iii at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is malocclusion   class iii?",
    answer: "Malocclusion   class Iii is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is malocclusion   class iii treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern orthodontics techniques to address malocclusion   class iii. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of malocclusion   class iii treatment?",
  ...
  {
    question: "Is malocclusion   class iii treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for malocclusion   class iii?",
...
export default function MalocclusionclassIiiPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Class Iii" serviceSlug="class-iii" />
		</SectionContainer>
		...
		<PageHeader title="Class Iii" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Class Iii Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert malocclusion   class iii care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Malocclusion   class Iii</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in orthodontics 
                    including comprehensive malocclusion   class iii care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert malocclusion   class iii care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Malocclusion   class Iii?"
		...
		<StandardServiceLayout serviceName="Class Iii" serviceSlug="class-iii" showPriceComparison={false} />
)
}
