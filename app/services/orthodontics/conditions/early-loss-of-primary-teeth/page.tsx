...
export const metadata: Metadata = {
  title: 'Early Loss Of Primary Teeth | Orthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert early loss of primary teeth services in orthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'early loss of primary teeth, orthodontics, conditions, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Early Loss Of Primary Teeth | Orthodontics in Vellore',
    description: 'Expert early loss of primary teeth in orthodontics',
...
const schemaMarkup = {
  ...
  "name": "Early Loss Of Primary Teeth",
  "description": "Professional early loss of primary teeth at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is early loss of primary teeth?",
    answer: "Early Loss Of Primary Teeth is a dental condition that requires professional diagnosis and treatment. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is early loss of primary teeth treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern orthodontics techniques to address early loss of primary teeth. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of early loss of primary teeth treatment?",
  ...
  {
    question: "Is early loss of primary teeth treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for early loss of primary teeth?",
...
export default function EarlyLossOfPrimaryTeethPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Early Loss Of Primary Teeth" serviceSlug="early-loss-of-primary-teeth" />
		</SectionContainer>
		...
		<PageHeader title="Early Loss Of Primary Teeth" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Early Loss Of Primary Teeth Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert early loss of primary teeth care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Early Loss Of Primary Teeth</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in orthodontics 
                    including comprehensive early loss of primary teeth care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert early loss of primary teeth care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Early Loss Of Primary Teeth?"
		...
		<StandardServiceLayout serviceName="Early Loss Of Primary Teeth" serviceSlug="early-loss-of-primary-teeth" showPriceComparison={false} />
)
}
