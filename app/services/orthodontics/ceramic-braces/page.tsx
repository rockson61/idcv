...
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Orthodontics', href: '/services/orthodontics' }, { title: 'Ceramic Braces', href: '/services/orthodontics/ceramic-braces' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
		...
		<CTAWidget title={`Book Ceramic Braces`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />
