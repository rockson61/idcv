...
export const metadata: Metadata = {
  title: "Braces Cost in Mumbai vs Vellore - Price Comparison | Indira Dental Clinic",
...
export default function ServicePage() {
  const faqs = [
  {
    "q": "Braces cost in Mumbai?",
    "a": "Mumbai: ₹45,000-1,50,000. Vellore (our clinic): ₹25,000-80,000 depending on type."
  },
  {
    "q": "Which braces are cheapest?",
    "a": "Traditional metal braces are most affordable and equally effective."
  },
  {
    "q": "How long does braces treatment take?",
    "a": "Typically 12-24 months depending on complexity of alignment needed."
  }
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Braces Cost in Mumbai vs Vellore - Complete Guide",
            "description": "Compare orthodontic treatment costs. Get braces at 40% less in Vellore.",
            "provider": {
              "@type": "Dentist",
...
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Braces Cost', href: '#' }]} />
        <ModernCard className="mb-8">
          <ModernCardHeader>
            <ModernCardTitle className="text-4xl md:text-5xl text-gray-900">Braces Cost in Mumbai vs Vellore - Complete Guide</ModernCardTitle>
