...
export const metadata: Metadata = {
  title: 'Metal Braces in Vellore | Indira Dental Clinic',
  description: 'Expert metal braces services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced metal braces with modern technology and affordable pricing.',
  keywords: 'metal braces, metal braces vellore, orthodontics, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Metal Braces in Vellore | Indira Dental Clinic',
    description: 'Expert metal braces services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Metal Braces",
  "description": "Professional metal braces treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is metal braces?",
    answer: "Metal Braces is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does metal braces cost in Vellore?",
    answer: "The cost of metal braces varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is metal braces painful?",
    answer: "Modern metal braces procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does metal braces take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for metal braces?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Metal Braces" serviceSlug="metal-braces" />
		</SectionContainer>
		...
		<PageHeader title="Metal Braces" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Orthodontics', href: '/services/orthodontics' },
                { title: 'Braces', href: '/services/orthodontics/braces' },
                { title: 'Metal Braces', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert metal braces services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Metal Braces</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive metal braces services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Metal Braces?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert metal braces treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="Metal Braces" serviceSlug="metal-braces" showPriceComparison={false} />
)
}
