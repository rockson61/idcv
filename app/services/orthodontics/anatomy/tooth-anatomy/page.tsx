...
export const metadata: Metadata = {
  title: 'Tooth Anatomy | Orthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert tooth anatomy services in orthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'tooth anatomy, orthodontics, anatomy, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Tooth Anatomy | Orthodontics in Vellore',
    description: 'Expert tooth anatomy in orthodontics',
...
const schemaMarkup = {
  ...
  "name": "Tooth Anatomy",
  "description": "Professional tooth anatomy at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is tooth anatomy?",
    answer: "Tooth Anatomy is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is tooth anatomy treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern orthodontics techniques to address tooth anatomy. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of tooth anatomy treatment?",
  ...
  {
    question: "Is tooth anatomy treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for tooth anatomy?",
...
export default function ToothAnatomyPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Tooth Anatomy" serviceSlug="tooth-anatomy" />
		</SectionContainer>
		...
		<PageHeader title="Tooth Anatomy" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Tooth Anatomy Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert tooth anatomy care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Tooth Anatomy</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in orthodontics 
                    including comprehensive tooth anatomy care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert tooth anatomy care in Vellore</p>
		...
		<StandardServiceLayout serviceName="Tooth Anatomy" serviceSlug="tooth-anatomy" showPriceComparison={false} />
)
}
