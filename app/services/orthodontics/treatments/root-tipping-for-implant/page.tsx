...
export const metadata: Metadata = {
  title: 'Root Tipping For Implant | Orthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert root tipping for implant services in orthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'root tipping for implant, orthodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Root Tipping For Implant | Orthodontics in Vellore',
    description: 'Expert root tipping for implant in orthodontics',
...
const schemaMarkup = {
  ...
  "name": "Root Tipping For Implant",
  "description": "Professional root tipping for implant at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is root tipping for implant?",
    answer: "Root Tipping For Implant is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is root tipping for implant treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern orthodontics techniques to address root tipping for implant. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of root tipping for implant treatment?",
  ...
  {
    question: "Is root tipping for implant treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for root tipping for implant?",
...
export default function RootTippingForImplantPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Root Tipping For Implant" serviceSlug="root-tipping-for-implant" />
		</SectionContainer>
		...
		<PageHeader title="Root Tipping For Implant" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Root Tipping For Implant Doctors in India - Implant Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert root tipping for implant care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Root Tipping For Implant</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in orthodontics 
                    including comprehensive root tipping for implant care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert root tipping for implant care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Root Tipping For Implant?"
		...
		<StandardServiceLayout serviceName="Root Tipping For Implant" serviceSlug="root-tipping-for-implant" showPriceComparison={false} />
)
}
