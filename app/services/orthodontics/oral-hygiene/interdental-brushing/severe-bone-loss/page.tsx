...
export const metadata: Metadata = {
  title: 'Interdental Brushing   severe Bone Loss | Orthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert interdental brushing   severe bone loss services in orthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'interdental brushing   severe bone loss, orthodontics, oral hygiene, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Interdental Brushing   severe Bone Loss | Orthodontics in Vellore',
    description: 'Expert interdental brushing   severe bone loss in orthodontics',
...
const schemaMarkup = {
  ...
  "name": "Interdental Brushing   severe Bone Loss",
  "description": "Professional interdental brushing   severe bone loss at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is interdental brushing   severe bone loss?",
    answer: "Interdental Brushing   severe Bone Loss is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is interdental brushing   severe bone loss treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern orthodontics techniques to address interdental brushing   severe bone loss. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of interdental brushing   severe bone loss treatment?",
  ...
  {
    question: "Is interdental brushing   severe bone loss treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for interdental brushing   severe bone loss?",
...
export default function InterdentalBrushingsevereBoneLossPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Severe Bone Loss" serviceSlug="severe-bone-loss" />
		</SectionContainer>
		...
		<PageHeader title="Severe Bone Loss" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Orthodontics', href: '/services/orthodontics' },
                { title: 'Oral Hygiene', href: '/services/orthodontics/oral-hygiene' },
                { title: 'Interdental Brushing   severe Bone Loss', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Severe Bone Loss Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert interdental brushing   severe bone loss care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Interdental Brushing   severe Bone Loss</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in orthodontics 
                    including comprehensive interdental brushing   severe bone loss care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert interdental brushing   severe bone loss care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Interdental Brushing   severe Bone Loss?"
		...
		<StandardServiceLayout serviceName="Severe Bone Loss" serviceSlug="severe-bone-loss" showPriceComparison={false} />
)
}
