...
export const metadata: Metadata = {
  title: 'Orthodontist Consultation in Vellore | Indira Dental Clinic',
  description: 'Expert orthodontist consultation services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced orthodontist consultation with modern technology and affordable pricing.',
  keywords: 'orthodontist consultation, orthodontist consultation vellore, orthodontics, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Orthodontist Consultation in Vellore | Indira Dental Clinic',
    description: 'Expert orthodontist consultation services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Orthodontist Consultation",
  "description": "Professional orthodontist consultation treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is orthodontist consultation?",
    answer: "Orthodontist Consultation is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does orthodontist consultation cost in Vellore?",
    answer: "The cost of orthodontist consultation varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is orthodontist consultation painful?",
    answer: "Modern orthodontist consultation procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does orthodontist consultation take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for orthodontist consultation?",
    answer: "Dr. Rockson Samuel (BDS, PgDM, BDM) brings expertise in orthodontics with 15+ years of experience, modern equipment, and affordable pricing in Vellore."
  }
];

export default function OrthodontistConsultationPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Orthodontist Consultation" serviceSlug="orthodontist-consultation" />
		</SectionContainer>
		...
		<PageHeader title="Orthodontist Consultation" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Orthodontist Consultation Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert orthodontist consultation services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Orthodontist Consultation</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive orthodontist consultation services 
                    using the latest technology and techniques. Dr. Rockson Samuel (BDS, PgDM, BDM | General Dentist & Community Leader - DentalReach) 
                    has over 15 years of experience in orthodontics.
                  </p>
                  
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Orthodontist Consultation?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert orthodontist consultation treatment in Vellore
                  </p>
              ...
              <ModernCard>
                ...
                <ModernCardContent>
                  <div className="space-y-2">
                    ...
                    >
                      <span className="text-gray-900 group-hover:text-teal-600">All Orthodontics Services</span>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Orthodontist Consultation?"
