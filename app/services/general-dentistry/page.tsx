  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-teal-50 to-green-50">
      ...
      <SectionContainer className="pt-24 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best General Dentistry Doctors in India - Dental Specialist Near Me</h1>
      ...
      <SectionContainer className="py-16 bg-gradient-to-r from-blue-600 to-teal-600 text-white">
		...
		<StandardServiceLayout serviceName="General Dentistry" serviceSlug="general-dentistry" showPriceComparison={false} />
)
}
