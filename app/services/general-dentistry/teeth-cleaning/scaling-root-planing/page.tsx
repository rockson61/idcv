...
export const metadata: Metadata = {
  title: 'Scaling Root Planing in Vellore | Indira Dental Clinic',
  description: 'Expert scaling root planing services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced scaling root planing with modern technology and affordable pricing.',
  keywords: 'scaling root planing, scaling root planing vellore, general dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Scaling Root Planing in Vellore | Indira Dental Clinic',
    description: 'Expert scaling root planing services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional scaling root planing treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is scaling root planing?",
    answer: "Scaling Root Planing is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does scaling root planing cost in Vellore?",
    answer: "The cost of scaling root planing varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is scaling root planing painful?",
    answer: "Modern scaling root planing procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does scaling root planing take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for scaling root planing?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Scaling Root Planing" serviceSlug="scaling-root-planing" />
		</SectionContainer>
		...
		<PageHeader title="Scaling Root Planing" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Scaling Root Planing</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive scaling root planing services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Scaling Root Planing?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert scaling root planing treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Scaling Root Planing?"
