...
export const metadata: Metadata = {
  title: 'Ultrasonic Scaling in Vellore | Indira Dental Clinic',
  description: 'Expert ultrasonic scaling services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced ultrasonic scaling with modern technology and affordable pricing.',
  keywords: 'ultrasonic scaling, ultrasonic scaling vellore, general dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Ultrasonic Scaling in Vellore | Indira Dental Clinic',
    description: 'Expert ultrasonic scaling services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional ultrasonic scaling treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    ...
    answer: "Ultrasonic Scaling is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does ultrasonic scaling cost in Vellore?",
    answer: "The cost of ultrasonic scaling varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is ultrasonic scaling painful?",
    answer: "Modern ultrasonic scaling procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does ultrasonic scaling take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for ultrasonic scaling?",
...
export default function UltrasonicScalingPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Ultrasonic Scaling" serviceSlug="ultrasonic-scaling" />
		</SectionContainer>
		...
		<PageHeader title="Ultrasonic Scaling" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Ultrasonic Scaling Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert ultrasonic scaling services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Ultrasonic Scaling</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive ultrasonic scaling services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Ultrasonic Scaling?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert ultrasonic scaling treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Ultrasonic Scaling?"
		...
		<StandardServiceLayout serviceName="Ultrasonic Scaling" serviceSlug="ultrasonic-scaling" showPriceComparison={false} />
)
}
