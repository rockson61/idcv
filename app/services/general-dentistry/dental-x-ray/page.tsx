...
export const metadata: Metadata = {
  title: 'Dental X Ray in Vellore | Indira Dental Clinic',
  description: 'Expert dental x ray services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced dental x ray with modern technology and affordable pricing.',
  keywords: 'dental x ray, dental x ray vellore, general dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Dental X Ray in Vellore | Indira Dental Clinic',
    description: 'Expert dental x ray services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "Dental X Ray",
  "description": "Professional dental x ray treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is dental x ray?",
    answer: "Dental X Ray is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does dental x ray cost in Vellore?",
    answer: "The cost of dental x ray varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is dental x ray painful?",
    answer: "Modern dental x ray procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does dental x ray take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for dental x ray?",
...
export default function DentalXRayPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Dental X Ray" serviceSlug="dental-x-ray" />
		</SectionContainer>
		...
		<PageHeader title="Dental X Ray" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Dental X Ray</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive dental x ray services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Dental X Ray?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert dental x ray treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="Dental X Ray" serviceSlug="dental-x-ray" showPriceComparison={false} />
)
}
