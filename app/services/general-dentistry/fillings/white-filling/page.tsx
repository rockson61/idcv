...
export const metadata: Metadata = {
  title: 'White Filling in Vellore | Indira Dental Clinic',
  description: 'Expert white filling services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced white filling with modern technology and affordable pricing.',
  keywords: 'white filling, white filling vellore, general dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'White Filling in Vellore | Indira Dental Clinic',
    description: 'Expert white filling services in Vellore',
...
const schemaMarkup = {
  ...
  "name": "White Filling",
  "description": "Professional white filling treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is white filling?",
    answer: "White Filling is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does white filling cost in Vellore?",
    answer: "The cost of white filling varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is white filling painful?",
    answer: "Modern white filling procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does white filling take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for white filling?",
...
export default function WhiteFillingPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="White Filling" serviceSlug="white-filling" />
		</SectionContainer>
		...
		<PageHeader title="White Filling" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best White Filling Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert white filling services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About White Filling</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive white filling services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for White Filling?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert white filling treatment in Vellore
                  </p>
		...
		<StandardServiceLayout serviceName="White Filling" serviceSlug="white-filling" showPriceComparison={false} />
)
}
