...
export const metadata: Metadata = {
  title: 'Oral Cancer Screening in Vellore | Indira Dental Clinic',
  description: 'Expert oral cancer screening services at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced oral cancer screening with modern technology and affordable pricing.',
  keywords: 'oral cancer screening, oral cancer screening vellore, general dentistry, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Oral Cancer Screening in Vellore | Indira Dental Clinic',
    description: 'Expert oral cancer screening services in Vellore',
...
const schemaMarkup = {
  ...
  "description": "Professional oral cancer screening treatment at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is oral cancer screening?",
    answer: "Oral Cancer Screening is a dental procedure designed to improve your oral health. At Indira Dental Clinic, Dr. Rockson Samuel uses advanced techniques to ensure the best results."
  },
  {
    question: "How much does oral cancer screening cost in Vellore?",
    answer: "The cost of oral cancer screening varies based on individual needs. At Indira Dental Clinic, we offer competitive pricing 40-60% lower than metro cities. Contact us for a personalized quote."
  },
  {
    question: "Is oral cancer screening painful?",
    answer: "Modern oral cancer screening procedures are designed to be comfortable. We use advanced anesthesia techniques and pain management protocols to ensure a pain-free experience."
  },
  {
    question: "How long does oral cancer screening take?",
  ...
  {
    question: "Why choose Indira Dental Clinic for oral cancer screening?",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Oral Cancer Screening" serviceSlug="oral-cancer-screening" />
		</SectionContainer>
		...
		<PageHeader title="Oral Cancer Screening" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Oral Cancer Screening Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert oral cancer screening services by Dr. Rockson Samuel at Indira Dental Clinic. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Oral Cancer Screening</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we provide comprehensive oral cancer screening services 
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mt-6 mb-4">Why Choose Us for Oral Cancer Screening?</h3>
              ...
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">
                    Get expert oral cancer screening treatment in Vellore
                  </p>
          ...
          {/* CTA */}
          <CTAWidget 
            title="Ready for Oral Cancer Screening?"
		...
		<StandardServiceLayout serviceName="Oral Cancer Screening" serviceSlug="oral-cancer-screening" showPriceComparison={false} />
)
}
