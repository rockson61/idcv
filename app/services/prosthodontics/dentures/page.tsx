...
const reviews = generateServiceReviews('Dentures', 'default')
      ...
      <SectionContainer className="py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dentures Doctors in India - Prosthodontist Near Me</h1>
		...
		<StandardServiceLayout serviceName="Dentures" serviceSlug="dentures" showPriceComparison={false} />
)
}
