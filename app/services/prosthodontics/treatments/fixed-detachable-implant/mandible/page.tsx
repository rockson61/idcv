...
export const metadata: Metadata = {
  title: 'Fixed Detachable Implant   mandible | Prosthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert fixed detachable implant   mandible services in prosthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'fixed detachable implant   mandible, prosthodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Fixed Detachable Implant   mandible | Prosthodontics in Vellore',
    description: 'Expert fixed detachable implant   mandible in prosthodontics',
...
const schemaMarkup = {
  ...
  "name": "Fixed Detachable Implant   mandible",
  "description": "Professional fixed detachable implant   mandible at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is fixed detachable implant   mandible?",
    answer: "Fixed Detachable Implant   mandible is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is fixed detachable implant   mandible treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern prosthodontics techniques to address fixed detachable implant   mandible. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of fixed detachable implant   mandible treatment?",
  ...
  {
    question: "Is fixed detachable implant   mandible treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for fixed detachable implant   mandible?",
...
export default function FixedDetachableImplantmandiblePage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Mandible" serviceSlug="mandible" />
		</SectionContainer>
		...
		<PageHeader title="Mandible" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Mandible Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert fixed detachable implant   mandible care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Fixed Detachable Implant   mandible</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in prosthodontics 
                    including comprehensive fixed detachable implant   mandible care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert fixed detachable implant   mandible care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Fixed Detachable Implant   mandible?"
		...
		<StandardServiceLayout serviceName="Mandible" serviceSlug="mandible" showPriceComparison={false} />
)
}
