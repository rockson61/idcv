...
export const metadata: Metadata = {
  title: 'Anterior Teeth Splaying | Prosthodontics in Vellore | Indira Dental Clinic',
  description: 'Expert anterior teeth splaying services in prosthodontics at Indira Dental Clinic, Vellore. Dr. Rockson Samuel provides advanced care with modern technology.',
  keywords: 'anterior teeth splaying, prosthodontics, treatments, dental clinic vellore, dr rockson samuel',
  openGraph: {
    title: 'Anterior Teeth Splaying | Prosthodontics in Vellore',
    description: 'Expert anterior teeth splaying in prosthodontics',
...
const schemaMarkup = {
  ...
  "name": "Anterior Teeth Splaying",
  "description": "Professional anterior teeth splaying at Indira Dental Clinic, Vellore",
  "provider": {
    "@type": "Dentist",
...
const faqs = [
  {
    question: "What is anterior teeth splaying?",
    answer: "Anterior Teeth Splaying is a dental procedure that helps improve your oral health. Dr. Rockson Samuel at Indira Dental Clinic provides expert care using advanced techniques."
  },
  {
    question: "How is anterior teeth splaying treated in Vellore?",
    answer: "At Indira Dental Clinic, Dr. Rockson Samuel uses modern prosthodontics techniques to address anterior teeth splaying. The treatment is customized based on your specific needs and condition."
  },
  {
    question: "What is the cost of anterior teeth splaying treatment?",
  ...
  {
    question: "Is anterior teeth splaying treatment painful?",
  ...
  {
    question: "Why choose Indira Dental Clinic for anterior teeth splaying?",
...
export default function AnteriorTeethSplayingPage() {
  return (
    <>
      <script
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Anterior Teeth Splaying" serviceSlug="anterior-teeth-splaying" />
		</SectionContainer>
		...
		<PageHeader title="Anterior Teeth Splaying" subtitle="Expert care with modern technology" />
              items={[
                { title: 'Home', href: '/' },
                { title: 'Services', href: '/services' },
                { title: 'Prosthodontics', href: '/services/prosthodontics' },
                { title: 'Treatments', href: '/services/prosthodontics/treatments' },
                { title: 'Anterior Teeth Splaying', href: '#' }
              ]}
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Anterior Teeth Splaying Doctors in India - Dental Specialist Near Me</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Expert anterior teeth splaying care at Indira Dental Clinic, Vellore. 
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="md:col-span-2 space-y-8">
              <ModernCard>
                <ModernCardHeader>
                  <ModernCardTitle>About Anterior Teeth Splaying</ModernCardTitle>
                </ModernCardHeader>
                <ModernCardContent className="prose max-w-none">
                  <p>
                    At Indira Dental Clinic in Vellore, we specialize in prosthodontics 
                    including comprehensive anterior teeth splaying care. Dr. Rockson Samuel 
            ...
            <div className="space-y-6">
              <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
                <ModernCardContent className="p-6">
                  ...
                  <p className="mb-6 opacity-90">Get expert anterior teeth splaying care in Vellore</p>
          ...
          <CTAWidget 
            title="Ready for Anterior Teeth Splaying?"
		...
		<StandardServiceLayout serviceName="Anterior Teeth Splaying" serviceSlug="anterior-teeth-splaying" showPriceComparison={false} />
)
}
