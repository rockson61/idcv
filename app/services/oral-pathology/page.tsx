...
items={[{ title: 'Home', href: '/' }, { title: 'Services', href: '/services' }, { title: 'Oral Pathology', href: '/services/oral-pathology' }]} />
      </SectionContainer>
      ...
      <SectionContainer className="py-8">
		...
		<CTAWidget title={`Book Oral Pathology`} description="Get expert dental care from our team" primaryAction={{ text: 'Book Appointment', href: '/contact' }} secondaryAction={{ text: 'Call Now', href: 'tel:+917010650063' }} showRating showAvailability />
