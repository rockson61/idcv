    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
		<SectionContainer className="py-12">
			<ServiceSemanticContent serviceName="Sensitive Teeth Treatment" serviceSlug="sensitive-teeth-treatment" />
		</SectionContainer>

        <Breadcrumb

		<PageHeader title="Sensitive Teeth Treatment" subtitle="Expert care with modern technology" />
          items={[
            { title: 'Home', href: '/' },
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-6">
		...
		<StandardServiceLayout serviceName="Sensitive Teeth Treatment" serviceSlug="sensitive-teeth-treatment" showPriceComparison={false} />
)
}
