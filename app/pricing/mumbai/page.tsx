...
export default function ServicePage() {
  const faqs = [
  {
    "q": "How much cheaper is Vellore than Mumbai?",
    "a": "Average savings of 40-60% on all major dental treatments including implants, braces, and RCT."
  },
  {
    "q": "Is it worth traveling to Vellore?",
    "a": "Yes! Savings of ₹50,000-1,00,000 on major treatments easily cover travel costs with significant savings."
  },
  {
    "q": "Do you help with accommodation?",
    "a": "Yes, we provide assistance with nearby hotels and guest houses for outstation patients."
  }
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Mumbai vs Vellore Dental Treatment Price Comparison",
            "description": "Mumbai dental prices compared to Vellore. Save up to 50% on all treatments.",
            "provider": {
              "@type": "Dentist",
