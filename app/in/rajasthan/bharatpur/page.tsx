...
export const metadata: Metadata = {
  title: 'Best Dentist in Bharatpur, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Bharatpur, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bharatpur'
