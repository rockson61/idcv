...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajasthan, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajasthan, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajasthan'
