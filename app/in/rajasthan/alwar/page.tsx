...
export const metadata: Metadata = {
  title: 'Best Dentist in Alwar, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Alwar, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Alwar'
