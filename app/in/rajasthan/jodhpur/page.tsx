...
export const metadata: Metadata = {
  title: 'Best Dentist in Jodhpur, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Jodhpur, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jodhpur'
