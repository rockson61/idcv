...
export const metadata: Metadata = {
  title: 'Best Dentist in Ajmer, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Ajmer, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ajmer'
