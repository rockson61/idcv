...
export const metadata: Metadata = {
  title: 'Best Dentist in Jaipur, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Jaipur, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jaipur'
