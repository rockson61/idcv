...
export const metadata: Metadata = {
  title: 'Best Dentist in Sri Ganganagar, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Sri Ganganagar, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sri Ganganagar'
const city = 'Rajasthan'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
