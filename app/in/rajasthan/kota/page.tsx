...
export const metadata: Metadata = {
  title: 'Best Dentist in Kota, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Kota, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kota'
