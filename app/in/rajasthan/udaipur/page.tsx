...
export const metadata: Metadata = {
  title: 'Best Dentist in Udaipur, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Udaipur, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Udaipur'
