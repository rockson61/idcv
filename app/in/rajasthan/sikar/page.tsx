...
export const metadata: Metadata = {
  title: 'Best Dentist in Sikar, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Sikar, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sikar'
