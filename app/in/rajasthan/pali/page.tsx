...
export const metadata: Metadata = {
  title: 'Best Dentist in Pali, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Pali, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pali'
