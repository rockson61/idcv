...
export const metadata: Metadata = {
  title: 'Best Dentist in Bikaner, Rajasthan | Indira Dental Clinic',
  description: 'Top-rated dental care for Bikaner, Rajasthan. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bikaner'
