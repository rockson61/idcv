...
export const metadata: Metadata = {
  title: 'Best Dentist in Kohima, Nagaland | Indira Dental Clinic',
  description: 'Top-rated dental care for Kohima, Nagaland. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kohima'
const city = 'Nagaland'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
