...
export const metadata: Metadata = {
  title: 'Best Dentist in Nagaland, Nagaland | Indira Dental Clinic',
  description: 'Top-rated dental care for Nagaland, Nagaland. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nagaland'
const city = 'Nagaland'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
