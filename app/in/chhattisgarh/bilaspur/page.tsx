...
export const metadata: Metadata = {
  title: 'Best Dentist in Bilaspur, Chhattisgarh | Indira Dental Clinic',
  description: 'Top-rated dental care for Bilaspur, Chhattisgarh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bilaspur'
const city = 'Chhattisgarh'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
