...
export const metadata: Metadata = {
  title: 'Best Dentist in Durg, Chhattisgarh | Indira Dental Clinic',
  description: 'Top-rated dental care for Durg, Chhattisgarh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Durg'
