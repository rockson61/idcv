...
export const metadata: Metadata = {
  title: 'Best Dentist in Raipur, Chhattisgarh | Indira Dental Clinic',
  description: 'Top-rated dental care for Raipur, Chhattisgarh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Raipur'
