...
export const metadata: Metadata = {
  title: 'Best Dentist in Chhattisgarh, Chhattisgarh | Indira Dental Clinic',
  description: 'Top-rated dental care for Chhattisgarh, Chhattisgarh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chhattisgarh'
