...
export const metadata: Metadata = {
  title: 'Best Dentist in Korba, Chhattisgarh | Indira Dental Clinic',
  description: 'Top-rated dental care for Korba, Chhattisgarh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Korba'
