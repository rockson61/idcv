...
export const metadata: Metadata = {
  title: 'Best Dentist in Mahbubnagar, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Mahbubnagar, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mahbubnagar'
