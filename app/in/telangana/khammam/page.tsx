...
export const metadata: Metadata = {
  title: 'Best Dentist in Khammam, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Khammam, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Khammam'
