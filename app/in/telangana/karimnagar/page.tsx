...
export const metadata: Metadata = {
  title: 'Best Dentist in Karimnagar, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Karimnagar, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karimnagar'
