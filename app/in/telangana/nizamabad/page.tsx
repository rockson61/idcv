...
export const metadata: Metadata = {
  title: 'Best Dentist in Nizamabad, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Nizamabad, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nizamabad'
