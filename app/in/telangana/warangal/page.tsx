...
export const metadata: Metadata = {
  title: 'Best Dentist in Warangal, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Warangal, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Warangal'
