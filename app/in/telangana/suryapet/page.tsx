...
export const metadata: Metadata = {
  title: 'Best Dentist in Suryapet, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Suryapet, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Suryapet'
