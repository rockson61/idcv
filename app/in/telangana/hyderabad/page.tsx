...
export const metadata: Metadata = {
  title: 'Best Dentist in Hyderabad, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Hyderabad, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}
