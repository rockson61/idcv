...
export const metadata: Metadata = {
  title: 'Best Dentist in Ramagundam, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Ramagundam, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ramagundam'
