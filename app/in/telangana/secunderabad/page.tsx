...
export const metadata: Metadata = {
  title: 'Best Dentist in Secunderabad, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Secunderabad, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Secunderabad'
const city = 'Telangana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
