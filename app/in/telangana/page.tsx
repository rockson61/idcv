...
export const metadata: Metadata = {
  title: 'Best Dentist in Telangana, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Telangana, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Telangana'
