...
export const metadata: Metadata = {
  title: 'Best Dentist in Miryalaguda, Telangana | Indira Dental Clinic',
  description: 'Top-rated dental care for Miryalaguda, Telangana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Miryalaguda'
