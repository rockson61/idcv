...
export const metadata: Metadata = {
  title: 'Best Dentist in Page.Tsx, Page.Tsx | Indira Dental Clinic',
  description: 'Top-rated dental care for Page.Tsx, Page.Tsx. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Page.Tsx'
const city = 'Page.Tsx'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            { title: 'Home', href: '/' },
            { title: 'India', href: '/in' },
            { title: 'Page.Tsx', href: '/in/page.tsx' },
          ]}
        />
