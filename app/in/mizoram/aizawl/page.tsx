...
export const metadata: Metadata = {
  title: 'Best Dentist in Aizawl, Mizoram | Indira Dental Clinic',
  description: 'Top-rated dental care for Aizawl, Mizoram. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aizawl'
const city = 'Mizoram'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
