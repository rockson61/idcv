...
export const metadata: Metadata = {
  title: 'Best Dentist in Mizoram, Mizoram | Indira Dental Clinic',
  description: 'Top-rated dental care for Mizoram, Mizoram. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mizoram'
const city = 'Mizoram'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
