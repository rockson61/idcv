...
export const metadata: Metadata = {
  title: 'Dental Services in mizoram | Expert Dentist | Indira Dental Clinic',
  description: 'Comprehensive dental services in mizoram. Expert dental care including RCT, implants, braces, cosmetic dentistry. Visit Indira Dental Clinic in Vellore for 50% savings.',
  keywords: ['dentist mizoram', 'dental clinic mizoram', 'dental services mizoram'],
}

export default function MizoramPage() {
  const cities = [
    { name: 'Aizawl', href: '/in/mizoram/aizawl', description: 'Quality dental services in Aizawl' }
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Dental Services in Mizoram
          </h1>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-8">
            Find comprehensive dental care services across Mizoram. Expert dental treatments 
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Cities in Mizoram</h2>
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                Browse through our extensive network of dental services across Mizoram. 
