...
export const metadata: Metadata = {
  title: 'Best Dentist in Kaushambi, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Kaushambi, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kaushambi'
