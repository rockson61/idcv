...
export const metadata: Metadata = {
  title: 'Best Dentist in Hapur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Hapur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hapur'
