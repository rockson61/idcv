...
export const metadata: Metadata = {
  title: 'Best Dentist in Sambhal, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Sambhal, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sambhal'
