...
export const metadata: Metadata = {
  title: 'Best Dentist in Loni, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Loni, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Loni'
