...
export const metadata: Metadata = {
  title: 'Best Dentist in Ballia, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ballia, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ballia'
