...
export const metadata: Metadata = {
  title: 'Best Dentist in Kanpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Kanpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kanpur'
