...
export const metadata: Metadata = {
  title: 'Best Dentist in Fatehpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Fatehpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Fatehpur'
