...
export const metadata: Metadata = {
  title: 'Best Dentist in Hamirpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Hamirpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hamirpur'
