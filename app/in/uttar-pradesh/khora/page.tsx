...
export const metadata: Metadata = {
  title: 'Best Dentist in Khora, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Khora, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Khora'
