...
export const metadata: Metadata = {
  title: 'Best Dentist in Shahjahanpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Shahjahanpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shahjahanpur'
