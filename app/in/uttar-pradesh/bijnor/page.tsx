...
export const metadata: Metadata = {
  title: 'Best Dentist in Bijnor, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Bijnor, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bijnor'
