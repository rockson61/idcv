...
export const metadata: Metadata = {
  title: 'Best Dentist in Murwara, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Murwara, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Murwara'
