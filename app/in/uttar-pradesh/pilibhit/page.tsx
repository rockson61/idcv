...
export const metadata: Metadata = {
  title: 'Best Dentist in Pilibhit, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Pilibhit, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pilibhit'
