...
export const metadata: Metadata = {
  title: 'Best Dentist in Pratapgarh, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Pratapgarh, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pratapgarh'
