...
export const metadata: Metadata = {
  title: 'Best Dentist in Bareilly, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Bareilly, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bareilly'
