...
export const metadata: Metadata = {
  title: 'Best Dentist in Mainpuri, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Mainpuri, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mainpuri'
