...
export const metadata: Metadata = {
  title: 'Best Dentist in Uttar Pradesh, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Uttar Pradesh, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uttar Pradesh'
