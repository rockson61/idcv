...
export const metadata: Metadata = {
  title: 'Best Dentist in Mirzapur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Mirzapur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mirzapur'
