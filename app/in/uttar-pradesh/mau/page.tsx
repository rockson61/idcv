...
export const metadata: Metadata = {
  title: 'Best Dentist in Mau, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Mau, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mau'
