...
export const metadata: Metadata = {
  title: 'Best Dentist in Mathura, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Mathura, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mathura'
