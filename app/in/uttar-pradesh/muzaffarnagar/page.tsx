...
export const metadata: Metadata = {
  title: 'Best Dentist in Muzaffarnagar, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Muzaffarnagar, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Muzaffarnagar'
