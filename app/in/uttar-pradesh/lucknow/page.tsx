...
export const metadata: Metadata = {
  title: 'Best Dentist in Lucknow, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Lucknow, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}
