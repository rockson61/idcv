...
export const metadata: Metadata = {
  title: 'Best Dentist in Unnao, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Unnao, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Unnao'
