...
export const metadata: Metadata = {
  title: 'Best Dentist in Noida, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Noida, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Noida'
