...
export const metadata: Metadata = {
  title: 'Best Dentist in Agra, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Agra, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Agra'
