...
export const metadata: Metadata = {
  title: 'Best Dentist in Firozabad, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Firozabad, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Firozabad'
