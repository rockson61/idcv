...
export const metadata: Metadata = {
  title: 'Best Dentist in Amroha, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Amroha, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Amroha'
