...
export const metadata: Metadata = {
  title: 'Best Dentist in Ghaziabad, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ghaziabad, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ghaziabad'
