...
export const metadata: Metadata = {
  title: 'Best Dentist in Azamgarh, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Azamgarh, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Azamgarh'
