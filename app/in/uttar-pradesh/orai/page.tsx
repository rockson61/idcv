...
export const metadata: Metadata = {
  title: 'Best Dentist in Orai, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Orai, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Orai'
