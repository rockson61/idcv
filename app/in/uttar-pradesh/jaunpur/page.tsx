...
export const metadata: Metadata = {
  title: 'Best Dentist in Jaunpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Jaunpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jaunpur'
