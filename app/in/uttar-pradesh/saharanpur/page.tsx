...
export const metadata: Metadata = {
  title: 'Best Dentist in Saharanpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Saharanpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Saharanpur'
