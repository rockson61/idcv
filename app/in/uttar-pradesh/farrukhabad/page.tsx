...
export const metadata: Metadata = {
  title: 'Best Dentist in Farrukhabad, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Farrukhabad, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Farrukhabad'
