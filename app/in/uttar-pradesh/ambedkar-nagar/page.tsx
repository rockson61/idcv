...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambedkar Nagar, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambedkar Nagar, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ambedkar Nagar'
