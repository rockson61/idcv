...
export const metadata: Metadata = {
  title: 'Best Dentist in Sultanpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Sultanpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sultanpur'
