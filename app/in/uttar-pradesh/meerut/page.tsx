...
export const metadata: Metadata = {
  title: 'Best Dentist in Meerut, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Meerut, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Meerut'
