...
export const metadata: Metadata = {
  title: 'Best Dentist in Faizabad, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Faizabad, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Faizabad'
