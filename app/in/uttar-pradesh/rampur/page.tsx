...
export const metadata: Metadata = {
  title: 'Best Dentist in Rampur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Rampur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rampur'
