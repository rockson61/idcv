...
export const metadata: Metadata = {
  title: 'Best Dentist in Gorakhpur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Gorakhpur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gorakhpur'
