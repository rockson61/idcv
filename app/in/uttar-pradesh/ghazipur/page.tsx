...
export const metadata: Metadata = {
  title: 'Best Dentist in Ghazipur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ghazipur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ghazipur'
