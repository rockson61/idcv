...
export const metadata: Metadata = {
  title: 'Best Dentist in Etawah, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Etawah, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Etawah'
