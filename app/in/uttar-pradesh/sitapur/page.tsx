...
export const metadata: Metadata = {
  title: 'Best Dentist in Sitapur, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Sitapur, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sitapur'
