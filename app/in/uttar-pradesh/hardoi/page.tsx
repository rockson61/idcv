...
export const metadata: Metadata = {
  title: 'Best Dentist in Hardoi, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Hardoi, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hardoi'
