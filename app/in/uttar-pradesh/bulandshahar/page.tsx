...
export const metadata: Metadata = {
  title: 'Best Dentist in Bulandshahar, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Bulandshahar, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bulandshahar'
