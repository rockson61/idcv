...
export const metadata: Metadata = {
  title: 'Best Dentist in Baghpat, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Baghpat, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Baghpat'
