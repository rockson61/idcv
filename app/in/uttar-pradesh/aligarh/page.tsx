...
export const metadata: Metadata = {
  title: 'Best Dentist in Aligarh, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Aligarh, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aligarh'
