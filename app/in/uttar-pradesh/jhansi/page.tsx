...
export const metadata: Metadata = {
  title: 'Best Dentist in Jhansi, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Jhansi, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jhansi'
