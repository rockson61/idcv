...
export const metadata: Metadata = {
  title: 'Best Dentist in Greater Noida, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Greater Noida, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Greater Noida'
