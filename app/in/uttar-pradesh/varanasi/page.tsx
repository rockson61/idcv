...
export const metadata: Metadata = {
  title: 'Best Dentist in Varanasi, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Varanasi, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Varanasi'
