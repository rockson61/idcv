...
export const metadata: Metadata = {
  title: 'Best Dentist in Moradabad, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Moradabad, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Moradabad'
