...
export const metadata: Metadata = {
  title: 'Best Dentist in Prayagraj, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Prayagraj, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Prayagraj'
