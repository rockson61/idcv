...
export const metadata: Metadata = {
  title: 'Best Dentist in Bahraich, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Bahraich, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bahraich'
