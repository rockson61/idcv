...
export const metadata: Metadata = {
  title: 'Best Dentist in Rae Bareli, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Rae Bareli, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rae Bareli'
