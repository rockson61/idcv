...
export const metadata: Metadata = {
  title: 'Best Dentist in Chandauli, Uttar Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Chandauli, Uttar Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chandauli'
