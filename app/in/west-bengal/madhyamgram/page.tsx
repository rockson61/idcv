...
export const metadata: Metadata = {
  title: 'Best Dentist in Madhyamgram, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Madhyamgram, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madhyamgram'
