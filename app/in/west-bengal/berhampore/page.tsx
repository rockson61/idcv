...
export const metadata: Metadata = {
  title: 'Best Dentist in Berhampore, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Berhampore, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Berhampore'
