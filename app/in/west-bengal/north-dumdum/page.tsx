...
export const metadata: Metadata = {
  title: 'Best Dentist in North Dumdum, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for North Dumdum, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'North Dumdum'
