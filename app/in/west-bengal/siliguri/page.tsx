...
export const metadata: Metadata = {
  title: 'Best Dentist in Siliguri, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Siliguri, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Siliguri'
