...
export const metadata: Metadata = {
  title: 'Best Dentist in Asansol, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Asansol, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Asansol'
