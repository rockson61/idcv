...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajpur Sonarpur, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajpur Sonarpur, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajpur Sonarpur'
