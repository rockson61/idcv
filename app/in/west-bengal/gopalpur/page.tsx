...
export const metadata: Metadata = {
  title: 'Best Dentist in Gopalpur, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Gopalpur, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gopalpur'
