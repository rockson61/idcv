...
export const metadata: Metadata = {
  title: 'Best Dentist in Maheshtala, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Maheshtala, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Maheshtala'
