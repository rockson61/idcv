...
export const metadata: Metadata = {
  title: 'Best Dentist in Bardhaman, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Bardhaman, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bardhaman'
