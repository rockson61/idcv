...
export const metadata: Metadata = {
  title: 'Best Dentist in Naihati, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Naihati, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Naihati'
