...
export const metadata: Metadata = {
  title: 'Best Dentist in Durgapur, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Durgapur, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Durgapur'
