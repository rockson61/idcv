...
export const metadata: Metadata = {
  title: 'Best Dentist in South Dumdum, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for South Dumdum, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'South Dumdum'
