...
export const metadata: Metadata = {
  title: 'Best Dentist in Kamarhati, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Kamarhati, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kamarhati'
