...
export const metadata: Metadata = {
  title: 'Best Dentist in Kolkata, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Kolkata, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kolkata'
