...
export const metadata: Metadata = {
  title: 'Best Dentist in Hugli And Chinsurah, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Hugli And Chinsurah, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hugli And Chinsurah'
