...
export const metadata: Metadata = {
  title: 'Best Dentist in Howrah, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Howrah, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Howrah'
