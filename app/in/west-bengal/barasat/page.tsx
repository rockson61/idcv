...
export const metadata: Metadata = {
  title: 'Best Dentist in Barasat, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Barasat, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Barasat'
