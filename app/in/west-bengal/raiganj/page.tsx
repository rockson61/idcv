...
export const metadata: Metadata = {
  title: 'Best Dentist in Raiganj, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Raiganj, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Raiganj'
