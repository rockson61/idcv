...
export const metadata: Metadata = {
  title: 'Best Dentist in Bally, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Bally, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bally'
