...
export const metadata: Metadata = {
  title: 'Best Dentist in Kulti, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Kulti, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kulti'
