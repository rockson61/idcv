...
export const metadata: Metadata = {
  title: 'Best Dentist in Malda, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Malda, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Malda'
