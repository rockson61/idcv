...
export const metadata: Metadata = {
  title: 'Best Dentist in Panihati, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Panihati, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Panihati'
