...
export const metadata: Metadata = {
  title: 'Best Dentist in West Bengal, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for West Bengal, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'West Bengal'
