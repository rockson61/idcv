...
export const metadata: Metadata = {
  title: 'Best Dentist in Serampore, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Serampore, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Serampore'
