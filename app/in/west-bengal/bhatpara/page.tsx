...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhatpara, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Bhatpara, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bhatpara'
