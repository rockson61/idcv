...
export const metadata: Metadata = {
  title: 'Best Dentist in Baharampur, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Baharampur, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Baharampur'
