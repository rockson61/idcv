...
export const metadata: Metadata = {
  title: 'Best Dentist in Bidhan Nagar, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Bidhan Nagar, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bidhan Nagar'
