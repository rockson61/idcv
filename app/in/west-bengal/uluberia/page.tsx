...
export const metadata: Metadata = {
  title: 'Best Dentist in Uluberia, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Uluberia, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uluberia'
