...
export const metadata: Metadata = {
  title: 'Best Dentist in Bidhannagar, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Bidhannagar, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bidhannagar'
