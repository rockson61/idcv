...
export const metadata: Metadata = {
  title: 'Best Dentist in English Bazar, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for English Bazar, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'English Bazar'
