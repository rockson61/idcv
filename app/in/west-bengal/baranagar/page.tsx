...
export const metadata: Metadata = {
  title: 'Best Dentist in Baranagar, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Baranagar, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Baranagar'
