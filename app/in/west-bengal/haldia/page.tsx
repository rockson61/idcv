...
export const metadata: Metadata = {
  title: 'Best Dentist in Haldia, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Haldia, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Haldia'
