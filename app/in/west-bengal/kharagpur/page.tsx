...
export const metadata: Metadata = {
  title: 'Best Dentist in Kharagpur, West Bengal | Indira Dental Clinic',
  description: 'Top-rated dental care for Kharagpur, West Bengal. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kharagpur'
