...
export const metadata: Metadata = {
  title: 'Best Dentist in Manipur, Manipur | Indira Dental Clinic',
  description: 'Top-rated dental care for Manipur, Manipur. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manipur'
const city = 'Manipur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
