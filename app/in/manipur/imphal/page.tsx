...
export const metadata: Metadata = {
  title: 'Best Dentist in Imphal, Manipur | Indira Dental Clinic',
  description: 'Top-rated dental care for Imphal, Manipur. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Imphal'
const city = 'Manipur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
