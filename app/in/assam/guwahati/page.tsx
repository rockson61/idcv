...
export const metadata: Metadata = {
  title: 'Best Dentist in Guwahati, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Guwahati, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guwahati'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
