...
export const metadata: Metadata = {
  title: 'Best Dentist in Tinsukia, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Tinsukia, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tinsukia'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
