...
export const metadata: Metadata = {
  title: 'Best Dentist in Dibrugarh, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Dibrugarh, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dibrugarh'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
