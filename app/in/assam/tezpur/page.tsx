...
export const metadata: Metadata = {
  title: 'Best Dentist in Tezpur, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Tezpur, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tezpur'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
