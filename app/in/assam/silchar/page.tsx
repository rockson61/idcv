...
export const metadata: Metadata = {
  title: 'Best Dentist in Silchar, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Silchar, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Silchar'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
