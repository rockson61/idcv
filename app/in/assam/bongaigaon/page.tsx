...
export const metadata: Metadata = {
  title: 'Best Dentist in Bongaigaon, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Bongaigaon, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bongaigaon'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
