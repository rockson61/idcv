...
export const metadata: Metadata = {
  title: 'Best Dentist in Dispur, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Dispur, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dispur'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
