...
export const metadata: Metadata = {
  title: 'Best Dentist in Nagaon, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Nagaon, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nagaon'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
