...
export const metadata: Metadata = {
  title: 'Best Dentist in Jorhat, Assam | Indira Dental Clinic',
  description: 'Top-rated dental care for Jorhat, Assam. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jorhat'
const city = 'Assam'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
