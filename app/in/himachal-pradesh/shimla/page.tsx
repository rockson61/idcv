...
export const metadata: Metadata = {
  title: 'Best Dentist in Shimla, Himachal Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Shimla, Himachal Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shimla'
