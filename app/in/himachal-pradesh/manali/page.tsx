...
export const metadata: Metadata = {
  title: 'Best Dentist in Manali, Himachal Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Manali, Himachal Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manali'
const city = 'Himachal Pradesh'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
