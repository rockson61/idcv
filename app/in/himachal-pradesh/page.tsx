...
export const metadata: Metadata = {
  title: 'Best Dentist in Himachal Pradesh, Himachal Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Himachal Pradesh, Himachal Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Himachal Pradesh'
