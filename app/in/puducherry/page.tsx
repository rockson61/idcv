...
export const metadata: Metadata = {
  title: 'Best Dentist in Puducherry, Puducherry | Indira Dental Clinic',
  description: 'Top-rated dental care for Puducherry, Puducherry. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Puducherry'
