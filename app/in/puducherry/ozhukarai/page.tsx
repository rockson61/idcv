...
export const metadata: Metadata = {
  title: 'Best Dentist in Ozhukarai, Puducherry | Indira Dental Clinic',
  description: 'Top-rated dental care for Ozhukarai, Puducherry. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ozhukarai'
