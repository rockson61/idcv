...
export const metadata: Metadata = {
  title: 'Best Dentist in Uzhavarkarai, Puducherry | Indira Dental Clinic',
  description: 'Top-rated dental care for Uzhavarkarai, Puducherry. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uzhavarkarai'
