...
export const metadata: Metadata = {
  title: 'Best Dentist in Pondicherry, Puducherry | Indira Dental Clinic',
  description: 'Top-rated dental care for Pondicherry, Puducherry. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pondicherry'
