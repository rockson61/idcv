...
export const metadata: Metadata = {
  title: 'Best Dentist in Gujarat, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Gujarat, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gujarat'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
