...
export const metadata: Metadata = {
  title: 'Best Dentist in Vadodara, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Vadodara, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vadodara'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
