...
export const metadata: Metadata = {
  title: 'Best Dentist in Surendranagar Dudhrej, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Surendranagar Dudhrej, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Surendranagar Dudhrej'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
