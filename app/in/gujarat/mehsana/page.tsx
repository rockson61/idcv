...
export const metadata: Metadata = {
  title: 'Best Dentist in Mehsana, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Mehsana, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mehsana'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
