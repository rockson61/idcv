...
export const metadata: Metadata = {
  title: 'Best Dentist in Gandhinagar, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Gandhinagar, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}
