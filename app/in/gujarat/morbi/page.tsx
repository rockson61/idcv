...
export const metadata: Metadata = {
  title: 'Best Dentist in Morbi, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Morbi, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Morbi'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
