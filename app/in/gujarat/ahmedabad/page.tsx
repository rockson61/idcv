...
export const metadata: Metadata = {
  title: 'Best Dentist in Ahmedabad, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Ahmedabad, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ahmedabad'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
