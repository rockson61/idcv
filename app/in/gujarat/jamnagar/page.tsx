...
export const metadata: Metadata = {
  title: 'Best Dentist in Jamnagar, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Jamnagar, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jamnagar'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
