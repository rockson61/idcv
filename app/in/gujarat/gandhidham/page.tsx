...
export const metadata: Metadata = {
  title: 'Best Dentist in Gandhidham, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Gandhidham, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gandhidham'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
