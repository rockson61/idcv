...
export const metadata: Metadata = {
  title: 'Best Dentist in Junagadh, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Junagadh, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Junagadh'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
