...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajkot, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajkot, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajkot'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
