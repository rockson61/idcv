...
export const metadata: Metadata = {
  title: 'Best Dentist in Nadiad, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Nadiad, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nadiad'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
