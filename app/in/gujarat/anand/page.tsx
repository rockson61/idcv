...
export const metadata: Metadata = {
  title: 'Best Dentist in Anand, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Anand, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anand'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
