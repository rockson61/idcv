...
export const metadata: Metadata = {
  title: 'Best Dentist in Surat, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Surat, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Surat'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
