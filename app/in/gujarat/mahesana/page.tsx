...
export const metadata: Metadata = {
  title: 'Best Dentist in Mahesana, Gujarat | Indira Dental Clinic',
  description: 'Top-rated dental care for Mahesana, Gujarat. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mahesana'
const city = 'Gujarat'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
