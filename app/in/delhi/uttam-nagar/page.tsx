...
export const metadata: Metadata = {
  title: 'Best Dentist in Uttam Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Uttam Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uttam Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
