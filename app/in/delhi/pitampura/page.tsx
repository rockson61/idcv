...
export const metadata: Metadata = {
  title: 'Best Dentist in Pitampura, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Pitampura, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pitampura'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
