...
export const metadata: Metadata = {
  title: 'Best Dentist in Lajpat Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Lajpat Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Lajpat Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
