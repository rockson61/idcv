...
export const metadata: Metadata = {
  title: 'Best Dentist in Mayur Vihar Extension, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Mayur Vihar Extension, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mayur Vihar Extension'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
