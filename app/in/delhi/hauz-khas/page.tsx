...
export const metadata: Metadata = {
  title: 'Best Dentist in Hauz Khas, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Hauz Khas, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hauz Khas'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
