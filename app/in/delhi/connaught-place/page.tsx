...
export const metadata: Metadata = {
  title: 'Best Dentist in Connaught Place, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Connaught Place, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Connaught Place'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
