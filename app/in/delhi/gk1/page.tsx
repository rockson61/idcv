...
export const metadata: Metadata = {
  title: 'Best Dentist in Gk1, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Gk1, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gk1'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
