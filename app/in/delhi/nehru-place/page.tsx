...
export const metadata: Metadata = {
  title: 'Best Dentist in Nehru Place, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Nehru Place, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nehru Place'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
