...
export const metadata: Metadata = {
  title: 'Best Dentist in Delhi, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Delhi, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}
