...
export const metadata: Metadata = {
  title: 'Dental Services in mayur-vihar-phase-1 | Best Dentist in mayur-vihar-phase-1 | Indira Dental Clinic',
  description: 'Expert dental services in mayur-vihar-phase-1. RCT, dental implants, braces, cosmetic dentistry by Dr. Rockson Samuel. Save 50% on dental treatments by visiting Vellore.',
  keywords: ['dentist mayur-vihar-phase-1', 'dental clinic mayur-vihar-phase-1', 'dental services mayur-vihar-phase-1', 'best dentist mayur-vihar-phase-1'],
}

export default function MayurViharPhase1Page() {
  const services = [
    {
  ...
  const faqs = [
    {
      question: 'What are the best dental clinics in Mayur Vihar Phase 1?',
      answer: 'Indira Dental Clinic in Vellore offers the best dental services in Mayur Vihar Phase 1 with 50% lower costs. Our experienced team provides world-class dental care with modern technology and personalized treatment plans.'
    },
    {
      question: 'How much does dental treatment cost in Mayur Vihar Phase 1?',
      answer: 'Dental treatment costs in Mayur Vihar Phase 1 can be expensive, but you can save 50% by visiting Indira Dental Clinic in Vellore. Root canal treatment costs ₹3,000-8,000, dental implants ₹25,000-45,000, and braces ₹30,000-80,000 in Vellore.'
    },
    {
      question: 'Where can I find the best dentist in Mayur Vihar Phase 1?',
      answer: 'Dr. Rockson Samuel at Indira Dental Clinic in Vellore is the best dentist serving Mayur Vihar Phase 1 patients. With years of experience and modern facilities, we provide comprehensive dental care at affordable prices.'
    },
    {
      question: 'Is dental tourism to Vellore worth it from Mayur Vihar Phase 1?',
      answer: 'Yes, dental tourism to Vellore from Mayur Vihar Phase 1 is highly beneficial. You can save up to 50% on dental treatments while receiving world-class care. The travel cost is minimal compared to the savings on dental procedures.'
    },
    {
      question: 'What dental services are available in Mayur Vihar Phase 1?',
      answer: 'Indira Dental Clinic in Vellore offers all dental services for Mayur Vihar Phase 1 patients including RCT, implants, braces, cosmetic dentistry, general dentistry, and pediatric care. All services are available at 50% lower costs than Mayur Vihar Phase 1.'
    }
  ]
  ...
  const reviews = [
    {
      ...
      text: 'I traveled from Mayur Vihar Phase 1 to Vellore for dental implants and saved ₹15,000 compared to local prices. Dr. Rockson Samuel provided excellent care and the results are amazing.',
      date: '2024-01-15'
    },
    {
      name: 'Rajesh Kumar',
      ...
      text: 'Best decision to visit Indira Dental Clinic in Vellore. The RCT was painless and cost 50% less than Mayur Vihar Phase 1. Highly recommended for all dental treatments.',
      date: '2024-01-10'
    },
    {
      name: 'Sunita Singh',
      ...
      text: 'My daughter got braces treatment in Vellore and we saved ₹25,000 compared to Mayur Vihar Phase 1 prices. The treatment quality is excellent and the clinic is very modern.',
      date: '2024-01-08'
    }
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <Breadcrumb
          items={[
            ...
            { title: 'Mayur Vihar Phase 1', href: '/in/delhi/mayur-vihar-phase-1' }
          ]}
          className="mb-8"
        />
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Dental Services in Mayur Vihar Phase 1
          </h1>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-8">
            Experience world-class dental care in Mayur Vihar Phase 1, Delhi. Our expert dentists 
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Dental Services in Mayur Vihar Phase 1</h2>
        ...
        {/* Reviews */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Patient Reviews from Mayur Vihar Phase 1</h2>
          ...
          <ModernCard className="bg-gradient-to-r from-teal-600 to-blue-600 text-white">
            <ModernCardContent className="py-12 text-center">
              ...
              <p className="text-xl mb-6">
                Visit Indira Dental Clinic in Vellore and save up to 50% on all dental treatments compared to Mayur Vihar Phase 1 prices.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm opacity-90">Well-connected from Mayur Vihar Phase 1</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ModernCard>
              ...
              <ModernCardContent>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">From Mayur Vihar Phase 1 to Vellore:</h4>
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                ...
                Save 50% by visiting our Vellore clinic or get local consultation in Mayur Vihar Phase 1.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/contact"
