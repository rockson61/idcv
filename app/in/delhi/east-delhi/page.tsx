...
export const metadata: Metadata = {
  title: 'Best Dentist in East Delhi, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for East Delhi, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'East Delhi'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
