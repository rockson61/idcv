...
export const metadata: Metadata = {
  title: 'Best Dentist in Malviya Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Malviya Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Malviya Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
