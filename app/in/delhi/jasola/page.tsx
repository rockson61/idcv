...
export const metadata: Metadata = {
  title: 'Best Dentist in Jasola, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Jasola, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jasola'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
