...
export const metadata: Metadata = {
  title: 'Best Dentist in New Delhi, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for New Delhi, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}
