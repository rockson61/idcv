...
export const metadata: Metadata = {
  title: 'Best Dentist in Panchsheel Enclave, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Panchsheel Enclave, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Panchsheel Enclave'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
