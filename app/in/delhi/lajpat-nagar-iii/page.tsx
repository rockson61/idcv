...
export const metadata: Metadata = {
  title: 'Best Dentist in Lajpat Nagar Iii, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Lajpat Nagar Iii, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Lajpat Nagar Iii'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
