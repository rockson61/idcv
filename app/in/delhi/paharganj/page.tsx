...
export const metadata: Metadata = {
  title: 'Best Dentist in Paharganj, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Paharganj, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Paharganj'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
