...
export const metadata: Metadata = {
  title: 'Best Dentist in South Ext I, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for South Ext I, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'South Ext I'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
