...
export const metadata: Metadata = {
  title: 'Best Dentist in Delhi Ncr, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Delhi Ncr, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Delhi Ncr'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
