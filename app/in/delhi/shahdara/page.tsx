...
export const metadata: Metadata = {
  title: 'Best Dentist in Shahdara, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Shahdara, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shahdara'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
