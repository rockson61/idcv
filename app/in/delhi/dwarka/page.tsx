...
export const metadata: Metadata = {
  title: 'Best Dentist in Dwarka, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Dwarka, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dwarka'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
