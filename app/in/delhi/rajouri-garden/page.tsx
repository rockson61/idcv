...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajouri Garden, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajouri Garden, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajouri Garden'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
