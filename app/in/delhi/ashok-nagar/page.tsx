...
export const metadata: Metadata = {
  title: 'Best Dentist in Ashok Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Ashok Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ashok Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
