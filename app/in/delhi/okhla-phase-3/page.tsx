...
export const metadata: Metadata = {
  title: 'Best Dentist in Okhla Phase 3, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Okhla Phase 3, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Okhla Phase 3'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
