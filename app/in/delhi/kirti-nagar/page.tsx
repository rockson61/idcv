...
export const metadata: Metadata = {
  title: 'Best Dentist in Kirti Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Kirti Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kirti Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
