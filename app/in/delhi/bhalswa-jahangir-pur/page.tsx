...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhalswa Jahangir Pur, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Bhalswa Jahangir Pur, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bhalswa Jahangir Pur'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
