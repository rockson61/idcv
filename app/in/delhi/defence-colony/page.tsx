...
export const metadata: Metadata = {
  title: 'Best Dentist in Defence Colony, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Defence Colony, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Defence Colony'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
