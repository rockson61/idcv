...
export const metadata: Metadata = {
  title: 'Best Dentist in Okhla Phase 1, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Okhla Phase 1, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Okhla Phase 1'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
