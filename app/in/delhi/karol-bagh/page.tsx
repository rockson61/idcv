...
export const metadata: Metadata = {
  title: 'Best Dentist in Karol Bagh, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Karol Bagh, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karol Bagh'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
