...
export const metadata: Metadata = {
  title: 'Best Dentist in Sultan Pur Majra, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Sultan Pur Majra, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sultan Pur Majra'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
