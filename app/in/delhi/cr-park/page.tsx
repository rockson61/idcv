...
export const metadata: Metadata = {
  title: 'Best Dentist in Cr Park, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Cr Park, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Cr Park'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
