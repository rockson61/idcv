...
export const metadata: Metadata = {
  title: 'Best Dentist in Central Delhi, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Central Delhi, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Central Delhi'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
