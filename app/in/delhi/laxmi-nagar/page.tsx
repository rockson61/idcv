...
export const metadata: Metadata = {
  title: 'Best Dentist in Laxmi Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Laxmi Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Laxmi Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
