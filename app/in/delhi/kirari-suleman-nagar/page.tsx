...
export const metadata: Metadata = {
  title: 'Best Dentist in Kirari Suleman Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Kirari Suleman Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kirari Suleman Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
