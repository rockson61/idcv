...
export const metadata: Metadata = {
  title: 'Best Dentist in Karawal Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Karawal Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karawal Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
