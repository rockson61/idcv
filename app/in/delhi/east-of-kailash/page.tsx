...
export const metadata: Metadata = {
  title: 'Best Dentist in East Of Kailash, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for East Of Kailash, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'East Of Kailash'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
