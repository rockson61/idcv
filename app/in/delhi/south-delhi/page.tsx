...
export const metadata: Metadata = {
  title: 'Best Dentist in South Delhi, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for South Delhi, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'South Delhi'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
