...
export const metadata: Metadata = {
  title: 'Best Dentist in Lajpat Nagar I, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Lajpat Nagar I, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Lajpat Nagar I'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
