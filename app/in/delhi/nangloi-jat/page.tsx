...
export const metadata: Metadata = {
  title: 'Best Dentist in Nangloi Jat, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Nangloi Jat, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nangloi Jat'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
