...
export const metadata: Metadata = {
  title: 'Best Dentist in Sheikh Sarai, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Sheikh Sarai, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sheikh Sarai'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
