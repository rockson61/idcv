...
export const metadata: Metadata = {
  title: 'Best Dentist in Lajpat Nagar Iv, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Lajpat Nagar Iv, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Lajpat Nagar Iv'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
