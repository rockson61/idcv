...
export const metadata: Metadata = {
  title: 'Best Dentist in Janakpuri, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Janakpuri, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Janakpuri'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
