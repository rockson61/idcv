...
export const metadata: Metadata = {
  title: 'Best Dentist in New Friends Colony, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for New Friends Colony, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'New Friends Colony'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
