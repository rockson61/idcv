...
export const metadata: Metadata = {
  title: 'Best Dentist in Nirman Vihar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Nirman Vihar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nirman Vihar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
