...
export const metadata: Metadata = {
  title: 'Best Dentist in Gk2, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Gk2, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gk2'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
