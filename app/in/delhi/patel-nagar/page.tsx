...
export const metadata: Metadata = {
  title: 'Best Dentist in Patel Nagar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Patel Nagar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Patel Nagar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
