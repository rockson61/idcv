...
export const metadata: Metadata = {
  title: 'Best Dentist in Preet Vihar, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Preet Vihar, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Preet Vihar'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
