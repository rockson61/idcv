...
export const metadata: Metadata = {
  title: 'Best Dentist in Chittaranjan Park, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Chittaranjan Park, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chittaranjan Park'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
