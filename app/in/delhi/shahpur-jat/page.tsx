...
export const metadata: Metadata = {
  title: 'Best Dentist in Shahpur Jat, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Shahpur Jat, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shahpur Jat'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
