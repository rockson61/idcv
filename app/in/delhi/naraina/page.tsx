...
export const metadata: Metadata = {
  title: 'Best Dentist in Naraina, Delhi | Indira Dental Clinic',
  description: 'Top-rated dental care for Naraina, Delhi. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Naraina'
const city = 'Delhi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
