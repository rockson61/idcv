...
export const metadata: Metadata = {
  title: 'Best Dentist in Guntur, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Guntur, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guntur'
