...
export const metadata: Metadata = {
  title: 'Best Dentist in Anantapur, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Anantapur, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anantapur'
