...
export const metadata: Metadata = {
  title: 'Best Dentist in Kakinada, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Kakinada, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kakinada'
