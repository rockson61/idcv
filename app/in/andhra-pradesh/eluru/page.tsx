...
export const metadata: Metadata = {
  title: 'Best Dentist in Eluru, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Eluru, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Eluru'
