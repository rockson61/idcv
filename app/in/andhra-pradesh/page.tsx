...
export const metadata: Metadata = {
  title: 'Best Dentist in Andhra Pradesh, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Andhra Pradesh, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Andhra Pradesh'
