...
export const metadata: Metadata = {
  title: 'Best Dentist in Chittoor, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Chittoor, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}
