...
export const metadata: Metadata = {
  title: 'Best Dentist in Tadipatri, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Tadipatri, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tadipatri'
