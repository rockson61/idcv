...
export const metadata: Metadata = {
  title: 'Best Dentist in Anantapuram, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Anantapuram, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anantapuram'
