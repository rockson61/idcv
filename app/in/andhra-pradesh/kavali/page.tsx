...
export const metadata: Metadata = {
  title: 'Best Dentist in Kavali, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Kavali, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kavali'
