...
export const metadata: Metadata = {
  title: 'Best Dentist in Madanapalle, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Madanapalle, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madanapalle'
