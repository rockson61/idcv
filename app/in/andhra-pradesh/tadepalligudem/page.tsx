...
export const metadata: Metadata = {
  title: 'Best Dentist in Tadepalligudem, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Tadepalligudem, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tadepalligudem'
const city = 'Andhra Pradesh'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
