...
export const metadata: Metadata = {
  title: 'Best Dentist in Tenali, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Tenali, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tenali'
