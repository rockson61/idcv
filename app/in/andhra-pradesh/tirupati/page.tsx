...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupati, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Tirupati, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tirupati'
