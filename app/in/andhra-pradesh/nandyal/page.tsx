...
export const metadata: Metadata = {
  title: 'Best Dentist in Nandyal, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Nandyal, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nandyal'
