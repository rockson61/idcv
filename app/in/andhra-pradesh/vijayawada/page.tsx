...
export const metadata: Metadata = {
  title: 'Best Dentist in Vijayawada, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Vijayawada, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}
