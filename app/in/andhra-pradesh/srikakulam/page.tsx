...
export const metadata: Metadata = {
  title: 'Best Dentist in Srikakulam, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Srikakulam, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Srikakulam'
