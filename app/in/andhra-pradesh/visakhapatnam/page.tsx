...
export const metadata: Metadata = {
  title: 'Best Dentist in Visakhapatnam, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Visakhapatnam, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Visakhapatnam'
