...
export const metadata: Metadata = {
  title: 'Best Dentist in Adoni, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Adoni, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Adoni'
