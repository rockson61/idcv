...
export const metadata: Metadata = {
  title: 'Best Dentist in Narasaraopet, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Narasaraopet, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Narasaraopet'
