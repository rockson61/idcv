...
export const metadata: Metadata = {
  title: 'Best Dentist in Ongole, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ongole, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ongole'
