...
export const metadata: Metadata = {
  title: 'Best Dentist in Machilipatnam, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Machilipatnam, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Machilipatnam'
