...
export const metadata: Metadata = {
  title: 'Best Dentist in Vijayanagaram, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Vijayanagaram, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vijayanagaram'
