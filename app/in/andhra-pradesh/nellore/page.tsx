...
export const metadata: Metadata = {
  title: 'Best Dentist in Nellore, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Nellore, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nellore'
