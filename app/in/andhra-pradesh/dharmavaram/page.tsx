...
export const metadata: Metadata = {
  title: 'Best Dentist in Dharmavaram, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Dharmavaram, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dharmavaram'
