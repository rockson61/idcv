...
export const metadata: Metadata = {
  title: 'Best Dentist in Proddatur, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Proddatur, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Proddatur'
