...
export const metadata: Metadata = {
  title: 'Best Dentist in Guntakal, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Guntakal, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guntakal'
