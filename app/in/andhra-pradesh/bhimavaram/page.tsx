...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhimavaram, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Bhimavaram, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bhimavaram'
