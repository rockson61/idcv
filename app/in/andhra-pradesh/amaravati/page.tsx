...
export const metadata: Metadata = {
  title: 'Best Dentist in Amaravati, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Amaravati, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Amaravati'
