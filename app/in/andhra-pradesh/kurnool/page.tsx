...
export const metadata: Metadata = {
  title: 'Best Dentist in Kurnool, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Kurnool, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kurnool'
