...
export const metadata: Metadata = {
  title: 'Best Dentist in Hindupur, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Hindupur, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hindupur'
