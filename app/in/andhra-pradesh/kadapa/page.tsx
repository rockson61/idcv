...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadapa, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Kadapa, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kadapa'
