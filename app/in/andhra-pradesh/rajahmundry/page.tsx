...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajahmundry, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajahmundry, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajahmundry'
