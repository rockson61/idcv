...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudivada, Andhra Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Gudivada, Andhra Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gudivada'
