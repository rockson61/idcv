...
export const metadata: Metadata = {
  title: 'Best Dentist in Bellary, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Bellary, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bellary'
