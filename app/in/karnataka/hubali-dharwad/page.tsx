...
export const metadata: Metadata = {
  title: 'Best Dentist in Hubali Dharwad, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Hubali Dharwad, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hubali Dharwad'
