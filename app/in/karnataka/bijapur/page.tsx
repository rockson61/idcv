...
export const metadata: Metadata = {
  title: 'Best Dentist in Bijapur, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Bijapur, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bijapur'
