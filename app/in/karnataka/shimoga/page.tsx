...
export const metadata: Metadata = {
  title: 'Best Dentist in Shimoga, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Shimoga, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shimoga'
