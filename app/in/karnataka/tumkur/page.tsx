...
export const metadata: Metadata = {
  title: 'Best Dentist in Tumkur, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Tumkur, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tumkur'
