...
export const metadata: Metadata = {
  title: 'Best Dentist in Gulbarga, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Gulbarga, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gulbarga'
