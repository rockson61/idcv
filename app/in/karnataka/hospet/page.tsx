...
export const metadata: Metadata = {
  title: 'Best Dentist in Hospet, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Hospet, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hospet'
