...
export const metadata: Metadata = {
  title: 'Best Dentist in Udupi, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Udupi, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Udupi'
