...
export const metadata: Metadata = {
  title: 'Best Dentist in Bangalore, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Bangalore, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bangalore'
