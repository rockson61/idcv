...
export const metadata: Metadata = {
  title: 'Best Dentist in Bidar, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Bidar, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bidar'
