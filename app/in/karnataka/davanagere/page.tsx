...
export const metadata: Metadata = {
  title: 'Best Dentist in Davanagere, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Davanagere, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Davanagere'
