...
export const metadata: Metadata = {
  title: 'Best Dentist in Raichur, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Raichur, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Raichur'
