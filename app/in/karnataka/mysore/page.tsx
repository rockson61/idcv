...
export const metadata: Metadata = {
  title: 'Best Dentist in Mysore, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Mysore, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mysore'
