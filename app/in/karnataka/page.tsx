...
export const metadata: Metadata = {
  title: 'Best Dentist in Karnataka, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Karnataka, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karnataka'
