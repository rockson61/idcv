...
export const metadata: Metadata = {
  title: 'Best Dentist in Belgaum, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Belgaum, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Belgaum'
