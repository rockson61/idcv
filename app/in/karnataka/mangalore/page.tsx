...
export const metadata: Metadata = {
  title: 'Best Dentist in Mangalore, Karnataka | Indira Dental Clinic',
  description: 'Top-rated dental care for Mangalore, Karnataka. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mangalore'
