...
export const metadata: Metadata = {
  title: 'Best Dentist in Cuttack, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Cuttack, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Cuttack'
const city = 'Odisha'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
