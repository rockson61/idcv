...
export const metadata: Metadata = {
  title: 'Best Dentist in Sambalpur, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Sambalpur, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}
