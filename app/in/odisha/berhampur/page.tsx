...
export const metadata: Metadata = {
  title: 'Best Dentist in Berhampur, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Berhampur, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Berhampur'
const city = 'Odisha'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
