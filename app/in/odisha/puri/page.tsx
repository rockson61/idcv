...
export const metadata: Metadata = {
  title: 'Best Dentist in Puri, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Puri, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Puri'
const city = 'Odisha'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
