...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhubaneswar, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Bhubaneswar, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}
