...
export const metadata: Metadata = {
  title: 'Best Dentist in Rourkela, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Rourkela, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rourkela'
const city = 'Odisha'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
