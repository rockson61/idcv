...
export const metadata: Metadata = {
  title: 'Best Dentist in Raurkela Industrial Township, Odisha | Indira Dental Clinic',
  description: 'Top-rated dental care for Raurkela Industrial Township, Odisha. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Raurkela Industrial Township'
const city = 'Odisha'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
