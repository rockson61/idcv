...
export const metadata: Metadata = {
  title: 'Best Dentist in Jammu, Jammu And Kashmir | Indira Dental Clinic',
  description: 'Top-rated dental care for Jammu, Jammu And Kashmir. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jammu'
