...
export const metadata: Metadata = {
  title: 'Best Dentist in Srinagar, Jammu And Kashmir | Indira Dental Clinic',
  description: 'Top-rated dental care for Srinagar, Jammu And Kashmir. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Srinagar'
const city = 'Jammu And Kashmir'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
