...
export const metadata: Metadata = {
  title: 'Dental Services in jammu-and-kashmir | Expert Dentist | Indira Dental Clinic',
  description: 'Comprehensive dental services in jammu-and-kashmir. Expert dental care including RCT, implants, braces, cosmetic dentistry. Visit Indira Dental Clinic in Vellore for 50% savings.',
  keywords: ['dentist jammu-and-kashmir', 'dental clinic jammu-and-kashmir', 'dental services jammu-and-kashmir'],
}

export default function JammuAndKashmirPage() {
  const cities = [
    { name: 'Jammu', href: '/in/jammu-and-kashmir/jammu', description: 'Quality dental services in Jammu' },
    { name: 'Srinagar', href: '/in/jammu-and-kashmir/srinagar', description: 'Quality dental services in Srinagar' }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Cities in Jammu And Kashmir</h2>
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                Browse through our extensive network of dental services across Jammu And Kashmir. 
