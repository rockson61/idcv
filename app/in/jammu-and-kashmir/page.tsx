...
export const metadata: Metadata = {
  title: 'Best Dentist in Jammu And Kashmir, Jammu And Kashmir | Indira Dental Clinic',
  description: 'Top-rated dental care for Jammu And Kashmir, Jammu And Kashmir. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jammu And Kashmir'
