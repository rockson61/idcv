...
export const metadata: Metadata = {
  title: 'Best Dentist in Sikkim, Sikkim | Indira Dental Clinic',
  description: 'Top-rated dental care for Sikkim, Sikkim. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sikkim'
const city = 'Sikkim'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
