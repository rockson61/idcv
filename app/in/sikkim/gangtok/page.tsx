...
export const metadata: Metadata = {
  title: 'Best Dentist in Gangtok, Sikkim | Indira Dental Clinic',
  description: 'Top-rated dental care for Gangtok, Sikkim. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gangtok'
const city = 'Sikkim'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
