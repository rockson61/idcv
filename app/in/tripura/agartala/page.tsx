...
export const metadata: Metadata = {
  title: 'Best Dentist in Agartala, Tripura | Indira Dental Clinic',
  description: 'Top-rated dental care for Agartala, Tripura. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Agartala'
const city = 'Tripura'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
