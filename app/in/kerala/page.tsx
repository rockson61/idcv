...
export const metadata: Metadata = {
  title: 'Dental Services in kerala | Expert Dentist | Indira Dental Clinic',
  description: 'Comprehensive dental services in kerala. Expert dental care including RCT, implants, braces, cosmetic dentistry. Visit Indira Dental Clinic in Vellore for 50% savings.',
  keywords: ['dentist kerala', 'dental clinic kerala', 'dental services kerala'],
}

export default function KeralaPage() {
  const cities = [
    { name: 'Kochi', href: '/in/kerala/kochi', description: 'Quality dental services in Kochi' },
    { name: 'Thiruvananthapuram', href: '/in/kerala/thiruvananthapuram', description: 'Quality dental services in Thiruvananthapuram' },
    { name: 'Kozhikode', href: '/in/kerala/kozhikode', description: 'Quality dental services in Kozhikode' },
    { name: 'Kollam', href: '/in/kerala/kollam', description: 'Quality dental services in Kollam' },
    { name: 'Thrissur', href: '/in/kerala/thrissur', description: 'Quality dental services in Thrissur' },
    { name: 'Alappuzha', href: '/in/kerala/alappuzha', description: 'Quality dental services in Alappuzha' },
    { name: 'Kottayam', href: '/in/kerala/kottayam', description: 'Quality dental services in Kottayam' }
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Dental Services in Kerala
          </h1>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-8">
            Find comprehensive dental care services across Kerala. Expert dental treatments 
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Cities in Kerala</h2>
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                Browse through our extensive network of dental services across Kerala. 
