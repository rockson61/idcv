...
export const metadata: Metadata = {
  title: 'Best Dentist in Kerala, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Kerala, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kerala'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
