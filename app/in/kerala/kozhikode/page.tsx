...
export const metadata: Metadata = {
  title: 'Best Dentist in Kozhikode, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Kozhikode, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kozhikode'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
