...
export const metadata: Metadata = {
  title: 'Best Dentist in Kochi, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Kochi, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kochi'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
