...
export const metadata: Metadata = {
  title: 'Best Dentist in Kollam, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Kollam, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kollam'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
