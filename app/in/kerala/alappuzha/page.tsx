...
export const metadata: Metadata = {
  title: 'Best Dentist in Alappuzha, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Alappuzha, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Alappuzha'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
