...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvananthapuram, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvananthapuram, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvananthapuram'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
