...
export const metadata: Metadata = {
  title: 'Best Dentist in Thrissur, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Thrissur, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thrissur'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
