...
export const metadata: Metadata = {
  title: 'Best Dentist in Kottayam, Kerala | Indira Dental Clinic',
  description: 'Top-rated dental care for Kottayam, Kerala. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kottayam'
const city = 'Kerala'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
