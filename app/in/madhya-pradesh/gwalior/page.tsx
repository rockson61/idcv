...
export const metadata: Metadata = {
  title: 'Best Dentist in Gwalior, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Gwalior, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gwalior'
