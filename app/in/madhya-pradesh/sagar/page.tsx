...
export const metadata: Metadata = {
  title: 'Best Dentist in Sagar, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Sagar, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sagar'
