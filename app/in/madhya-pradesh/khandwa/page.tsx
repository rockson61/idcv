...
export const metadata: Metadata = {
  title: 'Best Dentist in Khandwa, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Khandwa, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Khandwa'
