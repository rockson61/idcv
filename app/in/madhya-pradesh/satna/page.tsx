...
export const metadata: Metadata = {
  title: 'Best Dentist in Satna, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Satna, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Satna'
