...
export const metadata: Metadata = {
  title: 'Best Dentist in Ratlam, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ratlam, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ratlam'
