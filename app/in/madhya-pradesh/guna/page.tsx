...
export const metadata: Metadata = {
  title: 'Best Dentist in Guna, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Guna, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guna'
