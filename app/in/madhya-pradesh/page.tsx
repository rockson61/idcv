...
export const metadata: Metadata = {
  title: 'Best Dentist in Madhya Pradesh, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Madhya Pradesh, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madhya Pradesh'
