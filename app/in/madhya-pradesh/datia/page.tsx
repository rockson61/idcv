...
export const metadata: Metadata = {
  title: 'Best Dentist in Datia, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Datia, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Datia'
