...
export const metadata: Metadata = {
  title: 'Best Dentist in Dewas, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Dewas, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dewas'
