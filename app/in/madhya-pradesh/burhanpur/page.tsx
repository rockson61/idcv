...
export const metadata: Metadata = {
  title: 'Best Dentist in Burhanpur, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Burhanpur, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Burhanpur'
