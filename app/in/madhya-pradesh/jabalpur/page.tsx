...
export const metadata: Metadata = {
  title: 'Best Dentist in Jabalpur, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Jabalpur, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}
