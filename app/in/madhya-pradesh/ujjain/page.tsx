...
export const metadata: Metadata = {
  title: 'Best Dentist in Ujjain, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Ujjain, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ujjain'
