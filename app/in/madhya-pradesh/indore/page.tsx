...
export const metadata: Metadata = {
  title: 'Best Dentist in Indore, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Indore, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Indore'
