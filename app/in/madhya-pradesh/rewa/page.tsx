...
export const metadata: Metadata = {
  title: 'Best Dentist in Rewa, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Rewa, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rewa'
