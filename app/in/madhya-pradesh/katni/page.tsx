...
export const metadata: Metadata = {
  title: 'Best Dentist in Katni, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Katni, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Katni'
