...
export const metadata: Metadata = {
  title: 'Best Dentist in Morena, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Morena, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Morena'
