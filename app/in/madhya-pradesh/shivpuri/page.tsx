...
export const metadata: Metadata = {
  title: 'Best Dentist in Shivpuri, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Shivpuri, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shivpuri'
