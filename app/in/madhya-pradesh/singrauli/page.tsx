...
export const metadata: Metadata = {
  title: 'Best Dentist in Singrauli, Madhya Pradesh | Indira Dental Clinic',
  description: 'Top-rated dental care for Singrauli, Madhya Pradesh. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Singrauli'
