...
export const metadata: Metadata = {
  title: 'Best Dentist in Giridih, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Giridih, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Giridih'
