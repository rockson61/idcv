...
export const metadata: Metadata = {
  title: 'Best Dentist in Ranchi, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Ranchi, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ranchi'
