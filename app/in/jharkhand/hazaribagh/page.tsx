...
export const metadata: Metadata = {
  title: 'Best Dentist in Hazaribagh, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Hazaribagh, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hazaribagh'
