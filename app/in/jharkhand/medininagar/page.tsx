...
export const metadata: Metadata = {
  title: 'Best Dentist in Medininagar, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Medininagar, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Medininagar'
const city = 'Jharkhand'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
