...
export const metadata: Metadata = {
  title: 'Best Dentist in Jharkhand, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Jharkhand, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jharkhand'
