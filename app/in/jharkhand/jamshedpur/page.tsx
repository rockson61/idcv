...
export const metadata: Metadata = {
  title: 'Best Dentist in Jamshedpur, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Jamshedpur, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jamshedpur'
