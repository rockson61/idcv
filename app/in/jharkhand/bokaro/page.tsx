...
export const metadata: Metadata = {
  title: 'Best Dentist in Bokaro, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Bokaro, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bokaro'
