...
export const metadata: Metadata = {
  title: 'Best Dentist in Dhanbad, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Dhanbad, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dhanbad'
