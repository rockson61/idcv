...
export const metadata: Metadata = {
  title: 'Best Dentist in Deoghar, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Deoghar, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Deoghar'
