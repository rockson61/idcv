...
export const metadata: Metadata = {
  title: 'Best Dentist in Ramgarh, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Ramgarh, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ramgarh'
