...
export const metadata: Metadata = {
  title: 'Best Dentist in Mango, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Mango, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}
