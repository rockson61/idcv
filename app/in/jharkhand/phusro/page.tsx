...
export const metadata: Metadata = {
  title: 'Best Dentist in Phusro, Jharkhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Phusro, Jharkhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Phusro'
