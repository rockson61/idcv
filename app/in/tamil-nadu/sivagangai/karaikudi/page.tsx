...
export const metadata: Metadata = {
  title: 'Best Dentist in Karaikudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Karaikudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karaikudi'
