...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupathur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tirupathur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tirupathur'
