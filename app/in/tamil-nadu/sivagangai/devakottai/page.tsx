...
export const metadata: Metadata = {
  title: 'Best Dentist in Devakottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Devakottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Devakottai'
