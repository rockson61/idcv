...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalaiyarkovil, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kalaiyarkovil, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kalaiyarkovil'
const city = 'Sivagangai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
