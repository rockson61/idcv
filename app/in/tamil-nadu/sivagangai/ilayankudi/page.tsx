...
export const metadata: Metadata = {
  title: 'Best Dentist in Ilayankudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ilayankudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ilayankudi'
