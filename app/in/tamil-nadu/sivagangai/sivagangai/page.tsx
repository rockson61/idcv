...
export const metadata: Metadata = {
  title: 'Best Dentist in Sivagangai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sivagangai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sivagangai'
