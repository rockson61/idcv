...
export const metadata: Metadata = {
  title: 'Best Dentist in Singampunari, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Singampunari, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Singampunari'
