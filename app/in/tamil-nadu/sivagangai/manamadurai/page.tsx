...
export const metadata: Metadata = {
  title: 'Best Dentist in Manamadurai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Manamadurai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
