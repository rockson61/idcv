...
export const metadata: Metadata = {
  title: 'Best Dentist in Thirupuvanam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thirupuvanam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thirupuvanam'
