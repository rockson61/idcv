...
export const metadata: Metadata = {
  title: 'Best Dentist in Coimbatorenorth, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Coimbatorenorth, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Coimbatorenorth'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Coimbatorenorth', href: '/in/tamil-nadu/coimbatore/coimbatorenorth' },
          ]}
        />
