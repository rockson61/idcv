...
export const metadata: Metadata = {
  title: 'Best Dentist in Mettupalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mettupalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mettupalayam'
