...
export const metadata: Metadata = {
  title: 'Best Dentist in Madukarai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Madukarai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madukarai'
