...
export const metadata: Metadata = {
  title: 'Best Dentist in Annur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Annur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Annur'
