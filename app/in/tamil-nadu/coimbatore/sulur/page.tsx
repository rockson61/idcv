...
export const metadata: Metadata = {
  title: 'Best Dentist in Sulur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sulur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sulur'
