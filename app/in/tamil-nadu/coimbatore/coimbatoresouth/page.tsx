...
export const metadata: Metadata = {
  title: 'Best Dentist in Coimbatoresouth, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Coimbatoresouth, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Coimbatoresouth'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Coimbatoresouth', href: '/in/tamil-nadu/coimbatore/coimbatoresouth' },
          ]}
        />
