...
export const metadata: Metadata = {
  title: 'Best Dentist in Kinathukadavu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kinathukadavu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kinathukadavu'
