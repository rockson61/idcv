...
export const metadata: Metadata = {
  title: 'Best Dentist in Pollachi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pollachi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pollachi'
