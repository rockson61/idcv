...
export const metadata: Metadata = {
  title: 'Best Dentist in Perur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Perur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Perur'
