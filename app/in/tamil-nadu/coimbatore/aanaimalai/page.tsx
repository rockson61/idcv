...
export const metadata: Metadata = {
  title: 'Best Dentist in Aanaimalai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Aanaimalai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aanaimalai'
