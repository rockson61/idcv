...
export const metadata: Metadata = {
  title: 'Best Dentist in Coimbatore, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Coimbatore, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
