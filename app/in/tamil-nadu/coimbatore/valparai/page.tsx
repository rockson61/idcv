...
export const metadata: Metadata = {
  title: 'Best Dentist in Valparai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Valparai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Valparai'
