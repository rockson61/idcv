...
export const metadata: Metadata = {
  title: 'Best Dentist in Sivaganga, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sivaganga, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sivaganga'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Sivaganga', href: '/in/tamil-nadu/sivaganga' },
          ]}
        />
