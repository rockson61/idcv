...
export const metadata: Metadata = {
  title: 'Best Dentist in Pallipattu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pallipattu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pallipattu'
