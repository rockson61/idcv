...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruthani, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruthani, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruthani'
