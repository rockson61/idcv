...
export const metadata: Metadata = {
  title: 'Best Dentist in Rk Pet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rk Pet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rk Pet'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Rk Pet', href: '/in/tamil-nadu/thiruvallur/rk-pet' },
          ]}
        />
