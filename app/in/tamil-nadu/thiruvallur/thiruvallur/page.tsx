...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvallur'
