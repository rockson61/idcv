...
export const metadata: Metadata = {
  title: 'Best Dentist in Gummidipoondi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gummidipoondi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gummidipoondi'
const city = 'Thiruvallur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
