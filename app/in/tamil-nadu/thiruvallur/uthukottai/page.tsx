...
export const metadata: Metadata = {
  title: 'Best Dentist in Uthukottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Uthukottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uthukottai'
