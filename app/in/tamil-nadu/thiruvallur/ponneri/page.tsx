...
export const metadata: Metadata = {
  title: 'Best Dentist in Ponneri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ponneri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
