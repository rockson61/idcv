...
export const metadata: Metadata = {
  title: 'Best Dentist in Poonamallee, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Poonamallee, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Poonamallee'
