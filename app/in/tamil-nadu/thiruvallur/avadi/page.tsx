...
export const metadata: Metadata = {
  title: 'Best Dentist in Avadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Avadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Avadi'
