...
export const metadata: Metadata = {
  title: 'Best Dentist in Thottiam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thottiam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thottiam'
