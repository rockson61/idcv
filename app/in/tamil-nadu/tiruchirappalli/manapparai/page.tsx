...
export const metadata: Metadata = {
  title: 'Best Dentist in Manapparai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Manapparai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manapparai'
