...
export const metadata: Metadata = {
  title: 'Best Dentist in Manachanallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Manachanallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manachanallur'
