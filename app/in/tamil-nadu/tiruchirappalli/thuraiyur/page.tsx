...
export const metadata: Metadata = {
  title: 'Best Dentist in Thuraiyur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thuraiyur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thuraiyur'
