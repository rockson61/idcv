...
export const metadata: Metadata = {
  title: 'Best Dentist in Marungapuri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Marungapuri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Marungapuri'
