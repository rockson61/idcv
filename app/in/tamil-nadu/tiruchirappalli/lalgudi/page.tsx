...
export const metadata: Metadata = {
  title: 'Best Dentist in Lalgudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Lalgudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Lalgudi'
