...
export const metadata: Metadata = {
  title: 'Best Dentist in Musiri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Musiri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Musiri'
