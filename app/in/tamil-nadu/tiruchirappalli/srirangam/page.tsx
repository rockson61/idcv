...
export const metadata: Metadata = {
  title: 'Best Dentist in Srirangam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Srirangam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Srirangam'
