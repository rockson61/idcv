...
export const metadata: Metadata = {
  title: 'Best Dentist in Papanasam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Papanasam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Papanasam'
