...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvaiyaru, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvaiyaru, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvaiyaru'
