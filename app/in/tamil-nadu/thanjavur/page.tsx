...
export const metadata: Metadata = {
  title: 'Best Dentist in Thanjavur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thanjavur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thanjavur'
