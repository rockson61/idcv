...
export const metadata: Metadata = {
  title: 'Best Dentist in Pattukottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pattukottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pattukottai'
