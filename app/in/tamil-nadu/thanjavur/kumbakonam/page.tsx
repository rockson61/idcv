...
export const metadata: Metadata = {
  title: 'Best Dentist in Kumbakonam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kumbakonam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kumbakonam'
