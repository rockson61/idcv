...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvidaimaruthur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvidaimaruthur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvidaimaruthur'
