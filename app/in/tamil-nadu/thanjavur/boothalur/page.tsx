...
export const metadata: Metadata = {
  title: 'Best Dentist in Boothalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Boothalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Boothalur'
