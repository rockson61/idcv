...
export const metadata: Metadata = {
  title: 'Best Dentist in Peravurani, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Peravurani, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Peravurani'
