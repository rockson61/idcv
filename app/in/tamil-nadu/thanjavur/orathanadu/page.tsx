...
export const metadata: Metadata = {
  title: 'Best Dentist in Orathanadu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Orathanadu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Orathanadu'
