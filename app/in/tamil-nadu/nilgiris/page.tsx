...
export const metadata: Metadata = {
  title: 'Best Dentist in Nilgiris, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nilgiris, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nilgiris'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Nilgiris', href: '/in/tamil-nadu/nilgiris' },
          ]}
        />
