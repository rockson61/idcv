...
export const metadata: Metadata = {
  title: 'Best Dentist in Theni, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Theni, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Theni'
