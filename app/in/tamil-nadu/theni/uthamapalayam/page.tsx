...
export const metadata: Metadata = {
  title: 'Best Dentist in Uthamapalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Uthamapalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uthamapalayam'
const city = 'Theni'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
