...
export const metadata: Metadata = {
  title: 'Best Dentist in Aandipatti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Aandipatti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aandipatti'
const city = 'Theni'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
