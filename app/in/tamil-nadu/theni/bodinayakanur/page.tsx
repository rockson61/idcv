...
export const metadata: Metadata = {
  title: 'Best Dentist in Bodinayakanur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Bodinayakanur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bodinayakanur'
const city = 'Theni'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
