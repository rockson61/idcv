...
export const metadata: Metadata = {
  title: 'Best Dentist in Tamil Nadu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tamil Nadu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tamil Nadu'
