...
export const metadata: Metadata = {
  title: 'Best Dentist in Kariyapatti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kariyapatti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kariyapatti'
