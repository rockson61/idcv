...
export const metadata: Metadata = {
  title: 'Best Dentist in Sivakasi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sivakasi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sivakasi'
