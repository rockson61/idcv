...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajapalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajapalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
