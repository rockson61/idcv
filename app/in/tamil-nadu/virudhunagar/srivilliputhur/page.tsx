...
export const metadata: Metadata = {
  title: 'Best Dentist in Srivilliputhur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Srivilliputhur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Srivilliputhur'
const city = 'Virudhunagar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
