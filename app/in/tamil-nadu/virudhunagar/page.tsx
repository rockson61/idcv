...
export const metadata: Metadata = {
  title: 'Best Dentist in Virudhunagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Virudhunagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Virudhunagar'
