...
export const metadata: Metadata = {
  title: 'Best Dentist in Aruppukottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Aruppukottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aruppukottai'
