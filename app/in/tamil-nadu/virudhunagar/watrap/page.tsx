...
export const metadata: Metadata = {
  title: 'Best Dentist in Watrap, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Watrap, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Watrap'
