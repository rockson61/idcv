...
export const metadata: Metadata = {
  title: 'Best Dentist in Sathur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sathur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sathur'
