...
export const metadata: Metadata = {
  title: 'Best Dentist in Vembakottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vembakottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vembakottai'
