...
export const metadata: Metadata = {
  title: 'Best Dentist in Shenkottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Shenkottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shenkottai'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
