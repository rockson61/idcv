...
export const metadata: Metadata = {
  title: 'Best Dentist in Veerakeralampudur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Veerakeralampudur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Veerakeralampudur'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
