...
export const metadata: Metadata = {
  title: 'Best Dentist in Alangulam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Alangulam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Alangulam'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
