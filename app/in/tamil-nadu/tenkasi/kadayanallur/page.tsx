...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadayanallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kadayanallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kadayanallur'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
