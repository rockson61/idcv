...
export const metadata: Metadata = {
  title: 'Best Dentist in Tenkasi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tenkasi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tenkasi'
