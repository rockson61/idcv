...
export const metadata: Metadata = {
  title: 'Best Dentist in Sankarankovil, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sankarankovil, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sankarankovil'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
