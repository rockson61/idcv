...
export const metadata: Metadata = {
  title: 'Best Dentist in Sivagiri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sivagiri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sivagiri'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
