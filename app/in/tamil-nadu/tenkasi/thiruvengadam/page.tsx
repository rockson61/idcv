...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvengadam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvengadam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvengadam'
const city = 'Tenkasi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
