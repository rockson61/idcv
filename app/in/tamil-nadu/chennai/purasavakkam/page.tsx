...
export const metadata: Metadata = {
  title: 'Best Dentist in Purasavakkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Purasavakkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Purasavakkam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
