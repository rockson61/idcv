...
export const metadata: Metadata = {
  title: 'Best Dentist in Chetput, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chetput, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chetput'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
