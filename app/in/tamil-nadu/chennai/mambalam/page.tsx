...
export const metadata: Metadata = {
  title: 'Best Dentist in Mambalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mambalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mambalam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
