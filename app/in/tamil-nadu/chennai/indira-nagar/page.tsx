...
export const metadata: Metadata = {
  title: 'Best Dentist in Indira Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Indira Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Indira Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
