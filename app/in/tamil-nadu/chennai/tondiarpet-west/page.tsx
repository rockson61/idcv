...
export const metadata: Metadata = {
  title: 'Best Dentist in Tondiarpet West, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tondiarpet West, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tondiarpet West'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
