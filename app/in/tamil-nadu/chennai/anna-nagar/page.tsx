...
export const metadata: Metadata = {
  title: 'Best Dentist in Anna Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anna Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anna Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
