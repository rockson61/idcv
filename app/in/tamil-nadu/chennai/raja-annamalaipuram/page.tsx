...
export const metadata: Metadata = {
  title: 'Best Dentist in Raja Annamalaipuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Raja Annamalaipuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Raja Annamalaipuram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
