...
export const metadata: Metadata = {
  title: 'Best Dentist in Saidapet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Saidapet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Saidapet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
