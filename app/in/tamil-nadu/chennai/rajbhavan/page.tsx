...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajbhavan, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajbhavan, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajbhavan'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
