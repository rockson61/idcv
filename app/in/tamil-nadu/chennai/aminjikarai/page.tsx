...
export const metadata: Metadata = {
  title: 'Best Dentist in Aminjikarai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Aminjikarai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aminjikarai'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
