...
export const metadata: Metadata = {
  title: 'Best Dentist in Thygaraya Nagar North, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thygaraya Nagar North, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thygaraya Nagar North'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
