...
export const metadata: Metadata = {
  title: 'Best Dentist in Anna Nagar East, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anna Nagar East, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anna Nagar East'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
