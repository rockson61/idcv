...
export const metadata: Metadata = {
  title: 'Best Dentist in Arumbakkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Arumbakkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
