...
export const metadata: Metadata = {
  title: 'Best Dentist in Nandanam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nandanam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nandanam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
