...
export const metadata: Metadata = {
  title: 'Best Dentist in Cemetry Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Cemetry Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Cemetry Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
