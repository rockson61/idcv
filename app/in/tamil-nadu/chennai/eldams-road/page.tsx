...
export const metadata: Metadata = {
  title: 'Best Dentist in Eldams Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Eldams Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Eldams Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
