...
export const metadata: Metadata = {
  title: 'Best Dentist in Purasawalkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Purasawalkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Purasawalkam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
