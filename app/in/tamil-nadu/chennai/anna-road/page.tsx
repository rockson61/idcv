...
export const metadata: Metadata = {
  title: 'Best Dentist in Anna Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anna Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anna Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
