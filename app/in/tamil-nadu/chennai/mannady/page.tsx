...
export const metadata: Metadata = {
  title: 'Best Dentist in Mannady, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mannady, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mannady'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
