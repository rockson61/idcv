...
export const metadata: Metadata = {
  title: 'Best Dentist in Foreshore Estate, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Foreshore Estate, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Foreshore Estate'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
