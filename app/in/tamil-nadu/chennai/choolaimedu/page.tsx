...
export const metadata: Metadata = {
  title: 'Best Dentist in Choolaimedu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Choolaimedu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Choolaimedu'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
