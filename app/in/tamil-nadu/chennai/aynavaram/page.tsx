...
export const metadata: Metadata = {
  title: "Best Dentist in Aynavaram, Chennai | Top Dental Clinic | Indira Dental Clinic",
  description: "Find the best dental clinic in Aynavaram, Chennai for all your dental needs. Dr. Rockson Samuel offers expert treatments including root canals, implants, braces, and cosmetic dentistry.",
  keywords: ["dentist in Aynavaram", "dental clinic Aynavaram Chennai", "best dentist Aynavaram", "dental care Aynavaram", "Indira Dental Clinic Aynavaram"],
  alternates: {
    canonical: `/in/tamil-nadu/chennai/aynavaram`,
  },
}

export default function AynavaramPage() {
  const services = [
  ...
  const faqs = [
    {
      question: "What dental services are available in Aynavaram, Chennai?",
    ...
    {
      question: "How can I book an appointment with Dr. Rockson Samuel from Aynavaram?",
      answer: "You can book an appointment by calling us at 7010650063 or visiting our website to use the online booking form. We are conveniently located near Chennai and serve patients from Aynavaram and all surrounding areas.",
    },
    {
      question: "What are the costs of dental treatments for Aynavaram patients?",
      answer: "Our clinic offers transparent and competitive pricing. Root canal treatment starts from ₹3,000, dental implants from ₹25,000, braces from ₹30,000, and teeth whitening from ₹8,000. We provide detailed cost estimates during your consultation. Patients from Aynavaram, Chennai can expect high-quality care at affordable prices.",
    },
    {
      question: "Is emergency dental care available for Aynavaram area?",
      answer: "Yes, we provide 24/7 emergency dental care for patients from Aynavaram and all Chennai areas. Whether you have a severe toothache, broken tooth, knocked-out tooth, or any dental emergency, call us immediately at 7010650063.",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Aynavaram', href: '/in/tamil-nadu/chennai/aynavaram' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in Aynavaram, Chennai"
          taluk="Aynavaram"
          pincode="600023"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="Aynavaram"
            address="3rd Floor, 54, Katpadi Main Rd, Gandhi Nagar, Vellore, Tamil Nadu - 632006"
          />
        </div>

        <WhyChooseUs locationName="Aynavaram" />

        <EnhancedServicesList locationName="Aynavaram" services={services} />

        <PriceComparisonTable locationName="Aynavaram" />
        ...
        <CTAWidget
          ...
          description="Experience expert dental care with Dr. Rockson Samuel. We serve all Chennai areas including Aynavaram."
