...
export const metadata: Metadata = {
  title: 'Best Dentist in Aynavaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Aynavaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aynavaram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
