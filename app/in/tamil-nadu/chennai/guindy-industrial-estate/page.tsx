...
export const metadata: Metadata = {
  title: 'Best Dentist in Guindy Industrial Estate, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Guindy Industrial Estate, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guindy Industrial Estate'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
