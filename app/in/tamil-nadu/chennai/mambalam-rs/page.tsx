...
export const metadata: Metadata = {
  title: 'Best Dentist in Mambalam Rs, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mambalam Rs, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mambalam Rs'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Mambalam Rs', href: '/in/tamil-nadu/chennai/mambalam-rs' },
          ]}
        />
