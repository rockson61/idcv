...
export const metadata: Metadata = {
  title: 'Best Dentist in Chintadripet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chintadripet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chintadripet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
