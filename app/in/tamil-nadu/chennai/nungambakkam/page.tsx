...
export const metadata: Metadata = {
  title: 'Best Dentist in Nungambakkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nungambakkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nungambakkam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
