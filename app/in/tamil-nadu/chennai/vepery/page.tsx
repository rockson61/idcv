...
export const metadata: Metadata = {
  title: 'Best Dentist in Vepery, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vepery, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vepery'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
