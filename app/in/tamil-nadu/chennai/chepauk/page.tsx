...
export const metadata: Metadata = {
  title: 'Best Dentist in Chepauk, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chepauk, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chepauk'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
