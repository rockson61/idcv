...
export const metadata: Metadata = {
  title: 'Best Dentist in Nungambakkam Bazaar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nungambakkam Bazaar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nungambakkam Bazaar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
