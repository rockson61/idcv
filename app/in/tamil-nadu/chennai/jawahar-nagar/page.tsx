...
export const metadata: Metadata = {
  title: 'Best Dentist in Jawahar Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Jawahar Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jawahar Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
