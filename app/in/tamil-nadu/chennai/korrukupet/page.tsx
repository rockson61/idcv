...
export const metadata: Metadata = {
  title: 'Best Dentist in Korrukupet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Korrukupet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Korrukupet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
