...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudupet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pudupet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pudupet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
