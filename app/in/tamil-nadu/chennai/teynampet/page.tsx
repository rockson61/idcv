...
export const metadata: Metadata = {
  title: 'Best Dentist in Teynampet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Teynampet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Teynampet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
