...
export const metadata: Metadata = {
  title: 'Best Dentist in New Avadi Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for New Avadi Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'New Avadi Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
