...
export const metadata: Metadata = {
  title: 'Best Dentist in Guindy, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Guindy, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guindy'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
