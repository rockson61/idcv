...
export const metadata: Metadata = {
  title: 'Best Dentist in Velacherry, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Velacherry, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Velacherry'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
