...
export const metadata: Metadata = {
  title: 'Best Dentist in Seven Wells, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Seven Wells, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Seven Wells'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
