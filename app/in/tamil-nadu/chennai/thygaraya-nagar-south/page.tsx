...
export const metadata: Metadata = {
  title: 'Best Dentist in Thygaraya Nagar South, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thygaraya Nagar South, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thygaraya Nagar South'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
