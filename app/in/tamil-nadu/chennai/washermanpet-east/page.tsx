...
export const metadata: Metadata = {
  title: 'Best Dentist in Washermanpet East, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Washermanpet East, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Washermanpet East'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
