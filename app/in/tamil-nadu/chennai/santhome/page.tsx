...
export const metadata: Metadata = {
  title: 'Best Dentist in Santhome, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Santhome, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Santhome'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
