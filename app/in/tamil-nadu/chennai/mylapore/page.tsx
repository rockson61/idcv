...
export const metadata: Metadata = {
  title: 'Best Dentist in Mylapore, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mylapore, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mylapore'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
