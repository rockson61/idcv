...
export const metadata: Metadata = {
  title: "Best Dentist in Fort St George, Chennai | Top Dental Clinic | Indira Dental Clinic",
  description: "Find the best dental clinic in Fort St George, Chennai for all your dental needs. Dr. Rockson Samuel offers expert treatments including root canals, implants, braces, and cosmetic dentistry.",
  keywords: ["dentist in Fort St George", "dental clinic Fort St George Chennai", "best dentist Fort St George", "dental care Fort St George", "Indira Dental Clinic Fort St George"],
  alternates: {
    canonical: `/in/tamil-nadu/chennai/fort-st-george`,
  },
}

export default function FortStGeorgePage() {
  const services = [
  ...
  const faqs = [
    {
      question: "What dental services are available in Fort St George, Chennai?",
      answer: "In Fort St George, Chennai, Indira Dental Clinic offers comprehensive dental services including general dentistry, cosmetic treatments, root canal therapy, dental implants, orthodontics (braces & Invisalign), teeth whitening, gum disease treatment, wisdom teeth removal, pediatric dentistry, and emergency dental care.",
    },
    {
      question: "How can I book an appointment with Dr. Rockson Samuel from Fort St George?",
      answer: "You can book an appointment by calling us at 7010650063 or visiting our website to use the online booking form. We are conveniently located near Chennai and serve patients from Fort St George and all surrounding areas.",
    },
    {
      question: "What are the costs of dental treatments for Fort St George patients?",
      answer: "Our clinic offers transparent and competitive pricing. Root canal treatment starts from ₹3,000, dental implants from ₹25,000, braces from ₹30,000, and teeth whitening from ₹8,000. We provide detailed cost estimates during your consultation. Patients from Fort St George, Chennai can expect high-quality care at affordable prices.",
    },
    {
      question: "Is emergency dental care available for Fort St George area?",
      answer: "Yes, we provide 24/7 emergency dental care for patients from Fort St George and all Chennai areas. Whether you have a severe toothache, broken tooth, knocked-out tooth, or any dental emergency, call us immediately at 7010650063.",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Fort St George', href: '/in/tamil-nadu/chennai/fort-st-george' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in Fort St George, Chennai"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="Fort St George"
            address="3rd Floor, 54, Katpadi Main Rd, Gandhi Nagar, Vellore, Tamil Nadu - 632006"
          />
        </div>

        <WhyChooseUs locationName="Fort St George" />

        <EnhancedServicesList locationName="Fort St George" services={services} />

        <PriceComparisonTable locationName="Fort St George" />
        ...
        <CTAWidget
          ...
          description="Experience expert dental care with Dr. Rockson Samuel. We serve all Chennai areas including Fort St George."
