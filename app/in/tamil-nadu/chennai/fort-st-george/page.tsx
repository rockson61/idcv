...
export const metadata: Metadata = {
  title: 'Best Dentist in Fort St George, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Fort St George, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Fort St George'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
