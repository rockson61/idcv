...
export const metadata: Metadata = {
  title: 'Best Dentist in Chennai Race Course, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chennai Race Course, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chennai Race Course'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
