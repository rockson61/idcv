...
export const metadata: Metadata = {
  title: 'Best Dentist in Tondiarpet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tondiarpet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tondiarpet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
