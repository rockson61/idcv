...
export const metadata: Metadata = {
  title: 'Best Dentist in Ethiraj Salai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ethiraj Salai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ethiraj Salai'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
