...
export const metadata: Metadata = {
  title: 'Best Dentist in Saligramam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Saligramam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Saligramam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
