...
export const metadata: Metadata = {
  title: 'Best Dentist in Alandur, Chennai | Dr. Rockson Samuel | Indira Dental Clinic',
  description: 'Top-rated dental clinic serving Alandur, Chennai. Expert treatments by Dr. Rockson Samuel. Root canal, implants, braces, cosmetic dentistry. Book: 7010650063',
  keywords: 'dentist Alandur, dental clinic Alandur, best dentist Chennai, Dr Rockson Samuel, dental implants Alandur, root canal Alandur',
}
...
const faqs = [
  {
    ...
    answer: 'Indira Dental Clinic is located in Gandhi Nagar, Vellore, easily accessible from Alandur, Chennai. We are just a short drive away.'
  },
  {
    question: 'Do you accept patients from Alandur?',
    answer: 'Yes! We welcome patients from Alandur, Chennai and all surrounding areas. Many of our patients travel from Chennai for our expert dental care.'
  },
  {
...
export default function AlandurTalukPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Alandur', href: '/in/tamil-nadu/chennai/alandur' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in Alandur, Chennai"
          taluk="Alandur"
          pincode="000000"
          distance="Near Vellore"
          category="town"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="Alandur"
            address="Gandhi Nagar, Vellore, Tamil Nadu - 632001"
          />
        </div>

        <div className="mb-8">
          <EnhancedServicesList locationName="Alandur" services={services} />
        </div>

        <div className="mb-8">
          <LocationReviews locationName="Alandur" reviews={reviews} />
        </div>

        <div className="mb-8">
          <LocationFAQs locationName="Alandur" faqs={faqs} />
        </div>

        <div className="mb-8">
          <PeopleAlsoSearchFor location="Alandur" city="Chennai" />
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl p-8 border-2 border-teal-200">
          ...
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Join hundreds of happy patients from Alandur, Chennai who trust Dr. Rockson Samuel for their dental needs.
          </p>
