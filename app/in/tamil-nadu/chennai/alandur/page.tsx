...
export const metadata: Metadata = {
  title: 'Best Dentist in Alandur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Alandur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Alandur'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
