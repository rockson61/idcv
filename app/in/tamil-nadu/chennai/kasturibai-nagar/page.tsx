...
export const metadata: Metadata = {
  title: 'Best Dentist in Kasturibai Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kasturibai Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kasturibai Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
