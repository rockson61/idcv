...
export const metadata: Metadata = {
  title: 'Best Dentist in Saidapet North, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Saidapet North, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Saidapet North'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
