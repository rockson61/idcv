...
export const metadata: Metadata = {
  title: 'Best Dentist in Royapettah High Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Royapettah High Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Royapettah High Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
