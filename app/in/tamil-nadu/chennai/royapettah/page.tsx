...
export const metadata: Metadata = {
  title: 'Best Dentist in Royapettah, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Royapettah, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Royapettah'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
