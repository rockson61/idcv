...
export const metadata: Metadata = {
  title: 'Best Dentist in Adyar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Adyar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Adyar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
