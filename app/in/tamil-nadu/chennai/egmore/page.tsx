...
export const metadata: Metadata = {
  title: 'Best Dentist in Egmore, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Egmore, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Egmore'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
