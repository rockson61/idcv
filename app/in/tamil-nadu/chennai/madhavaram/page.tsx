...
export const metadata: Metadata = {
  title: 'Best Dentist in Madhavaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Madhavaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madhavaram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
