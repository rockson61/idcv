...
export const metadata: Metadata = {
  title: 'Best Dentist in Sembiam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sembiam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sembiam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
