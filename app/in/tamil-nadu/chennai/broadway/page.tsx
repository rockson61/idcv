...
export const metadata: Metadata = {
  title: 'Best Dentist in Broadway, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Broadway, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Broadway'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
