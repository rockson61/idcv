...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodungaiyur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kodungaiyur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kodungaiyur'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
