...
export const metadata: Metadata = {
  title: 'Best Dentist in Greams Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Greams Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Greams Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
