...
export const metadata: Metadata = {
  title: 'Best Dentist in Ramakrishna Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ramakrishna Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ramakrishna Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
