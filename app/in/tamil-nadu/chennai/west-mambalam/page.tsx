...
export const metadata: Metadata = {
  title: 'Best Dentist in West Mambalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for West Mambalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'West Mambalam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
