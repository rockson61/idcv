...
export const metadata: Metadata = {
  title: 'Best Dentist in Washermanpet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Washermanpet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Washermanpet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
