...
export const metadata: Metadata = {
  title: 'Best Dentist in Chennai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chennai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
