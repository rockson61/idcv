...
export const metadata: Metadata = {
  title: 'Best Dentist in Flowers Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Flowers Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Flowers Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
