...
export const metadata: Metadata = {
  title: 'Best Dentist in Virugambakkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Virugambakkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Virugambakkam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
