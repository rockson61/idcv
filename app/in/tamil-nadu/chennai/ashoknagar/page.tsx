...
export const metadata: Metadata = {
  title: 'Best Dentist in Ashoknagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ashoknagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ashoknagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
