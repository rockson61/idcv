...
export const metadata: Metadata = {
  title: 'Best Dentist in Koyambedu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Koyambedu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Koyambedu'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
