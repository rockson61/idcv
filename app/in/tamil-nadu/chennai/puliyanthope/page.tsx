...
export const metadata: Metadata = {
  title: 'Best Dentist in Puliyanthope, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Puliyanthope, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Puliyanthope'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
