...
export const metadata: Metadata = {
  title: 'Best Dentist in Icf Colony, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Icf Colony, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Icf Colony'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
