...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodambakkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kodambakkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kodambakkam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
