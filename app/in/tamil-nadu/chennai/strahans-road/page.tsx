...
export const metadata: Metadata = {
  title: 'Best Dentist in Strahans Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Strahans Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Strahans Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
