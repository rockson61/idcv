...
export const metadata: Metadata = {
  title: "Best Dentist in Strahans Road, Chennai | Top Dental Clinic | Indira Dental Clinic",
  description: "Find the best dental clinic in Strahans Road, Chennai for all your dental needs. Dr. Rockson Samuel offers expert treatments including root canals, implants, braces, and cosmetic dentistry.",
  keywords: ["dentist in Strahans Road", "dental clinic Strahans Road Chennai", "best dentist Strahans Road", "dental care Strahans Road", "Indira Dental Clinic Strahans Road"],
  alternates: {
    canonical: `/in/tamil-nadu/chennai/strahans-road`,
  },
}

export default function StrahansRoadPage() {
  const services = [
  ...
  const faqs = [
    {
      question: "What dental services are available in Strahans Road, Chennai?",
      answer: "In Strahans Road, Chennai, Indira Dental Clinic offers comprehensive dental services including general dentistry, cosmetic treatments, root canal therapy, dental implants, orthodontics (braces & Invisalign), teeth whitening, gum disease treatment, wisdom teeth removal, pediatric dentistry, and emergency dental care.",
    },
    {
      question: "How can I book an appointment with Dr. Rockson Samuel from Strahans Road?",
      answer: "You can book an appointment by calling us at 7010650063 or visiting our website to use the online booking form. We are conveniently located near Chennai and serve patients from Strahans Road and all surrounding areas.",
    },
    {
      question: "What are the costs of dental treatments for Strahans Road patients?",
      answer: "Our clinic offers transparent and competitive pricing. Root canal treatment starts from ₹3,000, dental implants from ₹25,000, braces from ₹30,000, and teeth whitening from ₹8,000. We provide detailed cost estimates during your consultation. Patients from Strahans Road, Chennai can expect high-quality care at affordable prices.",
    },
    {
      question: "Is emergency dental care available for Strahans Road area?",
      answer: "Yes, we provide 24/7 emergency dental care for patients from Strahans Road and all Chennai areas. Whether you have a severe toothache, broken tooth, knocked-out tooth, or any dental emergency, call us immediately at 7010650063.",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Strahans Road', href: '/in/tamil-nadu/chennai/strahans-road' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in Strahans Road, Chennai"
          taluk="Strahans Road"
          pincode="600012"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="Strahans Road"
            address="3rd Floor, 54, Katpadi Main Rd, Gandhi Nagar, Vellore, Tamil Nadu - 632006"
          />
        </div>

        <WhyChooseUs locationName="Strahans Road" />

        <EnhancedServicesList locationName="Strahans Road" services={services} />

        <PriceComparisonTable locationName="Strahans Road" />
        ...
        <CTAWidget
          ...
          description="Experience expert dental care with Dr. Rockson Samuel. We serve all Chennai areas including Strahans Road."
