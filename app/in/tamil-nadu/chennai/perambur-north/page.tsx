...
export const metadata: Metadata = {
  title: 'Best Dentist in Perambur North, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Perambur North, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Perambur North'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
