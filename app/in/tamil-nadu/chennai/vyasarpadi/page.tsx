...
export const metadata: Metadata = {
  title: 'Best Dentist in Vyasarpadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vyasarpadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vyasarpadi'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
