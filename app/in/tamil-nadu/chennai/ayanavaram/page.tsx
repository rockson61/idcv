...
export const metadata: Metadata = {
  title: 'Best Dentist in Ayanavaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ayanavaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ayanavaram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
