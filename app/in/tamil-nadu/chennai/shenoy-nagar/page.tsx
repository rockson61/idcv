...
export const metadata: Metadata = {
  title: 'Best Dentist in Shenoy Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Shenoy Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Shenoy Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
