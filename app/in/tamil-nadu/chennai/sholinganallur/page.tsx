...
export const metadata: Metadata = {
  title: 'Best Dentist in Sholinganallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sholinganallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sholinganallur'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
