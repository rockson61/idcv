...
export const metadata: Metadata = {
  title: 'Best Dentist in Kotturpuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kotturpuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kotturpuram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
