...
export const metadata: Metadata = {
  title: 'Best Dentist in Rangarajapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rangarajapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rangarajapuram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
