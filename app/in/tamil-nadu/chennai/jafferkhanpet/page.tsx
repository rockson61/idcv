...
export const metadata: Metadata = {
  title: 'Best Dentist in Jafferkhanpet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Jafferkhanpet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jafferkhanpet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
