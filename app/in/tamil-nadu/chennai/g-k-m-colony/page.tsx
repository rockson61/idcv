...
export const metadata: Metadata = {
  title: 'Best Dentist in G K M Colony, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for G K M Colony, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'G K M Colony'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
