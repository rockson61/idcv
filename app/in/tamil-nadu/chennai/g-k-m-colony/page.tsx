...
export const metadata: Metadata = {
  title: "Best Dentist in G K M Colony, Chennai | Top Dental Clinic | Indira Dental Clinic",
  description: "Find the best dental clinic in G K M Colony, Chennai for all your dental needs. Dr. Rockson Samuel offers expert treatments including root canals, implants, braces, and cosmetic dentistry.",
  keywords: ["dentist in G K M Colony", "dental clinic G K M Colony Chennai", "best dentist G K M Colony", "dental care G K M Colony", "Indira Dental Clinic G K M Colony"],
  alternates: {
    canonical: `/in/tamil-nadu/chennai/g-k-m-colony`,
  },
}

export default function GKMColonyPage() {
  const services = [
  ...
  const faqs = [
    {
      question: "What dental services are available in G K M Colony, Chennai?",
      answer: "In G K M Colony, Chennai, Indira Dental Clinic offers comprehensive dental services including general dentistry, cosmetic treatments, root canal therapy, dental implants, orthodontics (braces & Invisalign), teeth whitening, gum disease treatment, wisdom teeth removal, pediatric dentistry, and emergency dental care.",
    },
    {
      question: "How can I book an appointment with Dr. Rockson Samuel from G K M Colony?",
      answer: "You can book an appointment by calling us at 7010650063 or visiting our website to use the online booking form. We are conveniently located near Chennai and serve patients from G K M Colony and all surrounding areas.",
    },
    {
      question: "What are the costs of dental treatments for G K M Colony patients?",
      answer: "Our clinic offers transparent and competitive pricing. Root canal treatment starts from ₹3,000, dental implants from ₹25,000, braces from ₹30,000, and teeth whitening from ₹8,000. We provide detailed cost estimates during your consultation. Patients from G K M Colony, Chennai can expect high-quality care at affordable prices.",
    },
    {
      question: "Is emergency dental care available for G K M Colony area?",
      answer: "Yes, we provide 24/7 emergency dental care for patients from G K M Colony and all Chennai areas. Whether you have a severe toothache, broken tooth, knocked-out tooth, or any dental emergency, call us immediately at 7010650063.",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'G K M Colony', href: '/in/tamil-nadu/chennai/g-k-m-colony' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in G K M Colony, Chennai"
          taluk="G K M Colony"
          pincode="600082"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="G K M Colony"
            address="3rd Floor, 54, Katpadi Main Rd, Gandhi Nagar, Vellore, Tamil Nadu - 632006"
          />
        </div>

        <WhyChooseUs locationName="G K M Colony" />

        <EnhancedServicesList locationName="G K M Colony" services={services} />

        <PriceComparisonTable locationName="G K M Colony" />
        ...
        <CTAWidget
          ...
          description="Experience expert dental care with Dr. Rockson Samuel. We serve all Chennai areas including G K M Colony."
