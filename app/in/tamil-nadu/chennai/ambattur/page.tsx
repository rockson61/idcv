...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambattur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambattur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ambattur'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
