...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajathottam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajathottam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajathottam'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
