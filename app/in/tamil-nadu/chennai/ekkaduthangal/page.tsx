...
export const metadata: Metadata = {
  title: 'Best Dentist in Ekkaduthangal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ekkaduthangal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ekkaduthangal'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
