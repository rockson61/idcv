...
export const metadata: Metadata = {
  title: 'Best Dentist in Royapuram Market, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Royapuram Market, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Royapuram Market'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
