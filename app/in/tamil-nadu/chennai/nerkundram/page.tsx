...
export const metadata: Metadata = {
  title: "Best Dentist in Nerkundram, Chennai | Top Dental Clinic | Indira Dental Clinic",
  description: "Find the best dental clinic in Nerkundram, Chennai for all your dental needs. Dr. Rockson Samuel offers expert treatments including root canals, implants, braces, and cosmetic dentistry.",
  keywords: ["dentist in Nerkundram", "dental clinic Nerkundram Chennai", "best dentist Nerkundram", "dental care Nerkundram", "Indira Dental Clinic Nerkundram"],
  alternates: {
    canonical: `/in/tamil-nadu/chennai/nerkundram`,
  },
}

export default function NerkundramPage() {
  const services = [
  ...
  const faqs = [
    {
      question: "What dental services are available in Nerkundram, Chennai?",
      answer: "In Nerkundram, Chennai, Indira Dental Clinic offers comprehensive dental services including general dentistry, cosmetic treatments, root canal therapy, dental implants, orthodontics (braces & Invisalign), teeth whitening, gum disease treatment, wisdom teeth removal, pediatric dentistry, and emergency dental care.",
    },
    {
      question: "How can I book an appointment with Dr. Rockson Samuel from Nerkundram?",
      answer: "You can book an appointment by calling us at 7010650063 or visiting our website to use the online booking form. We are conveniently located near Chennai and serve patients from Nerkundram and all surrounding areas.",
    },
    {
      question: "What are the costs of dental treatments for Nerkundram patients?",
      answer: "Our clinic offers transparent and competitive pricing. Root canal treatment starts from ₹3,000, dental implants from ₹25,000, braces from ₹30,000, and teeth whitening from ₹8,000. We provide detailed cost estimates during your consultation. Patients from Nerkundram, Chennai can expect high-quality care at affordable prices.",
    },
    {
      question: "Is emergency dental care available for Nerkundram area?",
      answer: "Yes, we provide 24/7 emergency dental care for patients from Nerkundram and all Chennai areas. Whether you have a severe toothache, broken tooth, knocked-out tooth, or any dental emergency, call us immediately at 7010650063.",
    },
  ]
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Nerkundram', href: '/in/tamil-nadu/chennai/nerkundram' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in Nerkundram, Chennai"
          taluk="Nerkundram"
          pincode="600107"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="Nerkundram"
            address="3rd Floor, 54, Katpadi Main Rd, Gandhi Nagar, Vellore, Tamil Nadu - 632006"
          />
        </div>

        <WhyChooseUs locationName="Nerkundram" />

        <EnhancedServicesList locationName="Nerkundram" services={services} />

        <PriceComparisonTable locationName="Nerkundram" />
        ...
        <CTAWidget
          ...
          description="Experience expert dental care with Dr. Rockson Samuel. We serve all Chennai areas including Nerkundram."
