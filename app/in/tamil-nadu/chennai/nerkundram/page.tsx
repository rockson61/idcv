...
export const metadata: Metadata = {
  title: 'Best Dentist in Nerkundram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nerkundram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nerkundram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
