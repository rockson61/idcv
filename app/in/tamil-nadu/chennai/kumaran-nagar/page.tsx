...
export const metadata: Metadata = {
  title: 'Best Dentist in Kumaran Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kumaran Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kumaran Nagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
