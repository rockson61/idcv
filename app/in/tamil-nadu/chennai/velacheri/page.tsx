...
export const metadata: Metadata = {
  title: 'Best Dentist in Velacheri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Velacheri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Velacheri'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
