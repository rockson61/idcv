...
export const metadata: Metadata = {
  title: 'Best Dentist in Choolai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Choolai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Choolai'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
