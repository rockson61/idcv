...
export const metadata: Metadata = {
  title: 'Best Dentist in Teynampet West, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Teynampet West, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Teynampet West'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
