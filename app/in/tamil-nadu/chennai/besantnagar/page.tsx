...
export const metadata: Metadata = {
  title: 'Best Dentist in Besantnagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Besantnagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Besantnagar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
