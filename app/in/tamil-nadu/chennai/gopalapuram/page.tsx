...
export const metadata: Metadata = {
  title: 'Best Dentist in Gopalapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gopalapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gopalapuram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
