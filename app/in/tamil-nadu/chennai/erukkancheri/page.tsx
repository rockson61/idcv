...
export const metadata: Metadata = {
  title: 'Best Dentist in Erukkancheri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Erukkancheri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Erukkancheri'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
