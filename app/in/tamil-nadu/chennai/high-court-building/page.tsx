...
export const metadata: Metadata = {
  title: 'Best Dentist in High Court Building, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for High Court Building, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'High Court Building'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
