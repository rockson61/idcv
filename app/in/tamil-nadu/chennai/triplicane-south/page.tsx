...
export const metadata: Metadata = {
  title: 'Best Dentist in Triplicane South, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Triplicane South, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Triplicane South'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
