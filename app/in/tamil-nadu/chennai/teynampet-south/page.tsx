...
export const metadata: Metadata = {
  title: 'Best Dentist in Teynampet South, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Teynampet South, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Teynampet South'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
