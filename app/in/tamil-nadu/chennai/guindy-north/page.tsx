...
export const metadata: Metadata = {
  title: 'Best Dentist in Guindy North, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Guindy North, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guindy North'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
