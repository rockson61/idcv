...
export const metadata: Metadata = {
  title: 'Best Dentist in Rayapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rayapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rayapuram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
