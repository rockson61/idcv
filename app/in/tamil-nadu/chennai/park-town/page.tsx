...
export const metadata: Metadata = {
  title: 'Best Dentist in Park Town, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Park Town, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Park Town'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
