...
export const metadata: Metadata = {
  title: 'Best Dentist in Madhuravoyal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Madhuravoyal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madhuravoyal'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
