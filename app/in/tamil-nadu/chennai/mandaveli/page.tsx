...
export const metadata: Metadata = {
  title: 'Best Dentist in Mandaveli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mandaveli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mandaveli'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
