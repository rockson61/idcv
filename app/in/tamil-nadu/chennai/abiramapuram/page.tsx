...
export const metadata: Metadata = {
  title: 'Best Dentist in Abiramapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Abiramapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Abiramapuram'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
