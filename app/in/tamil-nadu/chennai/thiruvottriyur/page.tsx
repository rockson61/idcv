...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvottriyur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvottriyur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvottriyur'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
