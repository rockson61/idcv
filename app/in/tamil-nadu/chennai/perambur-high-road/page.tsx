...
export const metadata: Metadata = {
  title: 'Best Dentist in Perambur High Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Perambur High Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Perambur High Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
