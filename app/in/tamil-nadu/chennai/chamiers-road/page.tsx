...
export const metadata: Metadata = {
  title: 'Best Dentist in Chamiers Road, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chamiers Road, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chamiers Road'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
