...
export const metadata: Metadata = {
  title: 'Best Dentist in Vadapalani, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vadapalani, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vadapalani'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
