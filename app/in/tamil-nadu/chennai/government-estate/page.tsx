...
export const metadata: Metadata = {
  title: 'Best Dentist in Government Estate, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Government Estate, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Government Estate'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
