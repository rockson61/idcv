...
export const metadata: Metadata = {
  title: 'Best Dentist in Sowcarpet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sowcarpet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sowcarpet'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
