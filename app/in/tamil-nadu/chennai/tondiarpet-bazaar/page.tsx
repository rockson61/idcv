...
export const metadata: Metadata = {
  title: 'Best Dentist in Tondiarpet Bazaar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tondiarpet Bazaar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tondiarpet Bazaar'
const city = 'Chennai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
