...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudukkottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pudukkottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pudukkottai'
