...
export const metadata: Metadata = {
  title: 'Best Dentist in Nagercoil, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nagercoil, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nagercoil'
