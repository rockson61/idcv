...
export const metadata: Metadata = {
  title: 'Best Dentist in Needamangalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Needamangalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Needamangalam'
