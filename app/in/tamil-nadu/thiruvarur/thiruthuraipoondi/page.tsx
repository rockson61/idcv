...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruthuraipoondi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruthuraipoondi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruthuraipoondi'
const city = 'Thiruvarur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
