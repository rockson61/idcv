...
export const metadata: Metadata = {
  title: 'Best Dentist in Koothanallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Koothanallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Koothanallur'
