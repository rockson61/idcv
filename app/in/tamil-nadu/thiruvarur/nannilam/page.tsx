...
export const metadata: Metadata = {
  title: 'Best Dentist in Nannilam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nannilam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nannilam'
