...
export const metadata: Metadata = {
  title: 'Best Dentist in Mannargudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mannargudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mannargudi'
