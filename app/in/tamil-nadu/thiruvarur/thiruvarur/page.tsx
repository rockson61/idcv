...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvarur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvarur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvarur'
