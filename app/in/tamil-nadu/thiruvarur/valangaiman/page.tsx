...
export const metadata: Metadata = {
  title: 'Best Dentist in Valangaiman, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Valangaiman, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Valangaiman'
