...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodavasal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kodavasal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kodavasal'
