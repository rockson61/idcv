...
export const metadata: Metadata = {
  title: 'Best Dentist in Karur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Karur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karur'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Karur', href: '/in/tamil-nadu/karur' },
          ]}
        />
