...
export const metadata: Metadata = {
  title: 'Best Dentist in Nambiyur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nambiyur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nambiyur'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
