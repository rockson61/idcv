...
export const metadata: Metadata = {
  title: 'Best Dentist in Gobichettipalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gobichettipalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gobichettipalayam'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
