...
export const metadata: Metadata = {
  title: 'Best Dentist in Modakurichi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Modakurichi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Modakurichi'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
