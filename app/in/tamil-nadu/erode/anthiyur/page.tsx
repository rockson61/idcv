...
export const metadata: Metadata = {
  title: 'Best Dentist in Anthiyur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anthiyur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anthiyur'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
