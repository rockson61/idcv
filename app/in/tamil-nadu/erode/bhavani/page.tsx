...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhavani, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Bhavani, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bhavani'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
