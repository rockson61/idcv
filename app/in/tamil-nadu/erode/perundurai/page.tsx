...
export const metadata: Metadata = {
  title: 'Best Dentist in Perundurai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Perundurai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Perundurai'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
