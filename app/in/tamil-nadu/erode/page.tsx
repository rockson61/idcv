...
export const metadata: Metadata = {
  title: 'Best Dentist in Erode, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Erode, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Erode'
