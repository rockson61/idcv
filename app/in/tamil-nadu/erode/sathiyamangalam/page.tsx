...
export const metadata: Metadata = {
  title: 'Best Dentist in Sathiyamangalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sathiyamangalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sathiyamangalam'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
