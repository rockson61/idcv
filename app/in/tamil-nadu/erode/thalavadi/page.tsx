...
export const metadata: Metadata = {
  title: 'Best Dentist in Thalavadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thalavadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thalavadi'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
