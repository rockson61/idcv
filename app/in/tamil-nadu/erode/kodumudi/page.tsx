...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodumudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kodumudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kodumudi'
const city = 'Erode'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
