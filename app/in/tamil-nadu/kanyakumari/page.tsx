...
export const metadata: Metadata = {
  title: 'Best Dentist in Kanyakumari, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kanyakumari, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kanyakumari'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Kanyakumari', href: '/in/tamil-nadu/kanyakumari' },
          ]}
        />
