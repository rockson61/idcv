...
export const metadata: Metadata = {
  title: 'Best Dentist in Viluppuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Viluppuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Viluppuram'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Viluppuram', href: '/in/tamil-nadu/viluppuram' },
          ]}
        />
