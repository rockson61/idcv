...
export const metadata: Metadata = {
  title: 'Best Dentist in Kovilpatti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kovilpatti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kovilpatti'
