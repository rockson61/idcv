...
export const metadata: Metadata = {
  title: 'Best Dentist in Ottapidaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ottapidaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ottapidaram'
