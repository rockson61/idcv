...
export const metadata: Metadata = {
  title: 'Best Dentist in Sattankulam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sattankulam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sattankulam'
