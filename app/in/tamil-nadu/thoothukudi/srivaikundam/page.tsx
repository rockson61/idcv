...
export const metadata: Metadata = {
  title: 'Best Dentist in Srivaikundam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Srivaikundam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Srivaikundam'
