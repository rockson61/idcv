...
export const metadata: Metadata = {
  title: 'Best Dentist in Thoothukudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thoothukudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thoothukudi'
