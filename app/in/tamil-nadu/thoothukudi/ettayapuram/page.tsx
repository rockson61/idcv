...
export const metadata: Metadata = {
  title: 'Best Dentist in Ettayapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ettayapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ettayapuram'
