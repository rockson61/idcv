...
export const metadata: Metadata = {
  title: 'Best Dentist in Vilathikulam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vilathikulam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vilathikulam'
