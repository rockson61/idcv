...
export const metadata: Metadata = {
  title: 'Best Dentist in Kayathar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kayathar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kayathar'
