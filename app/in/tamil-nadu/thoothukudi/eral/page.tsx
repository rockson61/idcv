...
export const metadata: Metadata = {
  title: 'Best Dentist in Eral, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Eral, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Eral'
