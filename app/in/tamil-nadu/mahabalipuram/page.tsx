...
export const metadata: Metadata = {
  title: 'Best Dentist in Mahabalipuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mahabalipuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mahabalipuram'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Mahabalipuram', href: '/in/tamil-nadu/mahabalipuram' },
          ]}
        />
