...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruppur South, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruppur South, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruppur South'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
