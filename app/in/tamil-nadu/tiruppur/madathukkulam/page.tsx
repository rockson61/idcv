...
export const metadata: Metadata = {
  title: 'Best Dentist in Madathukkulam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Madathukkulam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madathukkulam'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
