...
export const metadata: Metadata = {
  title: 'Best Dentist in Udumalaipettai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Udumalaipettai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Udumalaipettai'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
