...
export const metadata: Metadata = {
  title: 'Best Dentist in Avinashi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Avinashi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Avinashi'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
