...
export const metadata: Metadata = {
  title: 'Best Dentist in Palladam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Palladam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Palladam'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
