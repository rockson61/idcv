...
export const metadata: Metadata = {
  title: 'Best Dentist in Oothukuli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Oothukuli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Oothukuli'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
