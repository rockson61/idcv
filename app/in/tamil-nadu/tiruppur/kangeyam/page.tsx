...
export const metadata: Metadata = {
  title: 'Best Dentist in Kangeyam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kangeyam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kangeyam'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
