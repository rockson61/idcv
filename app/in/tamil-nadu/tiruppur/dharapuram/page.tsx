...
export const metadata: Metadata = {
  title: 'Best Dentist in Dharapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Dharapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dharapuram'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
