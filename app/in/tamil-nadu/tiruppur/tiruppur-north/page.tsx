...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruppur North, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruppur North, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruppur North'
const city = 'Tiruppur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
