...
export const metadata: Metadata = {
  title: 'Best Dentist in Melalathur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melalathur. Dr. Rockson Samuel. PIN: 635806. Book: +91 70106 50063',
  keywords: ['dentist Melalathur', 'dental clinic Melalathur', 'Gudiyattam dentist'],
}

export default function MelalathurPage() {
  const distance = "47 km"

  const locationName = 'Melalathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melalathur" city="Vellore" />
