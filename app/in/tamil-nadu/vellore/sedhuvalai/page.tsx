...
export const metadata: Metadata = {
  title: 'Best Dentist in Sedhuvalai, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sedhuvalai. Dr. Rockson Samuel. PIN: 632104. Book: +91 70106 50063',
  keywords: ['dentist Sedhuvalai', 'dental clinic Sedhuvalai', 'Vlr dentist'],
}

export default function SedhuvalaiPage() {
  const distance = "13 km"

  const locationName = 'Sedhuvalai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sedhuvalai" city="Vellore" />
