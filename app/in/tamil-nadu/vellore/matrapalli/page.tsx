...
export const metadata: Metadata = {
  title: 'Best Dentist in Matrapalli, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Matrapalli. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Matrapalli', 'dental clinic Matrapalli', 'Tirupattur dentist'],
}

export default function MatrapalliPage() {
  const distance = "67 km"

  const locationName = 'Matrapalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Matrapalli" city="Vellore" />
