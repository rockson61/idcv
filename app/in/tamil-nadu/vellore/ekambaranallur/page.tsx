...
export const metadata: Metadata = {
  title: 'Best Dentist in Ekambaranallur, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ekambaranallur. Dr. Rockson Samuel. PIN: 632405. Book: +91 70106 50063',
  keywords: ['dentist Ekambaranallur', 'dental clinic Ekambaranallur', 'Walajapet dentist'],
}

export default function EkambaranallurPage() {
  const distance = "21 km"

  const locationName = 'Ekambaranallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ekambaranallur" city="Vellore" />
