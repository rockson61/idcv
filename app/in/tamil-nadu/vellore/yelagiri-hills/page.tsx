...
export const metadata: Metadata = {
  title: 'Best Dentist in Yelagiri Hills, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Yelagiri Hills, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Yelagiri Hills', href: '/in/tamil-nadu/vellore/yelagiri-hills' },
          ]}
        />
