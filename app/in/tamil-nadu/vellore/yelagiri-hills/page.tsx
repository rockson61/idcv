...
export const metadata: Metadata = {
  title: 'Best Dentist in Yelagiri Hills, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Yelagiri Hills. Dr. Rockson Samuel. PIN: 635853. Book: +91 70106 50063',
  keywords: ['dentist Yelagiri Hills', 'dental clinic Yelagiri Hills', 'Tirupattur dentist'],
}

export default function YelagiriHillsPage() {
  const distance = "90 km"

  const locationName = 'Yelagiri Hills'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '90 km', slug: '', travelTime: '2 hours', pincode: '632001' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635853" distance="90 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="90 km" travelTime="2 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "90 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Yelagiri Hills" city="Vellore" />
