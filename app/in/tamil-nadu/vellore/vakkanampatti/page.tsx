...
export const metadata: Metadata = {
  title: 'Best Dentist in Vakkanampatti, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vakkanampatti. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Vakkanampatti', 'dental clinic Vakkanampatti', 'Tirupathur dentist'],
}

export default function VakkanampattiPage() {
  const distance = "80 km"

  const locationName = 'Vakkanampatti'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '80 km', slug: '', travelTime: '1.8 hours', pincode: '632001' },
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635851' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635851" distance="80 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="80 km" travelTime="1.8 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "80 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vakkanampatti" city="Vellore" />
