...
export const metadata: Metadata = {
  title: 'Best Dentist in Udayendiram, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Udayendiram. Dr. Rockson Samuel. PIN: 635754. Book: +91 70106 50063',
  keywords: ['dentist Udayendiram', 'dental clinic Udayendiram', 'Vaniyambadi dentist'],
}

export default function UdayendiramPage() {
  const distance = "56 km"

  const locationName = 'Udayendiram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Udayendiram" city="Vellore" />
