...
export const metadata: Metadata = {
  title: 'Best Dentist in TEL, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in TEL. Dr. Rockson Samuel. PIN: 632059. Book: +91 70106 50063',
  keywords: ['dentist TEL', 'dental clinic TEL', 'Vellore dentist'],
}

export default function TELPage() {
  const locationName = 'TEL'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632059' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632059" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Tel" city="Vellore" />
