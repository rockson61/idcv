...
export const metadata: Metadata = {
  title: 'Best Dentist in Nellivasalnadu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nellivasalnadu. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Nellivasalnadu', 'dental clinic Nellivasalnadu', 'Tirupattur dentist'],
}

export default function NellivasalnaduPage() {
  const distance = "69 km"

  const locationName = 'Nellivasalnadu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635655' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635655" distance="69 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Nellivasalnadu" city="Vellore" />
