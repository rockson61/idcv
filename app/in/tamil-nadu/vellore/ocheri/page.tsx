...
export const metadata: Metadata = {
  title: 'Best Dentist in Ocheri, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ocheri. Dr. Rockson Samuel. PIN: 632531. Book: +91 70106 50063',
  keywords: ['dentist Ocheri', 'dental clinic Ocheri', 'Arakkonam dentist'],
}

export default function OcheriPage() {
  const distance = "42 km"

  const locationName = 'Ocheri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ocheri" city="Vellore" />
