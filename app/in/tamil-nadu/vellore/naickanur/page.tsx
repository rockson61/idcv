...
export const metadata: Metadata = {
  title: 'Best Dentist in Naickanur, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Naickanur. Dr. Rockson Samuel. PIN: 635701. Book: +91 70106 50063',
  keywords: ['dentist Naickanur', 'dental clinic Naickanur', 'Vaniyambadi dentist'],
}

export default function NaickanurPage() {
  const locationName = 'Naickanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Naickanur" city="Vellore" />
