...
export const metadata: Metadata = {
  title: 'Best Dentist in Madanancherry, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Madanancherry. Dr. Rockson Samuel. PIN: 635754. Book: +91 70106 50063',
  keywords: ['dentist Madanancherry', 'dental clinic Madanancherry', 'Vaniyambadi dentist'],
}

export default function MadanancherryPage() {
  const distance = "56 km"

  const locationName = 'Madanancherry'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Madanancherry" city="Vellore" />
