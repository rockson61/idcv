...
export const metadata: Metadata = {
  title: 'Best Dentist in Thollapalli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thollapalli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Thollapalli', href: '/in/tamil-nadu/vellore/thollapalli' },
          ]}
        />
