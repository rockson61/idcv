...
export const metadata: Metadata = {
  title: 'Best Dentist in Pakkirithakka, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pakkirithakka. Dr. Rockson Samuel. PIN: 635853. Book: +91 70106 50063',
  keywords: ['dentist Pakkirithakka', 'dental clinic Pakkirithakka', 'Tirupathur dentist'],
}

export default function PakkirithakkaPage() {
  const distance = "77 km"

  const locationName = 'Pakkirithakka'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635853' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635853" distance="77 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Pakkirithakka" city="Vellore" />
