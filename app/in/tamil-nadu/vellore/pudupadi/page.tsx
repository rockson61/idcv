...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudupadi, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pudupadi. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Pudupadi', 'dental clinic Pudupadi', 'Arcot dentist'],
}

export default function PudupadiPage() {
  const locationName = 'Pudupadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pudupadi" city="Vellore" />
