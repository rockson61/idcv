...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilandur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilandur. Dr. Rockson Samuel. PIN: 631003. Book: +91 70106 50063',
  keywords: ['dentist Kilandur', 'dental clinic Kilandur', 'Arakkonam dentist'],
}

export default function KilandurPage() {
  const distance = "37 km"

  const locationName = 'Kilandur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilandur" city="Vellore" />
