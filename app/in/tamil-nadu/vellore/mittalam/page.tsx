...
export const metadata: Metadata = {
  title: 'Best Dentist in Mittalam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mittalam. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Mittalam', 'dental clinic Mittalam', 'Gudiyattam dentist'],
}

export default function MittalamPage() {
  const distance = "60 km"

  const locationName = 'Mittalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mittalam" city="Vellore" />
