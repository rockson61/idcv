...
export const metadata: Metadata = {
  title: 'Best Dentist in Sakkaramallur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sakkaramallur. Dr. Rockson Samuel. PIN: 632511. Book: +91 70106 50063',
  keywords: ['dentist Sakkaramallur', 'dental clinic Sakkaramallur', 'Arcot dentist'],
}

export default function SakkaramallurPage() {
  const distance = "29 km"

  const locationName = 'Sakkaramallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sakkaramallur" city="Vellore" />
