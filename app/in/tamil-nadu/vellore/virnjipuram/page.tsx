...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Virnjipuram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Virnjipuram. Dr. Rockson Samuel. PIN: 632104. Book: +91 70106 50063',
  keywords: ['dentist Virnjipuram', 'dental clinic Virnjipuram', 'Vellore dentist'],
}

export default function VirnjipuramPage() {
  const distance = "13 km"

  const locationName = 'Virnjipuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632104' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632104" distance="13 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Virnjipuram" city="Vellore" />
