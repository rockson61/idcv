...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajakuppam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rajakuppam. Dr. Rockson Samuel. PIN: 635806. Book: +91 70106 50063',
  keywords: ['dentist Rajakuppam', 'dental clinic Rajakuppam', 'Gudiyattam dentist'],
}

export default function RajakuppamPage() {
  const distance = "47 km"

  const locationName = 'Rajakuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Rajakuppam" city="Vellore" />
