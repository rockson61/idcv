...
export const metadata: Metadata = {
  title: 'Best Dentist in Naganadhi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Naganadhi. Dr. Rockson Samuel. PIN: 632113. Book: +91 70106 50063',
  keywords: ['dentist Naganadhi', 'dental clinic Naganadhi', 'Vlr dentist'],
}

export default function NaganadhiPage() {
  const distance = "16 km"

  const locationName = 'Naganadhi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Naganadhi" city="Vellore" />
