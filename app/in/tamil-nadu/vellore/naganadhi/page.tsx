...
export const metadata: Metadata = {
  title: 'Best Dentist in Naganadhi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Naganadhi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Naganadhi', href: '/in/tamil-nadu/vellore/naganadhi' },
          ]}
        />
