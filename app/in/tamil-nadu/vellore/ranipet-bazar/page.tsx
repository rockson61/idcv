...
export const metadata: Metadata = {
  title: 'Best Dentist in Ranipet Bazar, Walaja | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ranipet Bazar. Dr. Rockson Samuel. PIN: 632401. Book: +91 70106 50063',
  keywords: ['dentist Ranipet Bazar', 'dental clinic Ranipet Bazar', 'Walaja dentist'],
}

export default function RanipetBazarPage() {
  const locationName = 'Ranipet Bazar'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '20 km', slug: '', travelTime: '30 minutes', pincode: '632001' },
    { name: 'Walaja', distance: '5-10 km', slug: 'walaja', travelTime: '15 min', pincode: '632401' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walaja" pincode="632401" distance="20 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="20 km" travelTime="30 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "20 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Ranipet Bazar" city="Vellore" />
