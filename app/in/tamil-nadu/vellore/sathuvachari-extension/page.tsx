...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Sathuvachari Extension, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sathuvachari Extension. Dr. Rockson Samuel. PIN: 632009. Book: +91 70106 50063',
  keywords: ['dentist Sathuvachari Extension', 'dental clinic Sathuvachari Extension', 'Vellore dentist'],
}

export default function SathuvachariExtensionPage() {
  const distance = "8 km"

  const locationName = 'Sathuvachari Extension'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '8 km', slug: '', travelTime: '18 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632009' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632009" distance="8 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="8 km" travelTime="18 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "8 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Sathuvachari Extension" city="Vellore" />
