...
export const metadata: Metadata = {
  title: 'Best Dentist in Meleri, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Meleri. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Meleri', 'dental clinic Meleri', 'Arakonam dentist'],
}

export default function MeleriPage() {
  const distance = "35 km"

  const locationName = 'Meleri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Meleri" city="Vellore" />
