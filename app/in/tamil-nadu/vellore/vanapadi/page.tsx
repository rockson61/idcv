...
export const metadata: Metadata = {
  title: 'Best Dentist in Vanapadi, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vanapadi. Dr. Rockson Samuel. PIN: 632404. Book: +91 70106 50063',
  keywords: ['dentist Vanapadi', 'dental clinic Vanapadi', 'Walajapet dentist'],
}

export default function VanapadiPage() {
  const distance = "21 km"

  const locationName = 'Vanapadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vanapadi" city="Vellore" />
