...
export const metadata: Metadata = {
  title: 'Best Dentist in Pakkamvenkatapuram, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pakkamvenkatapuram. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Pakkamvenkatapuram', 'dental clinic Pakkamvenkatapuram', 'Gudiyatham dentist'],
}

export default function PakkamvenkatapuramPage() {
  const distance = "45 km"

  const locationName = 'Pakkamvenkatapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyatham', distance: '5-10 km', slug: 'gudiyatham', travelTime: '15 min', pincode: '632601' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyatham" pincode="632601" distance="45 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Pakkamvenkatapuram" city="Vellore" />
