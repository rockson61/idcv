...
export const metadata: Metadata = {
  title: 'Best Dentist in Sozhamur, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sozhamur. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Sozhamur', 'dental clinic Sozhamur', 'Katpadi dentist'],
}

export default function SozhamurPage() {
  const distance = "17 km"

  const locationName = 'Sozhamur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sozhamur" city="Vellore" />
