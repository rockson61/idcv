...
export const metadata: Metadata = {
  title: 'Best Dentist in Vembi, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vembi. Dr. Rockson Samuel. PIN: 632518. Book: +91 70106 50063',
  keywords: ['dentist Vembi', 'dental clinic Vembi', 'Arcot dentist'],
}

export default function VembiPage() {
  const distance = "26 km"

  const locationName = 'Vembi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vembi" city="Vellore" />
