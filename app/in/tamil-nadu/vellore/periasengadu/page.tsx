...
export const metadata: Metadata = {
  title: 'Best Dentist in Periasengadu, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periasengadu. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Periasengadu', 'dental clinic Periasengadu', 'Wallajah dentist'],
}

export default function PeriasengaduPage() {
  const distance = "24 km"

  const locationName = 'Periasengadu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '632501' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="632501" distance="24 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Periasengadu" city="Vellore" />
