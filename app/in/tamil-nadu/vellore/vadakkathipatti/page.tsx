...
export const metadata: Metadata = {
  title: 'Best Dentist in Vadakkathipatti, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vadakkathipatti. Dr. Rockson Samuel. PIN: 635804. Book: +91 70106 50063',
  keywords: ['dentist Vadakkathipatti', 'dental clinic Vadakkathipatti', 'Vaniyambadi dentist'],
}

export default function VadakkathipattiPage() {
  const distance = "57 km"

  const locationName = 'Vadakkathipatti'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vadakkathipatti" city="Vellore" />
