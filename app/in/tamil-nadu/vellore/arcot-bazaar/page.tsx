...
export const metadata: Metadata = {
  title: 'Best Dentist in Arcot Bazaar, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arcot Bazaar. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Arcot Bazaar', 'dental clinic Arcot Bazaar', 'Arcot dentist'],
}

export default function ArcotBazaarPage() {
  const locationName = 'Arcot Bazaar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Arcot Bazaar" city="Vellore" />
