...
export const metadata: Metadata = {
  title: 'Best Dentist in TB Sanatorium, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in TB Sanatorium. Dr. Rockson Samuel. PIN: 632011. Book: +91 70106 50063',
  keywords: ['dentist TB Sanatorium', 'dental clinic TB Sanatorium', 'Vellore dentist'],
}

export default function TBSanatoriumPage() {
  const distance = "7 km"

  const locationName = 'TB Sanatorium'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632011' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632011" distance="7 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Tb Sanatorium" city="Vellore" />
