...
export const metadata: Metadata = {
  title: 'Best Dentist in Kaniyanur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kaniyanur. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Kaniyanur', 'dental clinic Kaniyanur', 'Arcot dentist'],
}

export default function KaniyanurPage() {
  const locationName = 'Kaniyanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kaniyanur" city="Vellore" />
