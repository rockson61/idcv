...
export const metadata: Metadata = {
  title: 'Best Dentist in Vandranthangal, Vl | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vandranthangal. Dr. Rockson Samuel. PIN: 632059. Book: +91 70106 50063',
  keywords: ['dentist Vandranthangal', 'dental clinic Vandranthangal', 'Vl dentist'],
}

export default function VandranthangalPage() {
  const locationName = 'Vandranthangal'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vl', distance: '5-10 km', slug: 'vl', travelTime: '15 min', pincode: '632059' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vl" pincode="632059" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Vandranthangal" city="Vellore" />
