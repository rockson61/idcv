...
export const metadata: Metadata = {
  title: 'Best Dentist in Jayapuram, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jayapuram. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Jayapuram', 'dental clinic Jayapuram', 'Tirupathur dentist'],
}

export default function JayapuramPage() {
  const distance = "68 km"

  const locationName = 'Jayapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Jayapuram" city="Vellore" />
