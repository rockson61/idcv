...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayapalayamottur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Palayapalayamottur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Palayapalayamottur', href: '/in/tamil-nadu/vellore/palayapalayamottur' },
          ]}
        />
