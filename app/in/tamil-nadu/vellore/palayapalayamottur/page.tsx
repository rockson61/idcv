...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayapalayamottur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palayapalayamottur. Dr. Rockson Samuel. PIN: 632505. Book: +91 70106 50063',
  keywords: ['dentist Palayapalayamottur', 'dental clinic Palayapalayamottur', 'Arakkonam dentist'],
}

export default function PalayapalayamotturPage() {
  const distance = "36 km"

  const locationName = 'Palayapalayamottur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Palayapalayamottur" city="Vellore" />
