...
export const metadata: Metadata = {
  title: 'Best Dentist in Karai, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karai. Dr. Rockson Samuel. PIN: 632404. Book: +91 70106 50063',
  keywords: ['dentist Karai', 'dental clinic Karai', 'Walajapet dentist'],
}

export default function KaraiPage() {
  const distance = "21 km"

  const locationName = 'Karai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karai" city="Vellore" />
