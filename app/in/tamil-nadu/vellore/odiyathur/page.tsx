...
export const metadata: Metadata = {
  title: 'Best Dentist in Odiyathur, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Odiyathur. Dr. Rockson Samuel. PIN: 635809. Book: +91 70106 50063',
  keywords: ['dentist Odiyathur', 'dental clinic Odiyathur', 'Katpadi dentist'],
}

export default function OdiyathurPage() {
  const distance = "35 km"

  const locationName = 'Odiyathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Odiyathur" city="Vellore" />
