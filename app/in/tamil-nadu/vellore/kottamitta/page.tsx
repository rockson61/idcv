...
export const metadata: Metadata = {
  title: 'Best Dentist in Kottamitta, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kottamitta. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Kottamitta', 'dental clinic Kottamitta', 'Gudiyatham dentist'],
}

export default function KottamittaPage() {
  const distance = "45 km"

  const locationName = 'Kottamitta'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kottamitta" city="Vellore" />
