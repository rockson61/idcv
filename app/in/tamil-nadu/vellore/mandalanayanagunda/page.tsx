...
export const metadata: Metadata = {
  title: 'Best Dentist in Mandalanayanagunda, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mandalanayanagunda. Dr. Rockson Samuel. PIN: 635901. Book: +91 70106 50063',
  keywords: ['dentist Mandalanayanagunda', 'dental clinic Mandalanayanagunda', 'Tirupattur dentist'],
}

export default function MandalanayanagundaPage() {
  const distance = "72 km"

  const locationName = 'Mandalanayanagunda'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mandalanayanagunda" city="Vellore" />
