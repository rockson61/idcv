...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayanur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palayanur. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Palayanur', 'dental clinic Palayanur', 'Arcot dentist'],
}

export default function PalayanurPage() {
  const locationName = 'Palayanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Palayanur" city="Vellore" />
