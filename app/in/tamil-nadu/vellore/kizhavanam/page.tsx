...
export const metadata: Metadata = {
  title: 'Best Dentist in Kizhavanam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kizhavanam. Dr. Rockson Samuel. PIN: 631101. Book: +91 70106 50063',
  keywords: ['dentist Kizhavanam', 'dental clinic Kizhavanam', 'Arakkonam dentist'],
}

export default function KizhavanamPage() {
  const distance = "39 km"

  const locationName = 'Kizhavanam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kizhavanam" city="Vellore" />
