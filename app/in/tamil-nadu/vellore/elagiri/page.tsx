...
export const metadata: Metadata = {
  title: 'Best Dentist in Elagiri, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Elagiri. Dr. Rockson Samuel. PIN: 635853. Book: +91 70106 50063',
  keywords: ['dentist Elagiri', 'dental clinic Elagiri', 'Tirupattur dentist'],
}

export default function ElagiriPage() {
  const distance = "77 km"

  const locationName = 'Elagiri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Elagiri" city="Vellore" />
