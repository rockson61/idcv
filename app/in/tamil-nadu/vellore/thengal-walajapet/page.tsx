...
export const metadata: Metadata = {
  title: 'Best Dentist in Thengal Walajapet, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thengal Walajapet. Dr. Rockson Samuel. PIN: 632404. Book: +91 70106 50063',
  keywords: ['dentist Thengal Walajapet', 'dental clinic Thengal Walajapet', 'Walajapet dentist'],
}

export default function ThengalWalajapetPage() {
  const distance = "21 km"

  const locationName = 'Thengal Walajapet'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632404' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632404" distance="21 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Thengal Walajapet" city="Vellore" />
