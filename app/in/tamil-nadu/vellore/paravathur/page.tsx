...
export const metadata: Metadata = {
  title: 'Best Dentist in Paravathur, NA | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Paravathur. Dr. Rockson Samuel. PIN: 632510. Book: +91 70106 50063',
  keywords: ['dentist Paravathur', 'dental clinic Paravathur', 'NA dentist'],
}

export default function ParavathurPage() {
  const distance = "38 km"

  const locationName = 'Paravathur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'NA', distance: '5-10 km', slug: 'na', travelTime: '15 min', pincode: '632510' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="NA" pincode="632510" distance="38 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Paravathur" city="Vellore" />
