...
export const metadata: Metadata = {
  title: 'Best Dentist in Paradarami, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Paradarami. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Paradarami', 'dental clinic Paradarami', 'Arcot dentist'],
}

export default function ParadaramiPage() {
  const distance = "30 km"

  const locationName = 'Paradarami'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Paradarami" city="Vellore" />
