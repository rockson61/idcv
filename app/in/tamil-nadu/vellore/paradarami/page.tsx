...
export const metadata: Metadata = {
  title: 'Best Dentist in Paradarami, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Paradarami, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Paradarami', href: '/in/tamil-nadu/vellore/paradarami' },
          ]}
        />
