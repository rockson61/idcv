...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudiyattam RS, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gudiyattam RS. Dr. Rockson Samuel. PIN: 635803. Book: +91 70106 50063',
  keywords: ['dentist Gudiyattam RS', 'dental clinic Gudiyattam RS', 'Gudiyatham dentist'],
}

export default function GudiyattamRSPage() {
  const distance = "46 km"

  const locationName = 'Gudiyattam RS'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyatham', distance: '5-10 km', slug: 'gudiyatham', travelTime: '15 min', pincode: '635803' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyatham" pincode="635803" distance="46 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Gudiyattam Rs" city="Vellore" />
