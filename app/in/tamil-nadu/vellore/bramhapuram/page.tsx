...
export const metadata: Metadata = {
  title: 'Best Dentist in Bramhapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Bramhapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Bramhapuram', href: '/in/tamil-nadu/vellore/bramhapuram' },
          ]}
        />
