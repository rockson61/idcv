...
export const metadata: Metadata = {
  title: 'Best Dentist in Bramhapuram, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Bramhapuram. Dr. Rockson Samuel. PIN: 632014. Book: +91 70106 50063',
  keywords: ['dentist Bramhapuram', 'dental clinic Bramhapuram', 'Katpadi dentist'],
}

export default function BramhapuramPage() {
  const locationName = 'Bramhapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632014' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632014" distance="9 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Bramhapuram" city="Vellore" />
