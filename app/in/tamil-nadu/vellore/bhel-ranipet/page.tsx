...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhel Ranipet, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Bhel Ranipet. Dr. Rockson Samuel. PIN: 632406. Book: +91 70106 50063',
  keywords: ['dentist Bhel Ranipet', 'dental clinic Bhel Ranipet', 'Walajapet dentist'],
}

export default function BhelRanipetPage() {
  const distance = "22 km"

  const locationName = 'Bhel Ranipet'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632406' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632406" distance="22 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Bhel Ranipet" city="Vellore" />
