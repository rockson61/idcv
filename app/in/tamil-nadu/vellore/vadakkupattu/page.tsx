...
export const metadata: Metadata = {
  title: 'Best Dentist in Vadakkupattu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vadakkupattu. Dr. Rockson Samuel. PIN: 635801. Book: +91 70106 50063',
  keywords: ['dentist Vadakkupattu', 'dental clinic Vadakkupattu', 'Tirupattur dentist'],
}

export default function VadakkupattuPage() {
  const distance = "64 km"

  const locationName = 'Vadakkupattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vadakkupattu" city="Vellore" />
