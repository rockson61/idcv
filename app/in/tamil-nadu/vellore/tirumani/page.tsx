...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirumani, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tirumani. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Tirumani', 'dental clinic Tirumani', 'Vlr dentist'],
}

export default function TirumaniPage() {
  const distance = "17 km"

  const locationName = 'Tirumani'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tirumani" city="Vellore" />
