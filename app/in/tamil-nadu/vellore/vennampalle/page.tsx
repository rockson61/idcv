...
export const metadata: Metadata = {
  title: 'Best Dentist in Vennampalle, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vennampalle. Dr. Rockson Samuel. PIN: 632516. Book: +91 70106 50063',
  keywords: ['dentist Vennampalle', 'dental clinic Vennampalle', 'Katpadi dentist'],
}

export default function VennampallePage() {
  const distance = "13 km"

  const locationName = 'Vennampalle'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vennampalle" city="Vellore" />
