...
export const metadata: Metadata = {
  title: 'Best Dentist in Seyyoor, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Seyyoor. Dr. Rockson Samuel. PIN: 631004. Book: +91 70106 50063',
  keywords: ['dentist Seyyoor', 'dental clinic Seyyoor', 'Arakkonam dentist'],
}

export default function SeyyoorPage() {
  const distance = "36 km"

  const locationName = 'Seyyoor'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Seyyoor" city="Vellore" />
