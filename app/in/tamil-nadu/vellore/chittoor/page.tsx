...
export const metadata: Metadata = {
  title: 'Best Dentist in Chittoor, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chittoor. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Chittoor', 'dental clinic Chittoor', 'Tirupathur dentist'],
}

export default function ChittoorPage() {
  const distance = "69 km"

  const locationName = 'Chittoor'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chittoor" city="Vellore" />
