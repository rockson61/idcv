...
export const metadata: Metadata = {
  title: 'Best Dentist in Thanigaipolur, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thanigaipolur. Dr. Rockson Samuel. PIN: 631003. Book: +91 70106 50063',
  keywords: ['dentist Thanigaipolur', 'dental clinic Thanigaipolur', 'Arakonam dentist'],
}

export default function ThanigaipolurPage() {
  const distance = "37 km"

  const locationName = 'Thanigaipolur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '631003' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="631003" distance="37 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Thanigaipolur" city="Vellore" />
