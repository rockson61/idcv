...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilur. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Kilur', 'dental clinic Kilur', 'Tirupattur dentist'],
}

export default function KilurPage() {
  const distance = "69 km"

  const locationName = 'Kilur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilur" city="Vellore" />
