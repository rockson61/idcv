...
export const metadata: Metadata = {
  title: 'Best Dentist in Sendamangalam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sendamangalam. Dr. Rockson Samuel. PIN: 631051. Book: +91 70106 50063',
  keywords: ['dentist Sendamangalam', 'dental clinic Sendamangalam', 'Arakkonam dentist'],
}

export default function SendamangalamPage() {
  const distance = "38 km"

  const locationName = 'Sendamangalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sendamangalam" city="Vellore" />
