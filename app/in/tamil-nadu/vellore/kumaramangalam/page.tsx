...
export const metadata: Metadata = {
  title: 'Best Dentist in Kumaramangalam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kumaramangalam. Dr. Rockson Samuel. PIN: 635802. Book: +91 70106 50063',
  keywords: ['dentist Kumaramangalam', 'dental clinic Kumaramangalam', 'Vaniyambadi dentist'],
}

export default function KumaramangalamPage() {
  const distance = "58 km"

  const locationName = 'Kumaramangalam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '58 km', slug: '', travelTime: '1.3 hours', pincode: '632001' },
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635802' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635802" distance="58 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="58 km" travelTime="1.3 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "58 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Kumaramangalam" city="Vellore" />
