...
export const metadata: Metadata = {
  title: 'Best Dentist in Anaipakkam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Anaipakkam. Dr. Rockson Samuel. PIN: 631003. Book: +91 70106 50063',
  keywords: ['dentist Anaipakkam', 'dental clinic Anaipakkam', 'Arakkonam dentist'],
}

export default function AnaipakkamPage() {
  const distance = "37 km"

  const locationName = 'Anaipakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Anaipakkam" city="Vellore" />
