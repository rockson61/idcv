...
export const metadata: Metadata = {
  title: 'Best Dentist in CMC Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in CMC Vellore. Dr. Rockson Samuel. PIN: 632002. Book: +91 70106 50063',
  keywords: ['dentist CMC Vellore', 'dental clinic CMC Vellore', 'Vellore dentist'],
}

export default function CMCVellorePage() {
  const distance = "3 km"

  const locationName = 'CMC Vellore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Cmc Vellore" city="Vellore" />
