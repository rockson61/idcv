...
export const metadata: Metadata = {
  title: 'Best Dentist in Neelakandarayanpattai, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Neelakandarayanpattai. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Neelakandarayanpattai', 'dental clinic Neelakandarayanpattai', 'Walajapet dentist'],
}

export default function NeelakandarayanpattaiPage() {
  const distance = "24 km"

  const locationName = 'Neelakandarayanpattai'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '24 km', slug: '', travelTime: '35 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632501' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632501" distance="24 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="24 km" travelTime="35 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "24 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Neelakandarayanpattai" city="Vellore" />
