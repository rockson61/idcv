...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupattur Fort, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tirupattur Fort. Dr. Rockson Samuel. PIN: 635602. Book: +91 70106 50063',
  keywords: ['dentist Tirupattur Fort', 'dental clinic Tirupattur Fort', 'Tirupathur dentist'],
}

export default function TirupatturFortPage() {
  const distance = "66 km"

  const locationName = 'Tirupattur Fort'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tirupattur Fort" city="Vellore" />
