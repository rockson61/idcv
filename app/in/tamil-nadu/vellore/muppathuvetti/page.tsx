...
export const metadata: Metadata = {
  title: 'Best Dentist in Muppathuvetti, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Muppathuvetti. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Muppathuvetti', 'dental clinic Muppathuvetti', 'Arcot dentist'],
}

export default function MuppathuvettiPage() {
  const locationName = 'Muppathuvetti'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Muppathuvetti" city="Vellore" />
