...
export const metadata: Metadata = {
  title: 'Best Dentist for Kalavai, Vellore | Indira Dental Clinic',
  description: 'Expert dental services for Kalavai residents. RCT, dental implants, braces, cosmetic dentistry by Dr. Rockson Samuel at Vellore clinic.',
  keywords: ['dentist Kalavai', 'dental clinic Kalavai Vellore', 'dental services Kalavai', 'best dentist Kalavai'],
}

export default function KalavaiPage() {
  const services = [
  ...
  const faqs = [
    { question: 'Where is the best dental clinic near Kalavai?', answer: 'Indira Dental Clinic in Vellore is the best choice for Kalavai residents, offering comprehensive dental services with modern equipment just 18 km away.' },
    { question: 'How much does dental treatment cost for Kalavai patients?', answer: 'At Indira Dental Clinic, root canal treatment costs ₹3,000-8,000, dental implants ₹25,000-45,000, and braces ₹30,000-80,000 with transparent pricing.' },
    { question: 'Who is the best dentist for Kalavai patients?', answer: 'Dr. Rockson Samuel at Indira Dental Clinic has 15+ years of experience and is highly trusted by Kalavai residents for all dental treatments.' },
    { question: 'How far is the dental clinic from Kalavai?', answer: 'Our clinic in Vellore is approximately 18 km from Kalavai, easily reachable within 25-30 minutes by road.' },
    { question: 'What dental services are available for Kalavai residents?', answer: 'We offer complete dental services including RCT, implants, braces, cosmetic dentistry, general dentistry, and pediatric care with latest technology.' }
  ]

  const reviews = [
    { name: 'Ravi Prakash', location: 'Kalavai', rating: 5, treatment: 'Dental Implants', text: 'Excellent service! Traveled from Kalavai for dental implants. Dr. Rockson Samuel is very skilled. Results are amazing!', date: '2024-01-15' },
    { name: 'Sudha Ramesh', location: 'Kalavai', rating: 5, treatment: 'Root Canal', text: 'Best dentist near Kalavai! RCT was painless. Worth the short trip to Vellore for quality dental care.', date: '2024-01-10' },
    { name: 'Ganesh Kumar', location: 'Kalavai', rating: 5, treatment: 'Braces', text: 'My daughter got braces. Very satisfied with the treatment. Modern clinic with excellent facilities.', date: '2024-01-08' }
  ]
  ...
  const amenities = [
    ...
    { icon: Car, name: 'Easy Access', description: 'From Kalavai' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        <Breadcrumb items={[{ title: 'Home', href: '/' }, { title: 'India', href: '/in' }, { title: 'Tamil Nadu', href: '/in/tamil-nadu' }, { title: 'Vellore', href: '/in/tamil-nadu/vellore' }, { title: 'Kalavai', href: '/in/tamil-nadu/vellore/kalavai' }]} className="mb-8" />
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dentist and Dental Clinic in Kalavai, Vellore</h1>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">Welcome to Indira Dental Clinic - serving Kalavai and surrounding areas with comprehensive dental treatments.</p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Dental Services for Kalavai Patients</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Patient Reviews from Kalavai</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ModernCard><ModernCardHeader><ModernCardTitle className="flex items-center gap-2"><Navigation className="w-6 h-6 text-teal-600" />How to Reach from Kalavai</ModernCardTitle></ModernCardHeader><ModernCardContent><div className="space-y-4"><div><h4 className="font-semibold text-gray-900 mb-2">Distance from Kalavai:</h4><p className="text-gray-700">Approximately 18 km</p></div><div><h4 className="font-semibold text-gray-900 mb-2">Travel Options:</h4><ul className="text-sm text-gray-700 space-y-1"><li>• By Car: 25-30 minutes</li><li>• By Bus: Regular buses available</li><li>• Free parking at clinic</li></ul></div></div></ModernCardContent></ModernCard>
          </div>
        </section>
        <section className="mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <RelevantQAWidget title="Common Questions from Kalavai" questions={[{id:'1',title:'Best dental clinic near Kalavai?',slug:'best-dental-clinic-kalavai',excerpt:'Indira Dental Clinic in Vellore is the best choice.',helpfulVotes:45,views:1200,createdAt:'2023-12-20T10:30:00Z'},{id:'2',title:'Root canal cost for Kalavai patients?',slug:'root-canal-cost-kalavai',excerpt:'₹3,000-8,000 at our clinic.',helpfulVotes:52,views:1400,createdAt:'2023-12-18T14:15:00Z'}]} serviceName="dental care" />
            <CompactServiceWidget title="Popular Services" description="Most requested by Kalavai patients." services={[{name:"Root Canal Treatment",slug:"root-canal-treatment",price:"₹3,000 - ₹8,000",duration:"1-2 hours"},{name:"Dental Implants",slug:"dental-implants",price:"₹25,000 - ₹45,000",duration:"2-3 hours"}]} ctaText="View All Services" ctaLink="/services" />
          </div>
        </section>
        <section className="text-center mb-12">
          <ModernCard><ModernCardContent className="py-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to Transform Your Smile?</h2><p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">Book your appointment today. Easily accessible for Kalavai residents.</p><div className="flex flex-col sm:flex-row gap-4 justify-center"><Link href="/contact" className="inline-flex items-center justify-center px-8 py-3 bg-teal-600 text-white rounded-lg font-semibold hover:bg-teal-700 transition-colors"><Phone className="w-5 h-5 mr-2" />Book Appointment</Link><Link href="/services" className="inline-flex items-center justify-center px-8 py-3 border-2 border-teal-600 text-teal-600 rounded-lg font-semibold hover:bg-teal-50 transition-colors"><Navigation className="w-5 h-5 mr-2" />View Services</Link></div></ModernCardContent></ModernCard>
        </section>
        
        <PeopleAlsoSearchFor location="Kalavai" city="Vellore" />

        <CTAWidget title="Start Your Dental Journey Today" description="Join satisfied patients from Kalavai who trust Indira Dental Clinic." primaryAction={{text:"Book Free Consultation",href:"/contact"}} secondaryAction={{text:"Ask a Question",href:"/ask-the-dentist/submit"}} benefits={["15+ years experience","Modern equipment","Flexible payment plans","Well connected from Kalavai"]} showRating={true} showAvailability={true} />
      </div>
    </div>
  )
}
