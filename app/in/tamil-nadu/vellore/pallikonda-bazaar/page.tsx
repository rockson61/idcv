...
export const metadata: Metadata = {
  title: 'Best Dentist in Pallikonda Bazaar, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pallikonda Bazaar. Dr. Rockson Samuel. PIN: 635809. Book: +91 70106 50063',
  keywords: ['dentist Pallikonda Bazaar', 'dental clinic Pallikonda Bazaar', 'Gudiyatham dentist'],
}

export default function PallikondaBazaarPage() {
  const distance = "35 km"

  const locationName = 'Pallikonda Bazaar'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyatham', distance: '5-10 km', slug: 'gudiyatham', travelTime: '15 min', pincode: '635809' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyatham" pincode="635809" distance="35 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Pallikonda Bazaar" city="Vellore" />
