...
export const metadata: Metadata = {
  title: 'Best Dentist in Katrambakkam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Katrambakkam. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Katrambakkam', 'dental clinic Katrambakkam', 'Walajapet dentist'],
}

export default function KatrambakkamPage() {
  const distance = "24 km"

  const locationName = 'Katrambakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Katrambakkam" city="Vellore" />
