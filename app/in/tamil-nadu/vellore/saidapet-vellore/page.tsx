...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Saidapet Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Saidapet Vellore. Dr. Rockson Samuel. PIN: 632012. Book: +91 70106 50063',
  keywords: ['dentist Saidapet Vellore', 'dental clinic Saidapet Vellore', 'Vellore dentist'],
}

export default function SaidapetVellorePage() {
  const distance = "7 km"

  const locationName = 'Saidapet Vellore'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '7 km', slug: '', travelTime: '16 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632012' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632012" distance="7 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="7 km" travelTime="16 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Saidapet Vellore" city="Vellore" />
