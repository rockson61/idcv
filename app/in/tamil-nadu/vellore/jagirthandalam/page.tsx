...
export const metadata: Metadata = {
  title: 'Best Dentist in Jagirthandalam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jagirthandalam. Dr. Rockson Samuel. PIN: 631052. Book: +91 70106 50063',
  keywords: ['dentist Jagirthandalam', 'dental clinic Jagirthandalam', 'Arakkonam dentist'],
}

export default function JagirthandalamPage() {
  const distance = "38 km"

  const locationName = 'Jagirthandalam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631052' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631052" distance="38 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Jagirthandalam" city="Vellore" />
