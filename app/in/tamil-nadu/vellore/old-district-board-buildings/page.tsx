...
export const metadata: Metadata = {
  title: 'Best Dentist in Old District Board Buildings, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Old District Board Buildings, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Old District Board Buildings', href: '/in/tamil-nadu/vellore/old-district-board-buildings' },
          ]}
        />
