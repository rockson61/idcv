...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Old District Board Buildings, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Old District Board Buildings. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Old District Board Buildings', 'dental clinic Old District Board Buildings', 'Vellore dentist'],
}

export default function OldDistrictBoardBuildingsPage() {
  const distance = "1 km"

  const locationName = 'Old District Board Buildings'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '1 km', slug: '', travelTime: '5 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632001' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632001" distance="1 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="1 km" travelTime="5 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "1 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Old District Board Buildings" city="Vellore" />
