...
export const metadata: Metadata = {
  title: 'Best Dentist in Puthagaram, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Puthagaram. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Puthagaram', 'dental clinic Puthagaram', 'Tirupattur dentist'],
}

export default function PuthagaramPage() {
  const distance = "68 km"

  const locationName = 'Puthagaram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Puthagaram" city="Vellore" />
