...
export const metadata: Metadata = {
  title: 'Best Dentist in Thuthipattu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thuthipattu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Thuthipattu', href: '/in/tamil-nadu/vellore/thuthipattu' },
          ]}
        />
