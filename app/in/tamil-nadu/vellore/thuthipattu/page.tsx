...
export const metadata: Metadata = {
  title: 'Best Dentist in Thuthipattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thuthipattu. Dr. Rockson Samuel. PIN: 632011. Book: +91 70106 50063',
  keywords: ['dentist Thuthipattu', 'dental clinic Thuthipattu', 'Vlr dentist'],
}

export default function ThuthipattuPage() {
  const locationName = 'Thuthipattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632011' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632011" distance="7 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Thuthipattu" city="Vellore" />
