...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodumampalli, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kodumampalli. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Kodumampalli', 'dental clinic Kodumampalli', 'Tirupathur dentist'],
}

export default function KodumampalliPage() {
  const distance = "67 km"

  const locationName = 'Kodumampalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kodumampalli" city="Vellore" />
