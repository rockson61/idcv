...
export const metadata: Metadata = {
  title: 'Best Dentist in Tajpura, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tajpura. Dr. Rockson Samuel. PIN: 632521. Book: +91 70106 50063',
  keywords: ['dentist Tajpura', 'dental clinic Tajpura', 'Arcot dentist'],
}

export default function TajpuraPage() {
  const locationName = 'Tajpura'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tajpura" city="Vellore" />
