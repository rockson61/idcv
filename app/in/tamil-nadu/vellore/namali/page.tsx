...
export const metadata: Metadata = {
  title: 'Best Dentist in Namali, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Namali. Dr. Rockson Samuel. PIN: 631051. Book: +91 70106 50063',
  keywords: ['dentist Namali', 'dental clinic Namali', 'Arakkonam dentist'],
}

export default function NamaliPage() {
  const distance = "38 km"

  const locationName = 'Namali'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Namali" city="Vellore" />
