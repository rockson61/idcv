...
export const metadata: Metadata = {
  title: 'Best Dentist in Palamathi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palamathi. Dr. Rockson Samuel. PIN: 632002. Book: +91 70106 50063',
  keywords: ['dentist Palamathi', 'dental clinic Palamathi', 'Vlr dentist'],
}

export default function PalamathiPage() {
  const distance = "3 km"

  const locationName = 'Palamathi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Palamathi" city="Vellore" />
