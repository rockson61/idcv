...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodiyur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kodiyur. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Kodiyur', 'dental clinic Kodiyur', 'Tirupathur dentist'],
}

export default function KodiyurPage() {
  const distance = "80 km"

  const locationName = 'Kodiyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kodiyur" city="Vellore" />
