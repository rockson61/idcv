...
export const metadata: Metadata = {
  title: 'Best Dentist in Karigiri, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karigiri. Dr. Rockson Samuel. PIN: 632106. Book: +91 70106 50063',
  keywords: ['dentist Karigiri', 'dental clinic Karigiri', 'Katpadi dentist'],
}

export default function KarigiriPage() {
  const distance = "12 km"

  const locationName = 'Karigiri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karigiri" city="Vellore" />
