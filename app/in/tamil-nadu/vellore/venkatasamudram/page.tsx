...
export const metadata: Metadata = {
  title: 'Best Dentist in Venkatasamudram, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Venkatasamudram. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Venkatasamudram', 'dental clinic Venkatasamudram', 'Gudiyattam dentist'],
}

export default function VenkatasamudramPage() {
  const locationName = 'Venkatasamudram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '635811' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="635811" distance="60 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Venkatasamudram" city="Vellore" />
