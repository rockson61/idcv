...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore Institute Of Technology, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Institute Of Technology. Dr. Rockson Samuel. PIN: 632014. Book: +91 70106 50063',
  keywords: ['dentist Vellore Institute Of Technology', 'dental clinic Vellore Institute Of Technology', 'Vellore dentist'],
}

export default function VelloreInstituteOfTechnologyPage() {
  const distance = "9 km"

  const locationName = 'Vellore Institute Of Technology'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '9 km', slug: '', travelTime: '19 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632014' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632014" distance="9 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="9 km" travelTime="19 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "9 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vellore Institute Of Technology" city="Vellore" />
