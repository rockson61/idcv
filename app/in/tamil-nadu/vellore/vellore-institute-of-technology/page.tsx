...
export const metadata: Metadata = {
  title: 'Best Dentist in Vellore Institute Of Technology, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vellore Institute Of Technology, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Vellore Institute Of Technology', href: '/in/tamil-nadu/vellore/vellore-institute-of-technology' },
          ]}
        />
