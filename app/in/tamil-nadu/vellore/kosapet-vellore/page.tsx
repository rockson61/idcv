...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kosapet Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kosapet Vellore. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Kosapet Vellore', 'dental clinic Kosapet Vellore', 'Vellore dentist'],
}

export default function KosapetVellorePage() {
  const distance = "1 km"

  const locationName = 'Kosapet Vellore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kosapet Vellore" city="Vellore" />
