...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalambattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kalambattu. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Kalambattu', 'dental clinic Kalambattu', 'Vlr dentist'],
}

export default function KalambattuPage() {
  const distance = "17 km"

  const locationName = 'Kalambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kalambattu" city="Vellore" />
