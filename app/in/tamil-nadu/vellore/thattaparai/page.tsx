...
export const metadata: Metadata = {
  title: 'Best Dentist in Thattaparai, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thattaparai. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Thattaparai', 'dental clinic Thattaparai', 'Gudiyattam dentist'],
}

export default function ThattaparaiPage() {
  const distance = "45 km"

  const locationName = 'Thattaparai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thattaparai" city="Vellore" />
