...
export const metadata: Metadata = {
  title: 'Best Dentist in Nariyambattu, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nariyambattu. Dr. Rockson Samuel. PIN: 635808. Book: +91 70106 50063',
  keywords: ['dentist Nariyambattu', 'dental clinic Nariyambattu', 'Gudiyattam dentist'],
}

export default function NariyambattuPage() {
  const distance = "48 km"

  const locationName = 'Nariyambattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '635808' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="635808" distance="48 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Nariyambattu" city="Vellore" />
