...
export const metadata: Metadata = {
  title: 'Best Dentist in Nelvoy, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nelvoy. Dr. Rockson Samuel. PIN: 632011. Book: +91 70106 50063',
  keywords: ['dentist Nelvoy', 'dental clinic Nelvoy', 'Vlr dentist'],
}

export default function NelvoyPage() {
  const locationName = 'Nelvoy'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nelvoy" city="Vellore" />
