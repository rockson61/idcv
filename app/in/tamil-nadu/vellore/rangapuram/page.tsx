...
export const metadata: Metadata = {
  title: 'Best Dentist in Rangapuram, NA | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rangapuram. Dr. Rockson Samuel. PIN: 632009. Book: +91 70106 50063',
  keywords: ['dentist Rangapuram', 'dental clinic Rangapuram', 'NA dentist'],
}

export default function RangapuramPage() {
  const distance = "8 km"

  const locationName = 'Rangapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'NA', distance: '5-10 km', slug: 'na', travelTime: '15 min', pincode: '632009' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="NA" pincode="632009" distance="8 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Rangapuram" city="Vellore" />
