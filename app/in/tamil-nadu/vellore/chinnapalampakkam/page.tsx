...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnapalampakkam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chinnapalampakkam. Dr. Rockson Samuel. PIN: 632113. Book: +91 70106 50063',
  keywords: ['dentist Chinnapalampakkam', 'dental clinic Chinnapalampakkam', 'Vlr dentist'],
}

export default function ChinnapalampakkamPage() {
  const distance = "16 km"

  const locationName = 'Chinnapalampakkam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632113' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632113" distance="16 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Chinnapalampakkam" city="Vellore" />
