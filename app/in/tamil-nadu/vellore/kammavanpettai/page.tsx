...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kammavanpettai, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kammavanpettai. Dr. Rockson Samuel. PIN: 632319. Book: +91 70106 50063',
  keywords: ['dentist Kammavanpettai', 'dental clinic Kammavanpettai', 'Vellore dentist'],
}

export default function KammavanpettaiPage() {
  const distance = "8 km"

  const locationName = 'Kammavanpettai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632319' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632319" distance="8 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kammavanpettai" city="Vellore" />
