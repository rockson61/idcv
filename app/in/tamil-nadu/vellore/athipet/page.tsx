...
export const metadata: Metadata = {
  title: 'Best Dentist in Athipet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Athipet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Athipet', href: '/in/tamil-nadu/vellore/athipet' },
          ]}
        />
