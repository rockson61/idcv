...
export const metadata: Metadata = {
  title: 'Best Dentist in Athipet, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Athipet. Dr. Rockson Samuel. PIN: 635703. Book: +91 70106 50063',
  keywords: ['dentist Athipet', 'dental clinic Athipet', 'Tirupathur dentist'],
}

export default function AthipetPage() {
  const distance = "71 km"

  const locationName = 'Athipet'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '71 km', slug: '', travelTime: '1.7 hours', pincode: '632001' },
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635703' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635703" distance="71 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="71 km" travelTime="1.7 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "71 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Athipet" city="Vellore" />
