...
export const metadata: Metadata = {
  title: 'Best Dentist in Alankuppam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Alankuppam. Dr. Rockson Samuel. PIN: 635814. Book: +91 70106 50063',
  keywords: ['dentist Alankuppam', 'dental clinic Alankuppam', 'Vaniyambadi dentist'],
}

export default function AlankuppamPage() {
  const distance = "59 km"

  const locationName = 'Alankuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Alankuppam" city="Vellore" />
