...
export const metadata: Metadata = {
  title: 'Best Dentist in Vengalapuram, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vengalapuram. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Vengalapuram', 'dental clinic Vengalapuram', 'Tirupattur dentist'],
}

export default function VengalapuramPage() {
  const distance = "67 km"

  const locationName = 'Vengalapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vengalapuram" city="Vellore" />
