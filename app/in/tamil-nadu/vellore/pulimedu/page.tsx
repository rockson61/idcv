...
export const metadata: Metadata = {
  title: 'Best Dentist in Pulimedu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pulimedu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Pulimedu', href: '/in/tamil-nadu/vellore/pulimedu' },
          ]}
        />
