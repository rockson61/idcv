...
export const metadata: Metadata = {
  title: 'Best Dentist in Sumaithangi, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sumaithangi. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Sumaithangi', 'dental clinic Sumaithangi', 'Walajapet dentist'],
}

export default function SumaithangiPage() {
  const distance = "22 km"

  const locationName = 'Sumaithangi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sumaithangi" city="Vellore" />
