...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilkothur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilkothur. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Kilkothur', 'dental clinic Kilkothur', 'Vlr dentist'],
}

export default function KilkothurPage() {
  const distance = "16 km"

  const locationName = 'Kilkothur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilkothur" city="Vellore" />
