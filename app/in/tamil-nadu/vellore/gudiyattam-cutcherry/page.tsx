...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudiyattam Cutcherry, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gudiyattam Cutcherry. Dr. Rockson Samuel. PIN: 632602. Book: +91 70106 50063',
  keywords: ['dentist Gudiyattam Cutcherry', 'dental clinic Gudiyattam Cutcherry', 'Gudiyatham dentist'],
}

export default function GudiyattamCutcherryPage() {
  const distance = "45 km"

  const locationName = 'Gudiyattam Cutcherry'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '45 km', slug: '', travelTime: '1 hour', pincode: '632001' },
    { name: 'Gudiyatham', distance: '5-10 km', slug: 'gudiyatham', travelTime: '15 min', pincode: '632602' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyatham" pincode="632602" distance="45 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="45 km" travelTime="1 hour" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "45 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Gudiyattam Cutcherry" city="Vellore" />
