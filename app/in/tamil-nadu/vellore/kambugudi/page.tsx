...
export const metadata: Metadata = {
  title: 'Best Dentist in Kambugudi, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kambugudi. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Kambugudi', 'dental clinic Kambugudi', 'Tirupathur dentist'],
}

export default function KambugudiPage() {
  const distance = "69 km"

  const locationName = 'Kambugudi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kambugudi" city="Vellore" />
