...
export const metadata: Metadata = {
  title: 'Best Dentist in Minnur, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Minnur. Dr. Rockson Samuel. PIN: 635807. Book: +91 70106 50063',
  keywords: ['dentist Minnur', 'dental clinic Minnur', 'Vaniyambadi dentist'],
}

export default function MinnurPage() {
  const distance = "58 km"

  const locationName = 'Minnur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Minnur" city="Vellore" />
