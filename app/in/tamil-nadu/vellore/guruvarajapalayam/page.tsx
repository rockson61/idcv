...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Guruvarajapalayam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Guruvarajapalayam. Dr. Rockson Samuel. PIN: 632107. Book: +91 70106 50063',
  keywords: ['dentist Guruvarajapalayam', 'dental clinic Guruvarajapalayam', 'Vellore dentist'],
}

export default function GuruvarajapalayamPage() {
  const distance = "14 km"

  const locationName = 'Guruvarajapalayam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '14 km', slug: '', travelTime: '24 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632107' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632107" distance="14 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="14 km" travelTime="24 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "14 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Guruvarajapalayam" city="Vellore" />
