...
export const metadata: Metadata = {
  title: 'Best Dentist in Vengili, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vengili. Dr. Rockson Samuel. PIN: 635812. Book: +91 70106 50063',
  keywords: ['dentist Vengili', 'dental clinic Vengili', 'Vaniyambadi dentist'],
}

export default function VengiliPage() {
  const distance = "60 km"

  const locationName = 'Vengili'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vengili" city="Vellore" />
