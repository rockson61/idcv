...
export const metadata: Metadata = {
  title: 'Best Dentist in Thandalam Krishnapuram, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thandalam Krishnapuram. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Thandalam Krishnapuram', 'dental clinic Thandalam Krishnapuram', 'Vlr dentist'],
}

export default function ThandalamKrishnapuramPage() {
  const distance = "2 km"

  const locationName = 'Thandalam Krishnapuram'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '2 km', slug: '', travelTime: '8 minutes', pincode: '632001' },
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632006' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632006" distance="2 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="2 km" travelTime="8 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "2 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Thandalam Krishnapuram" city="Vellore" />
