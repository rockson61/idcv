...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudur Nadu, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pudur Nadu. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Pudur Nadu', 'dental clinic Pudur Nadu', 'Tirupathur dentist'],
}

export default function PudurNaduPage() {
  const distance = "69 km"

  const locationName = 'Pudur Nadu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pudur Nadu" city="Vellore" />
