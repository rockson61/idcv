...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Anaikkattu, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Anaikkattu. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Anaikkattu', 'dental clinic Anaikkattu', 'Vellore dentist'],
}

export default function AnaikkattuPage() {
  const distance = "15 km"

  const locationName = 'Anaikkattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632101' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632101" distance="15 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Anaikkattu" city="Vellore" />
