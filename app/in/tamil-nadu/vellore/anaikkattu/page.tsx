...
export const metadata: Metadata = {
  title: 'Best Dentist in Anaikkattu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anaikkattu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Anaikkattu', href: '/in/tamil-nadu/vellore/anaikkattu' },
          ]}
        />
