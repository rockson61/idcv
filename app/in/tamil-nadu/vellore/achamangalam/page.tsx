...
export const metadata: Metadata = {
  title: 'Best Dentist in Achamangalam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Achamangalam. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Achamangalam', 'dental clinic Achamangalam', 'Tirupattur dentist'],
}

export default function AchamangalamPage() {
  const distance = "68 km"

  const locationName = 'Achamangalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Achamangalam" city="Vellore" />
