...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Ussoor, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ussoor. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Ussoor', 'dental clinic Ussoor', 'Vellore dentist'],
}

export default function UssoorPage() {
  const distance = "13 km"

  const locationName = 'Ussoor'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632105' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632105" distance="13 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Ussoor" city="Vellore" />
