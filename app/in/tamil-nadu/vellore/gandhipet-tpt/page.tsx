...
export const metadata: Metadata = {
  title: 'Best Dentist in Gandhipet TPT, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gandhipet TPT. Dr. Rockson Samuel. PIN: 635601. Book: +91 70106 50063',
  keywords: ['dentist Gandhipet TPT', 'dental clinic Gandhipet TPT', 'Tirupathur dentist'],
}

export default function GandhipetTPTPage() {
  const distance = "65 km"

  const locationName = 'Gandhipet TPT'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gandhipet Tpt" city="Vellore" />
