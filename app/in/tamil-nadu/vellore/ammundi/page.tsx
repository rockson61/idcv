...
export const metadata: Metadata = {
  title: 'Best Dentist in Ammundi, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ammundi. Dr. Rockson Samuel. PIN: 632519. Book: +91 70106 50063',
  keywords: ['dentist Ammundi', 'dental clinic Ammundi', 'Walajapet dentist'],
}

export default function AmmundiPage() {
  const distance = "26 km"

  const locationName = 'Ammundi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ammundi" city="Vellore" />
