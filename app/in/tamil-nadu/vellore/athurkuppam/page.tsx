...
export const metadata: Metadata = {
  title: 'Best Dentist in Athurkuppam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Athurkuppam. Dr. Rockson Samuel. PIN: 635815. Book: +91 70106 50063',
  keywords: ['dentist Athurkuppam', 'dental clinic Athurkuppam', 'Tirupattur dentist'],
}

export default function AthurkuppamPage() {
  const distance = "68 km"

  const locationName = 'Athurkuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Athurkuppam" city="Vellore" />
