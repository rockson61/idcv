...
export const metadata: Metadata = {
  title: 'Best Dentist in Puttavaripalli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Puttavaripalli. Dr. Rockson Samuel. PIN: 632603. Book: +91 70106 50063',
  keywords: ['dentist Puttavaripalli', 'dental clinic Puttavaripalli', 'Gudiyattam dentist'],
}

export default function PuttavaripalliPage() {
  const distance = "46 km"

  const locationName = 'Puttavaripalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Puttavaripalli" city="Vellore" />
