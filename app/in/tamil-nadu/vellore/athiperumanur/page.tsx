...
export const metadata: Metadata = {
  title: 'Best Dentist in Athiperumanur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Athiperumanur. Dr. Rockson Samuel. PIN: 635852. Book: +91 70106 50063',
  keywords: ['dentist Athiperumanur', 'dental clinic Athiperumanur', 'Tirupathur dentist'],
}

export default function AthiperumanurPage() {
  const distance = "77 km"

  const locationName = 'Athiperumanur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635852' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635852" distance="77 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Athiperumanur" city="Vellore" />
