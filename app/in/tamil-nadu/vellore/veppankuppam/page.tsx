...
export const metadata: Metadata = {
  title: 'Best Dentist in Veppankuppam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Veppankuppam. Dr. Rockson Samuel. PIN: 632107. Book: +91 70106 50063',
  keywords: ['dentist Veppankuppam', 'dental clinic Veppankuppam', 'Vlr dentist'],
}

export default function VeppankuppamPage() {
  const distance = "14 km"

  const locationName = 'Veppankuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Veppankuppam" city="Vellore" />
