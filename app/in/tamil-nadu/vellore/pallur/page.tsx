...
export const metadata: Metadata = {
  title: 'Best Dentist in Pallur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pallur. Dr. Rockson Samuel. PIN: 631051. Book: +91 70106 50063',
  keywords: ['dentist Pallur', 'dental clinic Pallur', 'Arakkonam dentist'],
}

export default function PallurPage() {
  const distance = "38 km"

  const locationName = 'Pallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pallur" city="Vellore" />
