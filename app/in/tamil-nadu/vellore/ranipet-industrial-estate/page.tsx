...
export const metadata: Metadata = {
  title: 'Best Dentist in Ranipet Industrial Estate, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ranipet Industrial Estate, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Ranipet Industrial Estate', href: '/in/tamil-nadu/vellore/ranipet-industrial-estate' },
          ]}
        />
