...
export const metadata: Metadata = {
  title: 'Best Dentist in Ranipet Industrial Estate, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ranipet Industrial Estate. Dr. Rockson Samuel. PIN: 632403. Book: +91 70106 50063',
  keywords: ['dentist Ranipet Industrial Estate', 'dental clinic Ranipet Industrial Estate', 'Walajapet dentist'],
}

export default function RanipetIndustrialEstatePage() {
  const distance = "21 km"

  const locationName = 'Ranipet Industrial Estate'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '21 km', slug: '', travelTime: '31 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632403' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632403" distance="21 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="21 km" travelTime="31 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "21 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Ranipet Industrial Estate" city="Vellore" />
