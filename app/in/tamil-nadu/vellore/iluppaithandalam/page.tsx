...
export const metadata: Metadata = {
  title: 'Best Dentist in Iluppaithandalam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Iluppaithandalam. Dr. Rockson Samuel. PIN: 631151. Book: +91 70106 50063',
  keywords: ['dentist Iluppaithandalam', 'dental clinic Iluppaithandalam', 'Arakkonam dentist'],
}

export default function IluppaithandalamPage() {
  const distance = "40 km"

  const locationName = 'Iluppaithandalam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '40 km', slug: '', travelTime: '52 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631151' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631151" distance="40 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="40 km" travelTime="52 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "40 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Iluppaithandalam" city="Vellore" />
