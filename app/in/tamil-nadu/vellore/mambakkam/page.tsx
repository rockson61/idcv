...
export const metadata: Metadata = {
  title: 'Best Dentist in Mambakkam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mambakkam. Dr. Rockson Samuel. PIN: 632318. Book: +91 70106 50063',
  keywords: ['dentist Mambakkam', 'dental clinic Mambakkam', 'Arcot dentist'],
}

export default function MambakkamPage() {
  const locationName = 'Mambakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mambakkam" city="Vellore" />
