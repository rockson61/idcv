...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vaduganthangal, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vaduganthangal. Dr. Rockson Samuel. PIN: 632204. Book: +91 70106 50063',
  keywords: ['dentist Vaduganthangal', 'dental clinic Vaduganthangal', 'Vellore dentist'],
}

export default function VaduganthangalPage() {
  const distance = "18 km"

  const locationName = 'Vaduganthangal'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '18 km', slug: '', travelTime: '28 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632204' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632204" distance="18 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="18 km" travelTime="28 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "18 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vaduganthangal" city="Vellore" />
