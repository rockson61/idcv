...
export const metadata: Metadata = {
  title: 'Best Dentist in Vaduganthangal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vaduganthangal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Vaduganthangal', href: '/in/tamil-nadu/vellore/vaduganthangal' },
          ]}
        />
