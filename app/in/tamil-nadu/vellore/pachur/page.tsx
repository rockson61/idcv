...
export const metadata: Metadata = {
  title: 'Best Dentist in Pachur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pachur. Dr. Rockson Samuel. PIN: 635854. Book: +91 70106 50063',
  keywords: ['dentist Pachur', 'dental clinic Pachur', 'Tirupattur dentist'],
}

export default function PachurPage() {
  const distance = "78 km"

  const locationName = 'Pachur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pachur" city="Vellore" />
