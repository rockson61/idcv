...
export const metadata: Metadata = {
  title: 'Best Dentist in Sorakayalnatham, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sorakayalnatham. Dr. Rockson Samuel. PIN: 635854. Book: +91 70106 50063',
  keywords: ['dentist Sorakayalnatham', 'dental clinic Sorakayalnatham', 'Tirupattur dentist'],
}

export default function SorakayalnathamPage() {
  const distance = "78 km"

  const locationName = 'Sorakayalnatham'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '78 km', slug: '', travelTime: '1.8 hours', pincode: '632001' },
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635854' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635854" distance="78 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="78 km" travelTime="1.8 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "78 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Sorakayalnatham" city="Vellore" />
