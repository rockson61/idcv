...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Ambalur', href: '/in/tamil-nadu/vellore/ambalur' },
          ]}
        />
