...
export const metadata: Metadata = {
  title: 'Best Dentist in Mohamedpet, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mohamedpet. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Mohamedpet', 'dental clinic Mohamedpet', 'Arcot dentist'],
}

export default function MohamedpetPage() {
  const locationName = 'Mohamedpet'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '30 km', slug: '', travelTime: '43 minutes', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632512' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632512" distance="30 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="30 km" travelTime="43 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "30 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Mohamedpet" city="Vellore" />
