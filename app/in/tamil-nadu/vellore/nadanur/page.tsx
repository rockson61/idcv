...
export const metadata: Metadata = {
  title: 'Best Dentist in Nadanur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nadanur. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Nadanur', 'dental clinic Nadanur', 'Vlr dentist'],
}

export default function NadanurPage() {
  const locationName = 'Nadanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nadanur" city="Vellore" />
