...
export const metadata: Metadata = {
  title: 'Best Dentist in Kesavanankuppam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kesavanankuppam. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Kesavanankuppam', 'dental clinic Kesavanankuppam', 'Arakkonam dentist'],
}

export default function KesavanankuppamPage() {
  const distance = "40 km"

  const locationName = 'Kesavanankuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631102' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631102" distance="40 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kesavanankuppam" city="Vellore" />
