...
export const metadata: Metadata = {
  title: 'Best Dentist in Rachamangalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rachamangalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Rachamangalam', href: '/in/tamil-nadu/vellore/rachamangalam' },
          ]}
        />
