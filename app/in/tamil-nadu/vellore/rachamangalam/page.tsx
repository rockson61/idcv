...
export const metadata: Metadata = {
  title: 'Best Dentist in Rachamangalam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rachamangalam. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Rachamangalam', 'dental clinic Rachamangalam', 'Tirupattur dentist'],
}

export default function RachamangalamPage() {
  const distance = "67 km"

  const locationName = 'Rachamangalam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635653' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635653" distance="67 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Rachamangalam" city="Vellore" />
