...
export const metadata: Metadata = {
  title: 'Best Dentist in Melapudupakkam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melapudupakkam. Dr. Rockson Samuel. PIN: 632318. Book: +91 70106 50063',
  keywords: ['dentist Melapudupakkam', 'dental clinic Melapudupakkam', 'Arcot dentist'],
}

export default function MelapudupakkamPage() {
  const distance = "32 km"

  const locationName = 'Melapudupakkam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '32 km', slug: '', travelTime: '45 minutes', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632318' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632318" distance="32 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="32 km" travelTime="45 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "32 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Melapudupakkam" city="Vellore" />
