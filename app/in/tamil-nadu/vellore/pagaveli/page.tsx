...
export const metadata: Metadata = {
  title: 'Best Dentist in Pagaveli, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pagaveli. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Pagaveli', 'dental clinic Pagaveli', 'Wallajah dentist'],
}

export default function PagaveliPage() {
  const distance = "22 km"

  const locationName = 'Pagaveli'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '632508' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="632508" distance="22 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Pagaveli" city="Vellore" />
