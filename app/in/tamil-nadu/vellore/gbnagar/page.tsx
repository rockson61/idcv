...
export const metadata: Metadata = {
  title: 'Best Dentist in G.B.Nagar, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in G.B.Nagar. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist G.B.Nagar', 'dental clinic G.B.Nagar', 'Arcot dentist'],
}

export default function GBNagarPage() {
  const distance = "28 km"

  const locationName = 'G.B.Nagar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gbnagar" city="Vellore" />
