...
export const metadata: Metadata = {
  title: 'Best Dentist in Gbnagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gbnagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gbnagar'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Gbnagar', href: '/in/tamil-nadu/vellore/gbnagar' },
          ]}
        />
