...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudupettai, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pudupettai. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Pudupettai', 'dental clinic Pudupettai', 'Tirupathur dentist'],
}

export default function PudupettaiPage() {
  const distance = "68 km"

  const locationName = 'Pudupettai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pudupettai" city="Vellore" />
