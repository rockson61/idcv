...
export const metadata: Metadata = {
  title: 'Best Dentist in Kombai, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kombai. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Kombai', 'dental clinic Kombai', 'Tirupathur dentist'],
}

export default function KombaiPage() {
  const distance = "69 km"

  const locationName = 'Kombai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kombai" city="Vellore" />
