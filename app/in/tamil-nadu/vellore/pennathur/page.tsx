...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Pennathur, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pennathur. Dr. Rockson Samuel. PIN: 632058. Book: +91 70106 50063',
  keywords: ['dentist Pennathur', 'dental clinic Pennathur', 'Vellore dentist'],
}

export default function PennathurPage() {
  const distance = "12 km"

  const locationName = 'Pennathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pennathur" city="Vellore" />
