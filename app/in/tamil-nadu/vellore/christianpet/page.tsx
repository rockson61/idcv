...
export const metadata: Metadata = {
  title: 'Best Dentist in Christianpet, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Christianpet. Dr. Rockson Samuel. PIN: 632059. Book: +91 70106 50063',
  keywords: ['dentist Christianpet', 'dental clinic Christianpet', 'Vlr dentist'],
}

export default function ChristianpetPage() {
  const distance = "12 km"

  const locationName = 'Christianpet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Christianpet" city="Vellore" />
