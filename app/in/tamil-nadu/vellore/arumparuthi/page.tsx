...
export const metadata: Metadata = {
  title: 'Best Dentist in Arumparuthi, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arumparuthi. Dr. Rockson Samuel. PIN: 632106. Book: +91 70106 50063',
  keywords: ['dentist Arumparuthi', 'dental clinic Arumparuthi', 'Katpadi dentist'],
}

export default function ArumparuthiPage() {
  const distance = "12 km"

  const locationName = 'Arumparuthi'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632106' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632106" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Arumparuthi" city="Vellore" />
