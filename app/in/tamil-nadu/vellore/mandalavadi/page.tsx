...
export const metadata: Metadata = {
  title: 'Best Dentist in Mandalavadi, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mandalavadi. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Mandalavadi', 'dental clinic Mandalavadi', 'Tirupattur dentist'],
}

export default function MandalavadiPage() {
  const locationName = 'Mandalavadi'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635851' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635851" distance="80 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Mandalavadi" city="Vellore" />
