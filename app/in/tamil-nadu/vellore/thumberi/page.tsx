...
export const metadata: Metadata = {
  title: 'Best Dentist in Thumberi, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thumberi. Dr. Rockson Samuel. PIN: 635754. Book: +91 70106 50063',
  keywords: ['dentist Thumberi', 'dental clinic Thumberi', 'Vaniyambadi dentist'],
}

export default function ThumberiPage() {
  const distance = "56 km"

  const locationName = 'Thumberi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thumberi" city="Vellore" />
