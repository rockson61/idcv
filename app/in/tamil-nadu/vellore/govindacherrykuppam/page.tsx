...
export const metadata: Metadata = {
  title: 'Best Dentist in Govindacherrykuppam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Govindacherrykuppam. Dr. Rockson Samuel. PIN: 632505. Book: +91 70106 50063',
  keywords: ['dentist Govindacherrykuppam', 'dental clinic Govindacherrykuppam', 'Arakkonam dentist'],
}

export default function GovindacherrykuppamPage() {
  const distance = "36 km"

  const locationName = 'Govindacherrykuppam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '36 km', slug: '', travelTime: '48 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '632505' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="632505" distance="36 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="36 km" travelTime="48 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "36 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Govindacherrykuppam" city="Vellore" />
