...
export const metadata: Metadata = {
  title: 'Best Dentist in Thirumalaicheryy, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thirumalaicheryy. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Thirumalaicheryy', 'dental clinic Thirumalaicheryy', 'Walajapet dentist'],
}

export default function ThirumalaicheryyPage() {
  const distance = "23 km"

  const locationName = 'Thirumalaicheryy'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thirumalaicheryy" city="Vellore" />
