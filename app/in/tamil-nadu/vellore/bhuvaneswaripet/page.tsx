...
export const metadata: Metadata = {
  title: 'Best Dentist in Bhuvaneswaripet, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Bhuvaneswaripet. Dr. Rockson Samuel. PIN: 632602. Book: +91 70106 50063',
  keywords: ['dentist Bhuvaneswaripet', 'dental clinic Bhuvaneswaripet', 'Gudiyatham dentist'],
}

export default function BhuvaneswaripetPage() {
  const distance = "45 km"

  const locationName = 'Bhuvaneswaripet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Bhuvaneswaripet" city="Vellore" />
