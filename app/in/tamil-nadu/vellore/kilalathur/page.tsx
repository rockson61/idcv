...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilalathur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilalathur. Dr. Rockson Samuel. PIN: 635803. Book: +91 70106 50063',
  keywords: ['dentist Kilalathur', 'dental clinic Kilalathur', 'Gudiyattam dentist'],
}

export default function KilalathurPage() {
  const distance = "46 km"

  const locationName = 'Kilalathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilalathur" city="Vellore" />
