...
export const metadata: Metadata = {
  title: 'Best Dentist in Rendadi, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rendadi. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Rendadi', 'dental clinic Rendadi', 'Arakkonam dentist'],
}

export default function RendadiPage() {
  const distance = "40 km"

  const locationName = 'Rendadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Rendadi" city="Vellore" />
