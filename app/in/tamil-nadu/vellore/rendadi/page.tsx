...
export const metadata: Metadata = {
  title: 'Best Dentist in Rendadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rendadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Rendadi', href: '/in/tamil-nadu/vellore/rendadi' },
          ]}
        />
