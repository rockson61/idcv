...
export const metadata: Metadata = {
  title: 'Best Dentist in Pinnathurai, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pinnathurai. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Pinnathurai', 'dental clinic Pinnathurai', 'Vlr dentist'],
}

export default function PinnathuraiPage() {
  const locationName = 'Pinnathurai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pinnathurai" city="Vellore" />
