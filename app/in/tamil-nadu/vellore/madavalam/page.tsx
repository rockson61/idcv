...
export const metadata: Metadata = {
  title: 'Best Dentist in Madavalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Madavalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Madavalam', href: '/in/tamil-nadu/vellore/madavalam' },
          ]}
        />
