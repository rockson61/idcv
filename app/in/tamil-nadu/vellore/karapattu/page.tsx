...
export const metadata: Metadata = {
  title: 'Best Dentist in Karapattu, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karapattu. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Karapattu', 'dental clinic Karapattu', 'Gudiyattam dentist'],
}

export default function KarapattuPage() {
  const distance = "60 km"

  const locationName = 'Karapattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karapattu" city="Vellore" />
