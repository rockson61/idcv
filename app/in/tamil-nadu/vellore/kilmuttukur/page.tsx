...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilmuttukur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilmuttukur. Dr. Rockson Samuel. PIN: 632204. Book: +91 70106 50063',
  keywords: ['dentist Kilmuttukur', 'dental clinic Kilmuttukur', 'Vlr dentist'],
}

export default function KilmuttukurPage() {
  const locationName = 'Kilmuttukur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilmuttukur" city="Vellore" />
