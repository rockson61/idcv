...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumapattu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumapattu. Dr. Rockson Samuel. PIN: 635702. Book: +91 70106 50063',
  keywords: ['dentist Perumapattu', 'dental clinic Perumapattu', 'Tirupattur dentist'],
}

export default function PerumapattuPage() {
  const locationName = 'Perumapattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Perumapattu" city="Vellore" />
