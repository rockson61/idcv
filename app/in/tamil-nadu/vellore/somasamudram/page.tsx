...
export const metadata: Metadata = {
  title: 'Best Dentist in Somasamudram, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Somasamudram. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Somasamudram', 'dental clinic Somasamudram', 'Arakkonam dentist'],
}

export default function SomasamudramPage() {
  const distance = "40 km"

  const locationName = 'Somasamudram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Somasamudram" city="Vellore" />
