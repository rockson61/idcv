...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajapalayam, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rajapalayam. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Rajapalayam', 'dental clinic Rajapalayam', 'Tirupathur dentist'],
}

export default function RajapalayamPage() {
  const distance = "67 km"

  const locationName = 'Rajapalayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Rajapalayam" city="Vellore" />
