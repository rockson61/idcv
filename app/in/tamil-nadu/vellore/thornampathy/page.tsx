...
export const metadata: Metadata = {
  title: 'Best Dentist in Thornampathy, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thornampathy. Dr. Rockson Samuel. PIN: 635602. Book: +91 70106 50063',
  keywords: ['dentist Thornampathy', 'dental clinic Thornampathy', 'Tirupathur dentist'],
}

export default function ThornampathyPage() {
  const distance = "66 km"

  const locationName = 'Thornampathy'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thornampathy" city="Vellore" />
