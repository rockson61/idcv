...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvalluvar University, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvalluvar University, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Thiruvalluvar University', href: '/in/tamil-nadu/vellore/thiruvalluvar-university' },
          ]}
        />
