...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvalluvar University, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thiruvalluvar University. Dr. Rockson Samuel. PIN: 632115. Book: +91 70106 50063',
  keywords: ['dentist Thiruvalluvar University', 'dental clinic Thiruvalluvar University', 'Katpadi dentist'],
}

export default function ThiruvalluvarUniversityPage() {
  const locationName = 'Thiruvalluvar University'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632115' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632115" distance="17 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Thiruvalluvar University" city="Vellore" />
