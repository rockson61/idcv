...
export const metadata: Metadata = {
  title: 'Best Dentist in Keerasathu, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Keerasathu. Dr. Rockson Samuel. PIN: 632514. Book: +91 70106 50063',
  keywords: ['dentist Keerasathu', 'dental clinic Keerasathu', 'Katpadi dentist'],
}

export default function KeerasathuPage() {
  const locationName = 'Keerasathu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Keerasathu" city="Vellore" />
