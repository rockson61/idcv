...
export const metadata: Metadata = {
  title: 'Best Dentist in Uppupettai, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Uppupettai. Dr. Rockson Samuel. PIN: 632521. Book: +91 70106 50063',
  keywords: ['dentist Uppupettai', 'dental clinic Uppupettai', 'Arcot dentist'],
}

export default function UppupettaiPage() {
  const locationName = 'Uppupettai'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '33 km', slug: '', travelTime: '46 minutes', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632521' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632521" distance="33 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="33 km" travelTime="46 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "33 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Uppupettai" city="Vellore" />
