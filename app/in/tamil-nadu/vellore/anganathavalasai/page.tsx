...
export const metadata: Metadata = {
  title: 'Best Dentist in Anganathavalasai, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Anganathavalasai. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Anganathavalasai', 'dental clinic Anganathavalasai', 'Tirupattur dentist'],
}

export default function AnganathavalasaiPage() {
  const distance = "67 km"

  const locationName = 'Anganathavalasai'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '67 km', slug: '', travelTime: '1.6 hours', pincode: '632001' },
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635652' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635652" distance="67 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="67 km" travelTime="1.6 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "67 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Anganathavalasai" city="Vellore" />
