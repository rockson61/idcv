...
export const metadata: Metadata = {
  title: 'Best Dentist in Mandarakuttai, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mandarakuttai. Dr. Rockson Samuel. PIN: 635701. Book: +91 70106 50063',
  keywords: ['dentist Mandarakuttai', 'dental clinic Mandarakuttai', 'Vaniyambadi dentist'],
}

export default function MandarakuttaiPage() {
  const distance = "60 km"

  const locationName = 'Mandarakuttai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mandarakuttai" city="Vellore" />
