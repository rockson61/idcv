...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambur Bazaar, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ambur Bazaar. Dr. Rockson Samuel. PIN: 635802. Book: +91 70106 50063',
  keywords: ['dentist Ambur Bazaar', 'dental clinic Ambur Bazaar', 'Vaniyambadi dentist'],
}

export default function AmburBazaarPage() {
  const distance = "58 km"

  const locationName = 'Ambur Bazaar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ambur Bazaar" city="Vellore" />
