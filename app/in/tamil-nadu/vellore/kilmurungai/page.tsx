...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilmurungai, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilmurungai. Dr. Rockson Samuel. PIN: 635812. Book: +91 70106 50063',
  keywords: ['dentist Kilmurungai', 'dental clinic Kilmurungai', 'Vaniyambadi dentist'],
}

export default function KilmurungaiPage() {
  const distance = "60 km"

  const locationName = 'Kilmurungai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635812' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635812" distance="60 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kilmurungai" city="Vellore" />
