...
export const metadata: Metadata = {
  title: 'Best Dentist in Ariyur Spinning Mills, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ariyur Spinning Mills, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Ariyur Spinning Mills', href: '/in/tamil-nadu/vellore/ariyur-spinning-mills' },
          ]}
        />
