...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Ariyur Spinning Mills, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ariyur Spinning Mills. Dr. Rockson Samuel. PIN: 632055. Book: +91 70106 50063',
  keywords: ['dentist Ariyur Spinning Mills', 'dental clinic Ariyur Spinning Mills', 'Vellore dentist'],
}

export default function AriyurSpinningMillsPage() {
  const distance = "11 km"

  const locationName = 'Ariyur Spinning Mills'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '11 km', slug: '', travelTime: '21 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632055' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632055" distance="11 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="11 km" travelTime="21 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "11 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Ariyur Spinning Mills" city="Vellore" />
