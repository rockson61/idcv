...
export const metadata: Metadata = {
  title: 'Best Dentist in Agaramcherry, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Agaramcherry. Dr. Rockson Samuel. PIN: 635804. Book: +91 70106 50063',
  keywords: ['dentist Agaramcherry', 'dental clinic Agaramcherry', 'Vaniyambadi dentist'],
}

export default function AgaramcherryPage() {
  const distance = "57 km"

  const locationName = 'Agaramcherry'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Agaramcherry" city="Vellore" />
