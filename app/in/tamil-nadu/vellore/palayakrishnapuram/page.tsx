...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayakrishnapuram, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palayakrishnapuram. Dr. Rockson Samuel. PIN: 632209. Book: +91 70106 50063',
  keywords: ['dentist Palayakrishnapuram', 'dental clinic Palayakrishnapuram', 'Katpadi dentist'],
}

export default function PalayakrishnapuramPage() {
  const distance = "19 km"

  const locationName = 'Palayakrishnapuram'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '19 km', slug: '', travelTime: '29 minutes', pincode: '632001' },
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632209' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632209" distance="19 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="19 km" travelTime="29 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "19 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Palayakrishnapuram" city="Vellore" />
