...
export const metadata: Metadata = {
  title: 'Best Dentist in Valayalkarapatti, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Valayalkarapatti. Dr. Rockson Samuel. PIN: 635804. Book: +91 70106 50063',
  keywords: ['dentist Valayalkarapatti', 'dental clinic Valayalkarapatti', 'Vaniyambadi dentist'],
}

export default function ValayalkarapattiPage() {
  const distance = "57 km"

  const locationName = 'Valayalkarapatti'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '57 km', slug: '', travelTime: '1.3 hours', pincode: '632001' },
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635804' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635804" distance="57 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="57 km" travelTime="1.3 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "57 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Valayalkarapatti" city="Vellore" />
