...
export const metadata: Metadata = {
  title: 'Best Dentist in Somanaickenpatti, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Somanaickenpatti. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Somanaickenpatti', 'dental clinic Somanaickenpatti', 'Tirupathur dentist'],
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Somanaickenpatti" city="Vellore" />
