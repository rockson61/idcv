...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudalur, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gudalur. Dr. Rockson Samuel. PIN: 632510. Book: +91 70106 50063',
  keywords: ['dentist Gudalur', 'dental clinic Gudalur', 'Arakonam dentist'],
}

export default function GudalurPage() {
  const distance = "38 km"

  const locationName = 'Gudalur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '632510' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="632510" distance="38 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Gudalur" city="Vellore" />
