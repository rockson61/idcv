...
export const metadata: Metadata = {
  title: 'Best Dentist in Vadapudupet, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vadapudupet. Dr. Rockson Samuel. PIN: 635812. Book: +91 70106 50063',
  keywords: ['dentist Vadapudupet', 'dental clinic Vadapudupet', 'Vaniyambadi dentist'],
}

export default function VadapudupetPage() {
  const distance = "60 km"

  const locationName = 'Vadapudupet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vadapudupet" city="Vellore" />
