...
export const metadata: Metadata = {
  title: 'Best Dentist in Kosapettai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kosapettai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kosapettai'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Kosapettai', href: '/in/tamil-nadu/vellore/kosapettai' },
          ]}
        />
