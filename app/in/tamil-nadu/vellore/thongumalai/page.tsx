...
export const metadata: Metadata = {
  title: 'Best Dentist in Thongumalai, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thongumalai. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Thongumalai', 'dental clinic Thongumalai', 'Vlr dentist'],
}

export default function ThongumalaiPage() {
  const locationName = 'Thongumalai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thongumalai" city="Vellore" />
