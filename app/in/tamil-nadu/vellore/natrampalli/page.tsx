...
export const metadata: Metadata = {
  title: 'Best Dentist in Natrampalli, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Natrampalli. Dr. Rockson Samuel. PIN: 635852. Book: +91 70106 50063',
  keywords: ['dentist Natrampalli', 'dental clinic Natrampalli', 'Tirupathur dentist'],
}

export default function NatrampalliPage() {
  const distance = "75 km"

  const locationName = 'Natrampalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635852" distance="75 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Natrampalli" city="Vellore" />
