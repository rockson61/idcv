...
export const metadata: Metadata = {
  title: 'Best Dentist in Seekarajapuram, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Seekarajapuram. Dr. Rockson Samuel. PIN: 632515. Book: +91 70106 50063',
  keywords: ['dentist Seekarajapuram', 'dental clinic Seekarajapuram', 'Wallajah dentist'],
}

export default function SeekarajapuramPage() {
  const locationName = 'Seekarajapuram'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '25 km', slug: '', travelTime: '37 minutes', pincode: '632001' },
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '632515' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="632515" distance="25 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="25 km" travelTime="37 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "25 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Seekarajapuram" city="Vellore" />
