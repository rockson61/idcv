...
export const metadata: Metadata = {
  title: 'Best Dentist in Panaiyur, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Panaiyur. Dr. Rockson Samuel. PIN: 632518. Book: +91 70106 50063',
  keywords: ['dentist Panaiyur', 'dental clinic Panaiyur', 'Arakonam dentist'],
}

export default function PanaiyurPage() {
  const distance = "26 km"

  const locationName = 'Panaiyur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '632518' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="632518" distance="26 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Panaiyur" city="Vellore" />
