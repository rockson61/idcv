...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumpalli, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumpalli. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Perumpalli', 'dental clinic Perumpalli', 'Tirupathur dentist'],
}

export default function PerumpalliPage() {
  const distance = "69 km"

  const locationName = 'Perumpalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Perumpalli" city="Vellore" />
