...
export const metadata: Metadata = {
  title: 'Best Dentist in Kondapalayam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kondapalayam. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Kondapalayam', 'dental clinic Kondapalayam', 'Arakkonam dentist'],
}

export default function KondapalayamPage() {
  const locationName = 'Kondapalayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kondapalayam" city="Vellore" />
