...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore Collectorate, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Collectorate. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist Vellore Collectorate', 'dental clinic Vellore Collectorate', 'Vellore dentist'],
}

export default function VelloreCollectoratePage() {
  const distance = "3 km"

  const locationName = 'Vellore Collectorate'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '3 km', slug: '', travelTime: '10 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632004' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632004" distance="3 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="3 km" travelTime="10 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "3 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vellore Collectorate" city="Vellore" />
