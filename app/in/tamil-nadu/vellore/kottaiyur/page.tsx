...
export const metadata: Metadata = {
  title: 'Best Dentist in Kottaiyur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kottaiyur. Dr. Rockson Samuel. PIN: 635853. Book: +91 70106 50063',
  keywords: ['dentist Kottaiyur', 'dental clinic Kottaiyur', 'Tirupathur dentist'],
}

export default function KottaiyurPage() {
  const distance = "77 km"

  const locationName = 'Kottaiyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kottaiyur" city="Vellore" />
