...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadaperi, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kadaperi. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Kadaperi', 'dental clinic Kadaperi', 'Walajapet dentist'],
}

export default function KadaperiPage() {
  const distance = "22 km"

  const locationName = 'Kadaperi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kadaperi" city="Vellore" />
