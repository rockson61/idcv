...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruparkadal, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thiruparkadal. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Thiruparkadal', 'dental clinic Thiruparkadal', 'Walajapet dentist'],
}

export default function ThiruparkadalPage() {
  const distance = "22 km"

  const locationName = 'Thiruparkadal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thiruparkadal" city="Vellore" />
