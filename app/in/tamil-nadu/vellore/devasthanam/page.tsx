...
export const metadata: Metadata = {
  title: 'Best Dentist in Devasthanam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Devasthanam. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Devasthanam', 'dental clinic Devasthanam', 'Vaniyambadi dentist'],
}

export default function DevasthanamPage() {
  const distance = "55 km"

  const locationName = 'Devasthanam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Devasthanam" city="Vellore" />
