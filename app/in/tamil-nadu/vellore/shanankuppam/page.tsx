...
export const metadata: Metadata = {
  title: 'Best Dentist in Shanankuppam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Shanankuppam. Dr. Rockson Samuel. PIN: 635814. Book: +91 70106 50063',
  keywords: ['dentist Shanankuppam', 'dental clinic Shanankuppam', 'Vaniyambadi dentist'],
}

export default function ShanankuppamPage() {
  const distance = "59 km"

  const locationName = 'Shanankuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Shanankuppam" city="Vellore" />
