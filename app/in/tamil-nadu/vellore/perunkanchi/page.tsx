...
export const metadata: Metadata = {
  title: 'Best Dentist in Perunkanchi, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perunkanchi. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Perunkanchi', 'dental clinic Perunkanchi', 'Arakkonam dentist'],
}

export default function PerunkanchiPage() {
  const distance = "40 km"

  const locationName = 'Perunkanchi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Perunkanchi" city="Vellore" />
