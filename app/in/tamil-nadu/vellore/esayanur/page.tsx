...
export const metadata: Metadata = {
  title: 'Best Dentist in Esayanur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Esayanur. Dr. Rockson Samuel. PIN: 632511. Book: +91 70106 50063',
  keywords: ['dentist Esayanur', 'dental clinic Esayanur', 'Arcot dentist'],
}

export default function EsayanurPage() {
  const distance = "29 km"

  const locationName = 'Esayanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Esayanur" city="Vellore" />
