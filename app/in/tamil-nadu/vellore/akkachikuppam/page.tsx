...
export const metadata: Metadata = {
  title: 'Best Dentist in Akkachikuppam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Akkachikuppam. Dr. Rockson Samuel. PIN: 632510. Book: +91 70106 50063',
  keywords: ['dentist Akkachikuppam', 'dental clinic Akkachikuppam', 'Arakkonam dentist'],
}

export default function AkkachikuppamPage() {
  const distance = "38 km"

  const locationName = 'Akkachikuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '632510' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="632510" distance="38 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Akkachikuppam" city="Vellore" />
