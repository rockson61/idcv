...
export const metadata: Metadata = {
  title: 'Best Dentist in Agaram Tpt, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Agaram Tpt, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Agaram Tpt', href: '/in/tamil-nadu/vellore/agaram-tpt' },
          ]}
        />
