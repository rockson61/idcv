...
export const metadata: Metadata = {
  title: 'Best Dentist in Agaram TPT, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Agaram TPT. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Agaram TPT', 'dental clinic Agaram TPT', 'Tirupathur dentist'],
}

export default function AgaramTPTPage() {
  const distance = "67 km"

  const locationName = 'Agaram TPT'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Agaram Tpt" city="Vellore" />
