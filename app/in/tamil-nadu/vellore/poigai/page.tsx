...
export const metadata: Metadata = {
  title: 'Best Dentist in Poigai, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Poigai. Dr. Rockson Samuel. PIN: 632114. Book: +91 70106 50063',
  keywords: ['dentist Poigai', 'dental clinic Poigai', 'Vlr dentist'],
}

export default function PoigaiPage() {
  const distance = "17 km"

  const locationName = 'Poigai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Poigai" city="Vellore" />
