...
export const metadata: Metadata = {
  title: 'Best Dentist in Paniyandapalli, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Paniyandapalli. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Paniyandapalli', 'dental clinic Paniyandapalli', 'Tirupattur dentist'],
}

export default function PaniyandapalliPage() {
  const distance = "68 km"

  const locationName = 'Paniyandapalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Paniyandapalli" city="Vellore" />
