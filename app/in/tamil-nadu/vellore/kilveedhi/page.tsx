...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilveedhi, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilveedhi. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Kilveedhi', 'dental clinic Kilveedhi', 'Arakkonam dentist'],
}

export default function KilveedhiPage() {
  const distance = "35 km"

  const locationName = 'Kilveedhi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilveedhi" city="Vellore" />
