...
export const metadata: Metadata = {
  title: 'Best Dentist in Eachangal, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Eachangal. Dr. Rockson Samuel. PIN: 635801. Book: +91 70106 50063',
  keywords: ['dentist Eachangal', 'dental clinic Eachangal', 'Vaniyambadi dentist'],
}

export default function EachangalPage() {
  const distance = "56 km"

  const locationName = 'Eachangal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Eachangal" city="Vellore" />
