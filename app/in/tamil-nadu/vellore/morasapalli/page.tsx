...
export const metadata: Metadata = {
  title: 'Best Dentist in Morasapalli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Morasapalli. Dr. Rockson Samuel. PIN: 635810. Book: +91 70106 50063',
  keywords: ['dentist Morasapalli', 'dental clinic Morasapalli', 'Gudiyattam dentist'],
}

export default function MorasapalliPage() {
  const distance = "48 km"

  const locationName = 'Morasapalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Morasapalli" city="Vellore" />
