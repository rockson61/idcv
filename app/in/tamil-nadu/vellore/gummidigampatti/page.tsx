...
export const metadata: Metadata = {
  title: 'Best Dentist in Gummidigampatti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gummidigampatti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Gummidigampatti', href: '/in/tamil-nadu/vellore/gummidigampatti' },
          ]}
        />
