...
export const metadata: Metadata = {
  title: 'Best Dentist in Walajapet, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Walajapet. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Walajapet', 'dental clinic Walajapet', 'Wallajah dentist'],
}

export default function WalajapetPage() {
  const distance = "18 km"

  const locationName = 'Walajapet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Walajapet" city="Vellore" />
