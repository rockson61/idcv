...
export const metadata: Metadata = {
  title: 'Best Dentist in Mudinampattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mudinampattu. Dr. Rockson Samuel. PIN: 632204. Book: +91 70106 50063',
  keywords: ['dentist Mudinampattu', 'dental clinic Mudinampattu', 'Vlr dentist'],
}

export default function MudinampattuPage() {
  const distance = "18 km"

  const locationName = 'Mudinampattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632204' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632204" distance="18 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Mudinampattu" city="Vellore" />
