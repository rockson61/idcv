...
export const metadata: Metadata = {
  title: 'Best Dentist in Mazharyur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mazharyur. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Mazharyur', 'dental clinic Mazharyur', 'Arcot dentist'],
}

export default function MazharyurPage() {
  const distance = "28 km"

  const locationName = 'Mazharyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mazharyur" city="Vellore" />
