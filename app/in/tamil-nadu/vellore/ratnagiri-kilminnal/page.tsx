...
export const metadata: Metadata = {
  title: 'Best Dentist in Ratnagiri Kilminnal, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ratnagiri Kilminnal. Dr. Rockson Samuel. PIN: 632517. Book: +91 70106 50063',
  keywords: ['dentist Ratnagiri Kilminnal', 'dental clinic Ratnagiri Kilminnal', 'Walajapet dentist'],
}

export default function RatnagiriKilminnalPage() {
  const distance = "24 km"

  const locationName = 'Ratnagiri Kilminnal'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '24 km', slug: '', travelTime: '36 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632517' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632517" distance="24 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="24 km" travelTime="36 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Ratnagiri Kilminnal" city="Vellore" />
