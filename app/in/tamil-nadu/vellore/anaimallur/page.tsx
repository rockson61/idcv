...
export const metadata: Metadata = {
  title: 'Best Dentist in Anaimallur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Anaimallur. Dr. Rockson Samuel. PIN: 632507. Book: +91 70106 50063',
  keywords: ['dentist Anaimallur', 'dental clinic Anaimallur', 'Arcot dentist'],
}

export default function AnaimallurPage() {
  const distance = "27 km"

  const locationName = 'Anaimallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Anaimallur" city="Vellore" />
