...
export const metadata: Metadata = {
  title: 'Best Dentist in Valathoor, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Valathoor. Dr. Rockson Samuel. PIN: 635813. Book: +91 70106 50063',
  keywords: ['dentist Valathoor', 'dental clinic Valathoor', 'Gudiyattam dentist'],
}

export default function ValathoorPage() {
  const distance = "49 km"

  const locationName = 'Valathoor'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Valathoor" city="Vellore" />
