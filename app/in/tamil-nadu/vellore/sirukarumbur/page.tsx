...
export const metadata: Metadata = {
  title: 'Best Dentist in Sirukarumbur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sirukarumbur. Dr. Rockson Samuel. PIN: 632531. Book: +91 70106 50063',
  keywords: ['dentist Sirukarumbur', 'dental clinic Sirukarumbur', 'Arakkonam dentist'],
}

export default function SirukarumburPage() {
  const distance = "42 km"

  const locationName = 'Sirukarumbur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sirukarumbur" city="Vellore" />
