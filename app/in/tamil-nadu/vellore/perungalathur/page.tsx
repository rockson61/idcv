...
export const metadata: Metadata = {
  title: 'Best Dentist in Perungalathur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perungalathur. Dr. Rockson Samuel. PIN: 631003. Book: +91 70106 50063',
  keywords: ['dentist Perungalathur', 'dental clinic Perungalathur', 'Arakkonam dentist'],
}

export default function PerungalathurPage() {
  const distance = "37 km"

  const locationName = 'Perungalathur'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '37 km', slug: '', travelTime: '49 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631003' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631003" distance="37 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="37 km" travelTime="49 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "37 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Perungalathur" city="Vellore" />
