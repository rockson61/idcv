...
export const metadata: Metadata = {
  title: 'Best Dentist in Paradarami Gudiyattam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Paradarami Gudiyattam. Dr. Rockson Samuel. PIN: 632603. Book: +91 70106 50063',
  keywords: ['dentist Paradarami Gudiyattam', 'dental clinic Paradarami Gudiyattam', 'Gudiyattam dentist'],
}

export default function ParadaramiGudiyattamPage() {
  const distance = "46 km"

  const locationName = 'Paradarami Gudiyattam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '46 km', slug: '', travelTime: '1 hour', pincode: '632001' },
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '632603' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="632603" distance="46 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="46 km" travelTime="1 hour" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "46 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Paradarami Gudiyattam" city="Vellore" />
