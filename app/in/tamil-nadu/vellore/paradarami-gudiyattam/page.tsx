...
export const metadata: Metadata = {
  title: 'Best Dentist in Paradarami Gudiyattam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Paradarami Gudiyattam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Paradarami Gudiyattam', href: '/in/tamil-nadu/vellore/paradarami-gudiyattam' },
          ]}
        />
