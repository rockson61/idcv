...
export const metadata: Metadata = {
  title: 'Best Dentist in Dharanampet, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Dharanampet. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Dharanampet', 'dental clinic Dharanampet', 'Gudiyatham dentist'],
}

export default function DharanampetPage() {
  const distance = "45 km"

  const locationName = 'Dharanampet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Dharanampet" city="Vellore" />
