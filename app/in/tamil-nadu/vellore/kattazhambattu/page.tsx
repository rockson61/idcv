...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kattazhambattu, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kattazhambattu. Dr. Rockson Samuel. PIN: 632312. Book: +91 70106 50063',
  keywords: ['dentist Kattazhambattu', 'dental clinic Kattazhambattu', 'Vellore dentist'],
}

export default function KattazhambattuPage() {
  const locationName = 'Kattazhambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kattazhambattu" city="Vellore" />
