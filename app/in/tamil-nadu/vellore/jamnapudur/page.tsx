...
export const metadata: Metadata = {
  title: 'Best Dentist in Jamnapudur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jamnapudur. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Jamnapudur', 'dental clinic Jamnapudur', 'Tirupathur dentist'],
}

export default function JamnapudurPage() {
  const distance = "67 km"

  const locationName = 'Jamnapudur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635652' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635652" distance="67 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Jamnapudur" city="Vellore" />
