...
export const metadata: Metadata = {
  title: 'Best Dentist in CMC H, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in CMC H. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist CMC H', 'dental clinic CMC H', 'Vellore dentist'],
}

export default function CMCHPage() {
  const locationName = 'CMC H'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Cmc H" city="Vellore" />
