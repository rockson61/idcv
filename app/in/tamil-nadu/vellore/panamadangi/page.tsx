...
export const metadata: Metadata = {
  title: 'Best Dentist in Panamadangi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Panamadangi. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Panamadangi', 'dental clinic Panamadangi', 'Vlr dentist'],
}

export default function PanamadangiPage() {
  const locationName = 'Panamadangi'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632202' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632202" distance="17 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Panamadangi" city="Vellore" />
