...
export const metadata: Metadata = {
  title: 'Best Dentist in Periyakonapattu, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periyakonapattu. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Periyakonapattu', 'dental clinic Periyakonapattu', 'Tirupathur dentist'],
}

export default function PeriyakonapattuPage() {
  const distance = "68 km"

  const locationName = 'Periyakonapattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635651' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635651" distance="68 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Periyakonapattu" city="Vellore" />
