...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilveeranam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilveeranam. Dr. Rockson Samuel. PIN: 632505. Book: +91 70106 50063',
  keywords: ['dentist Kilveeranam', 'dental clinic Kilveeranam', 'Arakkonam dentist'],
}

export default function KilveeranamPage() {
  const distance = "36 km"

  const locationName = 'Kilveeranam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilveeranam" city="Vellore" />
