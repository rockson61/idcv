...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumalkuppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumalkuppam. Dr. Rockson Samuel. PIN: 632520. Book: +91 70106 50063',
  keywords: ['dentist Perumalkuppam', 'dental clinic Perumalkuppam', 'Katpadi dentist'],
}

export default function PerumalkuppamPage() {
  const distance = "14 km"

  const locationName = 'Perumalkuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632520' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632520" distance="14 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Perumalkuppam" city="Vellore" />
