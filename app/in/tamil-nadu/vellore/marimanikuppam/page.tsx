...
export const metadata: Metadata = {
  title: 'Best Dentist in Marimanikuppam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Marimanikuppam. Dr. Rockson Samuel. PIN: 635710. Book: +91 70106 50063',
  keywords: ['dentist Marimanikuppam', 'dental clinic Marimanikuppam', 'Tirupattur dentist'],
}

export default function MarimanikuppamPage() {
  const distance = "59 km"

  const locationName = 'Marimanikuppam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '59 km', slug: '', travelTime: '1.4 hours', pincode: '632001' },
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635710' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635710" distance="59 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="59 km" travelTime="1.4 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "59 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Marimanikuppam" city="Vellore" />
