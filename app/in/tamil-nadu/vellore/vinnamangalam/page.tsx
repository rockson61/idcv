...
export const metadata: Metadata = {
  title: 'Best Dentist in Vinnamangalam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vinnamangalam. Dr. Rockson Samuel. PIN: 635807. Book: +91 70106 50063',
  keywords: ['dentist Vinnamangalam', 'dental clinic Vinnamangalam', 'Vaniyambadi dentist'],
}

export default function VinnamangalamPage() {
  const distance = "58 km"

  const locationName = 'Vinnamangalam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635807' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635807" distance="58 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Vinnamangalam" city="Vellore" />
