...
export const metadata: Metadata = {
  title: 'Best Dentist in Nachiarkuppam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nachiarkuppam. Dr. Rockson Samuel. PIN: 635710. Book: +91 70106 50063',
  keywords: ['dentist Nachiarkuppam', 'dental clinic Nachiarkuppam', 'Tirupattur dentist'],
}

export default function NachiarkuppamPage() {
  const distance = "59 km"

  const locationName = 'Nachiarkuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nachiarkuppam" city="Vellore" />
