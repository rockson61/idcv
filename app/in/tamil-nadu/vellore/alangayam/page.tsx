...
export const metadata: Metadata = {
  title: 'Best Dentist in Alangayam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Alangayam. Dr. Rockson Samuel. PIN: 635701. Book: +91 70106 50063',
  keywords: ['dentist Alangayam', 'dental clinic Alangayam', 'Vaniyambadi dentist'],
}

export default function AlangayamPage() {
  const locationName = 'Alangayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Alangayam" city="Vellore" />
