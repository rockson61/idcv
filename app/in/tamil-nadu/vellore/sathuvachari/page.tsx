...
export const metadata: Metadata = {
  title: 'Best Dentist in Sathuvachari, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sathuvachari, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sathuvachari'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
