...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Sathuvachari, Vellore | Indira Dental Clinic',
  description: 'Expert dental services in Sathuvachari, Vellore. RCT, dental implants, braces, cosmetic dentistry by Dr. Rockson Samuel.',
  keywords: ['dentist Sathuvachari', 'dental clinic Sathuvachari Vellore', 'dental services Sathuvachari', 'best dentist Sathuvachari'],
}
...
export default function SathuvachariPage() {
  ...
  const faqs = [
    {
      question: 'Where is the best dental clinic near Sathuvachari?',
      answer: 'Indira Dental Clinic in Gandhi Nagar, Vellore is the best choice for Sathuvachari residents, offering comprehensive dental services with modern equipment and experienced dentists.'
    },
    {
      question: 'How much does dental treatment cost in Sathuvachari area?',
      answer: 'At Indira Dental Clinic serving Sathuvachari, root canal treatment costs ₹3,000-8,000, dental implants ₹25,000-45,000, and braces ₹30,000-80,000. We offer transparent pricing with no hidden costs.'
    },
    {
      question: 'Who is the best dentist for Sathuvachari patients?',
      answer: 'Dr. Rockson Samuel at Indira Dental Clinic in Vellore is highly experienced and trusted by Sathuvachari residents. With over 15 years of experience, he provides personalized dental care with modern technology.'
    },
    {
      question: 'How far is the dental clinic from Sathuvachari?',
      answer: 'Our clinic in Gandhi Nagar is easily accessible from Sathuvachari, just a short drive away with convenient parking facilities.'
    },
    {
      question: 'What dental services are available for Sathuvachari residents?',
  ...
  const reviews = [
    {
      ...
      text: 'Excellent dental care! I came from Sathuvachari for dental implants and the treatment was perfect. Dr. Rockson Samuel is highly skilled and caring.',
      date: '2024-01-15'
    },
    {
      name: 'Jayanthi Devi',
      ...
      text: 'Best dentist near Sathuvachari! The RCT was completely painless and the staff was very friendly. Highly recommend to everyone in the area.',
      date: '2024-01-10'
    },
    {
      name: 'Siva Kumar',
      ...
      text: 'My daughter got braces treatment and we are very satisfied. The clinic is modern and well-equipped. Worth visiting from Sathuvachari.',
      date: '2024-01-08'
    }
  ]
  ...
  const amenities = [
    ...
    { icon: Car, name: 'Easy Access', description: 'Convenient from Sathuvachari' },
      ...
      <div className="container mx-auto px-4 py-12">
        <Breadcrumb
          items={[
            ...
            { title: 'Sathuvachari', href: '/in/tamil-nadu/vellore/sathuvachari' }
          ]}
          className="mb-8"
        />

        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dentist and Dental Clinic in Sathuvachari, Vellore</h1>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
            Welcome to Indira Dental Clinic - your trusted dental care provider serving Sathuvachari and surrounding areas. 
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Dental Services for Sathuvachari Patients</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Patient Reviews from Sathuvachari</h2>
            ...
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle className="flex items-center gap-2">
                  ...
                  How to Reach from Sathuvachari
                </ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Distance from Sathuvachari:</h4>
                    <p className="text-gray-700">Approximately 3-4 km</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Travel Options:</h4>
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• By Car/Bike: 10-15 minutes</li>
                      <li>• By Auto: Easily available</li>
        ...
        <section className="mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <RelevantQAWidget
              title="Common Dental Questions from Sathuvachari"
              questions={[
                {
                  id: '1',
                  title: 'Best dental clinic near Sathuvachari?',
                  slug: 'best-dental-clinic-sathuvachari',
                  excerpt: 'Indira Dental Clinic in Gandhi Nagar is the best choice for Sathuvachari patients.',
                  helpfulVotes: 45,
                  views: 1200,
                ...
                {
                  id: '2',
                  title: 'Root canal cost near Sathuvachari?',
                  slug: 'root-canal-cost-sathuvachari',
                ...
                {
                  id: '3',
                  title: 'Dental implants for Sathuvachari patients?',
                  slug: 'dental-implants-sathuvachari',
            ...
            <CompactServiceWidget
              title="Popular Services for Sathuvachari Patients"
              description="Most requested dental treatments by patients from Sathuvachari."
              services={[
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                ...
                Conveniently located for Sathuvachari residents.
              </p>
