...
export const metadata: Metadata = {
  title: 'Best Dentist in Vellore Sugar Mills, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Sugar Mills. Dr. Rockson Samuel. PIN: 632519. Book: +91 70106 50063',
  keywords: ['dentist Vellore Sugar Mills', 'dental clinic Vellore Sugar Mills', 'Walajapet dentist'],
}

export default function VelloreSugarMillsPage() {
  const distance = "26 km"

  const locationName = 'Vellore Sugar Mills'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '26 km', slug: '', travelTime: '38 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632519' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632519" distance="26 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="26 km" travelTime="38 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "26 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vellore Sugar Mills" city="Vellore" />
