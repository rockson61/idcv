...
export const metadata: Metadata = {
  title: 'Best Dentist in Vallam Kannamangalam, Arni | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vallam Kannamangalam. Dr. Rockson Samuel. PIN: 632311. Book: +91 70106 50063',
  keywords: ['dentist Vallam Kannamangalam', 'dental clinic Vallam Kannamangalam', 'Arni dentist'],
}

export default function VallamKannamangalamPage() {
  const distance = "75 km"

  const locationName = 'Vallam Kannamangalam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '75 km', slug: '', travelTime: '1.7 hours', pincode: '632001' },
    { name: 'Arni', distance: '5-10 km', slug: 'arni', travelTime: '15 min', pincode: '632311' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arni" pincode="632311" distance="75 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="75 km" travelTime="1.7 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "75 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vallam Kannamangalam" city="Vellore" />
