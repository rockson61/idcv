...
export const metadata: Metadata = {
  title: 'Best Dentist in Pullaneri, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pullaneri. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Pullaneri', 'dental clinic Pullaneri', 'Tirupathur dentist'],
}

export default function PullaneriPage() {
  const distance = "80 km"

  const locationName = 'Pullaneri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pullaneri" city="Vellore" />
