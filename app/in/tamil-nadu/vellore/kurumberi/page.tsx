...
export const metadata: Metadata = {
  title: 'Best Dentist in Kurumberi, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kurumberi. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Kurumberi', 'dental clinic Kurumberi', 'Tirupattur dentist'],
}

export default function KurumberiPage() {
  const distance = "67 km"

  const locationName = 'Kurumberi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kurumberi" city="Vellore" />
