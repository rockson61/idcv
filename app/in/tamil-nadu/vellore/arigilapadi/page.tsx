...
export const metadata: Metadata = {
  title: 'Best Dentist in Arigilapadi, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arigilapadi. Dr. Rockson Samuel. PIN: 631151. Book: +91 70106 50063',
  keywords: ['dentist Arigilapadi', 'dental clinic Arigilapadi', 'Arakkonam dentist'],
}

export default function ArigilapadiPage() {
  const locationName = 'Arigilapadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Arigilapadi" city="Vellore" />
