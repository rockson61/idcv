...
export const metadata: Metadata = {
  title: 'Best Dentist in Kanguppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kanguppam. Dr. Rockson Samuel. PIN: 632209. Book: +91 70106 50063',
  keywords: ['dentist Kanguppam', 'dental clinic Kanguppam', 'Katpadi dentist'],
}

export default function KanguppamPage() {
  const distance = "19 km"

  const locationName = 'Kanguppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kanguppam" city="Vellore" />
