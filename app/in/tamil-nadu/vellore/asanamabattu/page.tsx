...
export const metadata: Metadata = {
  title: 'Best Dentist in Asanamabattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Asanamabattu. Dr. Rockson Samuel. PIN: 632107. Book: +91 70106 50063',
  keywords: ['dentist Asanamabattu', 'dental clinic Asanamabattu', 'Vlr dentist'],
}

export default function AsanamabattuPage() {
  const distance = "14 km"

  const locationName = 'Asanamabattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Asanamabattu" city="Vellore" />
