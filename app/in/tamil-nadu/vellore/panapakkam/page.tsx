...
export const metadata: Metadata = {
  title: 'Best Dentist in Panapakkam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Panapakkam. Dr. Rockson Samuel. PIN: 631052. Book: +91 70106 50063',
  keywords: ['dentist Panapakkam', 'dental clinic Panapakkam', 'Arakkonam dentist'],
}

export default function PanapakkamPage() {
  const distance = "38 km"

  const locationName = 'Panapakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Panapakkam" city="Vellore" />
