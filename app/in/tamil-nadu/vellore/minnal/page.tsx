...
export const metadata: Metadata = {
  title: 'Best Dentist in Minnal, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Minnal. Dr. Rockson Samuel. PIN: 632510. Book: +91 70106 50063',
  keywords: ['dentist Minnal', 'dental clinic Minnal', 'Arakkonam dentist'],
}

export default function MinnalPage() {
  const distance = "38 km"

  const locationName = 'Minnal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Minnal" city="Vellore" />
