...
export const metadata: Metadata = {
  title: 'Best Dentist in Thottithuraimottur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thottithuraimottur. Dr. Rockson Samuel. PIN: 635810. Book: +91 70106 50063',
  keywords: ['dentist Thottithuraimottur', 'dental clinic Thottithuraimottur', 'Gudiyattam dentist'],
}

export default function ThottithuraimotturPage() {
  const distance = "48 km"

  const locationName = 'Thottithuraimottur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thottithuraimottur" city="Vellore" />
