...
export const metadata: Metadata = {
  title: 'Best Dentist in Pallavalli, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pallavalli. Dr. Rockson Samuel. PIN: 635702. Book: +91 70106 50063',
  keywords: ['dentist Pallavalli', 'dental clinic Pallavalli', 'Vaniyambadi dentist'],
}

export default function PallavalliPage() {
  const distance = "61 km"

  const locationName = 'Pallavalli'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '61 km', slug: '', travelTime: '1.4 hours', pincode: '632001' },
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635702' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635702" distance="61 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="61 km" travelTime="1.4 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "61 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Pallavalli" city="Vellore" />
