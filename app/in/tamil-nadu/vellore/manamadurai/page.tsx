...
export const metadata: Metadata = {
  title: 'Best Dentist in Manamadurai, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Manamadurai. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Manamadurai', 'dental clinic Manamadurai', 'Arakkonam dentist'],
}

export default function ManamaduraiPage() {
  const distance = "35 km"

  const locationName = 'Manamadurai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Manamadurai" city="Vellore" />
