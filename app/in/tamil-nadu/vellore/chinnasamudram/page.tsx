...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnasamudram, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chinnasamudram. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Chinnasamudram', 'dental clinic Chinnasamudram', 'Tirupathur dentist'],
}

export default function ChinnasamudramPage() {
  const distance = "67 km"

  const locationName = 'Chinnasamudram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635653' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635653" distance="67 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Chinnasamudram" city="Vellore" />
