...
export const metadata: Metadata = {
  title: 'Best Dentist in Karikkal, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karikkal. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Karikkal', 'dental clinic Karikkal', 'Arakkonam dentist'],
}

export default function KarikkalPage() {
  const distance = "40 km"

  const locationName = 'Karikkal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karikkal" city="Vellore" />
