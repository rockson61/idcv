...
export const metadata: Metadata = {
  title: 'Best Dentist in Ozhughur, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ozhughur. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Ozhughur', 'dental clinic Ozhughur', 'Walajapet dentist'],
}

export default function OzhughurPage() {
  const distance = "24 km"

  const locationName = 'Ozhughur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ozhughur" city="Vellore" />
