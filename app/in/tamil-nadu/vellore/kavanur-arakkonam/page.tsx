...
export const metadata: Metadata = {
  title: 'Best Dentist in Kavanur Arakkonam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kavanur Arakkonam. Dr. Rockson Samuel. PIN: 631004. Book: +91 70106 50063',
  keywords: ['dentist Kavanur Arakkonam', 'dental clinic Kavanur Arakkonam', 'Arakkonam dentist'],
}

export default function KavanurArakkonamPage() {
  const distance = "36 km"

  const locationName = 'Kavanur Arakkonam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631004' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631004" distance="36 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kavanur Arakkonam" city="Vellore" />
