...
export const metadata: Metadata = {
  title: 'Best Dentist in Pogalur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pogalur. Dr. Rockson Samuel. PIN: 635813. Book: +91 70106 50063',
  keywords: ['dentist Pogalur', 'dental clinic Pogalur', 'Gudiyattam dentist'],
}

export default function PogalurPage() {
  const distance = "49 km"

  const locationName = 'Pogalur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pogalur" city="Vellore" />
