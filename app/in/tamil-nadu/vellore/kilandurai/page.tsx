...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilandurai, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilandurai. Dr. Rockson Samuel. PIN: 631002. Book: +91 70106 50063',
  keywords: ['dentist Kilandurai', 'dental clinic Kilandurai', 'Arakkonam dentist'],
}

export default function KilanduraiPage() {
  const distance = "36 km"

  const locationName = 'Kilandurai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilandurai" city="Vellore" />
