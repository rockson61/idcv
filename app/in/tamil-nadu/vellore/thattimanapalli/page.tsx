...
export const metadata: Metadata = {
  title: 'Best Dentist in Thattimanapalli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thattimanapalli. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Thattimanapalli', 'dental clinic Thattimanapalli', 'Gudiyattam dentist'],
}

export default function ThattimanapalliPage() {
  const distance = "45 km"

  const locationName = 'Thattimanapalli'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '632601' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="632601" distance="45 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Thattimanapalli" city="Vellore" />
