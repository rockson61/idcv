...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalendira, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kalendira. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Kalendira', 'dental clinic Kalendira', 'Vaniyambadi dentist'],
}

export default function KalendiraPage() {
  const distance = "55 km"

  const locationName = 'Kalendira'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kalendira" city="Vellore" />
