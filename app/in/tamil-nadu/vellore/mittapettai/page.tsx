...
export const metadata: Metadata = {
  title: 'Best Dentist in Mittapettai, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mittapettai. Dr. Rockson Samuel. PIN: 631101. Book: +91 70106 50063',
  keywords: ['dentist Mittapettai', 'dental clinic Mittapettai', 'Arakkonam dentist'],
}

export default function MittapettaiPage() {
  const distance = "39 km"

  const locationName = 'Mittapettai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mittapettai" city="Vellore" />
