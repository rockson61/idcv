...
export const metadata: Metadata = {
  title: 'Best Dentist in Jothinagar, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jothinagar. Dr. Rockson Samuel. PIN: 631003. Book: +91 70106 50063',
  keywords: ['dentist Jothinagar', 'dental clinic Jothinagar', 'Arakonam dentist'],
}

export default function JothinagarPage() {
  const distance = "37 km"

  const locationName = 'Jothinagar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Jothinagar" city="Vellore" />
