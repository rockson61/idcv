...
export const metadata: Metadata = {
  title: 'Best Dentist in Devichettikuppam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Devichettikuppam. Dr. Rockson Samuel. PIN: 632107. Book: +91 70106 50063',
  keywords: ['dentist Devichettikuppam', 'dental clinic Devichettikuppam', 'Vlr dentist'],
}

export default function DevichettikuppamPage() {
  const distance = "14 km"

  const locationName = 'Devichettikuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Devichettikuppam" city="Vellore" />
