...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Ramanayanikuppam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ramanayanikuppam. Dr. Rockson Samuel. PIN: 632107. Book: +91 70106 50063',
  keywords: ['dentist Ramanayanikuppam', 'dental clinic Ramanayanikuppam', 'Vellore dentist'],
}

export default function RamanayanikuppamPage() {
  const distance = "14 km"

  const locationName = 'Ramanayanikuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ramanayanikuppam" city="Vellore" />
