...
export const metadata: Metadata = {
  title: 'Best Dentist in Melkuppachinna, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melkuppachinna. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Melkuppachinna', 'dental clinic Melkuppachinna', 'Vlr dentist'],
}

export default function MelkuppachinnaPage() {
  const locationName = 'Melkuppachinna'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melkuppachinna" city="Vellore" />
