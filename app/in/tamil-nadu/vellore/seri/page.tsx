...
export const metadata: Metadata = {
  title: 'Best Dentist in Seri, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Seri. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Seri', 'dental clinic Seri', 'Walajapet dentist'],
}

export default function SeriPage() {
  const distance = "22 km"

  const locationName = 'Seri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Seri" city="Vellore" />
