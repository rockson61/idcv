...
export const metadata: Metadata = {
  title: 'Best Dentist in Erthangal, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Erthangal. Dr. Rockson Samuel. PIN: 632604. Book: +91 70106 50063',
  keywords: ['dentist Erthangal', 'dental clinic Erthangal', 'Gudiyattam dentist'],
}

export default function ErthangalPage() {
  const distance = "46 km"

  const locationName = 'Erthangal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Erthangal" city="Vellore" />
