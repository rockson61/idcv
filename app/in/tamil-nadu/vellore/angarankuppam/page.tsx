...
export const metadata: Metadata = {
  title: 'Best Dentist in Angarankuppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Angarankuppam. Dr. Rockson Samuel. PIN: 632204. Book: +91 70106 50063',
  keywords: ['dentist Angarankuppam', 'dental clinic Angarankuppam', 'Katpadi dentist'],
}

export default function AngarankuppamPage() {
  const distance = "18 km"

  const locationName = 'Angarankuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632204' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632204" distance="18 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Angarankuppam" city="Vellore" />
