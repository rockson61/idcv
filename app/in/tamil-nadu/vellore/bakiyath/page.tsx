...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Bakiyath, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Bakiyath. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist Bakiyath', 'dental clinic Bakiyath', 'Vellore dentist'],
}

export default function BakiyathPage() {
  const locationName = 'Bakiyath'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Bakiyath" city="Vellore" />
