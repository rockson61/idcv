...
export const metadata: Metadata = {
  title: 'Best Dentist in Palanipet, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palanipet. Dr. Rockson Samuel. PIN: 631002. Book: +91 70106 50063',
  keywords: ['dentist Palanipet', 'dental clinic Palanipet', 'Arakonam dentist'],
}

export default function PalanipetPage() {
  const distance = "36 km"

  const locationName = 'Palanipet'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '631002' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="631002" distance="36 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Palanipet" city="Vellore" />
