...
export const metadata: Metadata = {
  title: 'Best Dentist in Kurumbakeri, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kurumbakeri. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Kurumbakeri', 'dental clinic Kurumbakeri', 'Tirupathur dentist'],
}

export default function KurumbakeriPage() {
  const distance = "67 km"

  const locationName = 'Kurumbakeri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kurumbakeri" city="Vellore" />
