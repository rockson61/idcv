...
export const metadata: Metadata = {
  title: 'Best Dentist in Eranthangal, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Eranthangal. Dr. Rockson Samuel. PIN: 632519. Book: +91 70106 50063',
  keywords: ['dentist Eranthangal', 'dental clinic Eranthangal', 'Walajapet dentist'],
}

export default function EranthangalPage() {
  const distance = "26 km"

  const locationName = 'Eranthangal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Eranthangal" city="Vellore" />
