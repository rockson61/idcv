...
export const metadata: Metadata = {
  title: 'Best Dentist in Sagayathottam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sagayathottam. Dr. Rockson Samuel. PIN: 631151. Book: +91 70106 50063',
  keywords: ['dentist Sagayathottam', 'dental clinic Sagayathottam', 'Arakkonam dentist'],
}

export default function SagayathottamPage() {
  const distance = "40 km"

  const locationName = 'Sagayathottam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sagayathottam" city="Vellore" />
