...
export const metadata: Metadata = {
  title: 'Best Dentist in Sagayathottam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sagayathottam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Sagayathottam', href: '/in/tamil-nadu/vellore/sagayathottam' },
          ]}
        />
