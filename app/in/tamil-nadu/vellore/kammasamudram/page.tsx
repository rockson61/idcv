...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kammasamudram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kammasamudram. Dr. Rockson Samuel. PIN: 632319. Book: +91 70106 50063',
  keywords: ['dentist Kammasamudram', 'dental clinic Kammasamudram', 'Vellore dentist'],
}

export default function KammasamudramPage() {
  const locationName = 'Kammasamudram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kammasamudram" city="Vellore" />
