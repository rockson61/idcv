...
export const metadata: Metadata = {
  title: 'Best Dentist in Ulli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ulli. Dr. Rockson Samuel. PIN: 635813. Book: +91 70106 50063',
  keywords: ['dentist Ulli', 'dental clinic Ulli', 'Gudiyattam dentist'],
}

export default function UlliPage() {
  const distance = "49 km"

  const locationName = 'Ulli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ulli" city="Vellore" />
