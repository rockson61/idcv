...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Gandhinagar East, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gandhinagar East. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Gandhinagar East', 'dental clinic Gandhinagar East', 'Vellore dentist'],
}

export default function GandhinagarEastPage() {
  const distance = "2 km"

  const locationName = 'Gandhinagar East'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632006' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632006" distance="2 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Gandhinagar East" city="Vellore" />
