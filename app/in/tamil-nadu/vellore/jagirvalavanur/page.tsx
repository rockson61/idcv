...
export const metadata: Metadata = {
  title: 'Best Dentist in Jagirvalavanur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jagirvalavanur. Dr. Rockson Samuel. PIN: 632511. Book: +91 70106 50063',
  keywords: ['dentist Jagirvalavanur', 'dental clinic Jagirvalavanur', 'Arcot dentist'],
}

export default function JagirvalavanurPage() {
  const distance = "29 km"

  const locationName = 'Jagirvalavanur'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '29 km', slug: '', travelTime: '42 minutes', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632511' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632511" distance="29 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="29 km" travelTime="42 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "29 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Jagirvalavanur" city="Vellore" />
