...
export const metadata: Metadata = {
  title: 'Best Dentist in Melnathambakkam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melnathambakkam. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Melnathambakkam', 'dental clinic Melnathambakkam', 'Arcot dentist'],
}

export default function MelnathambakkamPage() {
  const locationName = 'Melnathambakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melnathambakkam" city="Vellore" />
