...
export const metadata: Metadata = {
  title: 'Best Dentist in Alleri, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Alleri. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Alleri', 'dental clinic Alleri', 'Vlr dentist'],
}

export default function AlleriPage() {
  const locationName = 'Alleri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Alleri" city="Vellore" />
