...
export const metadata: Metadata = {
  title: 'Best Dentist in Durgam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Durgam. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Durgam', 'dental clinic Durgam', 'Arcot dentist'],
}

export default function DurgamPage() {
  const distance = "30 km"

  const locationName = 'Durgam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Durgam" city="Vellore" />
