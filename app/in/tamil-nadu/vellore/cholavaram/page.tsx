...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Cholavaram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Cholavaram. Dr. Rockson Samuel. PIN: 632113. Book: +91 70106 50063',
  keywords: ['dentist Cholavaram', 'dental clinic Cholavaram', 'Vellore dentist'],
}

export default function CholavaramPage() {
  const locationName = 'Cholavaram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Cholavaram" city="Vellore" />
