...
export const metadata: Metadata = {
  title: 'Best Dentist in Agraharam Tirupattur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Agraharam Tirupattur. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Agraharam Tirupattur', 'dental clinic Agraharam Tirupattur', 'Tirupattur dentist'],
}

export default function AgraharamTirupatturPage() {
  const distance = "68 km"

  const locationName = 'Agraharam Tirupattur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635651' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635651" distance="68 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Agraharam Tirupattur" city="Vellore" />
