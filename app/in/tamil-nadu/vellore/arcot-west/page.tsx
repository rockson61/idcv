...
export const metadata: Metadata = {
  title: 'Best Dentist in Arcot West, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arcot West. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Arcot West', 'dental clinic Arcot West', 'Arcot dentist'],
}

export default function ArcotWestPage() {
  const distance = "25 km"

  const locationName = 'Arcot West'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Arcot West" city="Vellore" />
