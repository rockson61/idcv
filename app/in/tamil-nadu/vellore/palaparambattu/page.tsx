...
export const metadata: Metadata = {
  title: 'Best Dentist in Palaparambattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palaparambattu. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Palaparambattu', 'dental clinic Palaparambattu', 'Vlr dentist'],
}

export default function PalaparambattuPage() {
  const locationName = 'Palaparambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Palaparambattu" city="Vellore" />
