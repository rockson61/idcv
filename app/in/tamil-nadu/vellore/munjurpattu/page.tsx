...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Munjurpattu, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Munjurpattu. Dr. Rockson Samuel. PIN: 632057. Book: +91 70106 50063',
  keywords: ['dentist Munjurpattu', 'dental clinic Munjurpattu', 'Vellore dentist'],
}

export default function MunjurpattuPage() {
  const distance = "12 km"

  const locationName = 'Munjurpattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632057' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632057" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Munjurpattu" city="Vellore" />
