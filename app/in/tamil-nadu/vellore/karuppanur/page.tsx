...
export const metadata: Metadata = {
  title: 'Best Dentist in Karuppanur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Karuppanur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Karuppanur', href: '/in/tamil-nadu/vellore/karuppanur' },
          ]}
        />
