...
export const metadata: Metadata = {
  title: 'Best Dentist in Poongulam, NA | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Poongulam. Dr. Rockson Samuel. PIN: 635710. Book: +91 70106 50063',
  keywords: ['dentist Poongulam', 'dental clinic Poongulam', 'NA dentist'],
}

export default function PoongulamPage() {
  const distance = "59 km"

  const locationName = 'Poongulam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'NA', distance: '5-10 km', slug: 'na', travelTime: '15 min', pincode: '635710' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="NA" pincode="635710" distance="59 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Poongulam" city="Vellore" />
