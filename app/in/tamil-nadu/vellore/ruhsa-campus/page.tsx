...
export const metadata: Metadata = {
  title: 'Best Dentist in Ruhsa Campus, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ruhsa Campus. Dr. Rockson Samuel. PIN: 632209. Book: +91 70106 50063',
  keywords: ['dentist Ruhsa Campus', 'dental clinic Ruhsa Campus', 'Katpadi dentist'],
}

export default function RuhsaCampusPage() {
  const distance = "19 km"

  const locationName = 'Ruhsa Campus'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ruhsa Campus" city="Vellore" />
