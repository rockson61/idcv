...
export const metadata: Metadata = {
  title: 'Best Dentist in Mukundarayapuram, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mukundarayapuram. Dr. Rockson Samuel. PIN: 632405. Book: +91 70106 50063',
  keywords: ['dentist Mukundarayapuram', 'dental clinic Mukundarayapuram', 'Walajapet dentist'],
}

export default function MukundarayapuramPage() {
  const distance = "21 km"

  const locationName = 'Mukundarayapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632405' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632405" distance="21 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Mukundarayapuram" city="Vellore" />
