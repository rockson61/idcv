...
export const metadata: Metadata = {
  title: 'Best Dentist in Vadacheri, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vadacheri. Dr. Rockson Samuel. PIN: 635754. Book: +91 70106 50063',
  keywords: ['dentist Vadacheri', 'dental clinic Vadacheri', 'Vaniyambadi dentist'],
}

export default function VadacheriPage() {
  const distance = "56 km"

  const locationName = 'Vadacheri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vadacheri" city="Vellore" />
