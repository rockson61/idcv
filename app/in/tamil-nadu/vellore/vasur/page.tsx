...
export const metadata: Metadata = {
  title: 'Best Dentist in Vasur, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vasur. Dr. Rockson Samuel. PIN: 632514. Book: +91 70106 50063',
  keywords: ['dentist Vasur', 'dental clinic Vasur', 'Katpadi dentist'],
}

export default function VasurPage() {
  const distance = "12 km"

  const locationName = 'Vasur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vasur" city="Vellore" />
