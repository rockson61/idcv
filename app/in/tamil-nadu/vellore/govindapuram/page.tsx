...
export const metadata: Metadata = {
  title: 'Best Dentist in Govindapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Govindapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Govindapuram', href: '/in/tamil-nadu/vellore/govindapuram' },
          ]}
        />
