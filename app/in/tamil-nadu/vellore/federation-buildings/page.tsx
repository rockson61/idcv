...
export const metadata: Metadata = {
  title: 'Best Dentist in Federation Buildings, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Federation Buildings. Dr. Rockson Samuel. PIN: 632509. Book: +91 70106 50063',
  keywords: ['dentist Federation Buildings', 'dental clinic Federation Buildings', 'Walajapet dentist'],
}

export default function FederationBuildingsPage() {
  const distance = "22 km"

  const locationName = 'Federation Buildings'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '22 km', slug: '', travelTime: '33 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632509' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632509" distance="22 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="22 km" travelTime="33 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "22 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Federation Buildings" city="Vellore" />
