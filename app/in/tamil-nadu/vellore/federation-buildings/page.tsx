...
export const metadata: Metadata = {
  title: 'Best Dentist in Federation Buildings, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Federation Buildings, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Federation Buildings', href: '/in/tamil-nadu/vellore/federation-buildings' },
          ]}
        />
