...
export const metadata: Metadata = {
  title: 'Best Dentist in Kothur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kothur. Dr. Rockson Samuel. PIN: 635854. Book: +91 70106 50063',
  keywords: ['dentist Kothur', 'dental clinic Kothur', 'Tirupattur dentist'],
}

export default function KothurPage() {
  const distance = "78 km"

  const locationName = 'Kothur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kothur" city="Vellore" />
