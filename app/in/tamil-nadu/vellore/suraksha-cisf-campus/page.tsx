...
export const metadata: Metadata = {
  title: 'Best Dentist in Suraksha Cisf Campus, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Suraksha Cisf Campus. Dr. Rockson Samuel. PIN: 631152. Book: +91 70106 50063',
  keywords: ['dentist Suraksha Cisf Campus', 'dental clinic Suraksha Cisf Campus', 'Arakkonam dentist'],
}

export default function SurakshaCisfCampusPage() {
  const distance = "41 km"

  const locationName = 'Suraksha Cisf Campus'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '41 km', slug: '', travelTime: '53 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631152' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631152" distance="41 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="41 km" travelTime="53 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
