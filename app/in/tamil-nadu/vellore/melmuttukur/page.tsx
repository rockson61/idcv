...
export const metadata: Metadata = {
  title: 'Best Dentist in Melmuttukur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melmuttukur. Dr. Rockson Samuel. PIN: 635806. Book: +91 70106 50063',
  keywords: ['dentist Melmuttukur', 'dental clinic Melmuttukur', 'Gudiyattam dentist'],
}

export default function MelmuttukurPage() {
  const distance = "47 km"

  const locationName = 'Melmuttukur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melmuttukur" city="Vellore" />
