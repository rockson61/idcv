...
export const metadata: Metadata = {
  title: 'Best Dentist in Periyapudhur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periyapudhur. Dr. Rockson Samuel. PIN: 632059. Book: +91 70106 50063',
  keywords: ['dentist Periyapudhur', 'dental clinic Periyapudhur', 'Vlr dentist'],
}

export default function PeriyapudhurPage() {
  const locationName = 'Periyapudhur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632059' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632059" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Periyapudhur" city="Vellore" />
