...
export const metadata: Metadata = {
  title: 'Best Dentist in Alapakkam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Alapakkam. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Alapakkam', 'dental clinic Alapakkam', 'Walajapet dentist'],
}

export default function AlapakkamPage() {
  const distance = "22 km"

  const locationName = 'Alapakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Alapakkam" city="Vellore" />
