...
export const metadata: Metadata = {
  title: 'Best Dentist in Modikuppam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Modikuppam. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Modikuppam', 'dental clinic Modikuppam', 'Gudiyattam dentist'],
}

export default function ModikuppamPage() {
  const distance = "45 km"

  const locationName = 'Modikuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Modikuppam" city="Vellore" />
