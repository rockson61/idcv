...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Veppampattu, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Veppampattu. Dr. Rockson Samuel. PIN: 632113. Book: +91 70106 50063',
  keywords: ['dentist Veppampattu', 'dental clinic Veppampattu', 'Vellore dentist'],
}

export default function VeppampattuPage() {
  const locationName = 'Veppampattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Veppampattu" city="Vellore" />
