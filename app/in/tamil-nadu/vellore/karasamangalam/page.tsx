...
export const metadata: Metadata = {
  title: 'Best Dentist in Karasamangalam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karasamangalam. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Karasamangalam', 'dental clinic Karasamangalam', 'Katpadi dentist'],
}

export default function KarasamangalamPage() {
  const locationName = 'Karasamangalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karasamangalam" city="Vellore" />
