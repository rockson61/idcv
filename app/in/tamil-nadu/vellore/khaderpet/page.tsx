...
export const metadata: Metadata = {
  title: 'Best Dentist in Khaderpet, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Khaderpet. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Khaderpet', 'dental clinic Khaderpet', 'Vaniyambadi dentist'],
}

export default function KhaderpetPage() {
  const distance = "55 km"

  const locationName = 'Khaderpet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Khaderpet" city="Vellore" />
