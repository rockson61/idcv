...
export const metadata: Metadata = {
  title: 'Best Dentist in Thenkadapanthangal, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thenkadapanthangal. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Thenkadapanthangal', 'dental clinic Thenkadapanthangal', 'Walajapet dentist'],
}

export default function ThenkadapanthangalPage() {
  const distance = "23 km"

  const locationName = 'Thenkadapanthangal'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '23 km', slug: '', travelTime: '34 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632513' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632513" distance="23 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="23 km" travelTime="34 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "23 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Thenkadapanthangal" city="Vellore" />
