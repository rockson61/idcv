...
export const metadata: Metadata = {
  title: 'Best Dentist in Valayathur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Valayathur. Dr. Rockson Samuel. PIN: 632504. Book: +91 70106 50063',
  keywords: ['dentist Valayathur', 'dental clinic Valayathur', 'Arcot dentist'],
}

export default function ValayathurPage() {
  const distance = "26 km"

  const locationName = 'Valayathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Valayathur" city="Vellore" />
