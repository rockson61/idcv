...
export const metadata: Metadata = {
  title: 'Best Dentist in Sankaranpalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sankaranpalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Sankaranpalayam', href: '/in/tamil-nadu/vellore/sankaranpalayam' },
          ]}
        />
