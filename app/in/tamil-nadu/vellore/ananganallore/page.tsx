...
export const metadata: Metadata = {
  title: 'Best Dentist in Ananganallore, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ananganallore. Dr. Rockson Samuel. PIN: 635806. Book: +91 70106 50063',
  keywords: ['dentist Ananganallore', 'dental clinic Ananganallore', 'Gudiyattam dentist'],
}

export default function AnanganallorePage() {
  const distance = "47 km"

  const locationName = 'Ananganallore'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '635806' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="635806" distance="47 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Ananganallore" city="Vellore" />
