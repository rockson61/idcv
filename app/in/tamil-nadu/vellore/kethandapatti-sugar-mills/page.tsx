...
export const metadata: Metadata = {
  title: 'Best Dentist in Kethandapatti Sugar Mills, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kethandapatti Sugar Mills. Dr. Rockson Samuel. PIN: 635815. Book: +91 70106 50063',
  keywords: ['dentist Kethandapatti Sugar Mills', 'dental clinic Kethandapatti Sugar Mills', 'Tirupathur dentist'],
}

export default function KethandapattiSugarMillsPage() {
  const distance = "68 km"

  const locationName = 'Kethandapatti Sugar Mills'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '68 km', slug: '', travelTime: '1.6 hours', pincode: '632001' },
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635815' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635815" distance="68 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="68 km" travelTime="1.6 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "68 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Kethandapatti Sugar Mills" city="Vellore" />
