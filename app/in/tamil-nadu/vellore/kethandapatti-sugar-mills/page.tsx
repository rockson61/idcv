...
export const metadata: Metadata = {
  title: 'Best Dentist in Kethandapatti Sugar Mills, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kethandapatti Sugar Mills, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Kethandapatti Sugar Mills', href: '/in/tamil-nadu/vellore/kethandapatti-sugar-mills' },
          ]}
        />
