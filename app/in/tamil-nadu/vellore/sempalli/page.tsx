...
export const metadata: Metadata = {
  title: 'Best Dentist in Sempalli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sempalli. Dr. Rockson Samuel. PIN: 632604. Book: +91 70106 50063',
  keywords: ['dentist Sempalli', 'dental clinic Sempalli', 'Gudiyattam dentist'],
}

export default function SempalliPage() {
  const distance = "46 km"

  const locationName = 'Sempalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sempalli" city="Vellore" />
