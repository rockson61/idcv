...
export const metadata: Metadata = {
  title: 'Best Dentist in Kattipattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kattipattu. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Kattipattu', 'dental clinic Kattipattu', 'Vlr dentist'],
}

export default function KattipattuPage() {
  const distance = "16 km"

  const locationName = 'Kattipattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kattipattu" city="Vellore" />
