...
export const metadata: Metadata = {
  title: 'Best Dentist in Ananthangal, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ananthangal. Dr. Rockson Samuel. PIN: 632511. Book: +91 70106 50063',
  keywords: ['dentist Ananthangal', 'dental clinic Ananthangal', 'Arcot dentist'],
}

export default function AnanthangalPage() {
  const distance = "29 km"

  const locationName = 'Ananthangal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ananthangal" city="Vellore" />
