...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudiyatham, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gudiyatham, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gudiyatham'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
