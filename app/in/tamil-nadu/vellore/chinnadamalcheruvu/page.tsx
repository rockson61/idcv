...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnadamalcheruvu, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chinnadamalcheruvu. Dr. Rockson Samuel. PIN: 635810. Book: +91 70106 50063',
  keywords: ['dentist Chinnadamalcheruvu', 'dental clinic Chinnadamalcheruvu', 'Gudiyattam dentist'],
}

export default function ChinnadamalcheruvuPage() {
  const distance = "48 km"

  const locationName = 'Chinnadamalcheruvu'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '48 km', slug: '', travelTime: '1.1 hours', pincode: '632001' },
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '635810' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="635810" distance="48 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="48 km" travelTime="1.1 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "48 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Chinnadamalcheruvu" city="Vellore" />
