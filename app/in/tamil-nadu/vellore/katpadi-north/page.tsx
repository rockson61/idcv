...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Katpadi North, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Katpadi North. Dr. Rockson Samuel. PIN: 632007. Book: +91 70106 50063',
  keywords: ['dentist Katpadi North', 'dental clinic Katpadi North', 'Vellore dentist'],
}

export default function KatpadiNorthPage() {
  const locationName = 'Katpadi North'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '6 km', slug: '', travelTime: '15 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632007' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632007" distance="6 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="6 km" travelTime="15 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "6 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Katpadi North" city="Vellore" />
