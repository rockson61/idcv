...
export const metadata: Metadata = {
  title: 'Best Dentist in Girisamudram, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Girisamudram. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Girisamudram', 'dental clinic Girisamudram', 'Vaniyambadi dentist'],
}

export default function GirisamudramPage() {
  const distance = "55 km"

  const locationName = 'Girisamudram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Girisamudram" city="Vellore" />
