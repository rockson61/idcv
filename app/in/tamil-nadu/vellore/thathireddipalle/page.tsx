...
export const metadata: Metadata = {
  title: 'Best Dentist in Thathireddipalle, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thathireddipalle. Dr. Rockson Samuel. PIN: 632516. Book: +91 70106 50063',
  keywords: ['dentist Thathireddipalle', 'dental clinic Thathireddipalle', 'Katpadi dentist'],
}

export default function ThathireddipallePage() {
  const distance = "13 km"

  const locationName = 'Thathireddipalle'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thathireddipalle" city="Vellore" />
