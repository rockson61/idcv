...
export const metadata: Metadata = {
  title: 'Best Dentist in Adiyur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Adiyur. Dr. Rockson Samuel. PIN: 635602. Book: +91 70106 50063',
  keywords: ['dentist Adiyur', 'dental clinic Adiyur', 'Tirupathur dentist'],
}

export default function AdiyurPage() {
  const distance = "66 km"

  const locationName = 'Adiyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Adiyur" city="Vellore" />
