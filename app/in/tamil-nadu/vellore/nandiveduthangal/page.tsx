...
export const metadata: Metadata = {
  title: 'Best Dentist in Nandiveduthangal, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nandiveduthangal. Dr. Rockson Samuel. PIN: 631101. Book: +91 70106 50063',
  keywords: ['dentist Nandiveduthangal', 'dental clinic Nandiveduthangal', 'Arakkonam dentist'],
}

export default function NandiveduthangalPage() {
  const distance = "39 km"

  const locationName = 'Nandiveduthangal'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '39 km', slug: '', travelTime: '51 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631101' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631101" distance="39 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="39 km" travelTime="51 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "39 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Nandiveduthangal" city="Vellore" />
