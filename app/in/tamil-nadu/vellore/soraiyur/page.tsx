...
export const metadata: Metadata = {
  title: 'Best Dentist in Soraiyur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Soraiyur. Dr. Rockson Samuel. PIN: 632318. Book: +91 70106 50063',
  keywords: ['dentist Soraiyur', 'dental clinic Soraiyur', 'Arcot dentist'],
}

export default function SoraiyurPage() {
  const distance = "32 km"

  const locationName = 'Soraiyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Soraiyur" city="Vellore" />
