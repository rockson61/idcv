...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Voorhees College, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Voorhees College. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Voorhees College', 'dental clinic Voorhees College', 'Vellore dentist'],
}

export default function VoorheesCollegePage() {
  const locationName = 'Voorhees College'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Voorhees College" city="Vellore" />
