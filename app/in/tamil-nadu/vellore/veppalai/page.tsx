...
export const metadata: Metadata = {
  title: 'Best Dentist in Veppalai, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Veppalai. Dr. Rockson Samuel. PIN: 632520. Book: +91 70106 50063',
  keywords: ['dentist Veppalai', 'dental clinic Veppalai', 'Katpadi dentist'],
}

export default function VeppalaiPage() {
  const distance = "14 km"

  const locationName = 'Veppalai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Veppalai" city="Vellore" />
