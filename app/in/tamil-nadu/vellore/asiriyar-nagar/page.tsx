...
export const metadata: Metadata = {
  title: 'Best Dentist in Asiriyar Nagar, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Asiriyar Nagar. Dr. Rockson Samuel. PIN: 635601. Book: +91 70106 50063',
  keywords: ['dentist Asiriyar Nagar', 'dental clinic Asiriyar Nagar', 'Tirupathur dentist'],
}

export default function AsiriyarNagarPage() {
  const distance = "65 km"

  const locationName = 'Asiriyar Nagar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Asiriyar Nagar" city="Vellore" />
