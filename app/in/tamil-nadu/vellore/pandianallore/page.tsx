...
export const metadata: Metadata = {
  title: 'Best Dentist in Pandianallore, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pandianallore. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Pandianallore', 'dental clinic Pandianallore', 'Arakkonam dentist'],
}

export default function PandianallorePage() {
  const locationName = 'Pandianallore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pandianallore" city="Vellore" />
