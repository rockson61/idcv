...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Sullivanpet, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sullivanpet. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Sullivanpet', 'dental clinic Sullivanpet', 'Vellore dentist'],
}

export default function SullivanpetPage() {
  const distance = "1 km"

  const locationName = 'Sullivanpet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sullivanpet" city="Vellore" />
