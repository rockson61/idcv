...
export const metadata: Metadata = {
  title: 'Best Dentist in Sattur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sattur. Dr. Rockson Samuel. PIN: 632521. Book: +91 70106 50063',
  keywords: ['dentist Sattur', 'dental clinic Sattur', 'Arcot dentist'],
}

export default function SatturPage() {
  const locationName = 'Sattur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sattur" city="Vellore" />
