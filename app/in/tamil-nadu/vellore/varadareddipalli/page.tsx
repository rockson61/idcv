...
export const metadata: Metadata = {
  title: 'Best Dentist in Varadareddipalli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Varadareddipalli. Dr. Rockson Samuel. PIN: 632603. Book: +91 70106 50063',
  keywords: ['dentist Varadareddipalli', 'dental clinic Varadareddipalli', 'Gudiyattam dentist'],
}

export default function VaradareddipalliPage() {
  const distance = "46 km"

  const locationName = 'Varadareddipalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Varadareddipalli" city="Vellore" />
