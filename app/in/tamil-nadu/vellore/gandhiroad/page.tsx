...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Gandhiroad, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gandhiroad. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist Gandhiroad', 'dental clinic Gandhiroad', 'Vellore dentist'],
}

export default function GandhiroadPage() {
  const distance = "3 km"

  const locationName = 'Gandhiroad'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gandhiroad" city="Vellore" />
