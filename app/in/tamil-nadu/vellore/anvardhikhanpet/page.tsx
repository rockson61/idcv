...
export const metadata: Metadata = {
  title: 'Best Dentist in Anvardhikhanpet, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Anvardhikhanpet. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Anvardhikhanpet', 'dental clinic Anvardhikhanpet', 'Arakkonam dentist'],
}

export default function AnvardhikhanpetPage() {
  const distance = "35 km"

  const locationName = 'Anvardhikhanpet'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '35 km', slug: '', travelTime: '47 minutes', pincode: '632001' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="632502" distance="35 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="35 km" travelTime="47 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Anvardhikhanpet" city="Vellore" />
