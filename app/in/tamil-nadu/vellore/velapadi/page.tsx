...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Velapadi, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Velapadi. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Velapadi', 'dental clinic Velapadi', 'Vellore dentist'],
}

export default function VelapadiPage() {
  const locationName = 'Velapadi'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '4 km', slug: '', travelTime: '12 minutes', pincode: '632001' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632001" distance="4 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="4 km" travelTime="12 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "4 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Velapadi" city="Vellore" />
