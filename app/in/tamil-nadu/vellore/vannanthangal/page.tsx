...
export const metadata: Metadata = {
  title: 'Best Dentist in Vannanthangal, Velr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vannanthangal. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Vannanthangal', 'dental clinic Vannanthangal', 'Velr dentist'],
}

export default function VannanthangalPage() {
  const distance = "16 km"

  const locationName = 'Vannanthangal'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Velr', distance: '5-10 km', slug: 'velr', travelTime: '15 min', pincode: '632103' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Velr" pincode="632103" distance="16 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Vannanthangal" city="Vellore" />
