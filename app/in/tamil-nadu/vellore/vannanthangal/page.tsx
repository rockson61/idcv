...
export const metadata: Metadata = {
  title: 'Best Dentist in Vannanthangal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vannanthangal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Vannanthangal', href: '/in/tamil-nadu/vellore/vannanthangal' },
          ]}
        />
