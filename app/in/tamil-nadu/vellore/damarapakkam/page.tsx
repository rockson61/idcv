...
export const metadata: Metadata = {
  title: 'Best Dentist in Damarapakkam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Damarapakkam. Dr. Rockson Samuel. PIN: 632504. Book: +91 70106 50063',
  keywords: ['dentist Damarapakkam', 'dental clinic Damarapakkam', 'Arcot dentist'],
}

export default function DamarapakkamPage() {
  const distance = "26 km"

  const locationName = 'Damarapakkam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632504' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632504" distance="26 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Damarapakkam" city="Vellore" />
