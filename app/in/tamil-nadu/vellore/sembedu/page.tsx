...
export const metadata: Metadata = {
  title: 'Best Dentist in Sembedu, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sembedu. Dr. Rockson Samuel. PIN: 635813. Book: +91 70106 50063',
  keywords: ['dentist Sembedu', 'dental clinic Sembedu', 'Gudiyattam dentist'],
}

export default function SembeduPage() {
  const distance = "49 km"

  const locationName = 'Sembedu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sembedu" city="Vellore" />
