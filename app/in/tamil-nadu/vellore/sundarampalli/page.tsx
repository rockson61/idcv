...
export const metadata: Metadata = {
  title: 'Best Dentist in Sundarampalli, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sundarampalli. Dr. Rockson Samuel. PIN: 635654. Book: +91 70106 50063',
  keywords: ['dentist Sundarampalli', 'dental clinic Sundarampalli', 'Tirupattur dentist'],
}

export default function SundarampalliPage() {
  const distance = "68 km"

  const locationName = 'Sundarampalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sundarampalli" city="Vellore" />
