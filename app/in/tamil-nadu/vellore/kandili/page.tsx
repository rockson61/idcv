...
export const metadata: Metadata = {
  title: 'Best Dentist in Kandili, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kandili. Dr. Rockson Samuel. PIN: 635901. Book: +91 70106 50063',
  keywords: ['dentist Kandili', 'dental clinic Kandili', 'Tirupattur dentist'],
}

export default function KandiliPage() {
  const distance = "72 km"

  const locationName = 'Kandili'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kandili" city="Vellore" />
