...
export const metadata: Metadata = {
  title: 'Best Dentist in Eriyur Amirdhi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Eriyur Amirdhi. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Eriyur Amirdhi', 'dental clinic Eriyur Amirdhi', 'Vlr dentist'],
}

export default function EriyurAmirdhiPage() {
  const distance = "16 km"

  const locationName = 'Eriyur Amirdhi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Eriyur Amirdhi" city="Vellore" />
