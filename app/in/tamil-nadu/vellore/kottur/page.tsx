...
export const metadata: Metadata = {
  title: 'Best Dentist in Kottur, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kottur. Dr. Rockson Samuel. PIN: 635808. Book: +91 70106 50063',
  keywords: ['dentist Kottur', 'dental clinic Kottur', 'Gudiyatham dentist'],
}

export default function KotturPage() {
  const distance = "48 km"

  const locationName = 'Kottur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kottur" city="Vellore" />
