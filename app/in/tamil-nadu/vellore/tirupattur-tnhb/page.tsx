...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupattur TNHB, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tirupattur TNHB. Dr. Rockson Samuel. PIN: 635601. Book: +91 70106 50063',
  keywords: ['dentist Tirupattur TNHB', 'dental clinic Tirupattur TNHB', 'Tirupathur dentist'],
}

export default function TirupatturTNHBPage() {
  const distance = "65 km"

  const locationName = 'Tirupattur TNHB'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '65 km', slug: '', travelTime: '1.5 hours', pincode: '632001' },
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635601' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635601" distance="65 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="65 km" travelTime="1.5 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "65 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Tirupattur Tnhb" city="Vellore" />
