...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupattur Tnhb, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tirupattur Tnhb, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Tirupattur Tnhb', href: '/in/tamil-nadu/vellore/tirupattur-tnhb' },
          ]}
        />
