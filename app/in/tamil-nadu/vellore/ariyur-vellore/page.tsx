...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Ariyur Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ariyur Vellore. Dr. Rockson Samuel. PIN: 632055. Book: +91 70106 50063',
  keywords: ['dentist Ariyur Vellore', 'dental clinic Ariyur Vellore', 'Vellore dentist'],
}

export default function AriyurVellorePage() {
  const distance = "11 km"

  const locationName = 'Ariyur Vellore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ariyur Vellore" city="Vellore" />
