...
export const metadata: Metadata = {
  title: 'Best Dentist in Ariyur Vellore, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ariyur Vellore, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Ariyur Vellore', href: '/in/tamil-nadu/vellore/ariyur-vellore' },
          ]}
        />
