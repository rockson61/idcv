...
export const metadata: Metadata = {
  title: 'Best Dentist in Nemandhapuram, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nemandhapuram. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Nemandhapuram', 'dental clinic Nemandhapuram', 'Vlr dentist'],
}

export default function NemandhapuramPage() {
  const distance = "16 km"

  const locationName = 'Nemandhapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nemandhapuram" city="Vellore" />
