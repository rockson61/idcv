...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Slr Sanatorium, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Slr Sanatorium. Dr. Rockson Samuel. PIN: 632106. Book: +91 70106 50063',
  keywords: ['dentist Slr Sanatorium', 'dental clinic Slr Sanatorium', 'Vellore dentist'],
}

export default function SlrSanatoriumPage() {
  const distance = "12 km"

  const locationName = 'Slr Sanatorium'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632106' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632106" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Slr Sanatorium" city="Vellore" />
