...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudiyattam South, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gudiyattam South. Dr. Rockson Samuel. PIN: 632602. Book: +91 70106 50063',
  keywords: ['dentist Gudiyattam South', 'dental clinic Gudiyattam South', 'Gudiyatham dentist'],
}

export default function GudiyattamSouthPage() {
  const distance = "45 km"

  const locationName = 'Gudiyattam South'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gudiyattam South" city="Vellore" />
