...
export const metadata: Metadata = {
  title: 'Best Dentist in Viludonpalayam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Viludonpalayam. Dr. Rockson Samuel. PIN: 632603. Book: +91 70106 50063',
  keywords: ['dentist Viludonpalayam', 'dental clinic Viludonpalayam', 'Gudiyattam dentist'],
}

export default function ViludonpalayamPage() {
  const distance = "46 km"

  const locationName = 'Viludonpalayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Viludonpalayam" city="Vellore" />
