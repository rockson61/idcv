...
export const metadata: Metadata = {
  title: 'Best Dentist in Nilavur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nilavur. Dr. Rockson Samuel. PIN: 635853. Book: +91 70106 50063',
  keywords: ['dentist Nilavur', 'dental clinic Nilavur', 'Tirupathur dentist'],
}

export default function NilavurPage() {
  const distance = "77 km"

  const locationName = 'Nilavur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nilavur" city="Vellore" />
