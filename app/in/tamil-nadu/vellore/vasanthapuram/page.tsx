...
export const metadata: Metadata = {
  title: 'Best Dentist in Vasanthapuram, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vasanthapuram. Dr. Rockson Samuel. PIN: 635701. Book: +91 70106 50063',
  keywords: ['dentist Vasanthapuram', 'dental clinic Vasanthapuram', 'Vaniyambadi dentist'],
}

export default function VasanthapuramPage() {
  const distance = "60 km"

  const locationName = 'Vasanthapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vasanthapuram" city="Vellore" />
