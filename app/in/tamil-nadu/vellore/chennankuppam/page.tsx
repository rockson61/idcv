...
export const metadata: Metadata = {
  title: 'Best Dentist in Chennankuppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chennankuppam. Dr. Rockson Samuel. PIN: 632209. Book: +91 70106 50063',
  keywords: ['dentist Chennankuppam', 'dental clinic Chennankuppam', 'Katpadi dentist'],
}

export default function ChennankuppamPage() {
  const distance = "19 km"

  const locationName = 'Chennankuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chennankuppam" city="Vellore" />
