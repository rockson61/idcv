...
export const metadata: Metadata = {
  title: 'Best Dentist in Melmayil, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melmayil. Dr. Rockson Samuel. PIN: 632203. Book: +91 70106 50063',
  keywords: ['dentist Melmayil', 'dental clinic Melmayil', 'Katpadi dentist'],
}

export default function MelmayilPage() {
  const distance = "17 km"

  const locationName = 'Melmayil'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melmayil" city="Vellore" />
