...
export const metadata: Metadata = {
  title: 'Best Dentist in Melpattu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melpattu. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Melpattu', 'dental clinic Melpattu', 'Tirupattur dentist'],
}

export default function MelpattuPage() {
  const distance = "69 km"

  const locationName = 'Melpattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melpattu" city="Vellore" />
