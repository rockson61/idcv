...
export const metadata: Metadata = {
  title: 'Best Dentist in Velur Kalavai, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Velur Kalavai. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Velur Kalavai', 'dental clinic Velur Kalavai', 'Arcot dentist'],
}

export default function VelurKalavaiPage() {
  const distance = "28 km"

  const locationName = 'Velur Kalavai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Velur Kalavai" city="Vellore" />
