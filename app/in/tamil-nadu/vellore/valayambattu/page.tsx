...
export const metadata: Metadata = {
  title: 'Best Dentist in Valayambattu, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Valayambattu. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Valayambattu', 'dental clinic Valayambattu', 'Vaniyambadi dentist'],
}

export default function ValayambattuPage() {
  const distance = "55 km"

  const locationName = 'Valayambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Valayambattu" city="Vellore" />
