...
export const metadata: Metadata = {
  title: 'Best Dentist in Kakangarai RS, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kakangarai RS. Dr. Rockson Samuel. PIN: 635654. Book: +91 70106 50063',
  keywords: ['dentist Kakangarai RS', 'dental clinic Kakangarai RS', 'Tirupattur dentist'],
}

export default function KakangaraiRSPage() {
  const distance = "68 km"

  const locationName = 'Kakangarai RS'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kakangarai Rs" city="Vellore" />
