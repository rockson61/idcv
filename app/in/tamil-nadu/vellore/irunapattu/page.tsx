...
export const metadata: Metadata = {
  title: 'Best Dentist in Irunapattu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Irunapattu. Dr. Rockson Samuel. PIN: 635702. Book: +91 70106 50063',
  keywords: ['dentist Irunapattu', 'dental clinic Irunapattu', 'Tirupattur dentist'],
}

export default function IrunapattuPage() {
  const locationName = 'Irunapattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Irunapattu" city="Vellore" />
