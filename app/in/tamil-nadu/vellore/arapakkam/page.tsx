...
export const metadata: Metadata = {
  title: 'Best Dentist in Arapakkam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arapakkam. Dr. Rockson Samuel. PIN: 632517. Book: +91 70106 50063',
  keywords: ['dentist Arapakkam', 'dental clinic Arapakkam', 'Walajapet dentist'],
}

export default function ArapakkamPage() {
  const distance = "24 km"

  const locationName = 'Arapakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Arapakkam" city="Vellore" />
