...
export const metadata: Metadata = {
  title: 'Best Dentist in Manthangal, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Manthangal. Dr. Rockson Samuel. PIN: 632404. Book: +91 70106 50063',
  keywords: ['dentist Manthangal', 'dental clinic Manthangal', 'Wallajah dentist'],
}

export default function ManthangalPage() {
  const distance = "21 km"

  const locationName = 'Manthangal'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '632404' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="632404" distance="21 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Manthangal" city="Vellore" />
