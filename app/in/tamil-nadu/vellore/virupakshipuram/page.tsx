...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Virupakshipuram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Virupakshipuram. Dr. Rockson Samuel. PIN: 632002. Book: +91 70106 50063',
  keywords: ['dentist Virupakshipuram', 'dental clinic Virupakshipuram', 'Vellore dentist'],
}

export default function VirupakshipuramPage() {
  const distance = "3 km"

  const locationName = 'Virupakshipuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Virupakshipuram" city="Vellore" />
