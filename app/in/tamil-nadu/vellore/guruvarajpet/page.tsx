...
export const metadata: Metadata = {
  title: 'Best Dentist in Guruvarajpet, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Guruvarajpet. Dr. Rockson Samuel. PIN: 631101. Book: +91 70106 50063',
  keywords: ['dentist Guruvarajpet', 'dental clinic Guruvarajpet', 'Arakonam dentist'],
}

export default function GuruvarajpetPage() {
  const distance = "39 km"

  const locationName = 'Guruvarajpet'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '631101' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="631101" distance="39 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Guruvarajpet" city="Vellore" />
