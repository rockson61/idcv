...
export const metadata: Metadata = {
  title: 'Best Dentist in Ayal, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ayal. Dr. Rockson Samuel. PIN: 632505. Book: +91 70106 50063',
  keywords: ['dentist Ayal', 'dental clinic Ayal', 'Arakkonam dentist'],
}

export default function AyalPage() {
  const distance = "36 km"

  const locationName = 'Ayal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ayal" city="Vellore" />
