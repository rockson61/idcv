...
export const metadata: Metadata = {
  title: 'Best Dentist in Pasumathur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pasumathur. Dr. Rockson Samuel. PIN: 635803. Book: +91 70106 50063',
  keywords: ['dentist Pasumathur', 'dental clinic Pasumathur', 'Gudiyattam dentist'],
}

export default function PasumathurPage() {
  const distance = "46 km"

  const locationName = 'Pasumathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pasumathur" city="Vellore" />
