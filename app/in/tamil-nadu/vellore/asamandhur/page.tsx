...
export const metadata: Metadata = {
  title: 'Best Dentist in Asamandhur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Asamandhur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Asamandhur', href: '/in/tamil-nadu/vellore/asamandhur' },
          ]}
        />
