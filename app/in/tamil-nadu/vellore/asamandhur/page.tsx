...
export const metadata: Metadata = {
  title: 'Best Dentist in Asamandhur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Asamandhur. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Asamandhur', 'dental clinic Asamandhur', 'Arakkonam dentist'],
}

export default function AsamandhurPage() {
  const distance = "36 km"

  const locationName = 'Asamandhur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '632502' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="632502" distance="36 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Asamandhur" city="Vellore" />
