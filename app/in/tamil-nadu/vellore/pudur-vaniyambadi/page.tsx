...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudur Vaniyambadi, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pudur Vaniyambadi. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Pudur Vaniyambadi', 'dental clinic Pudur Vaniyambadi', 'Vaniyambadi dentist'],
}

export default function PudurVaniyambadiPage() {
  const distance = "55 km"

  const locationName = 'Pudur Vaniyambadi'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '55 km', slug: '', travelTime: '1.25 hours', pincode: '632001' },
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635751' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635751" distance="55 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="55 km" travelTime="1.25 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "55 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Pudur Vaniyambadi" city="Vellore" />
