...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Konavattam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Konavattam. Dr. Rockson Samuel. PIN: 632013. Book: +91 70106 50063',
  keywords: ['dentist Konavattam', 'dental clinic Konavattam', 'Vellore dentist'],
}

export default function KonavattamPage() {
  const distance = "9 km"

  const locationName = 'Konavattam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632013' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632013" distance="9 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Konavattam" city="Vellore" />
