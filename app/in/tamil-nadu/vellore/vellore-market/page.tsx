...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore Market, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Market. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist Vellore Market', 'dental clinic Vellore Market', 'Vellore dentist'],
}

export default function VelloreMarketPage() {
  const distance = "3 km"

  const locationName = 'Vellore Market'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vellore Market" city="Vellore" />
