...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruvalam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tiruvalam. Dr. Rockson Samuel. PIN: 632515. Book: +91 70106 50063',
  keywords: ['dentist Tiruvalam', 'dental clinic Tiruvalam', 'Walajapet dentist'],
}

export default function TiruvalamPage() {
  const distance = "25 km"

  const locationName = 'Tiruvalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tiruvalam" city="Vellore" />
