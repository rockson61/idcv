...
export const metadata: Metadata = {
  title: 'Best Dentist in Kavanur Arcot, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kavanur Arcot. Dr. Rockson Samuel. PIN: 632507. Book: +91 70106 50063',
  keywords: ['dentist Kavanur Arcot', 'dental clinic Kavanur Arcot', 'Arcot dentist'],
}

export default function KavanurArcotPage() {
  const distance = "27 km"

  const locationName = 'Kavanur Arcot'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kavanur Arcot" city="Vellore" />
