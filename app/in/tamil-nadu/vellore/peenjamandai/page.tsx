...
export const metadata: Metadata = {
  title: 'Best Dentist in Peenjamandai, NA | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Peenjamandai. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Peenjamandai', 'dental clinic Peenjamandai', 'NA dentist'],
}

export default function PeenjamandaiPage() {
  const distance = "16 km"

  const locationName = 'Peenjamandai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'NA', distance: '5-10 km', slug: 'na', travelTime: '15 min', pincode: '632103' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="NA" pincode="632103" distance="16 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Peenjamandai" city="Vellore" />
