...
export const metadata: Metadata = {
  title: 'Best Dentist in Karungali, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karungali. Dr. Rockson Samuel. PIN: 635804. Book: +91 70106 50063',
  keywords: ['dentist Karungali', 'dental clinic Karungali', 'Vaniyambadi dentist'],
}

export default function KarungaliPage() {
  const distance = "57 km"

  const locationName = 'Karungali'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karungali" city="Vellore" />
