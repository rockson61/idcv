...
export const metadata: Metadata = {
  title: 'Best Dentist in Kandaneri, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kandaneri. Dr. Rockson Samuel. PIN: 635809. Book: +91 70106 50063',
  keywords: ['dentist Kandaneri', 'dental clinic Kandaneri', 'Katpadi dentist'],
}

export default function KandaneriPage() {
  const distance = "35 km"

  const locationName = 'Kandaneri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kandaneri" city="Vellore" />
