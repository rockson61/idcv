...
export const metadata: Metadata = {
  title: 'Best Dentist in Karugambathur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karugambathur. Dr. Rockson Samuel. PIN: 632013. Book: +91 70106 50063',
  keywords: ['dentist Karugambathur', 'dental clinic Karugambathur', 'Vlr dentist'],
}

export default function KarugambathurPage() {
  const distance = "9 km"

  const locationName = 'Karugambathur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632013' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632013" distance="9 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Karugambathur" city="Vellore" />
