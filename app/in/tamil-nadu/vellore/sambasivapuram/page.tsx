...
export const metadata: Metadata = {
  title: 'Best Dentist in Sambasivapuram, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sambasivapuram. Dr. Rockson Samuel. PIN: 632507. Book: +91 70106 50063',
  keywords: ['dentist Sambasivapuram', 'dental clinic Sambasivapuram', 'Arcot dentist'],
}

export default function SambasivapuramPage() {
  const distance = "27 km"

  const locationName = 'Sambasivapuram'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '27 km', slug: '', travelTime: '39 minutes', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632507' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632507" distance="27 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="27 km" travelTime="39 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "27 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Sambasivapuram" city="Vellore" />
