...
export const metadata: Metadata = {
  title: 'Best Dentist in Velam, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Velam. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Velam', 'dental clinic Velam', 'Wallajah dentist'],
}

export default function VelamPage() {
  const distance = "24 km"

  const locationName = 'Velam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Velam" city="Vellore" />
