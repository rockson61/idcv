...
export const metadata: Metadata = {
  title: 'Best Dentist in Arumbakkam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arumbakkam. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Arumbakkam', 'dental clinic Arumbakkam', 'Arcot dentist'],
}

export default function ArumbakkamPage() {
  const distance = "28 km"

  const locationName = 'Arumbakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Arumbakkam" city="Vellore" />
