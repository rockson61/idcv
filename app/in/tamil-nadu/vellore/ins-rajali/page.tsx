...
export const metadata: Metadata = {
  title: 'Best Dentist in Ins Rajali, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ins Rajali. Dr. Rockson Samuel. PIN: 631006. Book: +91 70106 50063',
  keywords: ['dentist Ins Rajali', 'dental clinic Ins Rajali', 'Arakonam dentist'],
}

export default function InsRajaliPage() {
  const distance = "36 km"

  const locationName = 'Ins Rajali'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '631006' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="631006" distance="36 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Ins Rajali" city="Vellore" />
