...
export const metadata: Metadata = {
  title: 'Best Dentist in Vellakuttai, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellakuttai. Dr. Rockson Samuel. PIN: 635752. Book: +91 70106 50063',
  keywords: ['dentist Vellakuttai', 'dental clinic Vellakuttai', 'Vaniyambadi dentist'],
}

export default function VellakuttaiPage() {
  const distance = "56 km"

  const locationName = 'Vellakuttai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vellakuttai" city="Vellore" />
