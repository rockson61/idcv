...
export const metadata: Metadata = {
  title: 'Best Dentist in Ayarpadi, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ayarpadi. Dr. Rockson Samuel. PIN: 632531. Book: +91 70106 50063',
  keywords: ['dentist Ayarpadi', 'dental clinic Ayarpadi', 'Arakkonam dentist'],
}

export default function AyarpadiPage() {
  const locationName = 'Ayarpadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ayarpadi" city="Vellore" />
