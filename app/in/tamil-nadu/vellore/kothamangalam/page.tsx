...
export const metadata: Metadata = {
  title: 'Best Dentist in Kothamangalam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kothamangalam. Dr. Rockson Samuel. PIN: 632104. Book: +91 70106 50063',
  keywords: ['dentist Kothamangalam', 'dental clinic Kothamangalam', 'Vlr dentist'],
}

export default function KothamangalamPage() {
  const distance = "13 km"

  const locationName = 'Kothamangalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kothamangalam" city="Vellore" />
