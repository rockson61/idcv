...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Katpadi, Vellore | Indira Dental Clinic',
  description: 'Expert dental services in Katpadi, Vellore. RCT, dental implants, braces, cosmetic dentistry by Dr. Rockson Samuel. Near Katpadi Junction.',
  keywords: ['dentist Katpadi', 'dental clinic Katpadi Vellore', 'dental services Katpadi', 'best dentist Katpadi'],
}
...
export default function KatpadiPage() {
  ...
  const faqs = [
    {
      question: 'Where is the best dental clinic near Katpadi?',
      answer: 'Indira Dental Clinic in Gandhi Nagar, Vellore is the best choice for Katpadi residents, conveniently located near Katpadi Junction. We offer comprehensive dental services with modern equipment and experienced dentists.'
    },
    {
      question: 'How much does dental treatment cost in Katpadi area?',
      answer: 'At Indira Dental Clinic serving Katpadi, root canal treatment costs ₹3,000-8,000, dental implants ₹25,000-45,000, and braces ₹30,000-80,000. We offer transparent pricing with no hidden costs.'
    },
    {
      question: 'Who is the best dentist for Katpadi patients?',
      answer: 'Dr. Rockson Samuel at Indira Dental Clinic in Vellore is highly experienced and trusted by Katpadi residents. With over 15 years of experience, he provides personalized dental care with modern technology.'
    },
    {
      question: 'How far is the dental clinic from Katpadi Junction?',
      answer: 'Our clinic in Gandhi Nagar is approximately 5-6 km from Katpadi Junction, easily accessible by car, auto, or bus within 15-20 minutes.'
    },
    {
      question: 'What dental services are available for Katpadi residents?',
  ...
  const reviews = [
    {
      ...
      text: 'Excellent dental clinic near Katpadi! Got my dental implants done by Dr. Rockson Samuel. The treatment was painless and the results are fantastic. Highly recommend!',
      date: '2024-01-15'
    },
    {
      ...
      text: 'Best orthodontist in Vellore! I live near Katpadi Junction and the clinic is very accessible. My braces treatment is going smoothly with great results.',
      date: '2024-01-10'
    },
    {
      name: 'Karthik Rajan',
      ...
      text: 'Came from Katpadi for RCT. The procedure was completely painless and completed in single sitting. Very professional staff and modern clinic.',
      date: '2024-01-08'
    }
  ]
  ...
  const amenities = [
    ...
    { icon: Car, name: 'Easy Access', description: 'Near Katpadi Junction' },
      ...
      <div className="container mx-auto px-4 py-12">
        <Breadcrumb
          items={[
            ...
            { title: 'Katpadi', href: '/in/tamil-nadu/vellore/katpadi' }
          ]}
          className="mb-8"
        />

        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dentist and Dental Clinic in Katpadi, Vellore</h1>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
            Welcome to Indira Dental Clinic - your trusted dental care provider serving Katpadi and surrounding areas. 
            Conveniently located near Katpadi Junction with comprehensive dental treatments.
          </p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Dental Services for Katpadi Patients</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Patient Reviews from Katpadi</h2>
            ...
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle className="flex items-center gap-2">
                  ...
                  How to Reach from Katpadi
                </ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Distance from Katpadi Junction:</h4>
                    <p className="text-gray-700">Approximately 5-6 km</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Travel Options:</h4>
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• By Car/Bike: 15-20 minutes</li>
                      <li>• By Auto: Easily available from Katpadi</li>
                      <li>• By Bus: Regular buses to Gandhi Nagar</li>
        ...
        <section className="mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <RelevantQAWidget
              title="Common Dental Questions from Katpadi"
              questions={[
                {
                  id: '1',
                  title: 'Best dental clinic near Katpadi Junction?',
                  slug: 'best-dental-clinic-katpadi',
                  excerpt: 'Indira Dental Clinic in Gandhi Nagar is the best choice for Katpadi patients.',
                  helpfulVotes: 45,
                  views: 1200,
                ...
                {
                  id: '2',
                  title: 'Root canal cost near Katpadi?',
                  slug: 'root-canal-cost-katpadi',
                ...
                {
                  id: '3',
                  title: 'Dental implants for Katpadi patients?',
                  slug: 'dental-implants-katpadi',
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                ...
                Conveniently located for Katpadi residents.
              </p>
        ...
        <PeopleAlsoSearchFor location="Katpadi" city="Vellore" />

        <CTAWidget
          title="Start Your Dental Journey Today"
          description="Join thousands of satisfied patients from Katpadi and surrounding areas who trust Indira Dental Clinic."
          primaryAction={{
          ...
          benefits={[
            ...
            "Convenient from Katpadi Junction"
          ]}
          showRating={true}
