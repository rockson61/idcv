...
export const metadata: Metadata = {
  title: 'Best Dentist in Thimmanamuthur, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thimmanamuthur. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Thimmanamuthur', 'dental clinic Thimmanamuthur', 'Tirupathur dentist'],
}

export default function ThimmanamuthurPage() {
  const distance = "67 km"

  const locationName = 'Thimmanamuthur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thimmanamuthur" city="Vellore" />
