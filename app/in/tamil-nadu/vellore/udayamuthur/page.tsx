...
export const metadata: Metadata = {
  title: 'Best Dentist in Udayamuthur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Udayamuthur. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Udayamuthur', 'dental clinic Udayamuthur', 'Tirupattur dentist'],
}

export default function UdayamuthurPage() {
  const distance = "67 km"

  const locationName = 'Udayamuthur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Udayamuthur" city="Vellore" />
