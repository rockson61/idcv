...
export const metadata: Metadata = {
  title: 'Best Dentist in Unai Vaniyambadi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Unai Vaniyambadi. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Unai Vaniyambadi', 'dental clinic Unai Vaniyambadi', 'Vlr dentist'],
}

export default function UnaiVaniyambadiPage() {
  const distance = "15 km"

  const locationName = 'Unai Vaniyambadi'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '15 km', slug: '', travelTime: '25 minutes', pincode: '632001' },
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632101' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632101" distance="15 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="15 km" travelTime="25 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "15 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Unai Vaniyambadi" city="Vellore" />
