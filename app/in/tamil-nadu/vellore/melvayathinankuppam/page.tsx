...
export const metadata: Metadata = {
  title: 'Best Dentist in Melvayathinankuppam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melvayathinankuppam. Dr. Rockson Samuel. PIN: 635805. Book: +91 70106 50063',
  keywords: ['dentist Melvayathinankuppam', 'dental clinic Melvayathinankuppam', 'Gudiyattam dentist'],
}

export default function MelvayathinankuppamPage() {
  const distance = "47 km"

  const locationName = 'Melvayathinankuppam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '47 km', slug: '', travelTime: '1 hour', pincode: '632001' },
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '635805' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="635805" distance="47 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="47 km" travelTime="1 hour" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "47 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Melvayathinankuppam" city="Vellore" />
