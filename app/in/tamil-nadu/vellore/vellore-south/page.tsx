...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore South, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore South. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Vellore South', 'dental clinic Vellore South', 'Vellore dentist'],
}

export default function VelloreSouthPage() {
  const distance = "1 km"

  const locationName = 'Vellore South'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vellore South" city="Vellore" />
