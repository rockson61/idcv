...
export const metadata: Metadata = {
  title: 'Best Dentist in Kamalapuram, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kamalapuram. Dr. Rockson Samuel. PIN: 635810. Book: +91 70106 50063',
  keywords: ['dentist Kamalapuram', 'dental clinic Kamalapuram', 'Gudiyatham dentist'],
}

export default function KamalapuramPage() {
  const distance = "48 km"

  const locationName = 'Kamalapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyatham', distance: '5-10 km', slug: 'gudiyatham', travelTime: '15 min', pincode: '635810' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyatham" pincode="635810" distance="48 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kamalapuram" city="Vellore" />
