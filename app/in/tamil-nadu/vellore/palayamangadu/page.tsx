...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayamangadu, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palayamangadu. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Palayamangadu', 'dental clinic Palayamangadu', 'Arcot dentist'],
}

export default function PalayamangaduPage() {
  const locationName = 'Palayamangadu'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '25 km', slug: '', travelTime: '35 minutes', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632503' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632503" distance="25 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="25 km" travelTime="35 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Palayamangadu" city="Vellore" />
