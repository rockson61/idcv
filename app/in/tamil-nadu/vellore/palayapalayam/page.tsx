...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayapalayam, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Palayapalayam. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Palayapalayam', 'dental clinic Palayapalayam', 'Tirupathur dentist'],
}

export default function PalayapalayamPage() {
  const distance = "69 km"

  const locationName = 'Palayapalayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Palayapalayam" city="Vellore" />
