...
export const metadata: Metadata = {
  title: 'Best Dentist in Sholingur Bazaar, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sholingur Bazaar. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Sholingur Bazaar', 'dental clinic Sholingur Bazaar', 'Arakkonam dentist'],
}

export default function SholingurBazaarPage() {
  const locationName = 'Sholingur Bazaar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631102" distance="50 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="50 km" travelTime="1 hour" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "50 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Sholingur Bazaar" city="Vellore" />
