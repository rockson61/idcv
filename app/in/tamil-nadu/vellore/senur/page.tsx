...
export const metadata: Metadata = {
  title: 'Best Dentist in Senur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Senur. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Senur', 'dental clinic Senur', 'Vlr dentist'],
}

export default function SenurPage() {
  const locationName = 'Senur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Senur" city="Vellore" />
