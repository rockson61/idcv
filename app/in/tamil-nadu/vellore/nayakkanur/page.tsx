...
export const metadata: Metadata = {
  title: 'Best Dentist in Nayakkanur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nayakkanur. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Nayakkanur', 'dental clinic Nayakkanur', 'Tirupattur dentist'],
}

export default function NayakkanurPage() {
  const distance = "67 km"

  const locationName = 'Nayakkanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nayakkanur" city="Vellore" />
