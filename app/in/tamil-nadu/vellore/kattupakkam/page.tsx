...
export const metadata: Metadata = {
  title: 'Best Dentist in Kattupakkam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kattupakkam. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Kattupakkam', 'dental clinic Kattupakkam', 'Arakkonam dentist'],
}

export default function KattupakkamPage() {
  const distance = "35 km"

  const locationName = 'Kattupakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kattupakkam" city="Vellore" />
