...
export const metadata: Metadata = {
  title: 'Best Dentist in Irungur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Irungur. Dr. Rockson Samuel. PIN: 604407. Book: +91 70106 50063',
  keywords: ['dentist Irungur', 'dental clinic Irungur', 'Arcot dentist'],
}

export default function IrungurPage() {
  const distance = "95 km"

  const locationName = 'Irungur'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '95 km', slug: '', travelTime: '2 hours', pincode: '632001' },
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '604407' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="604407" distance="95 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="95 km" travelTime="2 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "95 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Irungur" city="Vellore" />
