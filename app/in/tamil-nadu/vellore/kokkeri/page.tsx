...
export const metadata: Metadata = {
  title: 'Best Dentist in Kokkeri, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kokkeri. Dr. Rockson Samuel. PIN: 632520. Book: +91 70106 50063',
  keywords: ['dentist Kokkeri', 'dental clinic Kokkeri', 'Katpadi dentist'],
}

export default function KokkeriPage() {
  const distance = "14 km"

  const locationName = 'Kokkeri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kokkeri" city="Vellore" />
