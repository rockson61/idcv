...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumbulipakkam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumbulipakkam. Dr. Rockson Samuel. PIN: 632531. Book: +91 70106 50063',
  keywords: ['dentist Perumbulipakkam', 'dental clinic Perumbulipakkam', 'Arakkonam dentist'],
}

export default function PerumbulipakkamPage() {
  const locationName = 'Perumbulipakkam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '42 km', slug: '', travelTime: '55 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '632531' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="632531" distance="42 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="42 km" travelTime="55 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "42 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Perumbulipakkam" city="Vellore" />
