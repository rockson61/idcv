...
export const metadata: Metadata = {
  title: 'Best Dentist in Sathambakkam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sathambakkam. Dr. Rockson Samuel. PIN: 635808. Book: +91 70106 50063',
  keywords: ['dentist Sathambakkam', 'dental clinic Sathambakkam', 'Gudiyattam dentist'],
}

export default function SathambakkamPage() {
  const distance = "48 km"

  const locationName = 'Sathambakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sathambakkam" city="Vellore" />
