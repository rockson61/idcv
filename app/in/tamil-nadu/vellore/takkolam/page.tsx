...
export const metadata: Metadata = {
  title: 'Best Dentist in Takkolam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Takkolam. Dr. Rockson Samuel. PIN: 631151. Book: +91 70106 50063',
  keywords: ['dentist Takkolam', 'dental clinic Takkolam', 'Arakkonam dentist'],
}

export default function TakkolamPage() {
  const distance = "40 km"

  const locationName = 'Takkolam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Takkolam" city="Vellore" />
