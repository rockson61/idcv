...
export const metadata: Metadata = {
  title: 'Best Dentist in Poondi, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Poondi. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Poondi', 'dental clinic Poondi', 'Walajapet dentist'],
}

export default function PoondiPage() {
  const distance = "23 km"

  const locationName = 'Poondi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Poondi" city="Vellore" />
