...
export const metadata: Metadata = {
  title: 'Best Dentist in Timiri, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Timiri. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Timiri', 'dental clinic Timiri', 'Arcot dentist'],
}

export default function TimiriPage() {
  const distance = "32 km"

  const locationName = 'Timiri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632512" distance="32 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Timiri" city="Vellore" />
