...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Appukal, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Appukal. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Appukal', 'dental clinic Appukal', 'Vellore dentist'],
}

export default function AppukalPage() {
  const distance = "15 km"

  const locationName = 'Appukal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Appukal" city="Vellore" />
