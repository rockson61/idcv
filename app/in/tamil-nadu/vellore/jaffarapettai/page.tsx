...
export const metadata: Metadata = {
  title: 'Best Dentist in Jaffarapettai, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jaffarapettai. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Jaffarapettai', 'dental clinic Jaffarapettai', 'Katpadi dentist'],
}

export default function JaffarapettaiPage() {
  const distance = "7 km"

  const locationName = 'Jaffarapettai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632006' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632006" distance="7 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Jaffarapettai" city="Vellore" />
