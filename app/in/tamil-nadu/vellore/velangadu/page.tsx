...
export const metadata: Metadata = {
  title: 'Best Dentist in Velangadu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Velangadu. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Velangadu', 'dental clinic Velangadu', 'Vlr dentist'],
}

export default function VelangaduPage() {
  const distance = "15 km"

  const locationName = 'Velangadu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Velangadu" city="Vellore" />
