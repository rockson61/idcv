...
export const metadata: Metadata = {
  title: 'Best Dentist in Kosapet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kosapet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kosapet'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Kosapet', href: '/in/tamil-nadu/vellore/kosapet' },
          ]}
        />
