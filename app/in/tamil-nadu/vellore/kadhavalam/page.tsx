...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadhavalam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kadhavalam. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Kadhavalam', 'dental clinic Kadhavalam', 'Gudiyattam dentist'],
}

export default function KadhavalamPage() {
  const distance = "60 km"

  const locationName = 'Kadhavalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kadhavalam" city="Vellore" />
