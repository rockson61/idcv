...
export const metadata: Metadata = {
  title: 'Best Dentist in Thuthipattu Vaniyambadi, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thuthipattu Vaniyambadi. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Thuthipattu Vaniyambadi', 'dental clinic Thuthipattu Vaniyambadi', 'Vaniyambadi dentist'],
}

export default function ThuthipattuVaniyambadiPage() {
  const locationName = 'Thuthipattu Vaniyambadi'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '60 km', slug: '', travelTime: '1.4 hours', pincode: '632001' },
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635811' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635811" distance="60 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="60 km" travelTime="1.4 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "60 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Thuthipattu Vaniyambadi" city="Vellore" />
