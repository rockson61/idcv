...
export const metadata: Metadata = {
  title: 'Best Dentist in Thokkiyam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thokkiyam. Dr. Rockson Samuel. PIN: 635901. Book: +91 70106 50063',
  keywords: ['dentist Thokkiyam', 'dental clinic Thokkiyam', 'Tirupattur dentist'],
}

export default function ThokkiyamPage() {
  const distance = "72 km"

  const locationName = 'Thokkiyam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thokkiyam" city="Vellore" />
