...
export const metadata: Metadata = {
  title: 'Best Dentist in Budur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Budur. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Budur', 'dental clinic Budur', 'Vlr dentist'],
}

export default function BudurPage() {
  const distance = "13 km"

  const locationName = 'Budur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Budur" city="Vellore" />
