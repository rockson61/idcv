...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Nagalur, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nagalur. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Nagalur', 'dental clinic Nagalur', 'Vellore dentist'],
}

export default function NagalurPage() {
  const distance = "16 km"

  const locationName = 'Nagalur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nagalur" city="Vellore" />
