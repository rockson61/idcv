...
export const metadata: Metadata = {
  title: 'Best Dentist in Edayansathu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Edayansathu. Dr. Rockson Samuel. PIN: 632002. Book: +91 70106 50063',
  keywords: ['dentist Edayansathu', 'dental clinic Edayansathu', 'Vlr dentist'],
}

export default function EdayansathuPage() {
  const distance = "3 km"

  const locationName = 'Edayansathu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632002' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632002" distance="3 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Edayansathu" city="Vellore" />
