...
export const metadata: Metadata = {
  title: 'Best Dentist in Mallapalli, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mallapalli. Dr. Rockson Samuel. PIN: 635854. Book: +91 70106 50063',
  keywords: ['dentist Mallapalli', 'dental clinic Mallapalli', 'Tirupattur dentist'],
}

export default function MallapalliPage() {
  const distance = "78 km"

  const locationName = 'Mallapalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mallapalli" city="Vellore" />
