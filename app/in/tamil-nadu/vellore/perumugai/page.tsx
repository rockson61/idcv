...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumugai, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumugai. Dr. Rockson Samuel. PIN: 632009. Book: +91 70106 50063',
  keywords: ['dentist Perumugai', 'dental clinic Perumugai', 'Vlr dentist'],
}

export default function PerumugaiPage() {
  const distance = "8 km"

  const locationName = 'Perumugai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632009' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632009" distance="8 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Perumugai" city="Vellore" />
