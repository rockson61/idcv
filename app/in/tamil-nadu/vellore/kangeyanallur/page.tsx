...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kangeyanallur, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kangeyanallur. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Kangeyanallur', 'dental clinic Kangeyanallur', 'Vellore dentist'],
}

export default function KangeyanallurPage() {
  const locationName = 'Kangeyanallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kangeyanallur" city="Vellore" />
