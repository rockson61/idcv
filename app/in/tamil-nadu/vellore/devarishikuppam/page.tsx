...
export const metadata: Metadata = {
  title: 'Best Dentist in Devarishikuppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Devarishikuppam. Dr. Rockson Samuel. PIN: 632209. Book: +91 70106 50063',
  keywords: ['dentist Devarishikuppam', 'dental clinic Devarishikuppam', 'Katpadi dentist'],
}

export default function DevarishikuppamPage() {
  const distance = "19 km"

  const locationName = 'Devarishikuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Devarishikuppam" city="Vellore" />
