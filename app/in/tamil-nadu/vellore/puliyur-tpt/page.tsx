...
export const metadata: Metadata = {
  title: 'Best Dentist in Puliyur Tpt, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Puliyur Tpt. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Puliyur Tpt', 'dental clinic Puliyur Tpt', 'Tirupathur dentist'],
}

export default function PuliyurTptPage() {
  const distance = "69 km"

  const locationName = 'Puliyur Tpt'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Puliyur Tpt" city="Vellore" />
