...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kagithapattarai, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kagithapattarai. Dr. Rockson Samuel. PIN: 632012. Book: +91 70106 50063',
  keywords: ['dentist Kagithapattarai', 'dental clinic Kagithapattarai', 'Vellore dentist'],
}

export default function KagithapattaraiPage() {
  const distance = "7 km"

  const locationName = 'Kagithapattarai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kagithapattarai" city="Vellore" />
