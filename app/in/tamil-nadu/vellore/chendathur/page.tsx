...
export const metadata: Metadata = {
  title: 'Best Dentist in Chendathur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chendathur. Dr. Rockson Samuel. PIN: 635805. Book: +91 70106 50063',
  keywords: ['dentist Chendathur', 'dental clinic Chendathur', 'Gudiyattam dentist'],
}

export default function ChendathurPage() {
  const distance = "47 km"

  const locationName = 'Chendathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chendathur" city="Vellore" />
