...
export const metadata: Metadata = {
  title: 'Best Dentist in Sekkanur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sekkanur. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Sekkanur', 'dental clinic Sekkanur', 'Vlr dentist'],
}

export default function SekkanurPage() {
  const distance = "13 km"

  const locationName = 'Sekkanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sekkanur" city="Vellore" />
