...
export const metadata: Metadata = {
  title: 'Best Dentist in Gollamangalam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gollamangalam. Dr. Rockson Samuel. PIN: 635809. Book: +91 70106 50063',
  keywords: ['dentist Gollamangalam', 'dental clinic Gollamangalam', 'Katpadi dentist'],
}

export default function GollamangalamPage() {
  const distance = "35 km"

  const locationName = 'Gollamangalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gollamangalam" city="Vellore" />
