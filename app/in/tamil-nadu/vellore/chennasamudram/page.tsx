...
export const metadata: Metadata = {
  title: 'Best Dentist in Chennasamudram, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chennasamudram. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Chennasamudram', 'dental clinic Chennasamudram', 'Arcot dentist'],
}

export default function ChennasamudramPage() {
  const distance = "28 km"

  const locationName = 'Chennasamudram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chennasamudram" city="Vellore" />
