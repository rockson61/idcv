...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Sainathapuram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sainathapuram. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Sainathapuram', 'dental clinic Sainathapuram', 'Vellore dentist'],
}

export default function SainathapuramPage() {
  const distance = "1 km"

  const locationName = 'Sainathapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sainathapuram" city="Vellore" />
