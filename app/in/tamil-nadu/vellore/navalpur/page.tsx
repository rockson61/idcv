...
export const metadata: Metadata = {
  title: 'Best Dentist in Navalpur, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Navalpur. Dr. Rockson Samuel. PIN: 632401. Book: +91 70106 50063',
  keywords: ['dentist Navalpur', 'dental clinic Navalpur', 'Walajapet dentist'],
}

export default function NavalpurPage() {
  const locationName = 'Navalpur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632401' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632401" distance="20 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Navalpur" city="Vellore" />
