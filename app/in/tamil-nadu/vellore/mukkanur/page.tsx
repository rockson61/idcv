...
export const metadata: Metadata = {
  title: 'Best Dentist in Mukkanur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mukkanur. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Mukkanur', 'dental clinic Mukkanur', 'Tirupattur dentist'],
}

export default function MukkanurPage() {
  const distance = "68 km"

  const locationName = 'Mukkanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mukkanur" city="Vellore" />
