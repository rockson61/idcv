...
export const metadata: Metadata = {
  title: 'Best Dentist in Periyankuppam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periyankuppam. Dr. Rockson Samuel. PIN: 635814. Book: +91 70106 50063',
  keywords: ['dentist Periyankuppam', 'dental clinic Periyankuppam', 'Vaniyambadi dentist'],
}

export default function PeriyankuppamPage() {
  const distance = "59 km"

  const locationName = 'Periyankuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635814' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635814" distance="59 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Periyankuppam" city="Vellore" />
