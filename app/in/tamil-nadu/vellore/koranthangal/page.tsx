...
export const metadata: Metadata = {
  title: 'Best Dentist in Koranthangal, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Koranthangal. Dr. Rockson Samuel. PIN: 632106. Book: +91 70106 50063',
  keywords: ['dentist Koranthangal', 'dental clinic Koranthangal', 'Vlr dentist'],
}

export default function KoranthangalPage() {
  const locationName = 'Koranthangal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Koranthangal" city="Vellore" />
