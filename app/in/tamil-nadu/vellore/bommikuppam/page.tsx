...
export const metadata: Metadata = {
  title: 'Best Dentist in Bommikuppam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Bommikuppam. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Bommikuppam', 'dental clinic Bommikuppam', 'Tirupattur dentist'],
}

export default function BommikuppamPage() {
  const distance = "67 km"

  const locationName = 'Bommikuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Bommikuppam" city="Vellore" />
