...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Ampuram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ampuram. Dr. Rockson Samuel. PIN: 632009. Book: +91 70106 50063',
  keywords: ['dentist Ampuram', 'dental clinic Ampuram', 'Vellore dentist'],
}

export default function AmpuramPage() {
  const locationName = 'Ampuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ampuram" city="Vellore" />
