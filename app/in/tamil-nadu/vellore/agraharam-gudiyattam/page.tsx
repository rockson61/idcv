...
export const metadata: Metadata = {
  title: 'Best Dentist in Agraharam Gudiyattam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Agraharam Gudiyattam. Dr. Rockson Samuel. PIN: 632604. Book: +91 70106 50063',
  keywords: ['dentist Agraharam Gudiyattam', 'dental clinic Agraharam Gudiyattam', 'Gudiyattam dentist'],
}

export default function AgraharamGudiyattamPage() {
  const distance = "46 km"

  const locationName = 'Agraharam Gudiyattam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '632604' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="632604" distance="46 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Agraharam Gudiyattam" city="Vellore" />
