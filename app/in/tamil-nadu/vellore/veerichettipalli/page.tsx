...
export const metadata: Metadata = {
  title: 'Best Dentist in Veerichettipalli, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Veerichettipalli. Dr. Rockson Samuel. PIN: 632603. Book: +91 70106 50063',
  keywords: ['dentist Veerichettipalli', 'dental clinic Veerichettipalli', 'Gudiyattam dentist'],
}

export default function VeerichettipalliPage() {
  const distance = "46 km"

  const locationName = 'Veerichettipalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Veerichettipalli" city="Vellore" />
