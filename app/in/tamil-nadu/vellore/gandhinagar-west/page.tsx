...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Gandhinagar West, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gandhinagar West. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Gandhinagar West', 'dental clinic Gandhinagar West', 'Vellore dentist'],
}

export default function GandhinagarWestPage() {
  const locationName = 'Gandhinagar West'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gandhinagar West" city="Vellore" />
