...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Arakkonam, Vellore | Indira Dental Clinic | RCT, Implants, Braces',
  description: 'Expert dental care in Arakkonam. Dr. Rockson Samuel provides RCT, dental implants, braces, cosmetic dentistry. Book appointment: +91 70106 50063',
  keywords: ['dentist Arakkonam', 'dental clinic Arakkonam Vellore', 'dental implants Arakkonam', 'RCT Arakkonam', 'braces Arakkonam', 'best dentist Arakkonam'],
}

export default function ArakkonamPage() {
  const locationName = 'Arakkonam'
  const distance = '35 km'
  const travelTime = '45 minutes'
  ...
  const amenities = [
    { name: 'State Bank of India', type: 'bank' as const, distance: '0.5 km', address: 'Railway Station Road' },
    { name: 'ICICI Bank ATM', type: 'atm' as const, distance: '0.3 km', address: 'Near Bus Stand' },
    { name: 'Arakkonam Post Office', type: 'post_office' as const, distance: '0.8 km', address: 'Main Road' },
    { name: 'Government Hospital', type: 'hospital' as const, distance: '1.2 km', address: 'Hospital Road' },
    { name: 'Local Market', type: 'shopping' as const, distance: '0.4 km', address: 'Bazaar Street' },
    { name: 'Hotel Saravana Bhavan', type: 'restaurant' as const, distance: '0.6 km', address: 'Railway Road' },
  ]

  const touristPlaces = ['Arakkonam Fort', 'Sri Ranganathaswamy Temple', 'Vedanthangal Bird Sanctuary', 'INS Rajali Naval Base']
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore City', distance: '35 km', slug: '' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm">
              ...
              <span className="text-sm font-medium text-gray-700">{distance} from {locationName}</span>
            </div>
            <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-sm">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">
            Other Locations We Serve Near {locationName}
          </h2>
            ...
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle className="flex items-center gap-2">
                  ...
                  How to Reach from {locationName}
                </ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• By Train: Arakkonam to Katpadi Junction</li>
