...
export const metadata: Metadata = {
  title: 'Best Dentist in East Badanavadi, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in East Badanavadi. Dr. Rockson Samuel. PIN: 635901. Book: +91 70106 50063',
  keywords: ['dentist East Badanavadi', 'dental clinic East Badanavadi', 'Tirupathur dentist'],
}

export default function EastBadanavadiPage() {
  const distance = "72 km"

  const locationName = 'East Badanavadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="East Badanavadi" city="Vellore" />
