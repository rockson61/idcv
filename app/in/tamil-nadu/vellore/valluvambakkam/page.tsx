...
export const metadata: Metadata = {
  title: 'Best Dentist in Valluvambakkam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Valluvambakkam. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Valluvambakkam', 'dental clinic Valluvambakkam', 'Walajapet dentist'],
}

export default function ValluvambakkamPage() {
  const distance = "23 km"

  const locationName = 'Valluvambakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Valluvambakkam" city="Vellore" />
