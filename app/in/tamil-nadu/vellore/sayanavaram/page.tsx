...
export const metadata: Metadata = {
  title: 'Best Dentist in Sayanavaram, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sayanavaram. Dr. Rockson Samuel. PIN: 631051. Book: +91 70106 50063',
  keywords: ['dentist Sayanavaram', 'dental clinic Sayanavaram', 'Arakonam dentist'],
}

export default function SayanavaramPage() {
  const distance = "38 km"

  const locationName = 'Sayanavaram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '631051' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="631051" distance="38 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Sayanavaram" city="Vellore" />
