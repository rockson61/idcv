...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore Bazaar, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Bazaar. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist Vellore Bazaar', 'dental clinic Vellore Bazaar', 'Vellore dentist'],
}

export default function VelloreBazaarPage() {
  const distance = "3 km"

  const locationName = 'Vellore Bazaar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vellore Bazaar" city="Vellore" />
