...
export const metadata: Metadata = {
  title: 'Best Dentist in Karikkanthangal, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karikkanthangal. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Karikkanthangal', 'dental clinic Karikkanthangal', 'Arcot dentist'],
}

export default function KarikkanthangalPage() {
  const distance = "28 km"

  const locationName = 'Karikkanthangal'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632506' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632506" distance="28 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Karikkanthangal" city="Vellore" />
