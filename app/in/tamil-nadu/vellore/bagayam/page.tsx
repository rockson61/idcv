...
export const metadata: Metadata = {
  title: 'Best Dentist in Bagayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Bagayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bagayam'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
