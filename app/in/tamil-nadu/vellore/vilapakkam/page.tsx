...
export const metadata: Metadata = {
  title: 'Best Dentist in Vilapakkam, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vilapakkam. Dr. Rockson Samuel. PIN: 632521. Book: +91 70106 50063',
  keywords: ['dentist Vilapakkam', 'dental clinic Vilapakkam', 'Arcot dentist'],
}

export default function VilapakkamPage() {
  const distance = "33 km"

  const locationName = 'Vilapakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vilapakkam" city="Vellore" />
