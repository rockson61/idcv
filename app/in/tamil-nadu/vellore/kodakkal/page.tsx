...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodakkal, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kodakkal. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Kodakkal', 'dental clinic Kodakkal', 'Wallajah dentist'],
}

export default function KodakkalPage() {
  const distance = "40 km"

  const locationName = 'Kodakkal'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '631102' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="631102" distance="40 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kodakkal" city="Vellore" />
