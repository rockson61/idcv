...
export const metadata: Metadata = {
  title: 'Best Dentist in Jangalapuram, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jangalapuram. Dr. Rockson Samuel. PIN: 635852. Book: +91 70106 50063',
  keywords: ['dentist Jangalapuram', 'dental clinic Jangalapuram', 'Tirupathur dentist'],
}

export default function JangalapuramPage() {
  const distance = "77 km"

  const locationName = 'Jangalapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Jangalapuram" city="Vellore" />
