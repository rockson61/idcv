...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore Cantonment, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Cantonment. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Vellore Cantonment', 'dental clinic Vellore Cantonment', 'Vellore dentist'],
}

export default function VelloreCantonmentPage() {
  const distance = "1 km"

  const locationName = 'Vellore Cantonment'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vellore Cantonment" city="Vellore" />
