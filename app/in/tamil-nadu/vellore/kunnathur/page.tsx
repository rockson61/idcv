...
export const metadata: Metadata = {
  title: 'Best Dentist in Kunnathur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kunnathur. Dr. Rockson Samuel. PIN: 632510. Book: +91 70106 50063',
  keywords: ['dentist Kunnathur', 'dental clinic Kunnathur', 'Arakkonam dentist'],
}

export default function KunnathurPage() {
  const distance = "38 km"

  const locationName = 'Kunnathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kunnathur" city="Vellore" />
