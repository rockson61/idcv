...
export const metadata: Metadata = {
  title: 'Best Dentist in Vettuvanam, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vettuvanam. Dr. Rockson Samuel. PIN: 635809. Book: +91 70106 50063',
  keywords: ['dentist Vettuvanam', 'dental clinic Vettuvanam', 'Gudiyatham dentist'],
}

export default function VettuvanamPage() {
  const distance = "35 km"

  const locationName = 'Vettuvanam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vettuvanam" city="Vellore" />
