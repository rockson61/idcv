...
export const metadata: Metadata = {
  title: 'Best Dentist in Ganganallur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ganganallur. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Ganganallur', 'dental clinic Ganganallur', 'Vlr dentist'],
}

export default function GanganallurPage() {
  const distance = "15 km"

  const locationName = 'Ganganallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ganganallur" city="Vellore" />
