...
export const metadata: Metadata = {
  title: 'Best Dentist in Nayanacheruvu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nayanacheruvu. Dr. Rockson Samuel. PIN: 635852. Book: +91 70106 50063',
  keywords: ['dentist Nayanacheruvu', 'dental clinic Nayanacheruvu', 'Tirupattur dentist'],
}

export default function NayanacheruvuPage() {
  const distance = "77 km"

  const locationName = 'Nayanacheruvu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635852' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635852" distance="77 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Nayanacheruvu" city="Vellore" />
