...
export const metadata: Metadata = {
  title: 'Best Dentist in Karnavur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karnavur. Dr. Rockson Samuel. PIN: 631052. Book: +91 70106 50063',
  keywords: ['dentist Karnavur', 'dental clinic Karnavur', 'Arakkonam dentist'],
}

export default function KarnavurPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Karnavur" city="Vellore" />
