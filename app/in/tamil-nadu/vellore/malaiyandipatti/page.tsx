...
export const metadata: Metadata = {
  title: 'Best Dentist in Malaiyandipatti, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Malaiyandipatti. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Malaiyandipatti', 'dental clinic Malaiyandipatti', 'Tirupathur dentist'],
}

export default function MalaiyandipattiPage() {
  const distance = "69 km"

  const locationName = 'Malaiyandipatti'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '69 km', slug: '', travelTime: '1.6 hours', pincode: '632001' },
    { name: 'Tirupathur', distance: '5-10 km', slug: 'tirupathur', travelTime: '15 min', pincode: '635655' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupathur" pincode="635655" distance="69 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="69 km" travelTime="1.6 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "69 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Malaiyandipatti" city="Vellore" />
