...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kilarasampattu, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilarasampattu. Dr. Rockson Samuel. PIN: 632312. Book: +91 70106 50063',
  keywords: ['dentist Kilarasampattu', 'dental clinic Kilarasampattu', 'Vellore dentist'],
}

export default function KilarasampattuPage() {
  const distance = "10 km"

  const locationName = 'Kilarasampattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilarasampattu" city="Vellore" />
