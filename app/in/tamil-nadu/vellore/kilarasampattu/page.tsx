...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilarasampattu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kilarasampattu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Kilarasampattu', href: '/in/tamil-nadu/vellore/kilarasampattu' },
          ]}
        />
