...
export const metadata: Metadata = {
  title: 'Best Dentist in Shenbakkam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Shenbakkam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Shenbakkam', href: '/in/tamil-nadu/vellore/shenbakkam' },
          ]}
        />
