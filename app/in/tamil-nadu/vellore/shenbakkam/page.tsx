...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Shenbakkam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Shenbakkam. Dr. Rockson Samuel. PIN: 632008. Book: +91 70106 50063',
  keywords: ['dentist Shenbakkam', 'dental clinic Shenbakkam', 'Vellore dentist'],
}

export default function ShenbakkamPage() {
  const locationName = 'Shenbakkam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632008' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632008" distance="7 km" category="town" className="mb-12"/>
