...
export const metadata: Metadata = {
  title: 'Best Dentist in Chettikuppam, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chettikuppam. Dr. Rockson Samuel. PIN: 635806. Book: +91 70106 50063',
  keywords: ['dentist Chettikuppam', 'dental clinic Chettikuppam', 'Gudiyattam dentist'],
}

export default function ChettikuppamPage() {
  const distance = "47 km"

  const locationName = 'Chettikuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chettikuppam" city="Vellore" />
