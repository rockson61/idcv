...
export const metadata: Metadata = {
  title: 'Best Dentist in Pudur Kaniyanur, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pudur Kaniyanur. Dr. Rockson Samuel. PIN: 632506. Book: +91 70106 50063',
  keywords: ['dentist Pudur Kaniyanur', 'dental clinic Pudur Kaniyanur', 'Arcot dentist'],
}

export default function PudurKaniyanurPage() {
  const locationName = 'Pudur Kaniyanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pudur Kaniyanur" city="Vellore" />
