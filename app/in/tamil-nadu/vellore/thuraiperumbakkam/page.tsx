...
export const metadata: Metadata = {
  title: 'Best Dentist in Thuraiperumbakkam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thuraiperumbakkam. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Thuraiperumbakkam', 'dental clinic Thuraiperumbakkam', 'Walajapet dentist'],
}

export default function ThuraiperumbakkamPage() {
  const distance = "22 km"

  const locationName = 'Thuraiperumbakkam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '22 km', slug: '', travelTime: '32 minutes', pincode: '632001' },
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632508' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632508" distance="22 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="22 km" travelTime="32 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Thuraiperumbakkam" city="Vellore" />
