...
export const metadata: Metadata = {
  title: 'Best Dentist in Narasingapuram, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Narasingapuram. Dr. Rockson Samuel. PIN: 635701. Book: +91 70106 50063',
  keywords: ['dentist Narasingapuram', 'dental clinic Narasingapuram', 'Vaniyambadi dentist'],
}

export default function NarasingapuramPage() {
  const distance = "60 km"

  const locationName = 'Narasingapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635701' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635701" distance="60 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Narasingapuram" city="Vellore" />
