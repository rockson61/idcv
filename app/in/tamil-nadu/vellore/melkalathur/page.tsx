...
export const metadata: Metadata = {
  title: 'Best Dentist in Melkalathur, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melkalathur. Dr. Rockson Samuel. PIN: 632502. Book: +91 70106 50063',
  keywords: ['dentist Melkalathur', 'dental clinic Melkalathur', 'Arakonam dentist'],
}

export default function MelkalathurPage() {
  const distance = "35 km"

  const locationName = 'Melkalathur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '632502' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="632502" distance="35 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Melkalathur" city="Vellore" />
