...
export const metadata: Metadata = {
  title: 'Best Dentist in Melkalathur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Melkalathur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Melkalathur', href: '/in/tamil-nadu/vellore/melkalathur' },
          ]}
        />
