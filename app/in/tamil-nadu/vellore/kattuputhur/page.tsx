...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kattuputhur, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kattuputhur. Dr. Rockson Samuel. PIN: 632058. Book: +91 70106 50063',
  keywords: ['dentist Kattuputhur', 'dental clinic Kattuputhur', 'Vellore dentist'],
}

export default function KattuputhurPage() {
  const locationName = 'Kattuputhur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632058' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632058" distance="12 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kattuputhur" city="Vellore" />
