...
export const metadata: Metadata = {
  title: 'Best Dentist in Newtown Vaniyambadi, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Newtown Vaniyambadi. Dr. Rockson Samuel. PIN: 635752. Book: +91 70106 50063',
  keywords: ['dentist Newtown Vaniyambadi', 'dental clinic Newtown Vaniyambadi', 'Vaniyambadi dentist'],
}

export default function NewtownVaniyambadiPage() {
  const distance = "56 km"

  const locationName = 'Newtown Vaniyambadi'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635752' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635752" distance="56 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Newtown Vaniyambadi" city="Vellore" />
