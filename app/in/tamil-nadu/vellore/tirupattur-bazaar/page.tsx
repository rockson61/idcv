...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupattur Bazaar, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tirupattur Bazaar. Dr. Rockson Samuel. PIN: 635602. Book: +91 70106 50063',
  keywords: ['dentist Tirupattur Bazaar', 'dental clinic Tirupattur Bazaar', 'Tirupattur dentist'],
}

export default function TirupatturBazaarPage() {
  const distance = "66 km"

  const locationName = 'Tirupattur Bazaar'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635602' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635602" distance="66 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Tirupattur Bazaar" city="Vellore" />
