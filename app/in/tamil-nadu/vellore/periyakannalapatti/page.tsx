...
export const metadata: Metadata = {
  title: 'Best Dentist in Periyakannalapatti, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periyakannalapatti. Dr. Rockson Samuel. PIN: 635654. Book: +91 70106 50063',
  keywords: ['dentist Periyakannalapatti', 'dental clinic Periyakannalapatti', 'Tirupattur dentist'],
}

export default function PeriyakannalapattiPage() {
  const distance = "68 km"

  const locationName = 'Periyakannalapatti'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635654' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635654" distance="68 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Periyakannalapatti" city="Vellore" />
