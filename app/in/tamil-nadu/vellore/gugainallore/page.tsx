...
export const metadata: Metadata = {
  title: 'Best Dentist in Gugainallore, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gugainallore. Dr. Rockson Samuel. PIN: 632515. Book: +91 70106 50063',
  keywords: ['dentist Gugainallore', 'dental clinic Gugainallore', 'Walajapet dentist'],
}

export default function GugainallorePage() {
  const locationName = 'Gugainallore'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Walajapet', distance: '5-10 km', slug: 'walajapet', travelTime: '15 min', pincode: '632515' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Walajapet" pincode="632515" distance="25 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Gugainallore" city="Vellore" />
