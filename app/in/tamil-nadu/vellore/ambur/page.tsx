...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ambur'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
