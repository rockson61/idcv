...
export const metadata: Metadata = {
  title: 'Best Dentist in Maruthavallipalayam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Maruthavallipalayam. Dr. Rockson Samuel. PIN: 632104. Book: +91 70106 50063',
  keywords: ['dentist Maruthavallipalayam', 'dental clinic Maruthavallipalayam', 'Vlr dentist'],
}

export default function MaruthavallipalayamPage() {
  const distance = "13 km"

  const locationName = 'Maruthavallipalayam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632104' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632104" distance="13 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Maruthavallipalayam" city="Vellore" />
