...
export const metadata: Metadata = {
  title: 'Best Dentist in Senganavaram, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Senganavaram. Dr. Rockson Samuel. PIN: 632518. Book: +91 70106 50063',
  keywords: ['dentist Senganavaram', 'dental clinic Senganavaram', 'Arcot dentist'],
}

export default function SenganavaramPage() {
  const distance = "26 km"

  const locationName = 'Senganavaram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arcot', distance: '5-10 km', slug: 'arcot', travelTime: '15 min', pincode: '632518' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arcot" pincode="632518" distance="26 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Senganavaram" city="Vellore" />
