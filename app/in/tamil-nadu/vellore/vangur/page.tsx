...
export const metadata: Metadata = {
  title: 'Best Dentist in Vangur, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vangur. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Vangur', 'dental clinic Vangur', 'Walajapet dentist'],
}

export default function VangurPage() {
  const distance = "24 km"

  const locationName = 'Vangur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vangur" city="Vellore" />
