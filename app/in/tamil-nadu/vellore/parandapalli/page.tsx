...
export const metadata: Metadata = {
  title: 'Best Dentist in Parandapalli, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Parandapalli. Dr. Rockson Samuel. PIN: 635651. Book: +91 70106 50063',
  keywords: ['dentist Parandapalli', 'dental clinic Parandapalli', 'Tirupathur dentist'],
}

export default function ParandapalliPage() {
  const distance = "68 km"

  const locationName = 'Parandapalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Parandapalli" city="Vellore" />
