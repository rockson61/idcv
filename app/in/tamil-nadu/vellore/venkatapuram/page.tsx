...
export const metadata: Metadata = {
  title: 'Best Dentist in Venkatapuram, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Venkatapuram. Dr. Rockson Samuel. PIN: 632507. Book: +91 70106 50063',
  keywords: ['dentist Venkatapuram', 'dental clinic Venkatapuram', 'Arcot dentist'],
}

export default function VenkatapuramPage() {
  const distance = "27 km"

  const locationName = 'Venkatapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Venkatapuram" city="Vellore" />
