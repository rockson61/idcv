...
export const metadata: Metadata = {
  title: 'Best Dentist in Sirunamalli, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sirunamalli. Dr. Rockson Samuel. PIN: 631002. Book: +91 70106 50063',
  keywords: ['dentist Sirunamalli', 'dental clinic Sirunamalli', 'Arakkonam dentist'],
}

export default function SirunamalliPage() {
  const distance = "36 km"

  const locationName = 'Sirunamalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sirunamalli" city="Vellore" />
