...
export const metadata: Metadata = {
  title: 'Best Dentist in Sirunamalli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sirunamalli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Sirunamalli', href: '/in/tamil-nadu/vellore/sirunamalli' },
          ]}
        />
