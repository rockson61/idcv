...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilvenkatapuram, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilvenkatapuram. Dr. Rockson Samuel. PIN: 631051. Book: +91 70106 50063',
  keywords: ['dentist Kilvenkatapuram', 'dental clinic Kilvenkatapuram', 'Arakkonam dentist'],
}

export default function KilvenkatapuramPage() {
  const distance = "38 km"

  const locationName = 'Kilvenkatapuram'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '38 km', slug: '', travelTime: '50 minutes', pincode: '632001' },
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631051' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631051" distance="38 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="38 km" travelTime="50 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "38 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Kilvenkatapuram" city="Vellore" />
