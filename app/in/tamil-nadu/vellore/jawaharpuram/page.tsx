...
export const metadata: Metadata = {
  title: 'Best Dentist in Jawaharpuram, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jawaharpuram. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Jawaharpuram', 'dental clinic Jawaharpuram', 'Arcot dentist'],
}

export default function JawaharpuramPage() {
  const locationName = 'Jawaharpuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Jawaharpuram" city="Vellore" />
