...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilpatti, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilpatti. Dr. Rockson Samuel. PIN: 635805. Book: +91 70106 50063',
  keywords: ['dentist Kilpatti', 'dental clinic Kilpatti', 'Gudiyattam dentist'],
}

export default function KilpattiPage() {
  const distance = "47 km"

  const locationName = 'Kilpatti'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kilpatti" city="Vellore" />
