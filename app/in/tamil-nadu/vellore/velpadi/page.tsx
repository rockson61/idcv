...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Velpadi, Vellore | Indira Dental Clinic',
  description: 'Expert dental services in Velpadi, Vellore. RCT, dental implants, braces by Dr. Rockson Samuel.',
  keywords: ['dentist Velpadi', 'dental clinic Velpadi Vellore', 'dental services Velpadi', 'best dentist Velpadi'],
}

export default function VelpadiPage() {
  const services = [
  ...
  const faqs = [
    { question: 'Where is the best dental clinic near Velpadi?', answer: 'Indira Dental Clinic in Gandhi Nagar, Vellore is the best choice for Velpadi residents, just 4 km away with comprehensive dental services.' },
    { question: 'How much does dental treatment cost in Velpadi area?', answer: 'At Indira Dental Clinic serving Velpadi, root canal treatment costs ₹3,000-8,000, dental implants ₹25,000-45,000, and braces ₹30,000-80,000.' },
    { question: 'Who is the best dentist for Velpadi patients?', answer: 'Dr. Rockson Samuel at Indira Dental Clinic has 15+ years of experience and is highly trusted by Velpadi residents for all dental treatments.' },
    { question: 'How far is the dental clinic from Velpadi?', answer: 'Our clinic in Gandhi Nagar is approximately 4 km from Velpadi, easily reachable within 10-15 minutes.' },
    { question: 'What dental services are available for Velpadi residents?', answer: 'We offer complete dental services including RCT, implants, braces, cosmetic dentistry, general dentistry, and pediatric care with latest technology.' }
  ]

  const reviews = [
    { name: 'Saravanan Raj', location: 'Velpadi', rating: 5, treatment: 'Dental Implants', text: 'Very close to Velpadi! Got dental implants done. Dr. Rockson is excellent. Results are perfect!', date: '2024-01-15' },
    { name: 'Deepa Lakshmi', location: 'Velpadi', rating: 5, treatment: 'Root Canal', text: 'Best dentist near Velpadi! RCT was painless. Clinic is very close and convenient.', date: '2024-01-10' },
    { name: 'Naveen Kumar', location: 'Velpadi', rating: 5, treatment: 'Braces', text: 'My daughter got braces. Very satisfied. Just 10 minutes from Velpadi. Highly recommend!', date: '2024-01-08' }
  ]
  ...
  const amenities = [
    ...
    { icon: Car, name: 'Very Close', description: 'Just 4 km from Velpadi' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        <Breadcrumb items={[{ title: 'Home', href: '/' }, { title: 'India', href: '/in' }, { title: 'Tamil Nadu', href: '/in/tamil-nadu' }, { title: 'Vellore', href: '/in/tamil-nadu/vellore' }, { title: 'Velpadi', href: '/in/tamil-nadu/vellore/velpadi' }]} className="mb-8" />
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Best Dentist and Dental Clinic in Velpadi, Vellore</h1>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">Welcome to Indira Dental Clinic - serving Velpadi and surrounding areas. Just 4 km away with comprehensive dental treatments.</p>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Dental Services for Velpadi Patients</h2>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Patient Reviews from Velpadi</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ModernCard><ModernCardHeader><ModernCardTitle className="flex items-center gap-2"><Navigation className="w-6 h-6 text-teal-600" />How to Reach from Velpadi</ModernCardTitle></ModernCardHeader><ModernCardContent><div className="space-y-4"><div><h4 className="font-semibold text-gray-900 mb-2">Distance from Velpadi:</h4><p className="text-gray-700">Approximately 4 km</p></div><div><h4 className="font-semibold text-gray-900 mb-2">Travel Options:</h4><ul className="text-sm text-gray-700 space-y-1"><li>• By Car/Bike: 10-15 minutes</li><li>• By Auto: Very convenient</li><li>• Walking distance from parts of Velpadi</li><li>• Free parking at clinic</li></ul></div></div></ModernCardContent></ModernCard>
          </div>
        </section>
        <section className="mb-12">
        ...
        <section className="text-center mb-12">
          <ModernCard><ModernCardContent className="py-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to Transform Your Smile?</h2><p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">Book your appointment today. Just 10-15 minutes from Velpadi!</p><div className="flex flex-col sm:flex-row gap-4 justify-center"><Link href="/contact" className="inline-flex items-center justify-center px-8 py-3 bg-teal-600 text-white rounded-lg font-semibold hover:bg-teal-700 transition-colors"><Phone className="w-5 h-5 mr-2" />Book Appointment</Link><Link href="/services" className="inline-flex items-center justify-center px-8 py-3 border-2 border-teal-600 text-teal-600 rounded-lg font-semibold hover:bg-teal-50 transition-colors"><Navigation className="w-5 h-5 mr-2" />View Services</Link></div></ModernCardContent></ModernCard>
        </section>
        
        <PeopleAlsoSearchFor location="Velpadi" city="Vellore" />

        <CTAWidget title="Start Your Dental Journey Today" description="Join satisfied patients from Velpadi who trust Indira Dental Clinic." primaryAction={{text:"Book Free Consultation",href:"/contact"}} secondaryAction={{text:"Ask a Question",href:"/ask-the-dentist/submit"}} benefits={["15+ years experience","Modern equipment","Flexible payment plans","Very close to Velpadi"]} showRating={true} showAvailability={true} />
      </div>
    </div>
  )
}
