...
export const metadata: Metadata = {
  title: 'Best Dentist in Gandhi Nagar, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gandhi Nagar, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gandhi Nagar'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
