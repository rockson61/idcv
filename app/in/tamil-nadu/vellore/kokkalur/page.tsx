...
export const metadata: Metadata = {
  title: 'Best Dentist in Kokkalur, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kokkalur. Dr. Rockson Samuel. PIN: 635810. Book: +91 70106 50063',
  keywords: ['dentist Kokkalur', 'dental clinic Kokkalur', 'Gudiyatham dentist'],
}

export default function KokkalurPage() {
  const distance = "48 km"

  const locationName = 'Kokkalur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kokkalur" city="Vellore" />
