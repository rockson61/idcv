...
export const metadata: Metadata = {
  title: 'Best Dentist in Kosavanpudur, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kosavanpudur. Dr. Rockson Samuel. PIN: 635803. Book: +91 70106 50063',
  keywords: ['dentist Kosavanpudur', 'dental clinic Kosavanpudur', 'Gudiyatham dentist'],
}

export default function KosavanpudurPage() {
  const distance = "46 km"

  const locationName = 'Kosavanpudur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kosavanpudur" city="Vellore" />
