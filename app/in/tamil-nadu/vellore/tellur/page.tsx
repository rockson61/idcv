...
export const metadata: Metadata = {
  title: 'Best Dentist in Tellur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tellur. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Tellur', 'dental clinic Tellur', 'Vlr dentist'],
}

export default function TellurPage() {
  const distance = "13 km"

  const locationName = 'Tellur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tellur" city="Vellore" />
