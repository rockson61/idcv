...
export const metadata: Metadata = {
  title: 'Best Dentist in Chengalnatham, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chengalnatham. Dr. Rockson Samuel. PIN: 632520. Book: +91 70106 50063',
  keywords: ['dentist Chengalnatham', 'dental clinic Chengalnatham', 'Wallajah dentist'],
}

export default function ChengalnathamPage() {
  const distance = "28 km"

  const locationName = 'Chengalnatham'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '28 km', slug: '', travelTime: '40 minutes', pincode: '632001' },
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '632520' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="632520" distance="28 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="28 km" travelTime="40 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "28 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Chengalnatham" city="Vellore" />
