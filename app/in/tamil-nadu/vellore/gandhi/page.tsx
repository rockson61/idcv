...
export const metadata: Metadata = {
  title: 'Best Dentist in Gandhi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gandhi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gandhi'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Gandhi', href: '/in/tamil-nadu/vellore/gandhi' },
          ]}
        />
