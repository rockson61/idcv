...
export const metadata: Metadata = {
  title: 'Best Dentist in Arangaldurgam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arangaldurgam. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Arangaldurgam', 'dental clinic Arangaldurgam', 'Vaniyambadi dentist'],
}

export default function ArangaldurgamPage() {
  const distance = "60 km"

  const locationName = 'Arangaldurgam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Arangaldurgam" city="Vellore" />
