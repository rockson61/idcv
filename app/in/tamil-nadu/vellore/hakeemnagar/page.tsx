...
export const metadata: Metadata = {
  title: 'Best Dentist in Hakeemnagar, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Hakeemnagar. Dr. Rockson Samuel. PIN: 632509. Book: +91 70106 50063',
  keywords: ['dentist Hakeemnagar', 'dental clinic Hakeemnagar', 'Walajapet dentist'],
}

export default function HakeemnagarPage() {
  const distance = "22 km"

  const locationName = 'Hakeemnagar'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Hakeemnagar" city="Vellore" />
