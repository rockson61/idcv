...
export const metadata: Metadata = {
  title: 'Best Dentist in Ka Farm, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ka Farm. Dr. Rockson Samuel. PIN: 632007. Book: +91 70106 50063',
  keywords: ['dentist Ka Farm', 'dental clinic Ka Farm', 'Vlr dentist'],
}

export default function KaFarmPage() {
  const distance = "6 km"

  const locationName = 'Ka Farm'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ka Farm" city="Vellore" />
