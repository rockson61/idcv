...
export const metadata: Metadata = {
  title: 'Best Dentist in Erayangadu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Erayangadu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Erayangadu', href: '/in/tamil-nadu/vellore/erayangadu' },
          ]}
        />
