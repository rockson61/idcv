...
export const metadata: Metadata = {
  title: 'Best Dentist in Erayangadu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Erayangadu. Dr. Rockson Samuel. PIN: 632104. Book: +91 70106 50063',
  keywords: ['dentist Erayangadu', 'dental clinic Erayangadu', 'Vlr dentist'],
}

export default function ErayangaduPage() {
  const distance = "13 km"

  const locationName = 'Erayangadu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Erayangadu" city="Vellore" />
