...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudanagaram, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gudanagaram. Dr. Rockson Samuel. PIN: 635806. Book: +91 70106 50063',
  keywords: ['dentist Gudanagaram', 'dental clinic Gudanagaram', 'Gudiyattam dentist'],
}

export default function GudanagaramPage() {
  const distance = "47 km"

  const locationName = 'Gudanagaram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gudanagaram" city="Vellore" />
