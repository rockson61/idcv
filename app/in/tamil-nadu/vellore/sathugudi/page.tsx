...
export const metadata: Metadata = {
  title: 'Best Dentist in Sathugudi, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sathugudi. Dr. Rockson Samuel. PIN: 635810. Book: +91 70106 50063',
  keywords: ['dentist Sathugudi', 'dental clinic Sathugudi', 'Gudiyatham dentist'],
}

export default function SathugudiPage() {
  const distance = "48 km"

  const locationName = 'Sathugudi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sathugudi" city="Vellore" />
