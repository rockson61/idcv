...
export const metadata: Metadata = {
  title: 'Best Dentist in Nambarai, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nambarai. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Nambarai', 'dental clinic Nambarai', 'Arcot dentist'],
}

export default function NambaraiPage() {
  const distance = "30 km"

  const locationName = 'Nambarai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nambarai" city="Vellore" />
