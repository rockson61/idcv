...
export const metadata: Metadata = {
  title: 'Best Dentist in Vaniyambadi RS, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vaniyambadi RS. Dr. Rockson Samuel. PIN: 635751. Book: +91 70106 50063',
  keywords: ['dentist Vaniyambadi RS', 'dental clinic Vaniyambadi RS', 'Vaniyambadi dentist'],
}

export default function VaniyambadiRSPage() {
  const distance = "55 km"

  const locationName = 'Vaniyambadi RS'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vaniyambadi Rs" city="Vellore" />
