...
export const metadata: Metadata = {
  title: 'Best Dentist in Annangudi, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Annangudi. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Annangudi', 'dental clinic Annangudi', 'Katpadi dentist'],
}

export default function AnnangudiPage() {
  const distance = "17 km"

  const locationName = 'Annangudi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Annangudi" city="Vellore" />
