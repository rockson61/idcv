...
export const metadata: Metadata = {
  title: 'Best Dentist in Valapandal, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Valapandal. Dr. Rockson Samuel. PIN: 632318. Book: +91 70106 50063',
  keywords: ['dentist Valapandal', 'dental clinic Valapandal', 'Arcot dentist'],
}

export default function ValapandalPage() {
  const locationName = 'Valapandal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Valapandal" city="Vellore" />
