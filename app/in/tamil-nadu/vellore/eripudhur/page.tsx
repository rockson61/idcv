...
export const metadata: Metadata = {
  title: 'Best Dentist in Eripudhur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Eripudhur. Dr. Rockson Samuel. PIN: 632101. Book: +91 70106 50063',
  keywords: ['dentist Eripudhur', 'dental clinic Eripudhur', 'Vlr dentist'],
}

export default function EripudhurPage() {
  const locationName = 'Eripudhur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Eripudhur" city="Vellore" />
