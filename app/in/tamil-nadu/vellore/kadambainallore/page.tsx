...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadambainallore, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kadambainallore. Dr. Rockson Samuel. PIN: 631151. Book: +91 70106 50063',
  keywords: ['dentist Kadambainallore', 'dental clinic Kadambainallore', 'Arakkonam dentist'],
}

export default function KadambainallorePage() {
  const locationName = 'Kadambainallore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kadambainallore" city="Vellore" />
