...
export const metadata: Metadata = {
  title: 'Best Dentist in Ponneri, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ponneri. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Ponneri', 'dental clinic Ponneri', 'Tirupattur dentist'],
}

export default function PonneriPage() {
  const distance = "80 km"

  const locationName = 'Ponneri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ponneri" city="Vellore" />
