...
export const metadata: Metadata = {
  title: 'Best Dentist in Bn Palayam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Bn Palayam. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Bn Palayam', 'dental clinic Bn Palayam', 'Katpadi dentist'],
}

export default function BnPalayamPage() {
  const distance = "17 km"

  const locationName = 'Bn Palayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Bn Palayam" city="Vellore" />
