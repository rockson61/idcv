...
export const metadata: Metadata = {
  title: 'Best Dentist in Kethandapatti, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kethandapatti. Dr. Rockson Samuel. PIN: 635815. Book: +91 70106 50063',
  keywords: ['dentist Kethandapatti', 'dental clinic Kethandapatti', 'Tirupattur dentist'],
}

export default function KethandapattiPage() {
  const distance = "68 km"

  const locationName = 'Kethandapatti'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635815' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635815" distance="68 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kethandapatti" city="Vellore" />
