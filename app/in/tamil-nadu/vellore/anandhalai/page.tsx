...
export const metadata: Metadata = {
  title: 'Best Dentist in Anandhalai, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Anandhalai. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Anandhalai', 'dental clinic Anandhalai', 'Walajapet dentist'],
}

export default function AnandhalaiPage() {
  const distance = "23 km"

  const locationName = 'Anandhalai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Anandhalai" city="Vellore" />
