...
export const metadata: Metadata = {
  title: 'Best Dentist in Anandhalai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anandhalai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Anandhalai', href: '/in/tamil-nadu/vellore/anandhalai' },
          ]}
        />
