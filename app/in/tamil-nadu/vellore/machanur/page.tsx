...
export const metadata: Metadata = {
  title: 'Best Dentist in Machanur, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Machanur. Dr. Rockson Samuel. PIN: 632209. Book: +91 70106 50063',
  keywords: ['dentist Machanur', 'dental clinic Machanur', 'Katpadi dentist'],
}

export default function MachanurPage() {
  const distance = "19 km"

  const locationName = 'Machanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Machanur" city="Vellore" />
