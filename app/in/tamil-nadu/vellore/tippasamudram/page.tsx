...
export const metadata: Metadata = {
  title: 'Best Dentist in Tippasamudram, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tippasamudram. Dr. Rockson Samuel. PIN: 635809. Book: +91 70106 50063',
  keywords: ['dentist Tippasamudram', 'dental clinic Tippasamudram', 'Katpadi dentist'],
}

export default function TippasamudramPage() {
  const distance = "35 km"

  const locationName = 'Tippasamudram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tippasamudram" city="Vellore" />
