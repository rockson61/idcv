...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodayanchi, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kodayanchi. Dr. Rockson Samuel. PIN: 635801. Book: +91 70106 50063',
  keywords: ['dentist Kodayanchi', 'dental clinic Kodayanchi', 'Vaniyambadi dentist'],
}

export default function KodayanchiPage() {
  const distance = "56 km"

  const locationName = 'Kodayanchi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kodayanchi" city="Vellore" />
