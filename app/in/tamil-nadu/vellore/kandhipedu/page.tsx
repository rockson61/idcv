...
export const metadata: Metadata = {
  title: 'Best Dentist in Kandhipedu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kandhipedu. Dr. Rockson Samuel. PIN: 632106. Book: +91 70106 50063',
  keywords: ['dentist Kandhipedu', 'dental clinic Kandhipedu', 'Vlr dentist'],
}

export default function KandhipeduPage() {
  const distance = "12 km"

  const locationName = 'Kandhipedu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kandhipedu" city="Vellore" />
