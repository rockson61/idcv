...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnakarumbur, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chinnakarumbur. Dr. Rockson Samuel. PIN: 635811. Book: +91 70106 50063',
  keywords: ['dentist Chinnakarumbur', 'dental clinic Chinnakarumbur', 'Vaniyambadi dentist'],
}

export default function ChinnakarumburPage() {
  const distance = "60 km"

  const locationName = 'Chinnakarumbur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chinnakarumbur" city="Vellore" />
