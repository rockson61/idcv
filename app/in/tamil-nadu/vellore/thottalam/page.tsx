...
export const metadata: Metadata = {
  title: 'Best Dentist in Thottalam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thottalam. Dr. Rockson Samuel. PIN: 635804. Book: +91 70106 50063',
  keywords: ['dentist Thottalam', 'dental clinic Thottalam', 'Vaniyambadi dentist'],
}

export default function ThottalamPage() {
  const distance = "57 km"

  const locationName = 'Thottalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thottalam" city="Vellore" />
