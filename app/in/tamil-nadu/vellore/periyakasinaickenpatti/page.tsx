...
export const metadata: Metadata = {
  title: 'Best Dentist in Periyakasinaickenpatti, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periyakasinaickenpatti. Dr. Rockson Samuel. PIN: 635901. Book: +91 70106 50063',
  keywords: ['dentist Periyakasinaickenpatti', 'dental clinic Periyakasinaickenpatti', 'Tirupattur dentist'],
}

export default function PeriyakasinaickenpattiPage() {
  const distance = "72 km"

  const locationName = 'Periyakasinaickenpatti'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635901' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635901" distance="72 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Periyakasinaickenpatti" city="Vellore" />
