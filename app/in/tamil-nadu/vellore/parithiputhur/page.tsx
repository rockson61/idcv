...
export const metadata: Metadata = {
  title: 'Best Dentist in Parithiputhur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Parithiputhur. Dr. Rockson Samuel. PIN: 631002. Book: +91 70106 50063',
  keywords: ['dentist Parithiputhur', 'dental clinic Parithiputhur', 'Arakkonam dentist'],
}

export default function ParithiputhurPage() {
  const distance = "36 km"

  const locationName = 'Parithiputhur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Arakkonam', distance: '5-10 km', slug: 'arakkonam', travelTime: '15 min', pincode: '631002' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakkonam" pincode="631002" distance="36 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Parithiputhur" city="Vellore" />
