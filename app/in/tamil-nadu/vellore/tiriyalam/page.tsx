...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiriyalam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Tiriyalam. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Tiriyalam', 'dental clinic Tiriyalam', 'Tirupattur dentist'],
}

export default function TiriyalamPage() {
  const distance = "80 km"

  const locationName = 'Tiriyalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Tiriyalam" city="Vellore" />
