...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Vellore Fort, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vellore Fort. Dr. Rockson Samuel. PIN: 632004. Book: +91 70106 50063',
  keywords: ['dentist Vellore Fort', 'dental clinic Vellore Fort', 'Vellore dentist'],
}

export default function VelloreFortPage() {
  const distance = "3 km"

  const locationName = 'Vellore Fort'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vellore Fort" city="Vellore" />
