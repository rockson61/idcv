...
export const metadata: Metadata = {
  title: 'Best Dentist in Veppur, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Veppur. Dr. Rockson Samuel. PIN: 635803. Book: +91 70106 50063',
  keywords: ['dentist Veppur', 'dental clinic Veppur', 'Gudiyattam dentist'],
}

export default function VeppurPage() {
  const distance = "46 km"

  const locationName = 'Veppur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Veppur" city="Vellore" />
