...
export const metadata: Metadata = {
  title: 'Best Dentist in Arumbakkam Katpadi, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Arumbakkam Katpadi. Dr. Rockson Samuel. PIN: 632202. Book: +91 70106 50063',
  keywords: ['dentist Arumbakkam Katpadi', 'dental clinic Arumbakkam Katpadi', 'Katpadi dentist'],
}

export default function ArumbakkamKatpadiPage() {
  const distance = "17 km"

  const locationName = 'Arumbakkam Katpadi'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632202' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632202" distance="17 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Arumbakkam Katpadi" city="Vellore" />
