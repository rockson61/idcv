...
export const metadata: Metadata = {
  title: 'Best Dentist in Thimmampet, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thimmampet. Dr. Rockson Samuel. PIN: 635801. Book: +91 70106 50063',
  keywords: ['dentist Thimmampet', 'dental clinic Thimmampet', 'Tirupattur dentist'],
}

export default function ThimmampetPage() {
  const distance = "64 km"

  const locationName = 'Thimmampet'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thimmampet" city="Vellore" />
