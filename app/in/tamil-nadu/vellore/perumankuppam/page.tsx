...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumankuppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumankuppam. Dr. Rockson Samuel. PIN: 632201. Book: +91 70106 50063',
  keywords: ['dentist Perumankuppam', 'dental clinic Perumankuppam', 'Katpadi dentist'],
}

export default function PerumankuppamPage() {
  const distance = "17 km"

  const locationName = 'Perumankuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Perumankuppam" city="Vellore" />
