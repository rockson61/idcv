...
export const metadata: Metadata = {
  title: 'Best Dentist in Oomerabad, Gudiyatham | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Oomerabad. Dr. Rockson Samuel. PIN: 635808. Book: +91 70106 50063',
  keywords: ['dentist Oomerabad', 'dental clinic Oomerabad', 'Gudiyatham dentist'],
}

export default function OomerabadPage() {
  const distance = "48 km"

  const locationName = 'Oomerabad'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyatham', distance: '5-10 km', slug: 'gudiyatham', travelTime: '15 min', pincode: '635808' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyatham" pincode="635808" distance="48 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Oomerabad" city="Vellore" />
