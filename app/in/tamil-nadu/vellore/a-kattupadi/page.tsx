...
export const metadata: Metadata = {
  title: 'Best Dentist in A Kattupadi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in A Kattupadi. Dr. Rockson Samuel. PIN: 632011. Book: +91 70106 50063',
  keywords: ['dentist A Kattupadi', 'dental clinic A Kattupadi', 'Vlr dentist'],
}

export default function AKattupadiPage() {
  const distance = "7 km"

  const locationName = 'A Kattupadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="A Kattupadi" city="Vellore" />
