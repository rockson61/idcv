...
export const metadata: Metadata = {
  title: 'Best Dentist in Gundaleri, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Gundaleri. Dr. Rockson Samuel. PIN: 632512. Book: +91 70106 50063',
  keywords: ['dentist Gundaleri', 'dental clinic Gundaleri', 'Arcot dentist'],
}

export default function GundaleriPage() {
  const distance = "30 km"

  const locationName = 'Gundaleri'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Gundaleri" city="Vellore" />
