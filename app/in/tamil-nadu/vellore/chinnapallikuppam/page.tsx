...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnapallikuppam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chinnapallikuppam. Dr. Rockson Samuel. PIN: 632107. Book: +91 70106 50063',
  keywords: ['dentist Chinnapallikuppam', 'dental clinic Chinnapallikuppam', 'Vlr dentist'],
}

export default function ChinnapallikuppamPage() {
  const distance = "14 km"

  const locationName = 'Chinnapallikuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632107' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632107" distance="14 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Chinnapallikuppam" city="Vellore" />
