...
export const metadata: Metadata = {
  title: 'Best Dentist in R N Palayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for R N Palayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'R N Palayam', href: '/in/tamil-nadu/vellore/r-n-palayam' },
          ]}
        />
