...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in R N Palayam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in R N Palayam. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist R N Palayam', 'dental clinic R N Palayam', 'Vellore dentist'],
}

export default function RNPalayamPage() {
  const distance = "1 km"

  const locationName = 'R N Palayam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="R N Palayam" city="Vellore" />
