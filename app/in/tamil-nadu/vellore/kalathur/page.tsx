...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalathur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kalathur. Dr. Rockson Samuel. PIN: 632531. Book: +91 70106 50063',
  keywords: ['dentist Kalathur', 'dental clinic Kalathur', 'Arakkonam dentist'],
}

export default function KalathurPage() {
  const distance = "42 km"

  const locationName = 'Kalathur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kalathur" city="Vellore" />
