...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Melmonavur, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melmonavur. Dr. Rockson Samuel. PIN: 632010. Book: +91 70106 50063',
  keywords: ['dentist Melmonavur', 'dental clinic Melmonavur', 'Vellore dentist'],
}

export default function MelmonavurPage() {
  const locationName = 'Melmonavur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Melmonavur" city="Vellore" />
