...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Mottakkal, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mottakkal. Dr. Rockson Samuel. PIN: 632319. Book: +91 70106 50063',
  keywords: ['dentist Mottakkal', 'dental clinic Mottakkal', 'Vellore dentist'],
}

export default function MottakkalPage() {
  const distance = "8 km"

  const locationName = 'Mottakkal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mottakkal" city="Vellore" />
