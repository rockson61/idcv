...
export const metadata: Metadata = {
  title: 'Best Dentist in Thoppukhana, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thoppukhana. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Thoppukhana', 'dental clinic Thoppukhana', 'Arcot dentist'],
}

export default function ThoppukhanaPage() {
  const distance = "25 km"

  const locationName = 'Thoppukhana'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thoppukhana" city="Vellore" />
