...
export const metadata: Metadata = {
  title: 'Best Dentist in Melvisharam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Melvisharam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Melvisharam'
const city = 'Vellore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Melvisharam', href: '/in/tamil-nadu/vellore/melvisharam' },
          ]}
        />
