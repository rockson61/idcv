...
export const metadata: Metadata = {
  title: 'Best Dentist in Pallikuppam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pallikuppam. Dr. Rockson Samuel. PIN: 632007. Book: +91 70106 50063',
  keywords: ['dentist Pallikuppam', 'dental clinic Pallikuppam', 'Vlr dentist'],
}

export default function PallikuppamPage() {
  const distance = "6 km"

  const locationName = 'Pallikuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632007' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632007" distance="6 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Pallikuppam" city="Vellore" />
