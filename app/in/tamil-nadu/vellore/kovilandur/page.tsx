...
export const metadata: Metadata = {
  title: 'Best Dentist in Kovilandur, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kovilandur. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Kovilandur', 'dental clinic Kovilandur', 'Vlr dentist'],
}

export default function KovilandurPage() {
  const locationName = 'Kovilandur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kovilandur" city="Vellore" />
