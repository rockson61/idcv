...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilsaranakuppam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilsaranakuppam. Dr. Rockson Samuel. PIN: 632102. Book: +91 70106 50063',
  keywords: ['dentist Kilsaranakuppam', 'dental clinic Kilsaranakuppam', 'Vlr dentist'],
}

export default function KilsaranakuppamPage() {
  const distance = "16 km"

  const locationName = 'Kilsaranakuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632102' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632102" distance="16 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kilsaranakuppam" city="Vellore" />
