...
export const metadata: Metadata = {
  title: 'Best Dentist in Elavambadi, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Elavambadi. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Elavambadi', 'dental clinic Elavambadi', 'Vlr dentist'],
}

export default function ElavambadiPage() {
  const distance = "13 km"

  const locationName = 'Elavambadi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Elavambadi" city="Vellore" />
