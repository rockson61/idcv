...
export const metadata: Metadata = {
  title: 'Best Dentist in Melarasambattu, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Melarasambattu. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Melarasambattu', 'dental clinic Melarasambattu', 'Vlr dentist'],
}

export default function MelarasambattuPage() {
  const locationName = 'Melarasambattu'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632103' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632103" distance="16 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Melarasambattu" city="Vellore" />
