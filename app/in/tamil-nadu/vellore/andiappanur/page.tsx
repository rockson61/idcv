...
export const metadata: Metadata = {
  title: 'Best Dentist in Andiappanur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Andiappanur. Dr. Rockson Samuel. PIN: 635702. Book: +91 70106 50063',
  keywords: ['dentist Andiappanur', 'dental clinic Andiappanur', 'Tirupattur dentist'],
}

export default function AndiappanurPage() {
  const distance = "70 km"

  const locationName = 'Andiappanur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Andiappanur" city="Vellore" />
