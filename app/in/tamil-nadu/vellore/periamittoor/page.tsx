...
export const metadata: Metadata = {
  title: 'Best Dentist in Periamittoor, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Periamittoor. Dr. Rockson Samuel. PIN: 632516. Book: +91 70106 50063',
  keywords: ['dentist Periamittoor', 'dental clinic Periamittoor', 'Katpadi dentist'],
}

export default function PeriamittoorPage() {
  const distance = "13 km"

  const locationName = 'Periamittoor'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Periamittoor" city="Vellore" />
