...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalmelkuppam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kalmelkuppam. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Kalmelkuppam', 'dental clinic Kalmelkuppam', 'Walajapet dentist'],
}

export default function KalmelkuppamPage() {
  const distance = "24 km"

  const locationName = 'Kalmelkuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kalmelkuppam" city="Vellore" />
