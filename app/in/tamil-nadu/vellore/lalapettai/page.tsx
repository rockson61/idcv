...
export const metadata: Metadata = {
  title: 'Best Dentist in Lalapettai, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Lalapettai. Dr. Rockson Samuel. PIN: 635710. Book: +91 70106 50063',
  keywords: ['dentist Lalapettai', 'dental clinic Lalapettai', 'Vaniyambadi dentist'],
}

export default function LalapettaiPage() {
  const distance = "59 km"

  const locationName = 'Lalapettai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635710' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635710" distance="59 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Lalapettai" city="Vellore" />
