...
export const metadata: Metadata = {
  title: 'Best Dentist in Thennambattu, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Thennambattu. Dr. Rockson Samuel. PIN: 635802. Book: +91 70106 50063',
  keywords: ['dentist Thennambattu', 'dental clinic Thennambattu', 'Vaniyambadi dentist'],
}

export default function ThennambattuPage() {
  const distance = "58 km"

  const locationName = 'Thennambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Thennambattu" city="Vellore" />
