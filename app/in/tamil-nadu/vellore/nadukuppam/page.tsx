...
export const metadata: Metadata = {
  title: 'Best Dentist in Nadukuppam, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nadukuppam. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Nadukuppam', 'dental clinic Nadukuppam', 'Tirupathur dentist'],
}

export default function NadukuppamPage() {
  const distance = "69 km"

  const locationName = 'Nadukuppam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nadukuppam" city="Vellore" />
