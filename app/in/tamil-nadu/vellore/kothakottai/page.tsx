...
export const metadata: Metadata = {
  title: 'Best Dentist in Kothakottai, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kothakottai. Dr. Rockson Samuel. PIN: 635752. Book: +91 70106 50063',
  keywords: ['dentist Kothakottai', 'dental clinic Kothakottai', 'Vaniyambadi dentist'],
}

export default function KothakottaiPage() {
  const distance = "56 km"

  const locationName = 'Kothakottai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kothakottai" city="Vellore" />
