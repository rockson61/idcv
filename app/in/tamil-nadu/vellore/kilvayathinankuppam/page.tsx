...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilvayathinankuppam, Katpadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kilvayathinankuppam. Dr. Rockson Samuel. PIN: 632201. Book: +91 70106 50063',
  keywords: ['dentist Kilvayathinankuppam', 'dental clinic Kilvayathinankuppam', 'Katpadi dentist'],
}

export default function KilvayathinankuppamPage() {
  const distance = "17 km"

  const locationName = 'Kilvayathinankuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Katpadi', distance: '5-10 km', slug: 'katpadi', travelTime: '15 min', pincode: '632201' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Katpadi" pincode="632201" distance="17 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Kilvayathinankuppam" city="Vellore" />
