...
export const metadata: Metadata = {
  title: 'Best Dentist in Nellipattu, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nellipattu. Dr. Rockson Samuel. PIN: 635655. Book: +91 70106 50063',
  keywords: ['dentist Nellipattu', 'dental clinic Nellipattu', 'Tirupathur dentist'],
}

export default function NellipattuPage() {
  const distance = "69 km"

  const locationName = 'Nellipattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nellipattu" city="Vellore" />
