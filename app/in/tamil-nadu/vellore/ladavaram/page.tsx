...
export const metadata: Metadata = {
  title: 'Best Dentist in Ladavaram, Arcot | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ladavaram. Dr. Rockson Samuel. PIN: 632503. Book: +91 70106 50063',
  keywords: ['dentist Ladavaram', 'dental clinic Ladavaram', 'Arcot dentist'],
}

export default function LadavaramPage() {
  const locationName = 'Ladavaram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ladavaram" city="Vellore" />
