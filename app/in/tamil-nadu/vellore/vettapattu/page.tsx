...
export const metadata: Metadata = {
  title: 'Best Dentist in Vettapattu, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vettapattu. Dr. Rockson Samuel. PIN: 635852. Book: +91 70106 50063',
  keywords: ['dentist Vettapattu', 'dental clinic Vettapattu', 'Tirupattur dentist'],
}

export default function VettapattuPage() {
  const distance = "77 km"

  const locationName = 'Vettapattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vettapattu" city="Vellore" />
