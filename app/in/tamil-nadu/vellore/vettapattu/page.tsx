...
export const metadata: Metadata = {
  title: 'Best Dentist in Vettapattu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vettapattu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Vettapattu', href: '/in/tamil-nadu/vellore/vettapattu' },
          ]}
        />
