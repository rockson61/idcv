...
export const metadata: Metadata = {
  title: 'Best Dentist in Ammoor, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ammoor. Dr. Rockson Samuel. PIN: 632501. Book: +91 70106 50063',
  keywords: ['dentist Ammoor', 'dental clinic Ammoor', 'Wallajah dentist'],
}

export default function AmmoorPage() {
  const distance = "24 km"

  const locationName = 'Ammoor'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ammoor" city="Vellore" />
