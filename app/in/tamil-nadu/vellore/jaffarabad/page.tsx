...
export const metadata: Metadata = {
  title: 'Best Dentist in Jaffarabad, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Jaffarabad. Dr. Rockson Samuel. PIN: 635754. Book: +91 70106 50063',
  keywords: ['dentist Jaffarabad', 'dental clinic Jaffarabad', 'Vaniyambadi dentist'],
}

export default function JaffarabadPage() {
  const distance = "56 km"

  const locationName = 'Jaffarabad'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Jaffarabad" city="Vellore" />
