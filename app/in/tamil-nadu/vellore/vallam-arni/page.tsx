...
export const metadata: Metadata = {
  title: 'Best Dentist in Vallam Arni, Vandavasi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vallam Arni. Dr. Rockson Samuel. PIN: 604505. Book: +91 70106 50063',
  keywords: ['dentist Vallam Arni', 'dental clinic Vallam Arni', 'Vandavasi dentist'],
}

export default function VallamArniPage() {
  const distance = "85 km"

  const locationName = 'Vallam Arni'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '85 km', slug: '', travelTime: '1.9 hours', pincode: '632001' },
    { name: 'Vandavasi', distance: '5-10 km', slug: 'vandavasi', travelTime: '15 min', pincode: '604505' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vandavasi" pincode="604505" distance="85 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="85 km" travelTime="1.9 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "85 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Vallam Arni" city="Vellore" />
