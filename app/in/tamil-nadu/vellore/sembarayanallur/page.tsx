...
export const metadata: Metadata = {
  title: 'Best Dentist in Sembarayanallur, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sembarayanallur. Dr. Rockson Samuel. PIN: 632519. Book: +91 70106 50063',
  keywords: ['dentist Sembarayanallur', 'dental clinic Sembarayanallur', 'Walajapet dentist'],
}

export default function SembarayanallurPage() {
  const distance = "26 km"

  const locationName = 'Sembarayanallur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sembarayanallur" city="Vellore" />
