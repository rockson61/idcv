...
export const metadata: Metadata = {
  title: 'Best Dentist in Rottukadai, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rottukadai. Dr. Rockson Samuel. PIN: 632508. Book: +91 70106 50063',
  keywords: ['dentist Rottukadai', 'dental clinic Rottukadai', 'Walajapet dentist'],
}

export default function RottukadaiPage() {
  const distance = "22 km"

  const locationName = 'Rottukadai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Rottukadai" city="Vellore" />
