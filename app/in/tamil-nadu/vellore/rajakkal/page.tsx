...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajakkal, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Rajakkal. Dr. Rockson Samuel. PIN: 635805. Book: +91 70106 50063',
  keywords: ['dentist Rajakkal', 'dental clinic Rajakkal', 'Gudiyattam dentist'],
}

export default function RajakkalPage() {
  const distance = "47 km"

  const locationName = 'Rajakkal'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Rajakkal" city="Vellore" />
