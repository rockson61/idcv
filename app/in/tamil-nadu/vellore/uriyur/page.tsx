...
export const metadata: Metadata = {
  title: 'Best Dentist in Uriyur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Uriyur. Dr. Rockson Samuel. PIN: 631151. Book: +91 70106 50063',
  keywords: ['dentist Uriyur', 'dental clinic Uriyur', 'Arakkonam dentist'],
}

export default function UriyurPage() {
  const distance = "40 km"

  const locationName = 'Uriyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Uriyur" city="Vellore" />
