...
export const metadata: Metadata = {
  title: 'Best Dentist in Perumuchi, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perumuchi. Dr. Rockson Samuel. PIN: 631002. Book: +91 70106 50063',
  keywords: ['dentist Perumuchi', 'dental clinic Perumuchi', 'Arakkonam dentist'],
}

export default function PerumuchiPage() {
  const distance = "36 km"

  const locationName = 'Perumuchi'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Perumuchi" city="Vellore" />
