...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Kasba Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kasba Vellore. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Kasba Vellore', 'dental clinic Kasba Vellore', 'Vellore dentist'],
}

export default function KasbaVellorePage() {
  const distance = "1 km"

  const locationName = 'Kasba Vellore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kasba Vellore" city="Vellore" />
