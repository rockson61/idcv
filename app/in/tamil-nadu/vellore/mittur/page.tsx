...
export const metadata: Metadata = {
  title: 'Best Dentist in Mittur, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mittur. Dr. Rockson Samuel. PIN: 635710. Book: +91 70106 50063',
  keywords: ['dentist Mittur', 'dental clinic Mittur', 'Vaniyambadi dentist'],
}

export default function MitturPage() {
  const distance = "59 km"

  const locationName = 'Mittur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mittur" city="Vellore" />
