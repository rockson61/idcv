...
export const metadata: Metadata = {
  title: 'Best Dentist in Nandiyalam, Walajapet | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nandiyalam. Dr. Rockson Samuel. PIN: 632517. Book: +91 70106 50063',
  keywords: ['dentist Nandiyalam', 'dental clinic Nandiyalam', 'Walajapet dentist'],
}

export default function NandiyalamPage() {
  const distance = "24 km"

  const locationName = 'Nandiyalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Nandiyalam" city="Vellore" />
