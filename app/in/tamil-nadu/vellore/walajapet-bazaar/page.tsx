...
export const metadata: Metadata = {
  title: 'Best Dentist in Walajapet Bazaar, Wallajah | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Walajapet Bazaar. Dr. Rockson Samuel. PIN: 632513. Book: +91 70106 50063',
  keywords: ['dentist Walajapet Bazaar', 'dental clinic Walajapet Bazaar', 'Wallajah dentist'],
}

export default function WalajapetBazaarPage() {
  const distance = "18 km"

  const locationName = 'Walajapet Bazaar'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Wallajah', distance: '5-10 km', slug: 'wallajah', travelTime: '15 min', pincode: '632513' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Wallajah" pincode="632513" distance="18 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Walajapet Bazaar" city="Vellore" />
