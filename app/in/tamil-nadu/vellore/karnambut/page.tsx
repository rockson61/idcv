...
export const metadata: Metadata = {
  title: 'Best Dentist in Karnambut, NA | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Karnambut. Dr. Rockson Samuel. PIN: 632519. Book: +91 70106 50063',
  keywords: ['dentist Karnambut', 'dental clinic Karnambut', 'NA dentist'],
}

export default function KarnambutPage() {
  const distance = "26 km"

  const locationName = 'Karnambut'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'NA', distance: '5-10 km', slug: 'na', travelTime: '15 min', pincode: '632519' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="NA" pincode="632519" distance="26 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Karnambut" city="Vellore" />
