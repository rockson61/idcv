...
export const metadata: Metadata = {
  title: 'Best Dentist in Selandampalli, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Selandampalli. Dr. Rockson Samuel. PIN: 635653. Book: +91 70106 50063',
  keywords: ['dentist Selandampalli', 'dental clinic Selandampalli', 'Tirupathur dentist'],
}

export default function SelandampalliPage() {
  const distance = "67 km"

  const locationName = 'Selandampalli'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Selandampalli" city="Vellore" />
