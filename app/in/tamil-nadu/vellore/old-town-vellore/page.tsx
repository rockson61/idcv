...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Old Town Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Old Town Vellore. Dr. Rockson Samuel. PIN: 632001. Book: +91 70106 50063',
  keywords: ['dentist Old Town Vellore', 'dental clinic Old Town Vellore', 'Vellore dentist'],
}

export default function OldTownVellorePage() {
  const distance = "1 km"

  const locationName = 'Old Town Vellore'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Old Town Vellore" city="Vellore" />
