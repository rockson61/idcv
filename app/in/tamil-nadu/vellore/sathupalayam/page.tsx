...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Sathupalayam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sathupalayam. Dr. Rockson Samuel. PIN: 632113. Book: +91 70106 50063',
  keywords: ['dentist Sathupalayam', 'dental clinic Sathupalayam', 'Vellore dentist'],
}

export default function SathupalayamPage() {
  const locationName = 'Sathupalayam'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '16 km', slug: '', travelTime: '26 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632113' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632113" distance="16 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="16 km" travelTime="26 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "16 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Sathupalayam" city="Vellore" />
