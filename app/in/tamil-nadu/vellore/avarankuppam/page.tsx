...
export const metadata: Metadata = {
  title: 'Best Dentist in Avarankuppam, Vaniyambadi | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Avarankuppam. Dr. Rockson Samuel. PIN: 635801. Book: +91 70106 50063',
  keywords: ['dentist Avarankuppam', 'dental clinic Avarankuppam', 'Vaniyambadi dentist'],
}

export default function AvarankuppamPage() {
  const distance = "56 km"

  const locationName = 'Avarankuppam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vaniyambadi', distance: '5-10 km', slug: 'vaniyambadi', travelTime: '15 min', pincode: '635801' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vaniyambadi" pincode="635801" distance="56 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Avarankuppam" city="Vellore" />
