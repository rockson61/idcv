...
export const metadata: Metadata = {
  title: 'Best Dentist in Reddiyur, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Reddiyur. Dr. Rockson Samuel. PIN: 635851. Book: +91 70106 50063',
  keywords: ['dentist Reddiyur', 'dental clinic Reddiyur', 'Tirupattur dentist'],
}

export default function ReddiyurPage() {
  const distance = "80 km"

  const locationName = 'Reddiyur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Reddiyur" city="Vellore" />
