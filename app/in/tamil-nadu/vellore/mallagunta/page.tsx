...
export const metadata: Metadata = {
  title: 'Best Dentist in Mallagunta, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mallagunta. Dr. Rockson Samuel. PIN: 635852. Book: +91 70106 50063',
  keywords: ['dentist Mallagunta', 'dental clinic Mallagunta', 'Tirupattur dentist'],
}

export default function MallaguntaPage() {
  const distance = "77 km"

  const locationName = 'Mallagunta'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mallagunta" city="Vellore" />
