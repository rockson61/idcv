...
export const metadata: Metadata = {
  title: 'Best Dentist in Govindareddipalayam, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Govindareddipalayam. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Govindareddipalayam', 'dental clinic Govindareddipalayam', 'Vlr dentist'],
}

export default function GovindareddipalayamPage() {
  const distance = "13 km"

  const locationName = 'Govindareddipalayam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vlr', distance: '5-10 km', slug: 'vlr', travelTime: '15 min', pincode: '632105' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vlr" pincode="632105" distance="13 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Govindareddipalayam" city="Vellore" />
