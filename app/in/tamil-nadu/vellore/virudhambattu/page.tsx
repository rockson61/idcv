...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Virudhambattu, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Virudhambattu. Dr. Rockson Samuel. PIN: 632006. Book: +91 70106 50063',
  keywords: ['dentist Virudhambattu', 'dental clinic Virudhambattu', 'Vellore dentist'],
}

export default function VirudhambattuPage() {
  const distance = "2 km"

  const locationName = 'Virudhambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Virudhambattu" city="Vellore" />
