...
export const metadata: Metadata = {
  title: 'Best Dentist in Ashoknagar Vellore, Arakonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ashoknagar Vellore. Dr. Rockson Samuel. PIN: 631001. Book: +91 70106 50063',
  keywords: ['dentist Ashoknagar Vellore', 'dental clinic Ashoknagar Vellore', 'Arakonam dentist'],
}

export default function AshoknagarVellorePage() {
  const distance = "35 km"

  const locationName = 'Ashoknagar Vellore'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '35 km', slug: '', travelTime: '45 minutes', pincode: '632001' },
    { name: 'Arakonam', distance: '5-10 km', slug: 'arakonam', travelTime: '15 min', pincode: '631001' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Arakonam" pincode="631001" distance="35 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="35 km" travelTime="45 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Ashoknagar Vellore" city="Vellore" />
