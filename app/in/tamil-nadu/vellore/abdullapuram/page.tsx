...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Abdullapuram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Abdullapuram. Dr. Rockson Samuel. PIN: 632010. Book: +91 70106 50063',
  keywords: ['dentist Abdullapuram', 'dental clinic Abdullapuram', 'Vellore dentist'],
}

export default function AbdullapuramPage() {
  const distance = "6 km"

  const locationName = 'Abdullapuram'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632010' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632010" distance="6 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Abdullapuram" city="Vellore" />
