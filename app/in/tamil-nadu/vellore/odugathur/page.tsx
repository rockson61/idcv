...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Odugathur, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Odugathur. Dr. Rockson Samuel. PIN: 632103. Book: +91 70106 50063',
  keywords: ['dentist Odugathur', 'dental clinic Odugathur', 'Vellore dentist'],
}

export default function OdugathurPage() {
  const distance = "16 km"

  const locationName = 'Odugathur'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632103' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632103" distance="16 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Odugathur" city="Vellore" />
