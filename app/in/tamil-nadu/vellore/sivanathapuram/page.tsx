...
export const metadata: Metadata = {
  title: 'Best Dentist in Sivanathapuram, Vlr | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sivanathapuram. Dr. Rockson Samuel. PIN: 632105. Book: +91 70106 50063',
  keywords: ['dentist Sivanathapuram', 'dental clinic Sivanathapuram', 'Vlr dentist'],
}

export default function SivanathapuramPage() {
  const distance = "13 km"

  const locationName = 'Sivanathapuram'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Sivanathapuram" city="Vellore" />
