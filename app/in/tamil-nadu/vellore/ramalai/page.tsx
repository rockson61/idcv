...
export const metadata: Metadata = {
  title: 'Best Dentist in Ramalai, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ramalai. Dr. Rockson Samuel. PIN: 632601. Book: +91 70106 50063',
  keywords: ['dentist Ramalai', 'dental clinic Ramalai', 'Gudiyattam dentist'],
}

export default function RamalaiPage() {
  const distance = "45 km"

  const locationName = 'Ramalai'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Ramalai" city="Vellore" />
