...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadirimangalam, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Kadirimangalam. Dr. Rockson Samuel. PIN: 635602. Book: +91 70106 50063',
  keywords: ['dentist Kadirimangalam', 'dental clinic Kadirimangalam', 'Tirupattur dentist'],
}

export default function KadirimangalamPage() {
  const distance = "66 km"

  const locationName = 'Kadirimangalam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Kadirimangalam" city="Vellore" />
