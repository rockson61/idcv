...
export const metadata: Metadata = {
  title: 'Best Dentist in Ramanaickenpettai, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Ramanaickenpettai. Dr. Rockson Samuel. PIN: 635801. Book: +91 70106 50063',
  keywords: ['dentist Ramanaickenpettai', 'dental clinic Ramanaickenpettai', 'Tirupattur dentist'],
}

export default function RamanaickenpettaiPage() {
  const distance = "64 km"

  const locationName = 'Ramanaickenpettai'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '64 km', slug: '', travelTime: '1.5 hours', pincode: '632001' },
    { name: 'Tirupattur', distance: '5-10 km', slug: 'tirupattur', travelTime: '15 min', pincode: '635801' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Tirupattur" pincode="635801" distance="64 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="64 km" travelTime="1.5 hours" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "64 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Ramanaickenpettai" city="Vellore" />
