...
export const metadata: Metadata = {
  title: 'Best Dentist in Pillaipakkam, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Pillaipakkam. Dr. Rockson Samuel. PIN: 631052. Book: +91 70106 50063',
  keywords: ['dentist Pillaipakkam', 'dental clinic Pillaipakkam', 'Arakkonam dentist'],
}

export default function PillaipakkamPage() {
  const distance = "38 km"

  const locationName = 'Pillaipakkam'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Pillaipakkam" city="Vellore" />
