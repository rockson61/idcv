...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnakandili, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chinnakandili. Dr. Rockson Samuel. PIN: 635901. Book: +91 70106 50063',
  keywords: ['dentist Chinnakandili', 'dental clinic Chinnakandili', 'Tirupattur dentist'],
}

export default function ChinnakandiliPage() {
  const distance = "72 km"

  const locationName = 'Chinnakandili'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Chinnakandili" city="Vellore" />
