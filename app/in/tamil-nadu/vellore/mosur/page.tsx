...
export const metadata: Metadata = {
  title: 'Best Dentist in Mosur, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Mosur. Dr. Rockson Samuel. PIN: 631004. Book: +91 70106 50063',
  keywords: ['dentist Mosur', 'dental clinic Mosur', 'Arakkonam dentist'],
}

export default function MosurPage() {
  const distance = "36 km"

  const locationName = 'Mosur'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Mosur" city="Vellore" />
