...
export const metadata: Metadata = {
  title: 'Best Dentist in Natham, Tirupattur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Natham. Dr. Rockson Samuel. PIN: 635654. Book: +91 70106 50063',
  keywords: ['dentist Natham', 'dental clinic Natham', 'Tirupattur dentist'],
}

export default function NathamPage() {
  const distance = "68 km"

  const locationName = 'Natham'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Natham" city="Vellore" />
