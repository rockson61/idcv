...
export const metadata: Metadata = {
  title: 'Best Dentist in Vangupattu, Arakkonam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Vangupattu. Dr. Rockson Samuel. PIN: 631102. Book: +91 70106 50063',
  keywords: ['dentist Vangupattu', 'dental clinic Vangupattu', 'Arakkonam dentist'],
}

export default function VangupattuPage() {
  const locationName = 'Vangupattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Vangupattu" city="Vellore" />
