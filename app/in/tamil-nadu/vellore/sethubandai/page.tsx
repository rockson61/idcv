...
export const metadata: Metadata = {
  title: 'Best Dentist in Sethubandai, Gudiyattam | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sethubandai. Dr. Rockson Samuel. PIN: 635803. Book: +91 70106 50063',
  keywords: ['dentist Sethubandai', 'dental clinic Sethubandai', 'Gudiyattam dentist'],
}

export default function SethubandaiPage() {
  const distance = "46 km"

  const locationName = 'Sethubandai'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Gudiyattam', distance: '5-10 km', slug: 'gudiyattam', travelTime: '15 min', pincode: '635803' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Gudiyattam" pincode="635803" distance="46 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Sethubandai" city="Vellore" />
