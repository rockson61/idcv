...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Sathyamangalam, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Sathyamangalam. Dr. Rockson Samuel. PIN: 632114. Book: +91 70106 50063',
  keywords: ['dentist Sathyamangalam', 'dental clinic Sathyamangalam', 'Vellore dentist'],
}

export default function SathyamangalamPage() {
  const distance = "17 km"

  const locationName = 'Sathyamangalam'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632114' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632114" distance="17 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Sathyamangalam" city="Vellore" />
