...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Chitteri Vellore, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Chitteri Vellore. Dr. Rockson Samuel. PIN: 632002. Book: +91 70106 50063',
  keywords: ['dentist Chitteri Vellore', 'dental clinic Chitteri Vellore', 'Vellore dentist'],
}

export default function ChitteriVellorePage() {
  const locationName = 'Chitteri Vellore'
  const services = [
  ...
  const nearbyLocations = [
    ...
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632002' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632002" distance="3 km" category="town" className="mb-12"/>
        ...
        <PeopleAlsoSearchFor location="Chitteri Vellore" city="Vellore" />
