...
export const metadata: Metadata = {
  title: 'Best Dentist and Dental Clinic in Nanjukondapuram, Vellore | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Nanjukondapuram. Dr. Rockson Samuel. PIN: 632312. Book: +91 70106 50063',
  keywords: ['dentist Nanjukondapuram', 'dental clinic Nanjukondapuram', 'Vellore dentist'],
}

export default function NanjukondapuramPage() {
  const distance = "10 km"

  const locationName = 'Nanjukondapuram'
  const services = [
  ...
  const nearbyLocations = [
    { name: 'Vellore', distance: '10 km', slug: '', travelTime: '20 minutes', pincode: '632001' },
    { name: 'Vellore', distance: '5-10 km', slug: 'vellore', travelTime: '15 min', pincode: '632312' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <LocationHeader locationName={locationName} taluk="Vellore" pincode="632312" distance="10 km" category="town" className="mb-12"/>
        ...
        <TravelInfoCard fromLocation={locationName} distance="10 km" travelTime="20 minutes" options={{bus:{available:true},car:{available:true},auto:{available:true}}} className="mb-12"/>
        <LocationReviews reviews={generateDefaultReviews(locationName)} locationName={locationName} className="mb-12"/>
        <LocationFAQs faqs={generateDefaultFAQs(locationName, "10 km")} locationName={locationName} className="mb-12"/>
        <NearbyLocationsWidget currentLocation={locationName} locations={nearbyLocations} className="mb-12"/>
        
        <PeopleAlsoSearchFor location="Nanjukondapuram" city="Vellore" />
