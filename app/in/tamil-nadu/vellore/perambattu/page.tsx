...
export const metadata: Metadata = {
  title: 'Best Dentist in Perambattu, Tirupathur | Indira Dental Clinic | RCT, Implants',
  description: 'Expert dental care in Perambattu. Dr. Rockson Samuel. PIN: 635652. Book: +91 70106 50063',
  keywords: ['dentist Perambattu', 'dental clinic Perambattu', 'Tirupathur dentist'],
}

export default function PerambattuPage() {
  const distance = "67 km"

  const locationName = 'Perambattu'
  const services = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <PeopleAlsoSearchFor location="Perambattu" city="Vellore" />
