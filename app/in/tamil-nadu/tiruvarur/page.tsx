...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruvarur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruvarur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruvarur'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Tiruvarur', href: '/in/tamil-nadu/tiruvarur' },
          ]}
        />
