...
export const metadata: Metadata = {
  title: 'Best Dentist in Yercaud, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Yercaud, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Yercaud'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
