...
export const metadata: Metadata = {
  title: 'Best Dentist in Salem, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Salem, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
