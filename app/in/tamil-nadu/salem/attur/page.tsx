...
export const metadata: Metadata = {
  title: 'Best Dentist in Attur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Attur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Attur'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
