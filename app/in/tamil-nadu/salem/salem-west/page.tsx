...
export const metadata: Metadata = {
  title: 'Best Dentist in Salem West, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Salem West, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Salem West'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
