...
export const metadata: Metadata = {
  title: 'Best Dentist in Vazhapadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vazhapadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vazhapadi'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
