...
export const metadata: Metadata = {
  title: 'Best Dentist in Gangavalli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gangavalli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gangavalli'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
