...
export const metadata: Metadata = {
  title: 'Best Dentist in Pethanayakanpalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pethanayakanpalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pethanayakanpalayam'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
