...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadaiyampatti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kadaiyampatti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kadaiyampatti'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
