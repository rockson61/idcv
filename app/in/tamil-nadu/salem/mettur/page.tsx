...
export const metadata: Metadata = {
  title: 'Best Dentist in Mettur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mettur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mettur'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
