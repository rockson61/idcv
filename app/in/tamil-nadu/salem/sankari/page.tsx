...
export const metadata: Metadata = {
  title: 'Best Dentist in Sankari, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sankari, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sankari'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
