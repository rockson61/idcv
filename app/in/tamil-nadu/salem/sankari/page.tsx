...
export const metadata: Metadata = {
  title: 'Best Dentist in Sankari, Salem | Dr. Rockson Samuel | Indira Dental Clinic',
  description: 'Top-rated dental clinic serving Sankari, Salem. Expert treatments by Dr. Rockson Samuel. Root canal, implants, braces, cosmetic dentistry. Book: 7010650063',
  keywords: 'dentist Sankari, dental clinic Sankari, best dentist Salem, Dr Rockson Samuel, dental implants Sankari, root canal Sankari',
}
...
const faqs = [
  {
    ...
    answer: 'Indira Dental Clinic is located in Gandhi Nagar, Vellore, easily accessible from Sankari, Salem. We are just a short drive away.'
  },
  {
    question: 'Do you accept patients from Sankari?',
    answer: 'Yes! We welcome patients from Sankari, Salem and all surrounding areas. Many of our patients travel from Salem for our expert dental care.'
  },
  {
...
export default function SankariTalukPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Sankari', href: '/in/tamil-nadu/salem/sankari' }
          ]}
        />

        <LocationHeader
          locationName="Best Dentist and Dental Clinic in Sankari, Salem"
          taluk="Sankari"
          pincode="000000"
          distance="Near Vellore"
          category="town"
        ...
        <div className="mb-8">
          <GoogleMapEmbed
            locationName="Sankari"
            address="Gandhi Nagar, Vellore, Tamil Nadu - 632001"
          />
        </div>

        <div className="mb-8">
          <EnhancedServicesList locationName="Sankari" services={services} />
        </div>

        <div className="mb-8">
          <LocationReviews locationName="Sankari" reviews={reviews} />
        </div>

        <div className="mb-8">
          <LocationFAQs locationName="Sankari" faqs={faqs} />
        </div>

        <div className="mb-8">
          <PeopleAlsoSearchFor location="Sankari" city="Salem" />
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl p-8 border-2 border-teal-200">
          ...
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            Join hundreds of happy patients from Sankari, Salem who trust Dr. Rockson Samuel for their dental needs.
          </p>
