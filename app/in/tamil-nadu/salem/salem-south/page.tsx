...
export const metadata: Metadata = {
  title: 'Best Dentist in Salem South, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Salem South, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Salem South'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
