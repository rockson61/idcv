...
export const metadata: Metadata = {
  title: 'Best Dentist in Omalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Omalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Omalur'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
