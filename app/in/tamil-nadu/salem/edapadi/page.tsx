...
export const metadata: Metadata = {
  title: 'Best Dentist in Edapadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Edapadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Edapadi'
const city = 'Salem'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
