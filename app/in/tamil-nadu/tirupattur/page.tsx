...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirupattur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tirupattur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tirupattur'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Tirupattur', href: '/in/tamil-nadu/tirupattur' },
          ]}
        />
