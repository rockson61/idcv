...
export const metadata: Metadata = {
  title: 'Best Dentist in Ulundurpet, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ulundurpet, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ulundurpet'
