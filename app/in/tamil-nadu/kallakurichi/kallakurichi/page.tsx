...
export const metadata: Metadata = {
  title: 'Best Dentist in Kallakurichi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kallakurichi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kallakurichi'
