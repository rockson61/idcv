...
export const metadata: Metadata = {
  title: 'Best Dentist in Chinnaselam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chinnaselam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chinnaselam'
