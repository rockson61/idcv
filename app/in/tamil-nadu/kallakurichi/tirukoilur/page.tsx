...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirukoilur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tirukoilur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tirukoilur'
