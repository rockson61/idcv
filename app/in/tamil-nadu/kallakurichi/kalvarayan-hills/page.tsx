...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalvarayan Hills, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kalvarayan Hills, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kalvarayan Hills'
const city = 'Kallakurichi'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
