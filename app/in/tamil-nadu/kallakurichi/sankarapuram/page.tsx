...
export const metadata: Metadata = {
  title: 'Best Dentist in Sankarapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sankarapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sankarapuram'
