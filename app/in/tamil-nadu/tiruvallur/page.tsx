...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruvallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruvallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruvallur'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Tiruvallur', href: '/in/tamil-nadu/tiruvallur' },
          ]}
        />
