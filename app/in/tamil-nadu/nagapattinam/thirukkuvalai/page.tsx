...
export const metadata: Metadata = {
  title: 'Best Dentist in Thirukkuvalai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thirukkuvalai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thirukkuvalai'
