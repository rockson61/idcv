...
export const metadata: Metadata = {
  title: 'Best Dentist in Kilvelur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kilvelur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kilvelur'
