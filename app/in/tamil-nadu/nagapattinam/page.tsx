...
export const metadata: Metadata = {
  title: 'Best Dentist in Nagapattinam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nagapattinam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nagapattinam'
