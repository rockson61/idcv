...
export const metadata: Metadata = {
  title: 'Best Dentist in Vedaranyam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vedaranyam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vedaranyam'
