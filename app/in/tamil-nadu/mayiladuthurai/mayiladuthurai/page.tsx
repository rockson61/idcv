...
export const metadata: Metadata = {
  title: 'Best Dentist in Mayiladuthurai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mayiladuthurai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mayiladuthurai'
