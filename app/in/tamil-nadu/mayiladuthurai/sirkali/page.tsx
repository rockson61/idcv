...
export const metadata: Metadata = {
  title: 'Best Dentist in Sirkali, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sirkali, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sirkali'
