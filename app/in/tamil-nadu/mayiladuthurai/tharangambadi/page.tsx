...
export const metadata: Metadata = {
  title: 'Best Dentist in Tharangambadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tharangambadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tharangambadi'
