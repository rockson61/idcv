...
export const metadata: Metadata = {
  title: 'Best Dentist in Kuthalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kuthalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kuthalam'
