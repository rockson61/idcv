...
export const metadata: Metadata = {
  title: 'Best Dentist in Ariyalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ariyalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ariyalur'
