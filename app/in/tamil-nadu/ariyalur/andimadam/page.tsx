...
export const metadata: Metadata = {
  title: 'Best Dentist in Andimadam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Andimadam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Andimadam'
const city = 'Ariyalur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
