...
export const metadata: Metadata = {
  title: 'Best Dentist in Udaiyarpalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Udaiyarpalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Udaiyarpalayam'
const city = 'Ariyalur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
