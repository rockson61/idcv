...
export const metadata: Metadata = {
  title: 'Best Dentist in Sendurai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sendurai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sendurai'
const city = 'Ariyalur'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
