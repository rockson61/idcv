...
export const metadata: Metadata = {
  title: 'Best Dentist in Villupuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Villupuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Villupuram'
