...
export const metadata: Metadata = {
  title: 'Best Dentist in Vanur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vanur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vanur'
