...
export const metadata: Metadata = {
  title: 'Best Dentist in Vikravandi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vikravandi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vikravandi'
