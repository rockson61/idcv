...
export const metadata: Metadata = {
  title: 'Best Dentist in Tindivanam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tindivanam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tindivanam'
