...
export const metadata: Metadata = {
  title: 'Best Dentist in Gingee, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gingee, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gingee'
