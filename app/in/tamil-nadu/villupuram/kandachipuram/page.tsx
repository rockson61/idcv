...
export const metadata: Metadata = {
  title: 'Best Dentist in Kandachipuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kandachipuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kandachipuram'
