...
export const metadata: Metadata = {
  title: 'Best Dentist in Marakanam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Marakanam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Marakanam'
