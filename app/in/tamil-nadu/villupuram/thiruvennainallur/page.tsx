...
export const metadata: Metadata = {
  title: 'Best Dentist in Thiruvennainallur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thiruvennainallur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thiruvennainallur'
