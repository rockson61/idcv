...
export const metadata: Metadata = {
  title: 'Best Dentist in Melmalaiyanur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Melmalaiyanur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Melmalaiyanur'
