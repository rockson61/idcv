...
export const metadata: Metadata = {
  title: 'Best Dentist in Mohanoor, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mohanoor, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mohanoor'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
