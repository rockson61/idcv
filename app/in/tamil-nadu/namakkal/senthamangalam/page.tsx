...
export const metadata: Metadata = {
  title: 'Best Dentist in Senthamangalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Senthamangalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Senthamangalam'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
