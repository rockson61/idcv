...
export const metadata: Metadata = {
  title: 'Best Dentist in Kumarapalayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kumarapalayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kumarapalayam'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
