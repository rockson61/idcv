...
export const metadata: Metadata = {
  title: 'Best Dentist in Kholli Hills, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kholli Hills, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kholli Hills'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
