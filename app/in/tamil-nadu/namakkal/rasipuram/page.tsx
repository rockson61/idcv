...
export const metadata: Metadata = {
  title: 'Best Dentist in Rasipuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rasipuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rasipuram'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
