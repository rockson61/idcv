...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruchengode, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruchengode, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruchengode'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
