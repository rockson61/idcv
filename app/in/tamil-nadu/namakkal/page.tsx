...
export const metadata: Metadata = {
  title: 'Best Dentist in Namakkal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Namakkal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Namakkal'
