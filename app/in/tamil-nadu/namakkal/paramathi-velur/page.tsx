...
export const metadata: Metadata = {
  title: 'Best Dentist in Paramathi Velur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Paramathi Velur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Paramathi Velur'
const city = 'Namakkal'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
