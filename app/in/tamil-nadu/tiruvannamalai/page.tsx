...
export const metadata: Metadata = {
  title: 'Best Dentist in Tiruvannamalai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tiruvannamalai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tiruvannamalai'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Tiruvannamalai', href: '/in/tamil-nadu/tiruvannamalai' },
          ]}
        />
