...
export const metadata: Metadata = {
  title: 'Best Dentist in Hosur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Hosur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hosur'
