...
export const metadata: Metadata = {
  title: 'Best Dentist in Bargur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Bargur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bargur'
