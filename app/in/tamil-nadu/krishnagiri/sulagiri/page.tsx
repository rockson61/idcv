...
export const metadata: Metadata = {
  title: 'Best Dentist in Sulagiri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Sulagiri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sulagiri'
