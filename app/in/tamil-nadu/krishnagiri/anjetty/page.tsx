...
export const metadata: Metadata = {
  title: 'Best Dentist in Anjetty, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Anjetty, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Anjetty'
