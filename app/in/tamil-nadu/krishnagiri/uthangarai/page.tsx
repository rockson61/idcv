...
export const metadata: Metadata = {
  title: 'Best Dentist in Uthangarai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Uthangarai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uthangarai'
