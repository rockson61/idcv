...
export const metadata: Metadata = {
  title: 'Best Dentist in Krishnagiri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Krishnagiri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Krishnagiri'
