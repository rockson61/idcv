...
export const metadata: Metadata = {
  title: 'Best Dentist in Thenkanikottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thenkanikottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thenkanikottai'
const city = 'Krishnagiri'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
