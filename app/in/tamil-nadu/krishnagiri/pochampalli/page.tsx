...
export const metadata: Metadata = {
  title: 'Best Dentist in Pochampalli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pochampalli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pochampalli'
