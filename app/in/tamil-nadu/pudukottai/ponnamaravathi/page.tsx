...
export const metadata: Metadata = {
  title: 'Best Dentist in Ponnamaravathi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ponnamaravathi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ponnamaravathi'
