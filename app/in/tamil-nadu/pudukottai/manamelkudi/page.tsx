...
export const metadata: Metadata = {
  title: 'Best Dentist in Manamelkudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Manamelkudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manamelkudi'
