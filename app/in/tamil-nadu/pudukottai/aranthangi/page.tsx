...
export const metadata: Metadata = {
  title: 'Best Dentist in Aranthangi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Aranthangi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aranthangi'
