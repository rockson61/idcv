...
export const metadata: Metadata = {
  title: 'Best Dentist in Iluppur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Iluppur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Iluppur'
