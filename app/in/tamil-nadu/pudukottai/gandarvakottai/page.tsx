...
export const metadata: Metadata = {
  title: 'Best Dentist in Gandarvakottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gandarvakottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gandarvakottai'
const city = 'Pudukottai'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
