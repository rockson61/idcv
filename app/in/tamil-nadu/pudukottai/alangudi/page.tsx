...
export const metadata: Metadata = {
  title: 'Best Dentist in Alangudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Alangudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Alangudi'
