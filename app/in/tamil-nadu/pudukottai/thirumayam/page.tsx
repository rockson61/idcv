...
export const metadata: Metadata = {
  title: 'Best Dentist in Thirumayam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thirumayam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thirumayam'
