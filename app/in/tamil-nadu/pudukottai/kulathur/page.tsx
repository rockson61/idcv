...
export const metadata: Metadata = {
  title: 'Best Dentist in Kulathur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kulathur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kulathur'
