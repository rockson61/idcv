...
export const metadata: Metadata = {
  title: 'Best Dentist in Avudiyarkoil, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Avudiyarkoil, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Avudiyarkoil'
