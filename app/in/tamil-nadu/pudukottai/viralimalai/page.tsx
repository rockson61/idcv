...
export const metadata: Metadata = {
  title: 'Best Dentist in Viralimalai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Viralimalai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Viralimalai'
