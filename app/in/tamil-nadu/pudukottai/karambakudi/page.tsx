...
export const metadata: Metadata = {
  title: 'Best Dentist in Karambakudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Karambakudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karambakudi'
