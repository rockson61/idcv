...
export const metadata: Metadata = {
  title: 'Best Dentist in Harur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Harur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Harur'
