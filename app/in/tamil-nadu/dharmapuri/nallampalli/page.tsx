...
export const metadata: Metadata = {
  title: 'Best Dentist in Nallampalli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nallampalli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nallampalli'
