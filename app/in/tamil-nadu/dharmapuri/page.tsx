...
export const metadata: Metadata = {
  title: 'Best Dentist in Dharmapuri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Dharmapuri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dharmapuri'
