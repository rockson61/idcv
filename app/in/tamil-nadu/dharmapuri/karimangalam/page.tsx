...
export const metadata: Metadata = {
  title: 'Best Dentist in Karimangalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Karimangalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karimangalam'
