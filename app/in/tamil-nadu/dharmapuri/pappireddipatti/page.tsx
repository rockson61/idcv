...
export const metadata: Metadata = {
  title: 'Best Dentist in Pappireddipatti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pappireddipatti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pappireddipatti'
