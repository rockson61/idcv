...
export const metadata: Metadata = {
  title: 'Best Dentist in Pennagaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pennagaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pennagaram'
