...
export const metadata: Metadata = {
  title: 'Best Dentist in Palacode, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Palacode, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Palacode'
