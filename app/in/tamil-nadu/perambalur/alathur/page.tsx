...
export const metadata: Metadata = {
  title: 'Best Dentist in Alathur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Alathur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Alathur'
