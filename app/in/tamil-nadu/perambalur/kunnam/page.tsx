...
export const metadata: Metadata = {
  title: 'Best Dentist in Kunnam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kunnam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kunnam'
