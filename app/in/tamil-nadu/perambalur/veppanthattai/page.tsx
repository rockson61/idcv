...
export const metadata: Metadata = {
  title: 'Best Dentist in Veppanthattai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Veppanthattai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Veppanthattai'
