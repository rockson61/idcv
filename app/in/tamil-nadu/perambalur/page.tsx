...
export const metadata: Metadata = {
  title: 'Best Dentist in Perambalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Perambalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Perambalur'
