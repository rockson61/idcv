...
export const metadata: Metadata = {
  title: 'Best Dentist in Maduranthakam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Maduranthakam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Maduranthakam'
