...
export const metadata: Metadata = {
  title: 'Best Dentist in Pallavaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pallavaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pallavaram'
