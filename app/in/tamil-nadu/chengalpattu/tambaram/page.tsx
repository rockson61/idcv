...
export const metadata: Metadata = {
  title: 'Best Dentist in Tambaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tambaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tambaram'
