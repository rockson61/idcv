...
export const metadata: Metadata = {
  title: 'Best Dentist in Chengalpattu, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chengalpattu, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chengalpattu'
