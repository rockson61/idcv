...
export const metadata: Metadata = {
  title: 'Best Dentist in Vandalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vandalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vandalur'
