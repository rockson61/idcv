...
export const metadata: Metadata = {
  title: 'Best Dentist in Cheyyur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Cheyyur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Cheyyur'
