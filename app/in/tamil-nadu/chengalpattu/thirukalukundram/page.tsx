...
export const metadata: Metadata = {
  title: 'Best Dentist in Thirukalukundram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thirukalukundram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thirukalukundram'
