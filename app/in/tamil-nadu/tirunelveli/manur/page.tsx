...
export const metadata: Metadata = {
  title: 'Best Dentist in Manur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Manur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manur'
