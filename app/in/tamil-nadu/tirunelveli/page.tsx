...
export const metadata: Metadata = {
  title: 'Best Dentist in Tirunelveli, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Tirunelveli, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tirunelveli'
