...
export const metadata: Metadata = {
  title: 'Best Dentist in Cheranmahadevi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Cheranmahadevi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Cheranmahadevi'
