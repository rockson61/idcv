...
export const metadata: Metadata = {
  title: 'Best Dentist in Radhapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Radhapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Radhapuram'
