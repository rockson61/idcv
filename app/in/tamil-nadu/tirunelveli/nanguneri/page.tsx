...
export const metadata: Metadata = {
  title: 'Best Dentist in Nanguneri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nanguneri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nanguneri'
