...
export const metadata: Metadata = {
  title: 'Best Dentist in Palayamkottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Palayamkottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Palayamkottai'
