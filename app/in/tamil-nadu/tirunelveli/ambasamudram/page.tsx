...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambasamudram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambasamudram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ambasamudram'
