...
export const metadata: Metadata = {
  title: 'Best Dentist in Thisayanvilai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thisayanvilai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thisayanvilai'
