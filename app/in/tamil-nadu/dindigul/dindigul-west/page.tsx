...
export const metadata: Metadata = {
  title: 'Best Dentist in Dindigul West, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Dindigul West, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dindigul West'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
