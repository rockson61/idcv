...
export const metadata: Metadata = {
  title: 'Best Dentist in Guziliyamparai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Guziliyamparai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Guziliyamparai'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
