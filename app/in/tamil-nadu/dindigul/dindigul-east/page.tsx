...
export const metadata: Metadata = {
  title: 'Best Dentist in Dindigul East, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Dindigul East, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dindigul East'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
