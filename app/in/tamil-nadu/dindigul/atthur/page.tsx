...
export const metadata: Metadata = {
  title: 'Best Dentist in Atthur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Atthur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Atthur'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
