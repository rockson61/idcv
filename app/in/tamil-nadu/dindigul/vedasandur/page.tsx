...
export const metadata: Metadata = {
  title: 'Best Dentist in Vedasandur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Vedasandur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vedasandur'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
