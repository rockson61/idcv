...
export const metadata: Metadata = {
  title: 'Best Dentist in Kodaikanal, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kodaikanal, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kodaikanal'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
