...
export const metadata: Metadata = {
  title: 'Best Dentist in Palani, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Palani, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Palani'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
