...
export const metadata: Metadata = {
  title: 'Best Dentist in Natham, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Natham, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
