...
export const metadata: Metadata = {
  title: 'Best Dentist in Nilakottai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Nilakottai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nilakottai'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
