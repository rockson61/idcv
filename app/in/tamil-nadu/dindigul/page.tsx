...
export const metadata: Metadata = {
  title: 'Best Dentist in Dindigul, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Dindigul, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dindigul'
