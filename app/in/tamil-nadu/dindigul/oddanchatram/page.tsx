...
export const metadata: Metadata = {
  title: 'Best Dentist in Oddanchatram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Oddanchatram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Oddanchatram'
const city = 'Dindigul'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
