...
export const metadata: Metadata = {
  title: 'Best Dentist in Kanchipuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kanchipuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kanchipuram'
