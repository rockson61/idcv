...
export const metadata: Metadata = {
  title: 'Best Dentist in Gudalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Gudalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
