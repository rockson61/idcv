...
export const metadata: Metadata = {
  title: 'Best Dentist in Coonoor, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Coonoor, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Coonoor'
