...
export const metadata: Metadata = {
  title: 'Best Dentist in Kothagiri, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kothagiri, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kothagiri'
