...
export const metadata: Metadata = {
  title: 'Best Dentist in Pandalur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Pandalur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Pandalur'
