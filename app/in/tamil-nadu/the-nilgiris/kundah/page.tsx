...
export const metadata: Metadata = {
  title: 'Best Dentist in Kundah, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kundah, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kundah'
