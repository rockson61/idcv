...
export const metadata: Metadata = {
  title: 'Best Dentist in Udagamandalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Udagamandalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Udagamandalam'
const city = 'The Nilgiris'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
