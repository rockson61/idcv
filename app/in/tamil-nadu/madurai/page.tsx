...
export const metadata: Metadata = {
  title: 'Best Dentist in Madurai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Madurai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Madurai'
