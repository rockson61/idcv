...
export const metadata: Metadata = {
  title: 'Best Dentist in Kadaladi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kadaladi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kadaladi'
