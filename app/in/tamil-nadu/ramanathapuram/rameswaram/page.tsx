...
export const metadata: Metadata = {
  title: 'Best Dentist in Rameswaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rameswaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rameswaram'
