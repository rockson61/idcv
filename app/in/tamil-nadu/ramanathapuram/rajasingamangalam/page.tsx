...
export const metadata: Metadata = {
  title: 'Best Dentist in Rajasingamangalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Rajasingamangalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rajasingamangalam'
const city = 'Ramanathapuram'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
