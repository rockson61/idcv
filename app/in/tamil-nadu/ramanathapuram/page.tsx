...
export const metadata: Metadata = {
  title: 'Best Dentist in Ramanathapuram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Ramanathapuram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ramanathapuram'
