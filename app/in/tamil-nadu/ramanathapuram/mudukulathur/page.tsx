...
export const metadata: Metadata = {
  title: 'Best Dentist in Mudukulathur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Mudukulathur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mudukulathur'
