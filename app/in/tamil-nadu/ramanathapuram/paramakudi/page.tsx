...
export const metadata: Metadata = {
  title: 'Best Dentist in Paramakudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Paramakudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Paramakudi'
