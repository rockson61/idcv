...
export const metadata: Metadata = {
  title: 'Best Dentist in Kezhakarai, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kezhakarai, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kezhakarai'
