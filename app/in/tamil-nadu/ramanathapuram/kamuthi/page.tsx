...
export const metadata: Metadata = {
  title: 'Best Dentist in Kamuthi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kamuthi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kamuthi'
