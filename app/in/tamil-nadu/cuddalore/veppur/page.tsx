...
export const metadata: Metadata = {
  title: 'Best Dentist in Veppur, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Veppur, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}
