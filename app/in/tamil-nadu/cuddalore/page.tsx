...
export const metadata: Metadata = {
  title: 'Best Dentist in Cuddalore, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Cuddalore, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Cuddalore'
