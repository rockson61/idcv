...
export const metadata: Metadata = {
  title: 'Best Dentist in Chidambaram, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Chidambaram, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chidambaram'
