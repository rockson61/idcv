...
export const metadata: Metadata = {
  title: 'Best Dentist in Kattumannarkoil, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kattumannarkoil, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kattumannarkoil'
const city = 'Cuddalore'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
