...
export const metadata: Metadata = {
  title: 'Best Dentist in Kurinjipadi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Kurinjipadi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kurinjipadi'
