...
export const metadata: Metadata = {
  title: 'Best Dentist in Virudhachalam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Virudhachalam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Virudhachalam'
