...
export const metadata: Metadata = {
  title: 'Best Dentist in Thittakudi, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Thittakudi, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thittakudi'
