...
export const metadata: Metadata = {
  title: 'Best Dentist in Srimushnam, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Srimushnam, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Srimushnam'
