...
export const metadata: Metadata = {
  title: 'Best Dentist in Panruti, Tamil Nadu | Indira Dental Clinic',
  description: 'Top-rated dental care for Panruti, Tamil Nadu. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Panruti'
