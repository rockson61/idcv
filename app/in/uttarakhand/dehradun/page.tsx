...
export const metadata: Metadata = {
  title: 'Best Dentist in Dehradun, Uttarakhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Dehradun, Uttarakhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dehradun'
