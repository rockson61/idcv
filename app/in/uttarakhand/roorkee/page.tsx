...
export const metadata: Metadata = {
  title: 'Best Dentist in Roorkee, Uttarakhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Roorkee, Uttarakhand. Save on treatments at Indira Dental Clinic, Vellore.',
}
