...
export const metadata: Metadata = {
  title: 'Best Dentist in Rudrapur, Uttarakhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Rudrapur, Uttarakhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rudrapur'
