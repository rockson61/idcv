...
export const metadata: Metadata = {
  title: 'Best Dentist in Haridwar, Uttarakhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Haridwar, Uttarakhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Haridwar'
