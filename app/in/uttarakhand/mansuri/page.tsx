...
export const metadata: Metadata = {
  title: 'Best Dentist in Mansuri, Uttarakhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Mansuri, Uttarakhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mansuri'
