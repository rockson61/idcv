...
export const metadata: Metadata = {
  title: 'Dental Services in uttarakhand | Expert Dentist | Indira Dental Clinic',
  description: 'Comprehensive dental services in uttarakhand. Expert dental care including RCT, implants, braces, cosmetic dentistry. Visit Indira Dental Clinic in Vellore for 50% savings.',
  keywords: ['dentist uttarakhand', 'dental clinic uttarakhand', 'dental services uttarakhand'],
}

export default function UttarakhandPage() {
  const cities = [
    { name: 'Dehradun', href: '/in/uttarakhand/dehradun', description: 'Quality dental services in Dehradun' },
    { name: 'Haridwar', href: '/in/uttarakhand/haridwar', description: 'Quality dental services in Haridwar' },
    { name: 'Mansuri', href: '/in/uttarakhand/mansuri', description: 'Quality dental services in Mansuri' },
    { name: 'Rudrapur', href: '/in/uttarakhand/rudrapur', description: 'Quality dental services in Rudrapur' },
    { name: 'Roorkee', href: '/in/uttarakhand/roorkee', description: 'Quality dental services in Roorkee' }
  ]
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Dental Services in Uttarakhand
          </h1>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-8">
            Find comprehensive dental care services across Uttarakhand. Expert dental treatments 
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Cities in Uttarakhand</h2>
          ...
          <ModernCard>
            <ModernCardContent className="py-12">
              ...
              <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
                Browse through our extensive network of dental services across Uttarakhand. 
