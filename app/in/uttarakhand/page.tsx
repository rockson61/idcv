...
export const metadata: Metadata = {
  title: 'Best Dentist in Uttarakhand, Uttarakhand | Indira Dental Clinic',
  description: 'Top-rated dental care for Uttarakhand, Uttarakhand. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Uttarakhand'
