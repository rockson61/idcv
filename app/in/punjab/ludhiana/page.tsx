...
export const metadata: Metadata = {
  title: 'Best Dentist in Ludhiana, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Ludhiana, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ludhiana'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
