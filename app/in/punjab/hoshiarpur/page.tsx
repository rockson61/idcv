...
export const metadata: Metadata = {
  title: 'Best Dentist in Hoshiarpur, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Hoshiarpur, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hoshiarpur'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
