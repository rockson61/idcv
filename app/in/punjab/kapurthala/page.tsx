...
export const metadata: Metadata = {
  title: 'Best Dentist in Kapurthala, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Kapurthala, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kapurthala'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
