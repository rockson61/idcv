...
export const metadata: Metadata = {
  title: 'Best Dentist in Bathinda, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Bathinda, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bathinda'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
