...
export const metadata: Metadata = {
  title: 'Best Dentist in Jalandhar, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Jalandhar, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jalandhar'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
