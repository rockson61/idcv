...
export const metadata: Metadata = {
  title: 'Best Dentist in Mohali, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Mohali, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mohali'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
