...
export const metadata: Metadata = {
  title: 'Best Dentist in Gurdaspur, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Gurdaspur, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gurdaspur'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
