...
export const metadata: Metadata = {
  title: 'Best Dentist in Sangrur, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Sangrur, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sangrur'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
