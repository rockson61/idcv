...
export const metadata: Metadata = {
  title: 'Best Dentist in Chandigarh, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Chandigarh, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chandigarh'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
