...
export const metadata: Metadata = {
  title: 'Best Dentist in Phagwara, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Phagwara, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Phagwara'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
