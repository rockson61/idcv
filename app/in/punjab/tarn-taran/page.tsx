...
export const metadata: Metadata = {
  title: 'Best Dentist in Tarn Taran, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Tarn Taran, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Tarn Taran'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
