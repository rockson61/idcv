...
export const metadata: Metadata = {
  title: 'Best Dentist in Firozpur, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Firozpur, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Firozpur'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
