...
export const metadata: Metadata = {
  title: 'Best Dentist in Moga, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Moga, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Moga'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
