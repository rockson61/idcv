...
export const metadata: Metadata = {
  title: 'Best Dentist in Faridkot, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Faridkot, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Faridkot'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
