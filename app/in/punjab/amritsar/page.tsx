...
export const metadata: Metadata = {
  title: 'Best Dentist in Amritsar, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Amritsar, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Amritsar'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
