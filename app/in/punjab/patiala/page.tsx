...
export const metadata: Metadata = {
  title: 'Best Dentist in Patiala, Punjab | Indira Dental Clinic',
  description: 'Top-rated dental care for Patiala, Punjab. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Patiala'
const city = 'Punjab'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
