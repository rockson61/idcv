...
export const metadata: Metadata = {
  title: 'Best Dentist in Vasco Da Gama, Goa | Indira Dental Clinic',
  description: 'Top-rated dental care for Vasco Da Gama, Goa. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vasco Da Gama'
const city = 'Goa'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
