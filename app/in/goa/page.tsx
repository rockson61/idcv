...
export const metadata: Metadata = {
  title: 'Best Dentist in Goa, Goa | Indira Dental Clinic',
  description: 'Top-rated dental care for Goa, Goa. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Goa'
const city = 'Goa'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
