...
export const metadata: Metadata = {
  title: 'Best Dentist in Muzaffarpur, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Muzaffarpur, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Muzaffarpur'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
