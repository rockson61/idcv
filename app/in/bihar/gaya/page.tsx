...
export const metadata: Metadata = {
  title: 'Best Dentist in Gaya, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Gaya, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Gaya'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
