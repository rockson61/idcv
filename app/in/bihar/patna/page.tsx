...
export const metadata: Metadata = {
  title: 'Best Dentist in Patna, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Patna, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Patna'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
