...
export const metadata: Metadata = {
  title: 'Best Dentist in Saharsa, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Saharsa, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Saharsa'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
