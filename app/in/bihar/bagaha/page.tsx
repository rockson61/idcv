...
export const metadata: Metadata = {
  title: 'Best Dentist in Bagaha, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Bagaha, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bagaha'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
