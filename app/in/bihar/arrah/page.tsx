...
export const metadata: Metadata = {
  title: 'Best Dentist in Arrah, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Arrah, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Arrah'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
