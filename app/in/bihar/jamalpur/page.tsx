...
export const metadata: Metadata = {
  title: 'Best Dentist in Jamalpur, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Jamalpur, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jamalpur'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
