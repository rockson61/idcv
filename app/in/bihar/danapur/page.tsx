...
export const metadata: Metadata = {
  title: 'Best Dentist in Danapur, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Danapur, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Danapur'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
