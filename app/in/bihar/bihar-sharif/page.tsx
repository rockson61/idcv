...
export const metadata: Metadata = {
  title: 'Best Dentist in Bihar Sharif, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Bihar Sharif, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bihar Sharif'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
