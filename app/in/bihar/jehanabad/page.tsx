...
export const metadata: Metadata = {
  title: 'Best Dentist in Jehanabad, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Jehanabad, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jehanabad'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
