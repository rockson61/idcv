...
export const metadata: Metadata = {
  title: 'Best Dentist in Bihar, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Bihar, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bihar'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
