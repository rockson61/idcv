...
export const metadata: Metadata = {
  title: 'Best Dentist in Motihari, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Motihari, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Motihari'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
