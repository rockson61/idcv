...
export const metadata: Metadata = {
  title: 'Best Dentist in Hajipur, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Hajipur, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hajipur'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
