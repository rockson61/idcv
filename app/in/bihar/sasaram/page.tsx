...
export const metadata: Metadata = {
  title: 'Best Dentist in Sasaram, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Sasaram, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sasaram'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
