...
export const metadata: Metadata = {
  title: 'Best Dentist in Begusarai, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Begusarai, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Begusarai'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
