...
export const metadata: Metadata = {
  title: 'Best Dentist in Darbhanga, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Darbhanga, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Darbhanga'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
