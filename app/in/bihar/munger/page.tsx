...
export const metadata: Metadata = {
  title: 'Best Dentist in Munger, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Munger, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Munger'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
