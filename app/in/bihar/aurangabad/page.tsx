...
export const metadata: Metadata = {
  title: 'Best Dentist in Aurangabad, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Aurangabad, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}
