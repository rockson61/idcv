...
export const metadata: Metadata = {
  title: 'Best Dentist in Purnia, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Purnia, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Purnia'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
