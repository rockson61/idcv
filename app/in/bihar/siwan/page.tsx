...
export const metadata: Metadata = {
  title: 'Best Dentist in Siwan, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Siwan, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Siwan'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
