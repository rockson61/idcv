...
export const metadata: Metadata = {
  title: 'Best Dentist in Bettiah, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Bettiah, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bettiah'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
