...
export const metadata: Metadata = {
  title: 'Best Dentist in Kishanganj, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Kishanganj, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kishanganj'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
