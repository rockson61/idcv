...
export const metadata: Metadata = {
  title: 'Best Dentist in Dehri, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Dehri, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dehri'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
