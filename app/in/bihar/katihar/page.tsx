...
export const metadata: Metadata = {
  title: 'Best Dentist in Katihar, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Katihar, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Katihar'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
