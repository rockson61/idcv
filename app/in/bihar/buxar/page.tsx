...
export const metadata: Metadata = {
  title: 'Best Dentist in Buxar, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Buxar, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Buxar'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
