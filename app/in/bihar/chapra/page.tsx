...
export const metadata: Metadata = {
  title: 'Best Dentist in Chapra, Bihar | Indira Dental Clinic',
  description: 'Top-rated dental care for Chapra, Bihar. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chapra'
const city = 'Bihar'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
