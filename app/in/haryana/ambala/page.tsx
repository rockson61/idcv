...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambala, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambala, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ambala'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
