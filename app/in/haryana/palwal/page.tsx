...
export const metadata: Metadata = {
  title: 'Best Dentist in Palwal, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Palwal, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Palwal'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
