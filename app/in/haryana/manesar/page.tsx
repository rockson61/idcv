...
export const metadata: Metadata = {
  title: 'Best Dentist in Manesar, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Manesar, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Manesar'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
