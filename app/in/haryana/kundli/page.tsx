...
export const metadata: Metadata = {
  title: 'Best Dentist in Kundli, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Kundli, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kundli'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
