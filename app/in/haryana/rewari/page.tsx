...
export const metadata: Metadata = {
  title: 'Best Dentist in Rewari, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Rewari, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rewari'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
