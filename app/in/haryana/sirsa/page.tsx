...
export const metadata: Metadata = {
  title: 'Best Dentist in Sirsa, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Sirsa, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sirsa'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
