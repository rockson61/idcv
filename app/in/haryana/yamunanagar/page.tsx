...
export const metadata: Metadata = {
  title: 'Best Dentist in Yamunanagar, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Yamunanagar, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Yamunanagar'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
