...
export const metadata: Metadata = {
  title: 'Best Dentist in Karnal, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Karnal, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Karnal'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
