...
export const metadata: Metadata = {
  title: 'Best Dentist in Gurgaon, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Gurgaon, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}
