...
export const metadata: Metadata = {
  title: 'Best Dentist in Panipat, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Panipat, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Panipat'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
