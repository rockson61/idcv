...
export const metadata: Metadata = {
  title: 'Best Dentist in Rohtak, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Rohtak, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Rohtak'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
