...
export const metadata: Metadata = {
  title: 'Best Dentist in Chandigarh, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Chandigarh, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}
