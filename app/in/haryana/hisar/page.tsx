...
export const metadata: Metadata = {
  title: 'Best Dentist in Hisar, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Hisar, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Hisar'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
