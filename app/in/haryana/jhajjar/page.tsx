...
export const metadata: Metadata = {
  title: 'Best Dentist in Jhajjar, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Jhajjar, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jhajjar'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
