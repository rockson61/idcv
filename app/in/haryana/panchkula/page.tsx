...
export const metadata: Metadata = {
  title: 'Best Dentist in Panchkula, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Panchkula, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Panchkula'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
