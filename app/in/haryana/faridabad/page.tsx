...
export const metadata: Metadata = {
  title: 'Best Dentist in Faridabad, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Faridabad, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Faridabad'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
