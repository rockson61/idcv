...
export const metadata: Metadata = {
  title: 'Best Dentist in Jind, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Jind, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jind'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
