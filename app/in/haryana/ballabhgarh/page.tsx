...
export const metadata: Metadata = {
  title: 'Best Dentist in Ballabhgarh, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Ballabhgarh, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ballabhgarh'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
