...
export const metadata: Metadata = {
  title: 'Best Dentist in Sonipat, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Sonipat, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sonipat'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
