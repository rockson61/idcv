...
export const metadata: Metadata = {
  title: 'Best Dentist in Bahadurgarh, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Bahadurgarh, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Bahadurgarh'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
