...
export const metadata: Metadata = {
  title: 'Best Dentist in Kurukshetra, Haryana | Indira Dental Clinic',
  description: 'Top-rated dental care for Kurukshetra, Haryana. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kurukshetra'
const city = 'Haryana'
const services: any[] = []
const reviews: any[] = []
const faqs: any[] = []
