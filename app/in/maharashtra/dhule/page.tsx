...
export const metadata: Metadata = {
  title: 'Best Dentist in Dhule, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Dhule, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Dhule'
