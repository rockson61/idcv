...
export const metadata: Metadata = {
  title: 'Best Dentist in Mira Bhayandar, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Mira Bhayandar, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mira Bhayandar'
