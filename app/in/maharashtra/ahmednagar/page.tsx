...
export const metadata: Metadata = {
  title: 'Best Dentist in Ahmednagar, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Ahmednagar, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ahmednagar'
