...
export const metadata: Metadata = {
  title: 'Best Dentist in Mumbai, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Mumbai, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Mumbai'
