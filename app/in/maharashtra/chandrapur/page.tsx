...
export const metadata: Metadata = {
  title: 'Best Dentist in Chandrapur, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Chandrapur, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Chandrapur'
