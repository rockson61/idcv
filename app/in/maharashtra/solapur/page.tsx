...
export const metadata: Metadata = {
  title: 'Best Dentist in Solapur, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Solapur, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Solapur'
