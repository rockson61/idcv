...
export const metadata: Metadata = {
  title: 'Best Dentist in Ambarnath, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Ambarnath, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ambarnath'
