...
export const metadata: Metadata = {
  title: 'Best Dentist in Nashik, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Nashik, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nashik'
