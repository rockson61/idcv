...
export const metadata: Metadata = {
  title: 'Best Dentist in Kolhapur, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Kolhapur, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kolhapur'
