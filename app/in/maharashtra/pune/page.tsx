...
export const metadata: Metadata = {
  title: 'Best Dentist in Pune, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Pune, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}
