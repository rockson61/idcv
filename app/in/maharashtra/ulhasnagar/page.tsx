...
export const metadata: Metadata = {
  title: 'Best Dentist in Ulhasnagar, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Ulhasnagar, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ulhasnagar'
