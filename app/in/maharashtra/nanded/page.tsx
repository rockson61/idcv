...
export const metadata: Metadata = {
  title: 'Best Dentist in Nanded, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Nanded, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Nanded'
