...
export const metadata: Metadata = {
  title: 'Best Dentist in Jalna, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Jalna, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jalna'
