...
export const metadata: Metadata = {
  title: 'Best Dentist in Ichalkaranji, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Ichalkaranji, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Ichalkaranji'
