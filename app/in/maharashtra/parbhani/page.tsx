...
export const metadata: Metadata = {
  title: 'Best Dentist in Parbhani, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Parbhani, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Parbhani'
