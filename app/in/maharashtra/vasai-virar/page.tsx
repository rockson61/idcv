...
export const metadata: Metadata = {
  title: 'Best Dentist in Vasai Virar, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Vasai Virar, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Vasai Virar'
