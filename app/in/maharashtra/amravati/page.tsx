...
export const metadata: Metadata = {
  title: 'Best Dentist in Amravati, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Amravati, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Amravati'
