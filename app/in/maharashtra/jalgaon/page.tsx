...
export const metadata: Metadata = {
  title: 'Best Dentist in Jalgaon, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Jalgaon, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Jalgaon'
