...
export const metadata: Metadata = {
  title: 'Best Dentist in Panvel, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Panvel, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Panvel'
