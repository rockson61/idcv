...
export const metadata: Metadata = {
  title: 'Best Dentist in Kalyan Dombivli, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Kalyan Dombivli, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Kalyan Dombivli'
