...
export const metadata: Metadata = {
  title: 'Best Dentist in Thane, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Thane, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Thane'
