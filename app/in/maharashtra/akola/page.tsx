...
export const metadata: Metadata = {
  title: 'Best Dentist in Akola, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Akola, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Akola'
