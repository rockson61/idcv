...
export const metadata: Metadata = {
  title: 'Best Dentist in Navi Mumbai, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Navi Mumbai, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Navi Mumbai'
