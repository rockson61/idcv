...
export const metadata: Metadata = {
  title: 'Best Dentist in Pimpri Chinchwad, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Pimpri Chinchwad, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}
