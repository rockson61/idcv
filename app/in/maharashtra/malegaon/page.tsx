...
export const metadata: Metadata = {
  title: 'Best Dentist in Malegaon, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Malegaon, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Malegaon'
