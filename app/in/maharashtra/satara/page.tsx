...
export const metadata: Metadata = {
  title: 'Best Dentist in Satara, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Satara, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Satara'
