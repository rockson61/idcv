...
export const metadata: Metadata = {
  title: 'Best Dentist in Aurangabad, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Aurangabad, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Aurangabad'
