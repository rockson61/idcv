...
export const metadata: Metadata = {
  title: 'Best Dentist in Maharashtra, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Maharashtra, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Maharashtra'
