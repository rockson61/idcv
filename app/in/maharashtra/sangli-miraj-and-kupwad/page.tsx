...
export const metadata: Metadata = {
  title: 'Best Dentist in Sangli Miraj And Kupwad, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Sangli Miraj And Kupwad, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Sangli Miraj And Kupwad'
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <Breadcrumb
          items={[
            ...
            { title: 'Sangli Miraj And Kupwad', href: '/in/maharashtra/sangli-miraj-and-kupwad' },
          ]}
        />
