...
export const metadata: Metadata = {
  title: 'Best Dentist in Latur, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Latur, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}

const locationName = 'Latur'
