...
export const metadata: Metadata = {
  title: 'Best Dentist in Nagpur, Maharashtra | Indira Dental Clinic',
  description: 'Top-rated dental care for Nagpur, Maharashtra. Save on treatments at Indira Dental Clinic, Vellore.',
}
