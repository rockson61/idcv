...
export const metadata: Metadata = {
  title: 'Tmj Disorders Treatment in Vellore | Indira Dental Clinic',
  description: 'Expert tmj disorders treatment in Vellore by Dr. Rockson Samuel. Advanced diagnosis and treatment for tmj disorders at Indira Dental Clinic.',
  keywords: 'tmj disorders, tmj disorders treatment, dental conditions, vellore dentist',
}
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Tmj Disorders Treatment in Vellore
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert diagnosis and treatment for tmj disorders at Indira Dental Clinic by Dr. Rockson Samuel
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle>About Tmj Disorders</ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent className="prose max-w-none">
                <p>
                  Tmj Disorders is a common dental condition that requires professional treatment. 
          ...
          <div className="space-y-6">
            <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
              <ModernCardContent className="p-6">
                ...
                <p className="mb-6 opacity-90">Book consultation for tmj disorders</p>
                <Link
                  href="/contact"
        ...
        <div className="mt-12">
          <CTAWidget 
            title="Need Treatment for Tmj Disorders?"
            description="Dr. Rockson Samuel provides expert care for tmj disorders in Vellore"
            primaryAction={{
