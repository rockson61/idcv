...
export const metadata: Metadata = {
  title: 'Geographic Tongue Treatment in Vellore | Indira Dental Clinic',
  description: 'Expert geographic tongue treatment in Vellore by Dr. Rockson Samuel. Advanced diagnosis and treatment for geographic tongue at Indira Dental Clinic.',
  keywords: 'geographic tongue, geographic tongue treatment, dental conditions, vellore dentist',
}
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Geographic Tongue Treatment in Vellore
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert diagnosis and treatment for geographic tongue at Indira Dental Clinic by Dr. Rockson Samuel
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle>About Geographic Tongue</ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent className="prose max-w-none">
                <p>
                  Geographic Tongue is a common dental condition that requires professional treatment. 
          ...
          <div className="space-y-6">
            <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
              <ModernCardContent className="p-6">
                ...
                <p className="mb-6 opacity-90">Book consultation for geographic tongue</p>
                <Link
                  href="/contact"
        ...
        <div className="mt-12">
          <CTAWidget 
            title="Need Treatment for Geographic Tongue?"
            description="Dr. Rockson Samuel provides expert care for geographic tongue in Vellore"
            primaryAction={{
