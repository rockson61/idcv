...
export const metadata: Metadata = {
  title: "Cavities Causes, Symptoms & Treatment | Dr. Rockson Samuel | Vellore",
  description: 'Expert cavities treatment in Vellore by Dr. Rockson Samuel. Advanced diagnosis and treatment for cavities at Indira Dental Clinic.',
  keywords: 'cavities, cavities treatment, dental conditions, vellore dentist',
}
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">
                Cavities Causes, Symptoms & Treatment
              </span>
            </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert diagnosis and treatment for cavities at Indira Dental Clinic by Dr. Rockson Samuel
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle>About Cavities</ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent className="prose max-w-none">
                <p>
                  Cavities is a common dental condition that requires professional treatment. 
          ...
          <div className="space-y-6">
            <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
              <ModernCardContent className="p-6">
                ...
                <p className="mb-6 opacity-90">Book consultation for cavities</p>
                <Link
                  href="/contact"
        ...
        <div className="mt-12">
          <CTAWidget 
            title="Need Treatment for Cavities?"
            description="Dr. Rockson Samuel provides expert care for cavities in Vellore"
            primaryAction={{
