...
export const metadata: Metadata = {
  title: "Malocclusion Causes, Symptoms & Treatment | Dr. Rockson Samuel | Vellore",
  description: 'Expert malocclusion treatment in Vellore by Dr. Rockson Samuel. Advanced diagnosis and treatment for malocclusion at Indira Dental Clinic.',
  keywords: 'malocclusion, malocclusion treatment, dental conditions, vellore dentist',
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">
                Malocclusion Causes, Symptoms & Treatment
              </span>
            </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert diagnosis and treatment for malocclusion at Indira Dental Clinic by Dr. Rockson Samuel
          </p>
        </div>
          ...
          <div className="md:col-span-2">
            <ModernCard>
              ...
              <ModernCardContent className="prose max-w-none">
                <p>
                  Malocclusion is a common dental condition that requires professional treatment. 
          ...
          <div className="space-y-6">
            <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
              <ModernCardContent className="p-6">
                ...
                <p className="mb-6 opacity-90">Book consultation for malocclusion</p>
                <Link
                  href="/contact"
        ...
        <div className="mt-12">
          <CTAWidget 
            title="Need Treatment for Malocclusion?"
            description="Dr. Rockson Samuel provides expert care for malocclusion in Vellore"
            primaryAction={{
