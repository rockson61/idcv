...
export const metadata: Metadata = {
  title: "Abscessed Tooth Causes, Symptoms & Treatment | Dr. Rockson Samuel | Vellore",
  description: 'Expert abscessed tooth treatment in Vellore by Dr. Rockson Samuel. Advanced diagnosis and treatment for abscessed tooth at Indira Dental Clinic.',
  keywords: 'abscessed tooth, abscessed tooth treatment, dental conditions, vellore dentist',
}
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent">
                Abscessed Tooth Causes, Symptoms & Treatment
              </span>
            </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert diagnosis and treatment for abscessed tooth at Indira Dental Clinic by Dr. Rockson Samuel
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle>About Abscessed Tooth</ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent className="prose max-w-none">
                <p>
                  Abscessed Tooth is a common dental condition that requires professional treatment. 
          ...
          <div className="space-y-6">
            <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
              <ModernCardContent className="p-6">
                ...
                <p className="mb-6 opacity-90">Book consultation for abscessed tooth</p>
                <Link
                  href="/contact"
        ...
        <div className="mt-12">
          <CTAWidget 
            title="Need Treatment for Abscessed Tooth?"
            description="Dr. Rockson Samuel provides expert care for abscessed tooth in Vellore"
            primaryAction={{
