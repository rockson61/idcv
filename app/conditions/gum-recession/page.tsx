...
export const metadata: Metadata = {
  title: "Gum Recession Causes, Symptoms & Treatment | Dr. Rockson Samuel | Vellore",
  description: 'Expert gum recession treatment in Vellore by Dr. Rockson Samuel. Advanced diagnosis and treatment for gum recession at Indira Dental Clinic.',
  keywords: 'gum recession, gum recession treatment, dental conditions, vellore dentist',
}
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert diagnosis and treatment for gum recession at Indira Dental Clinic by Dr. Rockson Samuel
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <ModernCard>
              <ModernCardHeader>
                <ModernCardTitle>About Gum Recession</ModernCardTitle>
              </ModernCardHeader>
              <ModernCardContent className="prose max-w-none">
                <p>
                  Gum Recession is a common dental condition that requires professional treatment. 
          ...
          <div className="space-y-6">
            <ModernCard className="bg-gradient-to-br from-teal-600 to-blue-600 text-white">
              <ModernCardContent className="p-6">
                ...
                <p className="mb-6 opacity-90">Book consultation for gum recession</p>
                <Link
                  href="/contact"
        ...
        <div className="mt-12">
          <CTAWidget 
            title="Need Treatment for Gum Recession?"
            description="Dr. Rockson Samuel provides expert care for gum recession in Vellore"
            primaryAction={{
