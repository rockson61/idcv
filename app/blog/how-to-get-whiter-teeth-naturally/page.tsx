...
const slug = 'how-to-get-whiter-teeth-naturally'




export const metadata: Metadata = {
  title: "How To Get Whiter Teeth Naturally: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on how to get whiter teeth naturally. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'how, to, get, whiter, teeth, naturally, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'How To Get Whiter Teeth Naturally | Indira Dental Clinic Vellore',
    description: 'Expert guide on how to get whiter teeth naturally. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/how-to-get-whiter-teeth-naturally',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'How To Get Whiter Teeth Naturally'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['how, to, get, whiter, teeth, naturally'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How To Get Whiter Teeth Naturally',
    description: 'Expert guide on how to get whiter teeth naturally. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Sa',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/how-to-get-whiter-teeth-naturally'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'How to Get Whiter Teeth Naturally at Home',
...
export default function HowToGetWhiterTeethNaturallyPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">How To Get Whiter Teeth Naturally: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="How to Get Whiter Teeth Naturally at Home" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on how to get whiter teeth naturally at home from Indira Dental Clinic, Vellore. 
