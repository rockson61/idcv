...
const slug = 'smoking-gum-disease-risks'




export const metadata: Metadata = {
  title: "Smoking Gum Disease Risks: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on smoking gum disease risks. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'smoking, gum, disease, risks, periodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Smoking Gum Disease Risks | Indira Dental Clinic Vellore',
    description: 'Expert guide on smoking gum disease risks. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/smoking-gum-disease-risks',
    ...
    tags: ['smoking, gum, disease, risks'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Smoking Gum Disease Risks',
    description: 'Expert guide on smoking gum disease risks. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at ',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/smoking-gum-disease-risks'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Smoking and Gum Disease: Risks and Prevention',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.dentalclinicinvellore.in/blog/smoking-gum-disease-risks'
  }
}

export default function SmokingGumDiseaseRisksBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Smoking Gum Disease Risks: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image
                ...
                alt="Smoking and Gum Disease: Risks and Prevention"
                fill
              ...
              <ModernCardContent>
                <ul className="space-y-2">
                  <li><Link href="#what-is" className="text-blue-600 hover:text-blue-800 flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" /> What is Smoking and Gum Disease: Risks and Prevention?
                  </Link></li>
            ...
            <div className="prose prose-lg max-w-none mb-8">
              <p className="text-xl text-gray-700 leading-relaxed">
                Smoking and Gum Disease: Risks and Prevention is a common dental concern affecting millions of people in India. In this comprehensive guide, 
            ...
            <section id="what-is" className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                ...
                What is Smoking and Gum Disease: Risks and Prevention?
              </h2>
