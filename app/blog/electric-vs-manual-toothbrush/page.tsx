...
const slug = 'electric-vs-manual-toothbrush'




export const metadata: Metadata = {
  title: "Electric Vs Manual Toothbrush: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on electric vs manual toothbrush. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'electric, vs, manual, toothbrush, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Electric Vs Manual Toothbrush | Indira Dental Clinic Vellore',
    description: 'Expert guide on electric vs manual toothbrush. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/electric-vs-manual-toothbrush',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Electric Vs Manual Toothbrush'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['electric, vs, manual, toothbrush'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Electric Vs Manual Toothbrush',
    description: 'Expert guide on electric vs manual toothbrush. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/electric-vs-manual-toothbrush'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Electric vs Manual Toothbrush: Which is Better?',
...
export default function ElectricVsManualToothbrushPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Electric Vs Manual Toothbrush: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Electric vs Manual Toothbrush: Which is Better?" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on electric vs manual toothbrush: which is better? from Indira Dental Clinic, Vellore. 
