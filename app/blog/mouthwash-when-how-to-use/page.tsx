...
const slug = 'mouthwash-when-how-to-use'




export const metadata: Metadata = {
  title: "Mouthwash When How To Use: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on mouthwash when how to use. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'mouthwash, when, how, to, use, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Mouthwash When How To Use | Indira Dental Clinic Vellore',
    description: 'Expert guide on mouthwash when how to use. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/mouthwash-when-how-to-use',
    ...
    tags: ['mouthwash, when, how, to, use'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Mouthwash When How To Use',
    description: 'Expert guide on mouthwash when how to use. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at ',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/mouthwash-when-how-to-use'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Mouthwash: When and How to Use Effectively',
...
export default function MouthwashWhenHowToUsePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Mouthwash When How To Use: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Mouthwash: When and How to Use Effectively" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on mouthwash: when and how to use effectively from Indira Dental Clinic, Vellore. 
