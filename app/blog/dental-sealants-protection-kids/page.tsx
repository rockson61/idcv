...
const slug = 'dental-sealants-protection-kids'




export const metadata: Metadata = {
  title: "Dental Sealants Protection Kids: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on dental sealants protection kids. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'dental, sealants, protection, kids, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Dental Sealants Protection Kids | Indira Dental Clinic Vellore',
    description: 'Expert guide on dental sealants protection kids. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/dental-sealants-protection-kids',
    ...
    tags: ['dental, sealants, protection, kids'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Dental Sealants Protection Kids',
    description: 'Expert guide on dental sealants protection kids. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samu',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/dental-sealants-protection-kids'
  }
}
...
export default function DentalSealantsProtectionKidsPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Dental Sealants Protection Kids: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Dental Sealants: Protection for Kids' Teeth" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on dental sealants: protection for kids' teeth from Indira Dental Clinic, Vellore. 
