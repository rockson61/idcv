...
const slug = 'worn-down-teeth-causes-restoration'




export const metadata: Metadata = {
  title: "Worn Down Teeth Causes Restoration: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on worn down teeth causes restoration. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'worn, down, teeth, causes, restoration, restorative dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Worn Down Teeth Causes Restoration | Indira Dental Clinic Vellore',
    description: 'Expert guide on worn down teeth causes restoration. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/worn-down-teeth-causes-restoration',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Worn Down Teeth Causes Restoration'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['worn, down, teeth, causes, restoration'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Worn Down Teeth Causes Restoration',
    description: 'Expert guide on worn down teeth causes restoration. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson S',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/worn-down-teeth-causes-restoration'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Worn-Down Teeth: Causes and Restoration',
...
export default function WornDownTeethCausesRestorationBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <Breadcrumb
            items={[
              ...
              { title: 'Worn-Down Teeth: Causes and Restoration', href: `/blog/worn-down-teeth-causes-restoration` }
            ]}
          />
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Worn Down Teeth Causes Restoration: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Worn-Down Teeth: Causes and Restoration"
                fill
            ...
            <section className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Worn-Down Teeth: Causes and Restoration is a crucial aspect of restorative dentistry. This comprehensive guide by Dr. Rockson Samuel 
