...
const slug = 'professional-teeth-whitening-guide-2024'




export const metadata: Metadata = {
  title: "Professional Teeth Whitening Guide 2024: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on professional teeth whitening guide 2024. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'professional, teeth, whitening, guide, 2024, cosmetic dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Professional Teeth Whitening Guide 2024 | Indira Dental Clinic Vellore',
    description: 'Expert guide on professional teeth whitening guide 2024. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/professional-teeth-whitening-guide-2024',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Professional Teeth Whitening Guide 2024'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['professional, teeth, whitening, guide, 2024'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Professional Teeth Whitening Guide 2024',
    description: 'Expert guide on professional teeth whitening guide 2024. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rock',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/professional-teeth-whitening-guide-2024'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Professional Teeth Whitening: Complete Guide 2024',
...
export default function ProfessionalTeethWhiteningGuide2024Post() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Professional Teeth Whitening Guide 2024: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Professional Teeth Whitening: Complete Guide 2024" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on professional teeth whitening: complete guide 2024 from Indira Dental Clinic, Vellore. 
