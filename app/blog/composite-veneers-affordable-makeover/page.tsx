...
const slug = 'composite-veneers-affordable-makeover'




export const metadata: Metadata = {
  title: "Composite Veneers Affordable Makeover: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on composite veneers affordable makeover. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'composite, veneers, affordable, makeover, restorative dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Composite Veneers Affordable Makeover | Indira Dental Clinic Vellore',
    description: 'Expert guide on composite veneers affordable makeover. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/composite-veneers-affordable-makeover',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Composite Veneers Affordable Makeover'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['composite, veneers, affordable, makeover'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Composite Veneers Affordable Makeover',
    description: 'Expert guide on composite veneers affordable makeover. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockso',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/composite-veneers-affordable-makeover'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Composite Veneers: Affordable Smile Makeover',
...
export default function CompositeVeneersAffordableMakeoverPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Composite Veneers Affordable Makeover: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Composite Veneers: Affordable Smile Makeover" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on composite veneers: affordable smile makeover from Indira Dental Clinic, Vellore. 
