...
const slug = 'fluoride-treatment-adults-children'




export const metadata: Metadata = {
  title: "Fluoride Treatment Adults Children: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on fluoride treatment adults children. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'fluoride, treatment, adults, children, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Fluoride Treatment Adults Children | Indira Dental Clinic Vellore',
    description: 'Expert guide on fluoride treatment adults children. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/fluoride-treatment-adults-children',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Fluoride Treatment Adults Children'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['fluoride, treatment, adults, children'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Fluoride Treatment Adults Children',
    description: 'Expert guide on fluoride treatment adults children. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson S',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/fluoride-treatment-adults-children'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Fluoride Treatment for Adults and Children',
...
export default function FluorideTreatmentAdultsChildrenPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Fluoride Treatment Adults Children: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Fluoride Treatment for Adults and Children" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on fluoride treatment for adults and children from Indira Dental Clinic, Vellore. 
