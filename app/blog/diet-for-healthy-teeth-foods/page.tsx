...
const slug = 'diet-for-healthy-teeth-foods'




export const metadata: Metadata = {
  title: "Diet For Healthy Teeth Foods: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on diet for healthy teeth foods. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'diet, for, healthy, teeth, foods, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Diet For Healthy Teeth Foods | Indira Dental Clinic Vellore',
    description: 'Expert guide on diet for healthy teeth foods. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/diet-for-healthy-teeth-foods',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Diet For Healthy Teeth Foods'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['diet, for, healthy, teeth, foods'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Diet For Healthy Teeth Foods',
    description: 'Expert guide on diet for healthy teeth foods. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel ',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/diet-for-healthy-teeth-foods'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Diet for Healthy Teeth: Foods to Eat and Avoid',
...
export default function DietForHealthyTeethFoodsPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Diet For Healthy Teeth Foods: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Diet for Healthy Teeth: Foods to Eat and Avoid" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on diet for healthy teeth: foods to eat and avoid from Indira Dental Clinic, Vellore. 
