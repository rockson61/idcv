...
const slug = 'zoom-whitening-procedure-cost-results'




export const metadata: Metadata = {
  title: "Zoom Whitening Procedure Cost Results: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on zoom whitening procedure cost results. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'zoom, whitening, procedure, cost, results, cosmetic dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Zoom Whitening Procedure Cost Results | Indira Dental Clinic Vellore',
    description: 'Expert guide on zoom whitening procedure cost results. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/zoom-whitening-procedure-cost-results',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Zoom Whitening Procedure Cost Results'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['zoom, whitening, procedure, cost, results'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Zoom Whitening Procedure Cost Results',
    description: 'Expert guide on zoom whitening procedure cost results. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockso',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/zoom-whitening-procedure-cost-results'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Zoom Whitening: Procedure, Cost & Results',
...
export default function ZoomWhiteningProcedureCostResultsPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Zoom Whitening Procedure Cost Results: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Zoom Whitening: Procedure, Cost & Results" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on zoom whitening: procedure, cost & results from Indira Dental Clinic, Vellore. 
