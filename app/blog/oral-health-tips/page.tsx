...
const slug = 'oral-health-tips'




export const metadata: Metadata = {
  title: "Oral Health Tips: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on oral health tips. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'oral, health, tips, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Oral Health Tips | Indira Dental Clinic Vellore',
    description: 'Expert guide on oral health tips. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/oral-health-tips',
    ...
    tags: ['oral, health, tips'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Oral Health Tips',
    description: 'Expert guide on oral health tips. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira De',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/oral-health-tips'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Essential Oral Health Tips for Everyone',
...
export default function OralHealthTipsBlogPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Oral Health Tips: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image src="/dental-clinic-vellore.jpg" alt="Essential Oral Health Tips for Everyone" fill className="object-cover" priority />
            </div>
            ...
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Comprehensive guide to essential oral health tips for everyone. Learn from Dr. Rockson Samuel's expertise at Indira Dental Clinic, Vellore.
              </p>
            </div>
            ...
            <ModernCard className="mb-12 bg-gradient-to-r from-teal-50 to-blue-50 border-2 border-teal-300">
              <ModernCardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-6">Get expert preventive dentistry treatment from Dr. Rockson Samuel in Vellore.</p>
