...
export default function bridgesdenturesCategoryPage() {
  return (
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Expert articles and guides on bridges dentures by Dr. Rockson Samuel
          </p>
        </div>
        ...
        <ModernCard>
          ...
          <ModernCardContent>
            <p className="text-gray-600 mb-6">
              Explore our comprehensive collection of articles on bridges dentures. 
