...
const slug = 'gum-disease-prevention-daily-care'




export const metadata: Metadata = {
  title: "Gum Disease Prevention Daily Care: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on gum disease prevention daily care. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'gum, disease, prevention, daily, care, periodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Gum Disease Prevention Daily Care | Indira Dental Clinic Vellore',
    description: 'Expert guide on gum disease prevention daily care. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/gum-disease-prevention-daily-care',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Gum Disease Prevention Daily Care'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['gum, disease, prevention, daily, care'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gum Disease Prevention Daily Care',
    description: 'Expert guide on gum disease prevention daily care. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Sa',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/gum-disease-prevention-daily-care'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Gum Disease Prevention: Daily Care Tips',
...
export default function GumDiseasePreventionDailyCarePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Gum Disease Prevention Daily Care: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Gum Disease Prevention: Daily Care Tips" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on gum disease prevention: daily care tips from Indira Dental Clinic, Vellore. 
