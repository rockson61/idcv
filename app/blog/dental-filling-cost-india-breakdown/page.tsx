...
const slug = 'dental-filling-cost-india-breakdown'




export const metadata: Metadata = {
  title: "Dental Filling Cost India Breakdown: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on dental filling cost india breakdown. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'dental, filling, cost, india, breakdown, restorative dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Dental Filling Cost India Breakdown | Indira Dental Clinic Vellore',
    description: 'Expert guide on dental filling cost india breakdown. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/dental-filling-cost-india-breakdown',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Dental Filling Cost India Breakdown'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['dental, filling, cost, india, breakdown'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Dental Filling Cost India Breakdown',
    description: 'Expert guide on dental filling cost india breakdown. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson ',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/dental-filling-cost-india-breakdown'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Dental Filling Cost in India: Complete Breakdown',
...
export default function DentalFillingCostIndiaBreakdownBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Dental Filling Cost India Breakdown: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Dental Filling Cost in India: Complete Breakdown"
                fill
            ...
            <section className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Dental Filling Cost in India: Complete Breakdown is a crucial aspect of restorative dentistry. This comprehensive guide by Dr. Rockson Samuel 
