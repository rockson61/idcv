...
const slug = 'oral-cancer-screening-early-detection'




export const metadata: Metadata = {
  title: "Oral Cancer Screening Early Detection: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on oral cancer screening early detection. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'oral, cancer, screening, early, detection, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  ...
  openGraph: {
    ...
    description: 'Expert guide on oral cancer screening early detection. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/oral-cancer-screening-early-detection',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Oral Cancer Screening Early Detection'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['oral, cancer, screening, early, detection'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Oral Cancer Screening Early Detection',
    description: 'Expert guide on oral cancer screening early detection. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockso',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/oral-cancer-screening-early-detection'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Oral Cancer Screening: Early Detection Saves Lives',
...
export default function OralCancerScreeningEarlyDetectionPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Oral Cancer Screening Early Detection: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Oral Cancer Screening: Early Detection Saves Lives" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on oral cancer screening: early detection saves lives from Indira Dental Clinic, Vellore. 
