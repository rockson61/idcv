...
export const metadata: Metadata = {
  title: "6mm Gum Pocket: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on 6mm gum pocket. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: '6mm, gum, pocket, periodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: '6mm Gum Pocket | Indira Dental Clinic Vellore',
    description: 'Expert guide on 6mm gum pocket. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/6mm-gum-pocket',
    ...
    tags: ['6mm, gum, pocket'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: '6mm Gum Pocket',
    description: 'Expert guide on 6mm gum pocket. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dent',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/6mm-gum-pocket'
  }
}
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-teal-50">
        ...
        <article className="container mx-auto px-4 py-12 max-w-5xl">
          ...
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">6mm Gum Pocket: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
