...
const slug = 'tooth-decay-adults-treatment-options'




export const metadata: Metadata = {
  title: "Tooth Decay Adults Treatment Options: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on tooth decay adults treatment options. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'tooth, decay, adults, treatment, options, restorative dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Tooth Decay Adults Treatment Options | Indira Dental Clinic Vellore',
    description: 'Expert guide on tooth decay adults treatment options. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/tooth-decay-adults-treatment-options',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tooth Decay Adults Treatment Options'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['tooth, decay, adults, treatment, options'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Tooth Decay Adults Treatment Options',
    description: 'Expert guide on tooth decay adults treatment options. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/tooth-decay-adults-treatment-options'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Tooth Decay in Adults: Treatment Options',
...
export default function ToothDecayAdultsTreatmentOptionsBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Tooth Decay Adults Treatment Options: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Tooth Decay in Adults: Treatment Options"
                fill
            ...
            <section className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Tooth Decay in Adults: Treatment Options is a crucial aspect of restorative dentistry. This comprehensive guide by Dr. Rockson Samuel 
