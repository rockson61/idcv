...
const slug = 'home-teeth-whitening-kits-effectiveness'




export const metadata: Metadata = {
  title: "Home Teeth Whitening Kits Effectiveness: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on home teeth whitening kits effectiveness. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'home, teeth, whitening, kits, effectiveness, cosmetic dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Home Teeth Whitening Kits Effectiveness | Indira Dental Clinic Vellore',
    description: 'Expert guide on home teeth whitening kits effectiveness. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/home-teeth-whitening-kits-effectiveness',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Home Teeth Whitening Kits Effectiveness'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['home, teeth, whitening, kits, effectiveness'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Home Teeth Whitening Kits Effectiveness',
    description: 'Expert guide on home teeth whitening kits effectiveness. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rock',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/home-teeth-whitening-kits-effectiveness'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Home Teeth Whitening Kits: Do They Work?',
...
export default function HomeTeethWhiteningKitsEffectivenessPost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Home Teeth Whitening Kits Effectiveness: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Home Teeth Whitening Kits: Do They Work?" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on home teeth whitening kits: do they work? from Indira Dental Clinic, Vellore. 
