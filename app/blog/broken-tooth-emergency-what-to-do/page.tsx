...
const slug = 'broken-tooth-emergency-what-to-do'




export const metadata: Metadata = {
  title: "Broken Tooth Emergency What To Do: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on broken tooth emergency what to do. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'broken, tooth, emergency, what, to, do, emergency dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Broken Tooth Emergency What To Do | Indira Dental Clinic Vellore',
    description: 'Expert guide on broken tooth emergency what to do. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/broken-tooth-emergency-what-to-do',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Broken Tooth Emergency What To Do'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['broken, tooth, emergency, what, to, do'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Broken Tooth Emergency What To Do',
    description: 'Expert guide on broken tooth emergency what to do. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Sa',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/broken-tooth-emergency-what-to-do'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Broken Tooth Emergency: What to Do Immediately',
...
export default function BrokenToothEmergencyWhatToDoBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Broken Tooth Emergency What To Do: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Broken Tooth Emergency: What to Do Immediately"
                fill
            ...
            <section className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Broken Tooth Emergency: What to Do Immediately is a crucial aspect of restorative dentistry. This comprehensive guide by Dr. Rockson Samuel 
