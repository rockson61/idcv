...
const slug = 'composite-fillings-tooth-colored'




export const metadata: Metadata = {
  title: "Composite Fillings Tooth Colored: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on composite fillings tooth colored. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'composite, fillings, tooth, colored, restorative dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Composite Fillings Tooth Colored | Indira Dental Clinic Vellore',
    description: 'Expert guide on composite fillings tooth colored. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/composite-fillings-tooth-colored',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Composite Fillings Tooth Colored'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['composite, fillings, tooth, colored'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Composite Fillings Tooth Colored',
    description: 'Expert guide on composite fillings tooth colored. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Sam',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/composite-fillings-tooth-colored'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Composite Fillings: Tooth-Colored Restorations',
...
export default function CompositeFillingsToothColoredBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Composite Fillings Tooth Colored: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Composite Fillings: Tooth-Colored Restorations"
                fill
            ...
            <section className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Composite Fillings: Tooth-Colored Restorations is a crucial aspect of restorative dentistry. This comprehensive guide by Dr. Rockson Samuel 
