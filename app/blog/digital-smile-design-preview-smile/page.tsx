...
const slug = 'digital-smile-design-preview-smile'




export const metadata: Metadata = {
  title: "Digital Smile Design Preview Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on digital smile design preview smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'digital, smile, design, preview, smile, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Digital Smile Design Preview Smile | Indira Dental Clinic Vellore',
    description: 'Expert guide on digital smile design preview smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/digital-smile-design-preview-smile',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Digital Smile Design Preview Smile'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['digital, smile, design, preview, smile'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Digital Smile Design Preview Smile',
    description: 'Expert guide on digital smile design preview smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson S',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/digital-smile-design-preview-smile'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Digital Smile Design: Preview Your New Smile',
...
export default function DigitalSmileDesignPreviewSmilePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Digital Smile Design Preview Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Digital Smile Design: Preview Your New Smile" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on digital smile design: preview your new smile from Indira Dental Clinic, Vellore. 
