...
const slug = 'how-to-prevent-cavities-guide'




export const metadata: Metadata = {
  title: "How To Prevent Cavities Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on how to prevent cavities guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'how, to, prevent, cavities, guide, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'How To Prevent Cavities Guide | Indira Dental Clinic Vellore',
    description: 'Expert guide on how to prevent cavities guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/how-to-prevent-cavities-guide',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'How To Prevent Cavities Guide'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['how, to, prevent, cavities, guide'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How To Prevent Cavities Guide',
    description: 'Expert guide on how to prevent cavities guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/how-to-prevent-cavities-guide'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'How to Prevent Cavities: Complete Guide',
...
export default function HowToPreventCavitiesGuidePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">How To Prevent Cavities Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="How to Prevent Cavities: Complete Guide" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on how to prevent cavities: complete guide from Indira Dental Clinic, Vellore. 
