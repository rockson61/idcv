...
const slug = 'peri-implantitis-gum-disease-implants'




export const metadata: Metadata = {
  title: "Peri Implantitis Gum Disease Implants: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on peri implantitis gum disease implants. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'peri, implantitis, gum, disease, implants, periodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Peri Implantitis Gum Disease Implants | Indira Dental Clinic Vellore',
    description: 'Expert guide on peri implantitis gum disease implants. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/peri-implantitis-gum-disease-implants',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Peri Implantitis Gum Disease Implants'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['peri, implantitis, gum, disease, implants'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Peri Implantitis Gum Disease Implants',
    description: 'Expert guide on peri implantitis gum disease implants. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockso',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/peri-implantitis-gum-disease-implants'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Peri-Implantitis: Gum Disease Around Implants',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.dentalclinicinvellore.in/blog/peri-implantitis-gum-disease-implants'
  }
}

export default function PeriImplantitisGumDiseaseImplantsBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Peri Implantitis Gum Disease Implants: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Peri-Implantitis: Gum Disease Around Implants"
                fill
              ...
              <ModernCardContent>
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <Link href="#what-is" className="text-blue-600 hover:text-blue-800 flex items-center gap-2 p-2 hover:bg-blue-100 rounded">
                    <ArrowRight className="w-4 h-4" /> What is Peri-Implantitis: Gum Disease Around Implants?
                  </Link>
            ...
            <section id="introduction" className="mb-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed">
                  Peri-Implantitis: Gum Disease Around Implants is an important aspect of modern dentistry that can significantly impact your oral health 
