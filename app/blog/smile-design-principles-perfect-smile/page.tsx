...
const slug = 'smile-design-principles-perfect-smile'




export const metadata: Metadata = {
  title: "Smile Design Principles Perfect Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on smile design principles perfect smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'smile, design, principles, perfect, smile, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Smile Design Principles Perfect Smile | Indira Dental Clinic Vellore',
    description: 'Expert guide on smile design principles perfect smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/smile-design-principles-perfect-smile',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Smile Design Principles Perfect Smile'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['smile, design, principles, perfect, smile'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Smile Design Principles Perfect Smile',
    description: 'Expert guide on smile design principles perfect smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockso',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/smile-design-principles-perfect-smile'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Smile Design Principles: Creating Perfect Smile',
...
export default function SmileDesignPrinciplesPerfectSmilePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Smile Design Principles Perfect Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Smile Design Principles: Creating Perfect Smile" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on smile design principles: creating perfect smile from Indira Dental Clinic, Vellore. 
