...
const slug = 'gum-contouring-reshaping-perfect-smile'




export const metadata: Metadata = {
  title: "Gum Contouring Reshaping Perfect Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on gum contouring reshaping perfect smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'gum, contouring, reshaping, perfect, smile, periodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Gum Contouring Reshaping Perfect Smile | Indira Dental Clinic Vellore',
    description: 'Expert guide on gum contouring reshaping perfect smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/gum-contouring-reshaping-perfect-smile',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Gum Contouring Reshaping Perfect Smile'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['gum, contouring, reshaping, perfect, smile'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Gum Contouring Reshaping Perfect Smile',
    description: 'Expert guide on gum contouring reshaping perfect smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rocks',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/gum-contouring-reshaping-perfect-smile'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Gum Contouring: Reshaping for Perfect Smile',
...
export default function GumContouringReshapingPerfectSmilePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Gum Contouring Reshaping Perfect Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Gum Contouring: Reshaping for Perfect Smile" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on gum contouring: reshaping for perfect smile from Indira Dental Clinic, Vellore. 
