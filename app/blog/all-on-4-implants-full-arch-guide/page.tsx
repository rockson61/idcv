...
const slug = 'all-on-4-implants-full-arch-guide'




export const metadata: Metadata = {
  title: "All On 4 Implants Full Arch Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on all on 4 implants full arch guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'all, on, 4, implants, full, arch, guide, implantology, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'All On 4 Implants Full Arch Guide | Indira Dental Clinic Vellore',
    description: 'Expert guide on all on 4 implants full arch guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/all-on-4-implants-full-arch-guide',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'All On 4 Implants Full Arch Guide'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['all, on, 4, implants, full, arch, guide'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'All On 4 Implants Full Arch Guide',
    description: 'Expert guide on all on 4 implants full arch guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Sa',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/all-on-4-implants-full-arch-guide'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'All-on-4 Implants: Full Arch Restoration Guide',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.dentalclinicinvellore.in/blog/all-on-4-implants-full-arch-guide'
  }
}

export default function AllOn4ImplantsFullArchGuideBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">All On 4 Implants Full Arch Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="All-on-4 Implants: Full Arch Restoration Guide"
                fill
              ...
              <ModernCardContent>
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <Link href="#what-is" className="text-blue-600 hover:text-blue-800 flex items-center gap-2 p-2 hover:bg-blue-100 rounded">
                    <ArrowRight className="w-4 h-4" /> What is All-on-4 Implants: Full Arch Restoration Guide?
                  </Link>
            ...
            <section id="introduction" className="mb-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed">
                  All-on-4 Implants: Full Arch Restoration Guide is an important aspect of modern dentistry that can significantly impact your oral health 
            ...
            <section id="what-is" className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                ...
                Understanding All-on-4 Implants: Full Arch Restoration Guide
              </h2>
              <div className="prose prose-lg max-w-none">
