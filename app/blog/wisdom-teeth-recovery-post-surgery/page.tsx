...
const slug = 'wisdom-teeth-recovery-post-surgery'




export const metadata: Metadata = {
  title: "Wisdom Teeth Recovery Post Surgery: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on wisdom teeth recovery post surgery. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'wisdom, teeth, recovery, post, surgery, oral surgery, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Wisdom Teeth Recovery Post Surgery | Indira Dental Clinic Vellore',
    description: 'Expert guide on wisdom teeth recovery post surgery. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/wisdom-teeth-recovery-post-surgery',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Wisdom Teeth Recovery Post Surgery'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['wisdom, teeth, recovery, post, surgery'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Wisdom Teeth Recovery Post Surgery',
    description: 'Expert guide on wisdom teeth recovery post surgery. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson S',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/wisdom-teeth-recovery-post-surgery'
  }
}

export default function WisdomTeethRecoveryPostSurgeryPost() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <article className="mt-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Wisdom Teeth Recovery Post Surgery: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
          ...
          <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
            <Image src="/emergency-dental.jpg" alt="Wisdom Teeth Recovery: Post-Surgery Care" fill className="object-cover" priority />
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 leading-relaxed">Wisdom Teeth Recovery: Post-Surgery Care - comprehensive guide from Indira Dental Clinic, Vellore. Expert care when you need it most.</p>
          </div>
        </article>
      </div>
    </div>
