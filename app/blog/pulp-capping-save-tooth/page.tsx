...
const slug = 'pulp-capping-save-tooth'




export const metadata: Metadata = {
  title: "Pulp Capping Save Tooth: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on pulp capping save tooth. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'pulp, capping, save, tooth, endodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Pulp Capping Save Tooth | Indira Dental Clinic Vellore',
    description: 'Expert guide on pulp capping save tooth. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/pulp-capping-save-tooth',
    ...
    tags: ['pulp, capping, save, tooth'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Pulp Capping Save Tooth',
    description: 'Expert guide on pulp capping save tooth. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at In',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/pulp-capping-save-tooth'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Pulp Capping: Saving Your Natural Tooth',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.dentalclinicinvellore.in/blog/pulp-capping-save-tooth'
  }
}

export default function PulpCappingSaveToothBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Pulp Capping Save Tooth: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden shadow-xl">
              <Image
                ...
                alt="Pulp Capping: Saving Your Natural Tooth"
                fill
              ...
              <ModernCardContent>
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <Link href="#what-is" className="text-blue-600 hover:text-blue-800 flex items-center gap-2 p-2 hover:bg-blue-100 rounded">
                    <ArrowRight className="w-4 h-4" /> What is Pulp Capping: Saving Your Natural Tooth?
                  </Link>
            ...
            <section id="introduction" className="mb-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed">
                  Pulp Capping: Saving Your Natural Tooth is an important aspect of modern dentistry that can significantly impact your oral health 
            ...
            <section id="what-is" className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                ...
                Understanding Pulp Capping: Saving Your Natural Tooth
              </h2>
              <div className="prose prose-lg max-w-none">
