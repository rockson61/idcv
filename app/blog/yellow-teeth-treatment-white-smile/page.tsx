...
const slug = 'yellow-teeth-treatment-white-smile'




export const metadata: Metadata = {
  title: "Yellow Teeth Treatment White Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on yellow teeth treatment white smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'yellow, teeth, treatment, white, smile, cosmetic dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Yellow Teeth Treatment White Smile | Indira Dental Clinic Vellore',
    description: 'Expert guide on yellow teeth treatment white smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/yellow-teeth-treatment-white-smile',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Yellow Teeth Treatment White Smile'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['yellow, teeth, treatment, white, smile'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Yellow Teeth Treatment White Smile',
    description: 'Expert guide on yellow teeth treatment white smile. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson S',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/yellow-teeth-treatment-white-smile'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Yellow Teeth Treatment: Get White Smile',
...
export default function YellowTeethTreatmentWhiteSmilePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Yellow Teeth Treatment White Smile: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Yellow Teeth Treatment: Get White Smile" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on yellow teeth treatment: get white smile from Indira Dental Clinic, Vellore. 
