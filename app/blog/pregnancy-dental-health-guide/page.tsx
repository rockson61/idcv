...
const slug = 'pregnancy-dental-health-guide'




export const metadata: Metadata = {
  title: "Pregnancy Dental Health Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on pregnancy dental health guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'pregnancy, dental, health, guide, preventive dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Pregnancy Dental Health Guide | Indira Dental Clinic Vellore',
    description: 'Expert guide on pregnancy dental health guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/pregnancy-dental-health-guide',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Pregnancy Dental Health Guide'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['pregnancy, dental, health, guide'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Pregnancy Dental Health Guide',
    description: 'Expert guide on pregnancy dental health guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/pregnancy-dental-health-guide'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Pregnancy and Dental Health: What You Need to Know',
...
export default function PregnancyDentalHealthGuidePost() {
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Pregnancy Dental Health Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image src="/dental-clinic-vellore.jpg" alt="Pregnancy and Dental Health: What You Need to Know" fill className="object-cover" priority />
            </div>

            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert guide on pregnancy and dental health: what you need to know from Indira Dental Clinic, Vellore. 
