...
const slug = 'tooth-bonding-quick-cosmetic-repair'




export const metadata: Metadata = {
  title: "Tooth Bonding Quick Cosmetic Repair: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on tooth bonding quick cosmetic repair. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'tooth, bonding, quick, cosmetic, repair, restorative dentistry, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Tooth Bonding Quick Cosmetic Repair | Indira Dental Clinic Vellore',
    description: 'Expert guide on tooth bonding quick cosmetic repair. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/tooth-bonding-quick-cosmetic-repair',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tooth Bonding Quick Cosmetic Repair'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['tooth, bonding, quick, cosmetic, repair'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Tooth Bonding Quick Cosmetic Repair',
    description: 'Expert guide on tooth bonding quick cosmetic repair. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson ',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/tooth-bonding-quick-cosmetic-repair'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Tooth Bonding: Quick Cosmetic Repair',
...
export default function ToothBondingQuickCosmeticRepairBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Tooth Bonding Quick Cosmetic Repair: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <section className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Tooth Bonding: Quick Cosmetic Repair is a crucial aspect of restorative dentistry. This comprehensive guide by Dr. Rockson Samuel 
