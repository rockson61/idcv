...
const slug = 'periodontitis-gum-disease-guide'




export const metadata: Metadata = {
  title: "Periodontitis Gum Disease Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel",
  description: 'Expert guide on periodontitis gum disease guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: 'periodontitis, gum, disease, guide, periodontics, dental health, vellore dentist, dr rockson samuel, indira dental clinic, dental treatment india',
  authors: [{ name: 'Dr. Rockson Samuel', url: 'https://www.dentalclinicinvellore.in/about-us/dr-rockson-samuel' }],
  openGraph: {
    title: 'Periodontitis Gum Disease Guide | Indira Dental Clinic Vellore',
    description: 'Expert guide on periodontitis gum disease guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
    url: 'https://www.dentalclinicinvellore.in/blog/periodontitis-gum-disease-guide',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Periodontitis Gum Disease Guide'
      }
    ],
    locale: 'en_IN',
    type: 'article',
    ...
    tags: ['periodontitis, gum, disease, guide'.split(', ').slice(0, 10).join("', '")]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Periodontitis Gum Disease Guide',
    description: 'Expert guide on periodontitis gum disease guide. Learn about causes, symptoms, treatment options, costs, and recovery. Professional advice from Dr. Rockson Samu',
  ...
  alternates: {
    canonical: 'https://www.dentalclinicinvellore.in/blog/periodontitis-gum-disease-guide'
  }
}
...
const articleSchema = {
  ...
  '@type': 'BlogPosting',
  headline: 'Periodontitis: Complete Guide to Gum Disease',
  ...
  mainEntityOfPage: {
    '@type': 'WebPage',
    '@id': 'https://www.dentalclinicinvellore.in/blog/periodontitis-gum-disease-guide'
  }
}

export default function PeriodontitisGumDiseaseGuideBlogPost() {
  return (
    <>
      <script
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
          <Breadcrumb
            items={[
              ...
              { title: 'Periodontitis: Complete Guide to Gum Disease', href: `/blog/periodontitis-gum-disease-guide` }
            ]}
          />
          ...
          <article className="mt-8">
            <div className="mb-8">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-[#005f73] mb-6 leading-tight">Periodontitis Gum Disease Guide: Complete Expert Guide (2024) | Dr. Rockson Samuel</h1>
            ...
            <div className="relative w-full h-96 mb-8 rounded-xl overflow-hidden">
              <Image
                ...
                alt="Periodontitis: Complete Guide to Gum Disease"
                fill
              ...
              <ModernCardContent>
                <ul className="space-y-2">
                  <li><Link href="#what-is" className="text-blue-600 hover:text-blue-800 flex items-center gap-2">
                    <ArrowRight className="w-4 h-4" /> What is Periodontitis: Complete Guide to Gum Disease?
                  </Link></li>
            ...
            <div className="prose prose-lg max-w-none mb-8">
              <p className="text-xl text-gray-700 leading-relaxed">
                Periodontitis: Complete Guide to Gum Disease is a common dental concern affecting millions of people in India. In this comprehensive guide, 
            ...
            <section id="what-is" className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                ...
                What is Periodontitis: Complete Guide to Gum Disease?
              </h2>
