  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <LocationSchema
        ...
        locationDescription={`Indira Dental Clinic offers top-quality dental care in ${locationName}, ${stateOrCountry}. Expert treatments, state-of-the-art technology, and personalized care by Dr. Rockson Samuel.`}
        pagePath={pagePath}
