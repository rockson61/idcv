            ...
            <GlassCard className="p-8">
              <div className="text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600">BDS, 15+ Years Experience</p>
                  ...
                  <div className="flex items-center justify-center gap-2 mt-4">
                    ...
                    <span className="text-gray-600">(4.9/5 from 126 reviews)</span>
                  </div>
                </div>
        ...
        <div className="text-center mt-16">
          <GlassCard className="p-8 bg-gradient-to-r from-[#005f73] to-[#54CAD3] text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-[#005f73] hover:bg-gray-100 font-bold" asChild>
