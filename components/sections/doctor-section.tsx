        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <GlassCard variant="default" className="p-6 bg-white/80 dark:bg-gray-800/80">
              <div className="relative h-[600px] rounded-xl overflow-hidden">
                ...
                <div className="absolute top-6 right-6">
                  <GlassCard variant="accent" className="p-3 bg-white/95 dark:bg-gray-800/95">
                    <div className="flex items-center gap-2">
                      <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                      <span className="font-bold text-lg text-gray-900 dark:text-white">4.9/5</span>
                    </div>
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">500+ Reviews</p>
                  </GlassCard>
                </div>

                {/* Achievement Badges */}
                <div className="absolute bottom-6 left-6 right-6 grid grid-cols-2 gap-3">
                  <GlassCard variant="default" className="p-3 bg-white/95 dark:bg-gray-800/95">
                  ...
                  <GlassCard variant="default" className="p-3 bg-white/95 dark:bg-gray-800/95">
                    ...
                    <div className="text-xs text-gray-600 dark:text-gray-400">Happy Patients</div>
                  </GlassCard>
                </div>
              </div>
            </GlassCard>
          ...
          <div className="space-y-8 animate-fade-in" style={{ animationDelay: "200ms" }}>
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-white">Dr. Rockson Samuel</h2>
              <p className="text-xl text-gray-700 dark:text-gray-400 mb-6 font-semibold">BDS, General Dentist</p>
              ...
              {achievements.map((achievement, index) => {
                ...
                return (
                  <GlassCard
                    key={index}
                    variant="default"
                    className="p-4 group hover:scale-105 transition-transform bg-white dark:bg-gray-800"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="font-bold text-gray-900 dark:text-white text-sm">{achievement.value}</div>
                      </div>
                    </div>
                  </GlassCard>
                )
            ...
            {/* Specializations */}
            <div>
              <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Areas of Expertise</h3>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-gray-900 text-gray-900 dark:border-white dark:text-white hover:bg-gray-100 dark:hover:bg-white/10 bg-transparent font-semibold"
                asChild
              >
