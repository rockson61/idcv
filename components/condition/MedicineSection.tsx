    ...
    <ModernCard className={`${className} mb-8`}>
      ...
      <ModernCardContent className="p-6">
          ...
          {medicines.map((medicine, index) => (
            <div key={index} className={`border-2 rounded-lg p-5 ${typeColors[medicine.type]} bg-opacity-50`}>
              <div className="flex items-start justify-between mb-3">
                ...
                <Pill className="w-6 h-6 text-gray-600 flex-shrink-0" />
              </div>

              <div className="space-y-3 mt-4">
                <div className="flex items-start gap-2">
                  <Info className="w-4 h-4 text-gray-600 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-xs font-semibold text-gray-600 mb-0.5">Purpose</p>
                    <p className="text-sm text-gray-800">{medicine.purpose}</p>
                  </div>
                </div>

                <div className="flex items-start gap-2">
                  <Pill className="w-4 h-4 text-gray-600 flex-shrink-0 mt-1" />
                  <div>
                    <p className="text-xs font-semibold text-gray-600 mb-0.5">Dosage</p>
                    <p className="text-sm text-gray-800 font-medium">{medicine.dosage}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-600 mb-0.5">Duration</p>
                    <p className="text-sm text-gray-800 font-medium">{medicine.duration}</p>
                  </div>
                </div>
                ...
                {medicine.sideEffects && medicine.sideEffects.length > 0 && (
                  <div className="flex items-start gap-2 mt-3 pt-3 border-t border-gray-300">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-gray-600 mb-1">Possible Side Effects</p>
        ...
        <div className="mt-6 bg-gradient-to-r from-teal-50 to-blue-50 border-2 border-teal-200 rounded-lg p-5 text-center">
          <h3 className="font-bold text-gray-900 mb-2">🏥 Get Proper Prescription</h3>
