...
console.log('🔄 Updating old blog posts to enhanced template...\n');
...
function generateEnhancedBlogPost(slug, title, category) {
...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to ${title.toLowerCase()}. Expert advice from Dr. Rockson Samuel at Indira Dental Clinic, Vellore.',
  keywords: '${slug.replace(/-/g, ', ')}, ${category.toLowerCase()}, dental health vellore',
}
          ...
          <article className="mt-8">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              <p className="text-xl text-gray-700 leading-relaxed">
                Comprehensive guide to ${title.toLowerCase()}. Learn from Dr. Rockson Samuel's expertise at Indira Dental Clinic, Vellore.
              </p>
            </div>
            ...
            <ModernCard className="mb-12 bg-gradient-to-r from-teal-50 to-blue-50 border-2 border-teal-300">
              <ModernCardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-6">Get expert ${category.toLowerCase()} treatment from Dr. Rockson Samuel in Vellore.</p>
...
const blogTitles = {
  'benefits-professional-teeth-whitening': { title: 'Benefits of Professional Teeth Whitening', category: 'Cosmetic Dentistry' },
  'complete-guide-root-canal-treatment': { title: 'Complete Guide to Root Canal Treatment', category: 'Endodontics' },
  'dental-implants-complete-guide': { title: 'Dental Implants: Complete Guide', category: 'Implantology' },
  'dental-implants-vellore': { title: 'Dental Implants in Vellore: Best Clinic', category: 'Implantology' },
  'oral-health-tips': { title: 'Essential Oral Health Tips for Everyone', category: 'Preventive Dentistry' }
};

let updated = 0;

oldBlogPosts.forEach(slug => {
  const blogDir = path.join(__dirname, '..', 'app', 'blog', slug);
  const pagePath = path.join(blogDir, 'page.tsx');
  
  if (!fs.existsSync(pagePath)) {
    console.log(`  ⏭️  Skipped: ${slug} (doesn't exist)`);
    return;
  }
  
  const info = blogTitles[slug];
  if (!info) {
    console.log(`  ⏭️  Skipped: ${slug} (no title info)`);
    return;
  }
  
  const content = generateEnhancedBlogPost(slug, info.title, info.category);
...
console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
console.log(`✅ Old Blog Posts Updated: ${updated}`);
console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
