...
// Phase 2: Endodontics & Implantology Blog Posts (40 posts)
const blogTopics = {
  endodontics: [
    { title: "Tooth Pulp Infection: Causes, Symptoms & Treatment", slug: "tooth-pulp-infection-treatment", category: "Endodontics" },
    { title: "Root Canal Pain: What to Expect and How to Manage", slug: "root-canal-pain-management", category: "Endodontics" },
    { title: "Dental Pulpitis: Complete Guide to Tooth Inflammation", slug: "dental-pulpitis-complete-guide", category: "Endodontics" },
    { title: "Periapical Abscess: Emergency Treatment Guide", slug: "periapical-abscess-emergency", category: "Endodontics" },
    { title: "Root Canal Failure: Causes and Re-Treatment Options", slug: "root-canal-failure-retreatment", category: "Endodontics" },
    { title: "Cracked Tooth Syndrome: Diagnosis and Treatment", slug: "cracked-tooth-syndrome-diagnosis", category: "Endodontics" },
    { title: "Single Sitting Root Canal: Benefits and Procedure", slug: "single-sitting-root-canal-benefits", category: "Endodontics" },
    { title: "Multi-Visit Root Canal: When and Why Needed", slug: "multi-visit-root-canal-guide", category: "Endodontics" },
    { title: "Molar Root Canal: Complete Treatment Guide", slug: "molar-root-canal-treatment-guide", category: "Endodontics" },
    { title: "Anterior Root Canal: Front Tooth Treatment", slug: "anterior-root-canal-front-tooth", category: "Endodontics" },
    { title: "Root Canal Retreatment (Re-RCT): When Required", slug: "root-canal-retreatment-re-rct", category: "Endodontics" },
    { title: "Apicectomy: Root Tip Surgery Explained", slug: "apicectomy-root-tip-surgery", category: "Endodontics" },
    { title: "Pulpotomy in Children: Procedure and Care", slug: "pulpotomy-children-procedure", category: "Pediatric Dentistry" },
    { title: "Pulp Capping: Saving Your Natural Tooth", slug: "pulp-capping-save-tooth", category: "Endodontics" },
    { title: "Root Canal Cost in India: Complete Breakdown", slug: "root-canal-cost-india-breakdown", category: "Endodontics" },
    { title: "Root Canal vs Extraction: Which is Better?", slug: "root-canal-vs-extraction-comparison", category: "Endodontics" },
    { title: "Root Canal with Crown: Complete Treatment", slug: "root-canal-with-crown-treatment", category: "Endodontics" },
    { title: "Painless Root Canal: Modern Techniques", slug: "painless-root-canal-modern-techniques", category: "Endodontics" },
    { title: "Root Canal Recovery: Post-Treatment Care", slug: "root-canal-recovery-care-tips", category: "Endodontics" },
    { title: "Root Canal Complications: Prevention Guide", slug: "root-canal-complications-prevention", category: "Endodontics" },
  ],
  implantology: [
    { title: "Dental Implants: Complete Guide to Permanent Teeth", slug: "dental-implants-complete-guide-permanent", category: "Implantology" },
    { title: "Bone Loss After Extraction: Prevention and Treatment", slug: "bone-loss-after-extraction-prevention", category: "Implantology" },
    { title: "Failed Dental Implant: Causes and Solutions", slug: "failed-dental-implant-causes-solutions", category: "Implantology" },
    { title: "Peri-Implantitis: Gum Disease Around Implants", slug: "peri-implantitis-gum-disease-implants", category: "Implantology" },
    { title: "Sinus Pneumatization: Challenge for Implants", slug: "sinus-pneumatization-implant-challenge", category: "Implantology" },
    { title: "Jawbone Atrophy: Causes and Bone Grafting", slug: "jawbone-atrophy-bone-grafting", category: "Implantology" },
    { title: "Single Tooth Implant: Procedure and Cost", slug: "single-tooth-implant-procedure-cost", category: "Implantology" },
    { title: "Multiple Teeth Implants: Treatment Options", slug: "multiple-teeth-implants-options", category: "Implantology" },
    { title: "All-on-4 Implants: Full Arch Restoration Guide", slug: "all-on-4-implants-full-arch-guide", category: "Implantology" },
    { title: "All-on-6 Implants: Complete Treatment Guide", slug: "all-on-6-implants-treatment-guide", category: "Implantology" },
    { title: "Zygomatic Implants: Solution for Severe Bone Loss", slug: "zygomatic-implants-bone-loss-solution", category: "Implantology" },
    { title: "Mini Dental Implants: Benefits and Applications", slug: "mini-dental-implants-benefits", category: "Implantology" },
    { title: "Immediate Load Implants: Same-Day Teeth", slug: "immediate-load-implants-same-day", category: "Implantology" },
    { title: "Delayed Load Implants: Traditional Approach", slug: "delayed-load-implants-traditional", category: "Implantology" },
    { title: "Bone Grafting for Implants: Complete Guide", slug: "bone-grafting-implants-complete-guide", category: "Implantology" },
    { title: "Sinus Lift Procedure: Preparation for Implants", slug: "sinus-lift-procedure-implants", category: "Implantology" },
    { title: "Ridge Augmentation: Building Bone for Implants", slug: "ridge-augmentation-building-bone", category: "Implantology" },
    { title: "Socket Preservation: Preventing Bone Loss", slug: "socket-preservation-prevent-bone-loss", category: "Implantology" },
    { title: "Dental Implant Cost in India: 2024 Prices", slug: "dental-implant-cost-india-2024", category: "Implantology" },
    { title: "Dental Implant Success Rate: Factors and Statistics", slug: "dental-implant-success-rate-factors", category: "Implantology" },
  ]
};
...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to ${title.toLowerCase()}. Expert advice from Dr. Rockson Samuel on causes, symptoms, treatment options, and prevention.',
  keywords: '${slug.replace(/-/g, ', ')}, ${category.toLowerCase()}, dental health, vellore dentist, dr rockson samuel',
  openGraph: {
    title: '${title}',
    description: 'Expert guide to ${title.toLowerCase()} from Indira Dental Clinic, Vellore',
          ...
          <article className="mt-8">
            ...
            <section id="introduction" className="mb-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-xl text-gray-700 leading-relaxed">
                  ${title} is an important aspect of modern dentistry that can significantly impact your oral health 
            ...
            <ModernCard className="mb-12 bg-gradient-to-r from-teal-50 to-blue-50 border-2 border-teal-300">
              <ModernCardContent className="p-8 text-center">
                ...
                <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
                  Get expert ${category.toLowerCase()} treatment from Dr. Rockson Samuel at Indira Dental Clinic, Vellore. 
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm leading-relaxed mb-3">
                      With over 15 years of experience in ${category.toLowerCase()}, Dr. Rockson Samuel is dedicated to 
            ...
            <div className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Link href="/blog/category/${category.toLowerCase().replace(/\\s+/g, '-')}" className="group">
                  <ModernCard className="h-full hover:shadow-xl transition-all border-2 border-gray-200 group-hover:border-teal-400">
                    <ModernCardContent className="p-6">
                      ...
                      <p className="text-sm text-gray-600">
                        Explore our comprehensive library of ${category.toLowerCase()} guides and expert advice.
                      </p>
                    </ModernCardContent>
                  </ModernCard>
                </Link>
...
console.log('🚀 Generating Phase 2 Blog Posts (Endodontics & Implantology)...\n');
...
// Generate Endodontics blogs
console.log('📂 Creating Endodontics blog posts...');
blogTopics.endodontics.forEach(topic => {
...
// Generate Implantology blogs
console.log('\n📂 Creating Implantology blog posts...');
blogTopics.implantology.forEach(topic => {
  const topicDir = path.join(blogDir, topic.slug);
  const pagePath = path.join(topicDir, 'page.tsx');
...
console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('✅ Phase 2 Blog Generation Complete!');
console.log(`   Created:  ${created} new blog posts`);
console.log(`   Skipped:  ${skipped} (already exist)`);
console.log(`   Total:    ${blogTopics.endodontics.length + blogTopics.implantology.length} topics processed`);
console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
console.log('\n📊 Blog Post Progress:');
console.log('   Phase 1 (Orthodontics & Periodontics): 40 posts ✅');
console.log('   Phase 2 (Endodontics & Implantology):  40 posts ✅');
console.log('   Total blog posts:                      310+');
console.log('\n✅ Each blog post includes:');
console.log('   • SEO-optimized metadata & schema');
console.log('   • Enhanced table of contents (12 sections)');
console.log('   • 4-step treatment procedure visual');
console.log('   • Cost comparison (Vellore vs Metro cities)');
console.log('   • Prevention tips (3 categories)');
console.log('   • Author box with credentials');
